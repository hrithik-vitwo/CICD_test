...
{
    if(empty($p_id)){ 
        $sql = "SELECT id,gl_code,gl_label,typeAcc,$coatype FROM `".ERP_ACC_CHART_OF_ACCOUNTS."` WHERE glStType='account' AND `status`!='deleted' ORDER BY `gl_code` ASC";
    }else{
                    ...
                    <div class="card card-tabs" style="border-radius: 20px;">
                        ...
                        <div class="tab-content pt-0" id="custom-tabs-two-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    ?>
                                        ...
                                        <?php if ($coatype == $colmn['COLUMN_NAME']) { ?>
                                            <select class="form-control view-dropdown" name="coaDropdown" id="coaDropdown">
                                                ...
                                                <option value="gl-view.php?coatype=<?= $colmn['COLUMN_NAME']; ?>" selected>GL View</option>
                                            </select>
                                    <?php }
                                    } ?>
                                </div>
                                ...
                                <table class="table defaultDataTable table-hover gl-view-table">
                                    <thead>
                                        <tr class="alert-light">
                                            <th rowspan="2" class="border vertical-align">GL Code</th>
                                            <th rowspan="2" class="border vertical-align">GL Name</th>
                                            <th rowspan="2" class="border vertical-align">Type</th>
                                            <th rowspan="2" class="border vertical-align">Group 1</th>
                                            <th rowspan="2" class="border vertical-align">Group 2</th>
                                            <th rowspan="2" class="border vertical-align">Group 3</th>
                                            <th rowspan="2" class="text-center border">Group 4</th>
                                            <th rowspan="2" class="border vertical-align">Group 5</th>
                                            <th rowspan="2" class="border vertical-align">Group 6</th>
                                            <th rowspan="2" class="text-center border">Group 7</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                       // console($glAccList);
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $data['gl_code'] ?></td>
                                                <td><?= $data['gl_label'] ?></td>
                                                <td><?php if($data['typeAcc'] == 1 || $data['typeAcc'] == 2) { echo "Balance Sheet"; } else { echo "Profit and Loss"; }  ?></td>
                                                <td><?php if(isset($data['data'][0])) { echo $data['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                                <td><?php if(isset($data['data'][0]['data'][0])) { echo $data['data'][0]['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                                <td><?php if(isset($data['data'][0]['data'][0]['data'][0])) { echo $data['data'][0]['data'][0]['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                                <td><?php if(isset($data['data'][0]['data'][0]['data'][0]['data'][0])) { echo $data['data'][0]['data'][0]['data'][0]['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                                <td><?php if(isset($data['data'][0]['data'][0]['data'][0]['data'][0]['data'][0])) { echo $data['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                                <td><?php if(isset($data['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['data'][0])) { echo $data['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                                <td><?php if(isset($data['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['data'][0])) { echo $data['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['data'][0]['gl_label']; } else { echo "-"; }?></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>

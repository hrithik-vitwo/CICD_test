...
if ($processStatementObj["status"] != "success") {
    ...
    <form action="" method="post" id="statementForm_<?= $_POST["bank_id"] ?>">
        <input type="hidden" name="statement_data" value="<?= base64_encode($processStatementObj["data"]) ?>">
        ...
        <button type="submit" name="submitOcrStatementBtn" class="form-control">Save Statement</button>
    </form>
<?php
}

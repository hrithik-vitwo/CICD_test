...
if (isset($_POST["changeStatus"])) {
    ...
    // console($_POST);
    // exit();
    $newStatusObj = ChangeStatusfunctionalities($_POST, "table_id", "status");
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Table</a></li>
                            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Table</a></li>
                        </ol>
                    </div>
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
                            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Table</a></li>
                            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Edit Table</a></li>
                        </ol>
                    </div>
                    <div class="col-md-6" style="display: flex;">
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
                            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Table</a></li>
                            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">View Table</a></li>
                        </ol>
                    </div>
                    <div class="col-md-6" style="display: flex;">
                        <a href="<?= basename($_SERVER['PHP_SELF']); ?>"><button class="btn btn-danger btnstyle ml-2">Back</button></a>
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="add_frm" name="add_frm">
                                        ...
                                        <div class="modal-content card">
                                            <div class="modal-header card-header pt-2 pb-2 px-3">
                                                <h4 class="text-xs text-white mb-0">Create Table</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-input mb-3">
                                                            ...
                                                            <span class="error table_name"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            <label>Description</label>
                                                            <input type="text" name="table_desc" class="form-control" id="table_desc" value="" required>
                                                            <span class="error table_desc"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            <label>Code</label>
                                                            <input type="text" name="table_code" class="form-control" id="table_code" value="TABLE<?php echo time(); ?>" required readonly>
                                                            <span class="error table_code"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            ...
                                                            <select name="location" class="form-control" id="location">
                                                                ...
                                                                <?php
                                                                $location = queryGet("SELECT * FROM `erp_branch_otherslocation` AS loc LEFT JOIN `erp_branches` AS branch ON loc.branch_id  = branch.branch_id WHERE loc.`company_id`=$company_id AND `othersLocation_status`!='deleted' ", true);


                                                                foreach ($location['data'] as $location) {
                                                                ?>
                                                                    <option value="<?= $location['othersLocation_id'] ?>"><?= $location['othersLocation_name'] . "(" . $location['othersLocation_code'] . ")[Branch-" . $location['branch_name'] . "]" ?></option>
                                                                <?php
                                                                }
                                                                ?>
                                                            </select>
                            ...
                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] != '') {
                                        $cond .= " AND (`table_name` like '%" . $_REQUEST['keyword'] . "%' OR `table_description` like '%" . $_REQUEST['keyword'] . "%')";
                                    }

                                    $sql_list = "SELECT * FROM `erp_table_master` WHERE 1 " . $cond . " " . $sts . " AND company_id='" . $company_id . "' ORDER BY table_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                    $qry_list = mysqli_query($dbCon, $sql_list);
                                    $num_list = mysqli_num_rows($qry_list);


                                    $countShow = "SELECT count(*) FROM `erp_table_master` WHERE 1 " . $cond . " AND company_id='" . $company_id . "' " . $sts . " ";
                                    $countQry = mysqli_query($dbCon, $countShow);
                                    $rowCount = mysqli_fetch_array($countQry);
                                    $count = $rowCount[0];
                                    $cnt = $GLOBALS['start'] + 1;
                                    $settingsTable = getTableSettings(TBL_COMPANY_ADMIN_TABLESETTINGS, "ERP_TABLE", $company_id);
                                        ...
                                        <table id="mytable" class="table defaultDataTable table-hover text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($qry_list)) {
                                                    $loc = queryGet("SELECT * FROM `erp_branch_otherslocation` WHERE `othersLocation_id` = '" . $row['location_id'] . "'");
                                                ?>
                                                    <tr>
                                                        <td><?= $cnt++ ?></td>
                                                        <?php if (in_array(1, $settingsCheckbox)) { ?>
                                                            <td><?= $row['table_name'] . '(' . $row['table_code'] . ')' ?></td>
                                                        <?php }
                                                        if (in_array(2, $settingsCheckbox)) { ?>
                                                        ...
                                                        if (in_array(3, $settingsCheckbox)) { ?>
                                                            <td><?php if ($row['location_id'] != 0) {
                                                                    echo $loc['data']['othersLocation_name'] . '(' . $loc['data']['othersLocation_code'] . ')';
                                                                } ?></td>
                                                        <?php
                                                        }
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['table_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="View Branch"><i class="fa fa-eye po-list-icon"></i></a> -->
                                                            <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['table_id']; ?>" style="cursor: pointer;" class="btn btn-sm" data-toggle="modal" data-target="#editFunctionality_<?= $row['table_id'] ?>" title="Edit Branch"><i class="fa fa-edit po-list-icon"></i></a>


                                                            <div class="modal fade add-modal func-add-modal" id="editFunctionality_<?= $row['table_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="add_frm" name="add_frm">
                                                                        <input type="hidden" name="editdata" id="editdata" value="">
                                                                        <input type="hidden" name="id" id="" value="<?= $row['table_id'] ?>">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                        <div class="form-input mb-3">
                                                                                            <label>Table Name* </label>
                                                                                            <input type="text" class="form-control" id="table_name" name="table_name" value="<?= $row['table_name'] ?>" required>
                                                                                            <span class="error table_name"></span>
                                                                                        </div>
                                                                                        <div class="form-input">
                                                                                            <label>Description</label>
                                                                                            <input type="text" name="table_desc" class="form-control" id="table_desc" value="<?= $row['table_description'] ?>" required>
                                                                                            <span class="error table_desc"></span>
                                                                                        </div>
                                                                                        <div class="form-input">
                                                                                            <label>Code</label>
                                                                                            <input type="text" name="table_code" class="form-control" id="table_code" value="<?= $row['table_code'] ?>" required readonly>
                                                                                            <span class="error work_center_code"></span>
                                                                                        </div>
                                                                                        <div class="form-input">
                                                                                            <label> Select Location</label>
                                                                                            <select name="location" class="form-control" id="location">
                                                                                                ...
                                                                                                ?>
                                                                                                    ...
                                                                                                    <option value="<?= $location['othersLocation_id'] ?>" <?php if ($location['othersLocation_id'] == $row['location_id']) {
                                                                                                                                                                echo "selected";
                                                                                                                                                            } ?>><?= $location['othersLocation_name'] . "(" . $location['othersLocation_code'] . ")" ?></option>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                                            ...
                                            <input type="hidden" name="pageTableName" value="ERP_TABLE" />
                                            <div class="modal-body">
                                                ...
                                                <div id="main2">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="width: 165px"><input type="checkbox" <?php echo (in_array(7, $settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox10" value="7" />
                                                                Modified At</td>
                                                        </tr>

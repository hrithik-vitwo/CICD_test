...
if (isset($_POST['add_branch_location'])) {
  // console($_POST);
  $companyId = $_POST['fldAdminCompanyId'];
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="input-group">
                            <select name="branchId" class="form-control" id="selectedBranch">
                              <option value="">Select Branch</option>
                              <?php
                              $getBranchId = base64_decode($_GET['branchLocation']);
                              $sql = "SELECT `branch_id`,`branch_code`,`branch_name` FROM `erp_branches` WHERE `branch_status`='active' ORDER BY `branch_id` DESC";
                              $res = $dbCon->query($sql);
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          ?>
                            <span>
                              ...
                              <label><?= $row['functionalities_name'] ?></label>
                            </span>
                          <?php } ?>
                        </div>
                      </div>
                ...
                <div class="card-body fontSize">
                  <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade show active aiBranchDetails1" id="aiBranchDetails1" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                      <span class="text-warning">Please select a <strong>Branch!</strong></span>
                    </div>
          ...
          <div class="col-12 mt-2 p-0">
            <div class="card card-tabs">
              ...
              <table class="table">
                ...
                <?php
                $sql = "SELECT * FROM `erp_branch_otherslocation` WHERE `othersLocation_status`='active'";
                $res = $dbCon->query($sql);
                $i = 1;
                while ($row = $res->fetch_assoc()) {
                ...
                ?>
                  <tr>
                    ...
                    <td><strong class="text-capitalize text-secondary"><?= $row['othersLocation_status'] ?></strong></td>
                    <td>
                      <button class="btn text-info" data-toggle="modal" data-target="#locationModal_<?= $row['othersLocation_id'] ?>"><i class="fa fa-eye"></i></button>
                    </td>
                  </tr>
                  <!-- Modal -->
                              ...
                              <div class="row px-3 p-0 m-0" style="place-items: self-start;">
                                ...
                                <div class="col-md-6">
                                  <div class="row m-2 py-2 shadow-sm bg-light">
                                    ...
                                    <div class="col-md-6">
                                      <span><?= $row['othersLocation_created_at'] ?></span>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                  <div class="row m-2 py-2 shadow-sm bg-light">
                                    ...
                                    <div class="col-md-6">
                                      <span><?= $row['othersLocation_updated_at'] ?></span>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on("keyup paste keydown", "#branch_gstin", function() {
      ...
      if (leng_gstin > 14) {
        $("#CustomerPanNo").val(branch_gstin.substr(2, 10));

...
if (isset($_POST["createdata"])) {
    // console($_POST);
    // exit();
    $addNewObj = create_work_center($_POST);
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Work Center</a></li>
                            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Work Center</a></li>
                        </ol>
                    </div>
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
                            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Work Center</a></li>
                            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Edit Work Center</a></li>
                        </ol>
                    </div>
                    <div class="col-md-6" style="display: flex;">
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
                            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Work Center</a></li>
                            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">View Work Center</a></li>
                        </ol>
                    </div>
                    <div class="col-md-6" style="display: flex;">
                        <a href="<?= basename($_SERVER['PHP_SELF']); ?>"><button class="btn btn-danger btnstyle ml-2">Back</button></a>
                    ...
                    <div class="col-12 mt-2 p-0">
                        ...
                        <ul class="nav nav-tabs mb-3 border-bottom-0" id="custom-tabs-two-tab" role="tablist">
                            <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                <h3 class="card-title">Manage Work Center</h3>
                        ...
                        <div class="card card-tabs">
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="add_frm" name="add_frm">
                                        ...
                                        <div class="modal-content card">
                                            <div class="modal-header card-header pt-2 pb-2 px-3">
                                                <h4 class="text-xs text-white mb-0">Create Work Center</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-input mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="work_center_name" name="work_center_name" required>
                                                            <span class="error work_center_name"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            <label>Description</label>
                                                            <input type="text" name="work_center_desc" class="form-control" id="work_center_desc" value="" required>
                                                            <span class="error work_center_desc"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            <label>LHR</label>
                                                            <input type="text" name="work_center_lhr" class="form-control" id="work_center_lhr" value="" required>
                                                            <span class="error work_center_lhr"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            <label>MHR</label>
                                                            <input type="text" name="work_center_mhr" class="form-control" id="work_center_mhr" value="" required>
                                                            <span class="error work_center_mhr"></span>
                                                        </div>
                                                        <div class="form-input">
                                                            <label>Code</label>
                                                            <input type="text" name="work_center_code" class="form-control" id="work_center_code" value="WC<?php echo time(); ?>" required readonly>
                                                        ...
                                                        <div class="form-input">
                                                            ...
                                                            <select name="parent" class="form-control" id="parent">
                                                                ...
                                                                <?php
                                                                $cc = queryGet("SELECT * FROM `erp_cost_center` WHERE `company_id`=$company_id", true);
                                                                foreach ($cc['data'] as $cc) {

                                                                ?>
                                                                    <option value="<?= $cc['CostCenter_id'] ?>"><?= $cc['CostCenter_code'].'('.$cc['CostCenter_desc'].')' ?></option>
                                                                <?php
                                                                }
                                                                ?> </select>
                            ...
                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    $count = $rowCount[0];
                                    $cnt = $GLOBALS['start'] + 1;
                                    $settingsTable = getTableSettings(TBL_COMPANY_ADMIN_TABLESETTINGS, "ERP_WORK_CENTER", $company_id);
                                        ...
                                        <table id="mytable" class="table defaultDataTable table-hover text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($qry_list)) {
                                                    ...
                                                    $get_cost_center = queryGet("SELECT * FROM `erp_cost_center` WHERE `CostCenter_id`='" . $row['cost_center_id'] . "'");

                                                   // $code = $get_cost_center['data']['CostCenter_desc'];
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if (in_array(1, $settingsCheckbox)) { ?>
                                                            <td>
                                                                <p class="pre-normal"><?= $row['work_center_name'] . '(' . $row['work_center_code'] . ')' ?></p>
                                                            </td>
                                                        <?php }
                                                        if (in_array(2, $settingsCheckbox)) { ?>
                                                            <td>
                                                                <p class="pre-normal"><?= $row['work_center_description'] ?></p>
                                                            </td>
                                                        <?php }
                                                        if (in_array(3, $settingsCheckbox)) { ?>
                                                            <td><?php if($get_cost_center['numRows'] > 0) { echo $get_cost_center['data']['CostCenter_code'].'('. $get_cost_center['data']['CostCenter_desc'].')'; }?></td>
                                                        <?php }
                                                         if (in_array(4, $settingsCheckbox)) { ?>
                                                            ...
                                                            <div class="modal fade add-modal func-add-modal" id="editFunctionality_<?= $row['work_center_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="add_frm" name="add_frm">
                                                                        ...
                                                                        <div class="modal-content card">
                                                                            <div class="modal-header card-header pt-2 pb-2 px-3">
                                                                                <h4 class="text-xs text-white mb-0">Edit Work Center</h4>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                        <div class="form-input mb-3">
                                                                                            <label>Work Center Name* </label>
                                                                                            <input type="text" class="form-control" id="work_center_name" name="work_center_name" value="<?= $row['work_center_name'] ?>" required>
                                                                                            <span class="error work_center_name"></span>
                                                                                        </div>
                                                                                        <div class="form-input">
                                                                                            <label>Description</label>
                                                                                            <input type="text" name="work_center_desc" class="form-control" id="work_center_desc" value="<?= $row['work_center_description'] ?>" required>
                                                                                            <span class="error work_center_desc"></span>
                                                                                        </div>

                                                                                        <div class="form-input">
                                                                                            <label>LHR</label>
                                                                                            <input type="text" name="work_center_lhr" class="form-control" id="work_center_lhr" value="<?= $row['wc_lhr'] ?>" required>
                                                                                            <span class="error work_center_lhr"></span>
                                                                                        </div>

                                                                                        <div class="form-input">
                                                                                            <label>MHR</label>
                                                                                            <input type="text" name="work_center_mhr" class="form-control" id="work_center_mhr" value="<?= $row['wc_mhr'] ?>" required>
                                                                                            <span class="error work_center_mhr"></span>
                                                                                        </div>

                                                                                        <div class="form-input">
                                                                                            <label>Code</label>
                                                                                            <input type="text" name="work_center_code" class="form-control" id="work_center_code" value="<?= $row['work_center_code'] ?>" required readonly>
                                                                                            <span class="error work_center_code"></span>
                                                                                        </div>
                                                                                         ...
                                                                                         <div class="form-input">
                                                                                            ...
                                                                                            <select name="parent" class="form-control" id="parent">
                                                                                                ...
                                                                                                foreach ($cc['data'] as $cc) {
                                                                                                ?>
                                                                                                    <option value="<?= $cc['CostCenter_id'] ?>" <?php if ($row['cost_center_id'] == $cc['CostCenter_id']) {
                                                                                                                                                    echo "selected";
                                                                                                                                                } ?>><?= $cc['CostCenter_code'] .'(' .$cc['CostCenter_desc'] .')'?></option>
                                                                                                <?php
                                                                                                }
                                                                                                ?>
                                                                                            </select>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                                            ...
                                            <input type="hidden" name="pageTableName" value="ERP_WORK_CENTER" />
                                            <div class="modal-body">
                                                ...
                                                <div id="main2">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="width: 165px"><input type="checkbox" <?php echo (in_array(6, $settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox10" value="5" />
                                                                Modified By</td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" style="width: 165px"><input type="checkbox" <?php echo (in_array(7, $settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox10" value="6" />
                                                                Modified At</td>
                                                        </tr>
                                                    </table>
                                                </div>

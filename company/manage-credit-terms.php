        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add CreditTerms</a></li>
            </ol>
          </div>
        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
              <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage CreditTerms</a></li>
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">View CreditTerms</a></li>
            </ol>
          </div>
          <div class="col-md-6" style="display: flex;">
            <a href="<?= basename($_SERVER['PHP_SELF']); ?>"><button class="btn btn-danger btnstyle ml-2">Back</button></a>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="input-group">
                            <select id="" name="goodsType" class="select2 form-control form-control-border borderColor">
                              <option value="">CreditTerms Type</option>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="input-group">
                            <select name="goodsGroup" class="select4 form-control form-control-border borderColor">
                              <option value="">CreditTerms Group</option>
                              <option value="A">A</option>
                              <option value="B">B</option>
                            </select>
                          </div>
          ...
          <div class="col-12 mt-2 p-0">
            <ul class="nav nav-tabs border-bottom-0" id="custom-tabs-two-tab" role="tablist">
              <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                <h3 class="card-title mb-3">Manage Credit Terms</h3>
                <a href="<?php echo basename($_SERVER['PHP_SELF']) ?>?create" class="btn btn-sm btn-primary float-add-btn" data-toggle="modal" data-target="#creditTermsAddForm"><i class="fa fa-plus"></i></a>
              </li>
            </ul>
            <div class="card card-tabs">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12">
                      ...
                      <div class="row table-header-item">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1">
                          ...
                          <a href="<?php echo basename($_SERVER['PHP_SELF']) ?>?create" class="btn btn-sm btn-primary relative-add-btn" data-toggle="modal" data-target="#creditTermsAddForm"><i class="fa fa-plus"></i></a>
              ...
              <div class="modal fade add-modal credit-terms-add-modal" id="creditTermsAddForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="add_frm" name="add_frm">
                    ...
                    <div class="modal-content card">
                      <div class="modal-header card-header pt-2 pb-2 px-3">
                        <h4 class="text-xs text-white mb-0">Create Credit Terms</h4>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-input mb-3">
                              <label>Credit Period(In Days)* </b></label>
                              <input type="number" class="form-control" id="credit_terms_name" name="credit_terms_name">
                              <span class="error credit_terms_name"></span>
                            </div>
                            <div class="form-input">
                              <label>Description</label>
                              <input type="text" name="credit_terms_desc" class="form-control" id="credit_terms_desc" value="">
                              <span class="error credit_terms_desc"></span>
                            </div>
                          </div>
                        </div>
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                  ...
                  $sql_list = "SELECT * FROM `" . ERP_CREDIT_TERMS . "` WHERE 1 " . $cond . " " . $sts . " AND company_id='" . $_SESSION["logedCompanyAdminInfo"]["fldAdminCompanyId"] . "' ORDER BY credit_terms_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . "";
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><?= $cnt++ ?></td>
                            <?php if (in_array(1, $settingsCheckbox)) { ?>
                              <td><?= $row['credit_terms_name'] ?></td>
                            <?php }
                            if (in_array(2, $settingsCheckbox)) { ?>
                              <td><?= $row['credit_terms_desc'] ?></td>
                            <?php }
                            if (in_array(3, $settingsCheckbox)) { ?>
                              <td><?= $row['credit_terms_created_by'] ?></td>
                            <?php }
                            if (in_array(4, $settingsCheckbox)) { ?>
                              <td><?= formatDateTime($row['credit_terms_created_at']); ?></td>
                            <?php }
                            if (in_array(5, $settingsCheckbox)) { ?>
                              <td><?= $row['credit_terms_updated_by'] ?></td>
                            <?php }
                            if (in_array(6, $settingsCheckbox)) { ?>
                              <td><?= formatDateTime($row['credit_terms_updated_at']); ?></td>
                            <?php } ?>
                            <td>
                              <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                <input type="hidden" name="id" value="<?php echo $row['credit_terms_id'] ?>">
                                <input type="hidden" name="changeStatus" value="active_inactive">
                                <button <?php if ($row['credit_terms_status'] == "draft") { ?> type="button" style="cursor: inherit; border:none" <?php } else { ?>type="submit" onclick="return confirm('Are you sure change Status?')" style="cursor: pointer; border:none" <?php } ?> class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="<?php echo $row['credit_terms_status'] ?>">
                                  <?php if ($row['credit_terms_status'] == "active") { ?>
                                    <span class="status"><?php echo ucfirst($row['credit_terms_status']); ?></span>
                                  <?php } else if ($row['credit_terms_status'] == "inactive") { ?>
                                    <span class="status-danger"><?php echo ucfirst($row['credit_terms_status']); ?></span>
                                  <?php } else if ($row['credit_terms_status'] == "draft") { ?>
                                    <span class="status-warning"><?php echo ucfirst($row['credit_terms_status']); ?></span>
                            ...
                            <td>
                              ...
                              <!-- <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['credit_terms_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="View Branch"><i class="fa fa-eye po-list-icon"></i></a> -->
                              <!-- <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['credit_terms_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="Edit Branch" data-toggle="modal" data-target="#editCreditTerms"><i class="fa fa-edit po-list-icon"></i></a> -->
                              <a style="cursor: pointer;" class="btn btn-sm" title="Edit Branch" data-toggle="modal" data-target="#editCreditTerms"><i class="fa fa-edit po-list-icon"></i></a>

                              <form action="" method="POST" class="btn btn-sm">
                                <input type="hidden" name="id" value="<?php echo $row['credit_terms_id'] ?>">
                                <input type="hidden" name="changeStatus" value="delete">
                                <button title="Delete Branch" type="submit" onclick="return confirm('Are you sure to delete?')" class="btn btn-sm p-0" style="cursor: pointer; border:none"><i class="fa fa-trash po-list-icon"></i></button>
                              </form>
                            </td>

                            <div class="modal fade add-modal credit-terms-add-modal" id="editCreditTerms" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <form method="POST" action="" name="edit_credit_term" value="edit_credit_term">
                                  <input type="hidden" name="editdata" id="editdata" value="">
                                  <div class="modal-content card">
                                    <div class="modal-header card-header pt-2 pb-2 px-3">
                                      <h4 class="text-xs text-white mb-0">Edit Credit Terms</h4>
                                    </div>
                                    <div class="modal-body">
                                      <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                          <input type="hidden" value="<?= $row['credit_terms_id'] ?>" name="id">
                                          <div class="form-input mb-3">
                                            <label>Credit Period(In Days)* </b></label>
                                            <input type="number" class="form-control" name="name" value="<?= $row['credit_terms_name'] ?>">

                                          </div>
                                          <div class="form-input">
                                            <label>Description</label>
                                            <input type="text" name="desc" class="form-control" value="<?= $row['credit_terms_desc'] ?>">
                                    ...
                                    <div class="modal-footer">
                                      <button type="submit" class="btn btn-primary" value="" id="btnUpdate">Update</button>
                                    </div>
                                  </div>
                                </form>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                      ...
                      <input type="hidden" name="pageTableName" value="ERP_CREDIT_TERMS" />
                      <div class="modal-body">
...
<script>
  ...
  $(".add_data").click(function() {
    ...
    let flag = 1;
    var Ragex = "/[0-9]/";
    if ($("#credit_terms_name").val() == "") {
      $(".credit_terms_name").show();
      $(".credit_terms_name").html("Credit Period is requried.");
      flag++;
    }
    // } else {
    //   if ($("#credit_terms_name").val().match(Ragex)) {
    //     $(".credit_terms_name").hide();
    //     $(".credit_terms_name").html("");
    //   } else {
    //     $(".credit_terms_name").show();
    //     $(".credit_terms_name").html("Enter a valid Credit period.");
    //     flag++;
    //   }
    // }
    if ($("#credit_terms_desc").val() == "") {
      $(".credit_terms_desc").show();
      $(".credit_terms_desc").html("Description is requried.");
      flag++;
    } else {
      $(".credit_terms_desc").hide();
      $(".credit_terms_desc").html("");
    }
  ...
  $("").click(function() {
    ...
    if ($("#credit_terms_name").val() == "") {
      ...
      if ($("#credit_terms_name").val().match(Ragex)) {
        console.log($("#credit_terms_name").val())
        $(".credit_terms_name").hide();
        $(".credit_terms_name").html("");
      } else {
        console.log("1")
        $(".credit_terms_name").show();
        $(".credit_terms_name").html("Enter a valid Credite period.");
        flag++;
      }
    }
    if ($("#credit_terms_desc").val() == "") {

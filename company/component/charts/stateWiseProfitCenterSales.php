...
$searchValue = "stateWiseSalesProfitCenter"; // Add this from ajax "?chart=" value
...
?>
<!-- HTML -->
<!-- STATE WISE PROFIT CENTER SALES -->
<div class="col-md-6 col-sm-6 d-flex">
    <div class="card flex-fill stateWiseSalesProfitCenter">
        <div class="card-header">
            <div class="head-title">
                <button class="btn btn-primary pin-btn border" id="stateWiseProfitCenterSales"><?= chartExistorNot('stateWiseProfitCenterSales.php') ? 'Pinned' : 'Pin'; ?></button>
                <h5 class="card-title chartDivStateWiseProfitCenterSales"></h5>
            </div>
        ...
        <div class="card-body">
            ...
            <div id="chartDivStateWiseProfitCenterSales" class="chartContainer"></div>
        </div>
    </div>
</div>
<!-- STATE WISE PROFIT CENTER SALES -->
...
<script>
    // **************************************************** CHART FUNCTION ********************************************************
    // ============================= STATE WISE PROFIT CENTER SALES ===============================
    function stateWiseProfitCenterSales(chartData, chartTitle) {

        $(`.${chartTitle}`).text(`State Wise Profit Center Sales`);
        ...
        am4core.ready(function() {
            ...
            for (let obj of chartData) {
                ...
                outerIndex = outerObj.indexOf(obj.profit_center)
    ...
    // ===============================================================================================
    var quickDrop = $(".stateWiseSalesProfitCenter").find("select.quickDrop").val();

    function get_stateWiseProfitCenterSales(quickDrop, search) {
        // AJAX CALL 
        $.ajax({
            url: `<?= BASE_URL ?>company/ajaxs/reports/ajax-charts.php?chart=stateWiseSalesProfitCenter&search=${search}&quickDrop=${quickDrop}`,
            async: false,
            beforeSend: function() {
                $(".load-wrapp").show();
            ...
            success: function(result) {
                ...
                // =======================================================================================================================================
                stateWiseProfitCenterSales(res.stateWiseSalesProfitCenter.data, "chartDivStateWiseProfitCenterSales");
                // =======================================================================================================================================
            }
        });
    }

    get_stateWiseProfitCenterSales(quickDrop, null);

    $('.applyFilter<?= $searchValue; ?>').click(function() {
        var quickDrop = $(".stateWiseSalesProfitCenter").find("select.quickDrop").val();

        get_stateWiseProfitCenterSales(quickDrop, 'searching');
    });
</script>
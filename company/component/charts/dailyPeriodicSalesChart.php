...
<div class="col-md-12 col-sm-12 d-flex">
    <div class="card flex-fill dailyPeriodicSales">
...
<script>
    ...
    function get_dailyPeriodicSales(quickDrop, search) {
        // AJAX CALL 
        $.ajax({
            url: `<?= BASE_URL ?>company/ajaxs/reports/ajax-charts.php?chart=dailyPeriodicSales&search=${search}&quickDrop=${quickDrop}`,
            async: false,
            beforeSend: function() {
                $(".load-wrapp").show();

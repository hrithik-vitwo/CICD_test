                        ...
                        <div class="card card-tabs">
                            ...
                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    $sql_list = "SELECT * FROM `erp_customer_discount_group` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "' ORDER BY customer_discount_group_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                    ...
                                    $countShow = "SELECT count(*) FROM `erp_customer_discount_group` WHERE 1 " . $cond . " AND company_id='" . $company_id . "' ";

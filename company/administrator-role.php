                    ...
                    <div class="col-12 m-0 p-0">
                        <div class="card card-primary card-tabs">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="btn btn-warning btnstyle text-light">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                    <form action="" method="POST">
                                        ...
                                        <div class="col-12">
                                            <a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="btn btn-warning btnstyle text-light">Cancel</a>
                                            <button type="submit" name="updateAdminRoleFormBtn" class="btn btn-dark btnstyle">Modify Role</button>
                                        </div>
                                    </form>
                                <?php
                                } else {
                                ...
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="" method="POST">
                                                                    ...
                                                                    <button type="submit" onclick="return confirm('Are you sure change status?')" class="" style="cursor: pointer; border:none" data-toggle="tooltip" data-placement="top" title="<?= $listRowStatus ?>">
                                                                        <?php echo ($listRowStatus == "active") ? '<i class="fa fa-toggle-on pol-list-icon" ></i>' : '<i class="fa fa-toggle-off text-warning"></i>'; ?>
                                                                    </button>
                                                                </form>
                                                            </td>
                                                            <td>
                                                                <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $listRowKey; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-eye po-list-icon"></i></a>
                                                                <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $listRowKey; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-edit po-list-icon"></i></a>
                                                                <form action="" method="POST">
                                                                    <input type="hidden" name="id" value="<?= $listRowKey ?>">
                                                                    <input type="hidden" name="changeStatus" value="delete">
                                                                    <button type="submit" onclick="return confirm('Are you sure to delete?')" class="btn btn-sm" style="cursor: pointer; border:none"><i class='fa fa-trash text-danger po-list-icon'></i></button>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    <?php
                                    ...
                                    <div class="tab-pane fade" id="addNewTabPan" role="tabpanel" aria-labelledby="addNewTab">
                                        <form action="" method="POST">
                                            ...
                                            <div class="col-12">
                                                <a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="btn btn-warning btnstyle text-light">Cancel</a>
                                                <button type="submit" name="addNewAdminRoleFormBtn" class="btn btn-dark btnstyle">Add New Role</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>

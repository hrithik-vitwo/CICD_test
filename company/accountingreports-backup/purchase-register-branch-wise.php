                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <div class="label-select">
                      <h3 class="card-title mb-0">Purchase Register Branch Wise</h3>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT branch.branch_name AS branch_name,location.othersLocation_name AS location_name,grn.vendorCode AS vendor_code,grn.vendorName AS vendor_name,SUM(grn.grnTotalAmount) AS total_amount,SUM(grn.dueAmt) AS total_due_amount FROM erp_grninvoice AS grn LEFT JOIN erp_branches AS branch ON grn.branchId=branch.branch_id LEFT JOIN erp_branch_otherslocation AS location ON grn.locationId=location.othersLocation_id WHERE grn.companyId=$company_id AND grn.postingDate BETWEEN '2022-04-01' AND '2023-03-31' AND grn.grnStatus='active' GROUP BY branch_name,location_name,vendor_code,vendor_name;";
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT branch.branch_name AS branch_name,SUM(grn.grnTotalAmount) AS total_amount,SUM(grn.dueAmt) AS total_due_amount FROM erp_grninvoice AS grn LEFT JOIN erp_branches AS branch ON grn.branchId=branch.branch_id LEFT JOIN erp_branch_otherslocation AS location ON grn.locationId=location.othersLocation_id WHERE grn.companyId=$company_id AND grn.postingDate BETWEEN '2022-04-01' AND '2023-03-31' AND grn.grnStatus='active' GROUP BY branch_name;";
                      ...
                      <div class="row">
                        <div class="col-md-12 col-sm-12 d-flex">
                          <div class="card flex-fill reports-card">
                            ...
                            <div class="card-body">
                              <div id="chartDivPurchaseRegisterBranchWise" class="chartContainer"></div>
                            </div>
                          </div>
                        </div>
                      </div>
...
<script>
  ...
  am4core.ready(function() {
    ...
    var chart = am4core.create("chartDivPurchaseRegisterBranchWise", am4charts.XYChart);

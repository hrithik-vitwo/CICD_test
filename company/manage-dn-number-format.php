...
if (isset($_POST["changeStatus"])) {
  ...
  $id = $_POST["id"];
  $update = queryUpdate("UPDATE `erp_dn_varient` SET status='deleted' WHERE `id`=$id");
}
...
if (isset($_POST["submitInvNumber"]) && isset($_POST["createdata"])) {
  ...
  $insert = queryInsert("INSERT INTO `erp_dn_varient` SET 
  ...
  //update
  $update = queryUpdate("UPDATE `erp_dn_varient` SET 
  `company_id`='" . $company_id . "',
  `title`='" . $varient_name . "',
  `verient_serialized`='" . $serialized_data . "',
  `iv_number_example`='" . $iv_number_example . "',
...
?>
    ...
    <div class="content-header">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i class="fa fa-list po-list-icon"></i>Manage Debit Note Number Format</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card invoice-format-card">
                <div class="card-header p-3" style="display: flex;align-items: center;justify-content: space-between;">
                  <h4>Debit Note Number Format</h4>
                  ...
                  <div class="col-12 reset_time" style="display: none;">
                    ...
                    <div class="form-input my-2">
                      <input class="reset_radio" type="radio" name="reset_time" value="never"><label><b> I would like to continue the
                          ...
                          or Calendar year is changed. e.i- DN-2021/22-00567 it will continue as
                          DN-2022/23-00568]</i>.</label>
                    </div>
                    <div class="form-input mb-2">
                      <input class="reset_radio" type="radio" name="reset_time" value="fyearly"><label><b> I would like to Reset the Debit Note Number
                          serial on financial-year change</b> <i>[Where serial will be reset and start from beginning
                          while the financial-year is changed. e.i- DN-2021/22-00567 it will start from
                          DN-2022/23-00001]</i>.</label>
                    </div>
                    <div class="form-input mb-2">
                      <input class="reset_radio" type="radio" name="reset_time" value="yearly"><label><b> I would like to Reset the Debit Note Number
                          serial on Calendar year change</b> <i>[Where serial will be reset and start from beginning while
                          the Calendar year is changed. e.i- DN-2022-00567 it will start from
                          DN-2023-00001]</i>.</label>
                    </div>
                  </div>
                </div>
                <div class="row">
  ...
  $id = $_GET['update'];
  $getQuery = queryGet("SELECT * FROM `erp_dn_varient` WHERE `company_id`='$company_id' AND `id`='$id'", false);
                    ...
                    <div class="col-12 reset_time" <?php if ($chooseOne == 1) { ?>style="display: none;" <?php } ?>>
                      ...
                      <div class="form-input my-2">
                        <input class="reset_radio" type="radio" name="reset_time" value="never" <?php if ($queryData["reset_time"] == "never")
                            ...
                            DN-2021/22-00567 it will continue as DN-2022/23-00568]</i>.</label>
                      </div>
                      <div class="form-input mb-2">
                        <input class="reset_radio" type="radio" name="reset_time" value="fyearly" <?php if ($queryData["reset_time"] == "fyearly")
                            ...
                            Debit Note Number serial on financial-year change</b> <i>[Where serial will be reset and start from
                            beginning while the financial-year is changed. e.i- DN-2021/22-00567 it will start from
                            DN-2022/23-00001]</i>.</label>
                      </div>
                      <div class="form-input mb-2">
                        <input class="reset_radio" type="radio" name="reset_time" value="yearly" <?php if ($queryData["reset_time"] == "yearly")
                                                                                                    echo "checked" ?>><label><b> I would like to Reset the Debit Note Number serial on Calendar year
                            change</b> <i>[Where serial will be reset and start from beginning while the Calendar year is
                            changed. e.i- DN-2022-00567 it will start from DN-2023-00001]</i>.</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
          ...
          <div class="container-fluid">
            ...
            <table class="table defaultDataTable table-hover">
              ...
              <tbody>
                ...
                $Invquery = queryGet("SELECT * FROM `erp_dn_varient` WHERE `company_id`='$company_id' AND status='active'", true);
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if ($Invdata["reset_time"] == 'never') {
                        ...
                        $reset_time = "Reset the DN serial on financial-year change.";
                      } elseif ($Invdata["reset_time"] == 'yearly') {
                        $reset_time = "Reset the DN serial on Calendar year change";
                      } else {
                        $reset_time = "-";
                      }
                      echo $reset_time;

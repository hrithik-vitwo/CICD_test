                ...
                <div class="row p-0 m-0">
                    <div class="col-12 mt-2 p-0">
                        ...
                        <div class="row">
                            ...
                            $balanceSheetObj = new BalanceSheetForOneDate($balanceSheetReportDate);
                            $balSheetTreeObj = $balanceSheetObj->getBalanceTree(0);
                            // console($balSheetTreeObj);
                            ?>
                        </div>

                        <div class="card card-tabs blnc-sheet-card">
                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="overflow: auto;">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th>Particulars</th>
                                                <th class="text-right"> <input type="date" class="form-control filter-date" id="balanceSheetReportDate" value="<?= $balanceSheetReportDate ?>" max="<?= date("Y-m-d") ?>">
                                                </th>
                                            </tr>
                                        </thead>
                                        <script>
                                            $(document).ready(function() {
                                                $(document).on("change", "#balanceSheetReportDate", function() {
                                                    let date = btoa(`${$(this).val()}`);
                                                    window.location.href = `<?= BASE_URL ?>branch/location/report-balance-sheet.php?filter=${date}`;
                                                    console.log(date);
                                                });
                                            });
                                        </script>
                                        <tbody>
                                            ...
                                            ?><tr>
                                                                <td class="font-bold text-lg" style='<?= $paddingLeftStyle ?><?= $backgroundStyle ?>'><?= $node["gl_label"] ?></td>
                                                                <td class="font-bold text-lg text-right" style='<?= $backgroundStyle ?>'>Amount</td>
                                                            </tr><?php
                                                                } else {
                                                                    ?><tr>
                                                                <td class="font-bold" style='<?= $paddingLeftStyle ?><?= $backgroundStyle ?>'><?= $node["gl_label"] ?></td>
                                                                <td class="font-bold" style='<?= $backgroundStyle ?>'></td>
                                                            ...
                                                            if (!empty($node['data'])) {
                                                                $tempLoop = $loop + 1;
                                                                buildTreeHTML2($node['data'], $tempLoop);
                                                            }
                                                        }
                                                    }
                                                    buildTreeHTML2($balSheetTreeObj);
                                                                ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <!-- <div class="row p-0 m-0">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                                            <table class="table table-hover liability-table" id="dataTable">
                                                <thead>
                                                    <tr>
                                                        <th>Particulars</th>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                                            <table class="table table-hover assets-table" id="dataTable">
                                                <thead>
                                                    <tr>
                                                        <th>Particulars</th>
                                                        <th class="text-right">Amount</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    function buildTreeHTML($tree, $loop = 1)
                                                    {
                                                        ...
                                                        $colorShades = [""];
                                                        foreach ($tree as $node) {
                                                            if (in_array($node["typeAcc"], [2, 3, 4])) {
                                                                continue;
                                                            } else {
                                                                $paddingSize = $loop * 30;
                                                                $paddingLeftStyle = "padding-left:" . $paddingSize . "px;";
                                                    ...
                                                    ?><tr>
                                                                        <td class="font-bold text-lg" style='<?= $paddingLeftStyle ?><?= $backgroundStyle ?>'><?= $node["gl_label"] ?></td>
                                                                        <td class="font-bold text-lg" style='<?= $backgroundStyle ?>'></td>
                                                                    </tr><?php
                                                                        } else {
                                                                            ?><tr>
                                                                        <td class="font-bold" style='<?= $paddingLeftStyle ?><?= $backgroundStyle ?>'><?= $node["gl_label"] ?></td>

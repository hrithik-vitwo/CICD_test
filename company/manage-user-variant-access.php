                    ...
                    <div class="card card-tabs" style="border-radius: 20px;">
                        ...
                        <div class="tab-content" id="custom-tabs-two-tabContent">
                            <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                ...
                                $sql_list = "SELECT * FROM `tbl_branch_admin_details` WHERE 1 " . $cond . "  AND fldAdminCompanyId=$company_id " . $sts . "  ORDER BY fldAdminKey desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                $qry_list = mysqli_query($dbCon, $sql_list);
                                $num_list = mysqli_num_rows($qry_list);


                                $countShow = "SELECT count(*) FROM `tbl_branch_admin_details` WHERE 1 " . $cond . " AND fldAdminCompanyId=$company_id " . $sts;
                                    ...
                                    <table class="table defaultDataTable table-hover text-nowrap">
                                        <thead>
                                            <tr class="alert-light">
                                                ...
                                                if (in_array(3, $settingsCheckbox)) { ?>
                                                    <th class="borderNone">Admin Branch</th>
                                                <?php }
                                               
                                                if (in_array(4, $settingsCheckbox)) { ?>
                                                    <th class="borderNone">Admin Year Variant</th>
                                                <?php }
                                                if (in_array(5, $settingsCheckbox)) { ?>
                                                    <th class="borderNone">Admin Month Variant</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($qry_list)) {
                                                ...
                                                $admin_branch = $row['fldAdminBranchId'];
                                                if ($admin_var != 0) {
                                                    ...
                                                    $branch_sql = queryGet("SELECT * FROM " . ERP_BRANCHES . " WHERE `branch_id`=$admin_branch ");
                                            ...
                                            ?>
                                                ...
                                                <div class="modal fade hsn-dropdown-modal" id="goodsHSNModal_<?= $row['fldAdminKey'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" aria-hidden="true">
                                                    <div class="modal-dialog modal-full-height modal-notify modal-success" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header"> Change Variant Form
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body m-3 hsn-code">
                                                                        <div class="hsn-header">
                                                                            ...
                                                                            <input type="hidden" name="admin_id"  value="<?= $row['fldAdminKey']  ?>">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                        ...
                                                                                        <div class="form-input">
                                                                                            ...
                                                                                            <select id="" name="variant" class="form-control" required>

                                                                                                <option value="">Select Variant</option>
                                                                                                <?php


                                                                                                $variants =  queryGet("SELECT * FROM `erp_month_variant` WHERE `month_end`< CURRENT_DATE() OR MONTH(month_end) =MONTH(CURRENT_DATE())", true);
                                                                                                foreach ($variants['data'] as $data) {


                                                                                                ?>
                                                                                                    <option value="<?= $data['month_variant_id'] ?>"><?= $data['month_variant_name'] ?></option>

                ...
                <div class="reports-section">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h4 class="text-sm font-bold border-bottom pb-2 mb-3">Communication Setup</h4>
                        </div>
                    </div>
                    <div class="row">
                            <div class="col">
                                <a href="<?= COMPANY_URL; ?>manage-mail-setup.php">
                                    <div class="card reports-card">
                                        <div class="card-body">
                                            <div class="icon text-center">
                                                <img src="<?= BASE_URL; ?>public/assets/img/com-gmail.png"> 
                                            </div>
                                            <div class="report-name">
                                                <p class="font-bold text-xs text-center">Mail Setup</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col">
                                <a href="<?= COMPANY_URL; ?>manage-sms-setup.php">
                                    <div class="card reports-card">
                                        <div class="card-body">
                                            <div class="icon text-center">
                                               <img src="<?= BASE_URL; ?>public/assets/img/com-whatsapp.png"> 
                                            </div>
                                            <div class="report-name">
                                                <p class="font-bold text-xs text-center">Whatsapp Setup</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col">
                                <a href="<?= COMPANY_URL; ?>manage-whatsapp-setup.php">
                                    <div class="card reports-card">
                                        <div class="card-body">
                                            <div class="icon text-center">
                                               <img src="<?= BASE_URL; ?>public/assets/img/com-chatting.png"> 
                                            </div>
                                            <div class="report-name">
                                                <p class="font-bold text-xs text-center">SMS Setup</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>

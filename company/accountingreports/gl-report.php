              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT branch.branch_name AS branch_name, loc.othersLocation_name AS loc_name, temp_table.* FROM (SELECT
                    summary1.*,
                ...
                FROM
                    ...
                    WHERE
                        journal.journal_status = 'active' AND journal.company_id = $company_id
                    ) AS main_report
                        )
                    UNION
                        (
                ...
                ORDER BY postingDate desc) AS temp_table LEFT JOIN erp_branches AS branch ON temp_table.branch_id = branch.branch_id LEFT JOIN erp_branch_otherslocation AS loc ON temp_table.location_id = loc.othersLocation_id;";
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    ((SELECT subgl,SUM(closing_val) AS total_amount FROM erp_opening_closing_balance WHERE company_id=$company_id AND DATE_FORMAT(date,'%m')=DATE_FORMAT(DATE_SUB('" . $f_date . "',INTERVAL 1 MONTH),'%m') GROUP BY subgl)
                    UNION
                    ...
                    ((SELECT
                        ...
                        WHERE
                            journal.journal_status='active' AND
                            journal.company_id=$company_id)) AS table1 INNER JOIN " . ERP_ACC_CHART_OF_ACCOUNTS . " AS coa ON table1.glId = coa.id
                    WHERE
                        ...
                        <tbody class="">
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?php echo $data['debit_amount']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?php echo $data['credit_amount']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?php echo $data['open_balance']; ?></td>
                              <?php } ?>
                            </tr>
                          <?php
                          }
                          ...
                          <tr style="font-weight: bold;">
                            ...
                            $k++;
                            if (in_array($k, $settingsCheckbox_concised_view)) { ?>
                              <td class="text-right"><?php echo $DebitAmountTotal; ?></td>
                            <?php }
                            $k++;
                            if (in_array($k, $settingsCheckbox_concised_view)) { ?>
                              <td class="text-right"><?php echo $CreditAmountTotal; ?></td>
                            <?php }
                            $k++;
                            if (in_array($k, $settingsCheckbox_concised_view)) { ?>
                              <td></td>

                                            ...
                                            <table id="dataTable" class="table table-hover transactional-book-table" style="width: 100%; position: relative;">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($array['making'] as $key => $data) {
                                                        ...
                                                        $overdue_sql = queryGet("SELECT SUM(invoices.due_amount) AS overdue_amount FROM erp_branch_sales_order_invoices AS invoices WHERE invoices.company_id=1 AND DATE_ADD(invoices.invoice_date, INTERVAL invoices.credit_period DAY) < CURRENT_DATE AND customer_id=$customer_id");
                                                        //console($overdue_sql);
                                                    ...
                                                    <tr>
                                                        ...
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $overdue_total ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $thirty_total ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $sixty_total ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $ninety_total ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $oneeighty_total ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $total_above ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right font-bold"><?= $total_all ?></td>
                                                        <?php }
                                                        ?>
                                                    </tr>
                                                </tbody>

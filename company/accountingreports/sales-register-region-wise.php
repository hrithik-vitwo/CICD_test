                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  ...
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    ...
                    <div class="label-select">
                      <h3 class="card-title mb-0">Sales Register Region Wise</h3>
                    </div>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                    ...
                    $sql_list = "SELECT reg.region_name,branch.branch_name AS branch_name,location.othersLocation_name AS loc_name,SUM(invoices.sub_total_amt - invoices.totalDiscount) AS total_base_amount,SUM(invoices.all_total_amt) AS total_amount,SUM(invoices.due_amount) AS total_due_amount FROM erp_branch_sales_order_invoices AS invoices LEFT JOIN erp_customer AS customer ON invoices.customer_id=customer.customer_id LEFT JOIN erp_branch_otherslocation AS location ON invoices.location_id=location.othersLocation_id LEFT JOIN erp_branches AS branch ON invoices.branch_id=branch.branch_id LEFT JOIN erp_state_region AS reg ON branch.region=reg.region_id WHERE invoices.company_id=$company_id AND invoices.invoice_date BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND invoices.status='active' GROUP BY reg.region_name,branch_name,location.othersLocation_name;";
                        ...
                        <tbody>
                          ...
                          foreach ($datas as $data) {
                            ...
                            <tr>
                              ...
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['loc_name']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo $data['total_base_amount']; ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                              ...
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['total_due_amount']); ?>
                                </td>
                              <?php } ?>
                            </tr>
                            <?php
                ...
                <div class="card card-tabs mb-0" style="border-radius: 20px;">
                  ...
                  <div class="tab-content" id="custom-tabs-two-tabContent">
                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                      ...
                      $sql_list = "SELECT reg.region_name,branch.branch_name AS branch_name,SUM(invoices.sub_total_amt - invoices.totalDiscount) AS total_base_amount,SUM(invoices.all_total_amt) AS total_amount,SUM(invoices.due_amount) AS total_due_amount FROM erp_branch_sales_order_invoices AS invoices LEFT JOIN erp_customer AS customer ON invoices.customer_id=customer.customer_id LEFT JOIN erp_branches AS branch ON invoices.branch_id=branch.branch_id LEFT JOIN erp_state_region AS reg ON branch.region=reg.region_id WHERE invoices.company_id=$company_id AND invoices.invoice_date BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND invoices.status='active' GROUP BY reg.region_name,branch_name;";
              ...
              <div class="card card-tabs reports-card">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                    ...
                    $sql_list = "SELECT reg.region_name,SUM(invoices.sub_total_amt - invoices.totalDiscount) AS total_base_amount,SUM(invoices.all_total_amt) AS total_amount,SUM(invoices.due_amount) AS total_due_amount FROM erp_branch_sales_order_invoices AS invoices LEFT JOIN erp_customer AS customer ON invoices.customer_id=customer.customer_id LEFT JOIN erp_branches AS branch ON invoices.branch_id=branch.branch_id LEFT JOIN erp_state_region AS reg ON branch.region=reg.region_id WHERE invoices.company_id=$company_id AND invoices.invoice_date BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND invoices.status='active' GROUP BY reg.region_name;";
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 d-flex">
                            <div class="card flex-fill reports-card">
                              <div class="card-body">
                                <div id="chartDivSalesRegisterRegionWise" class="chartContainer"></div>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
  ...
  am4core.ready(function () {
    ...
    var chart = am4core.create("chartDivSalesRegisterRegionWise", am4charts.XYChart);
    ...
    for (elem of chartData.data) {
      finalData.push({
        ...
        "due_amount": elem.total_due_amount,
    ...
    series.dataFields.valueY = "due_amount";
    series.dataFields.categoryX = "region_name";
    series.clustered = false;
    series.tooltipText = "Due Amount of {categoryX} : [bold]{valueY}[/]";

    var series2 = chart.series.push(new am4charts.ColumnSeries());
    series2.dataFields.valueY = "total_amount";
    series2.dataFields.categoryX = "region_name";
    series2.clustered = false;
    series2.columns.template.width = am4core.percent(50);
    series2.tooltipText = "Total Amount of {categoryX} : [bold]{valueY}[/]";

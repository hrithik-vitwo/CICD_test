...
if (isset($_POST["createdata"])) {
  $addNewObj = createDataWorkInternal($_POST, $_SESSION["logedCompanyAdminInfo"]["adminId"]);
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="input-group">
                            <input type="text" class="m-input" id="CostCenter_code" name="CostCenter_code"  required readonly>
            ...
            <div class="card card-tabs">
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="add_frm" name="add_frm">
                    ...
                    <div class="modal-content card">
                      <div class="modal-header card-header pt-2 pb-2 px-3">
                        <h4 class="text-xs text-white mb-0">Create Work Center/Internal Order</h4>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="form-input">
                            ...
                            <div class="form-input">
                              ...
                              ?>
                              <option value="<?= $cc['CostCenter_id'] ?>"><?= $cc['CostCenter_code'] ?></option>
                              <?php
                              }
                              ?>
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                  ...
                  $sql_list = "SELECT * FROM `" . ERP_COST_CENTER . "` WHERE 1 " . $cond . $con . " " . $sts . " AND `type` != 'cost center' AND company_id='" . $_SESSION["logedCompanyAdminInfo"]["fldAdminCompanyId"] . "' ORDER BY CostCenter_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";

                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-12">
                                            ...
                                            <div class="row table-header-item">
                                                ...
                                                <div class="col-lg-1 col-md-1 col-sm-1">
                                                    ...
                                                    <a href="terms_and_condition-variant_actions.php" class="btn btn-sm btn-primary relative-add-btn"><i class="fa fa-plus"></i></a>
                          ...
                          <span aria-hidden="true">&times;</span>
                            ...
                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    $sql_list = "SELECT * FROM  `erp_terms_and_condition_format`  WHERE 1   AND company_id='" . $company_id . "' ORDER BY 	tc_id  desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                    $qry_list = mysqli_query($dbCon, $sql_list);
                                    $num_list = mysqli_num_rows($qry_list);


                                    $countShow = "SELECT count(*) FROM `erp_terms_and_condition_format` WHERE 1  AND company_id='" . $company_id . "'  ";

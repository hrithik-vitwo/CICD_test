    ...
    <div class="card flex-fill dailyProductQuantityWiseSales">
        <div class="card-header">
            <div class="head-title">
                <button class="btn btn-primary pin-btn border" id="dailyProductQuantityWiseSalesChart"><?= chartExistorNot('dailyProductQuantityWiseSalesChart.php') ? 'Pinned' : 'Pin'; ?></button>
...
<script>
    ...
    function get_dailyProductQuantityWiseSalesChart(quickDrop, search, itemCode) {
        // AJAX CALL 
        $.ajax({
            url: `<?= BASE_URL ?>branch/ajaxs/reports/ajax-charts.php?chart=dailyProductQuantityWiseSales&search=${search}&quickDrop=${quickDrop}&itemCode=${itemCode}`,
            async: false,
            beforeSend: function() {
                $(".load-wrapp").show();
    ...
    get_dailyProductQuantityWiseSalesChart(quickDrop, null, itemCode);

    $('.applyFilter<?= $searchValue; ?>').click(function() {
        var quickDrop = $(".dailyProductQuantityWiseSales").find("select.quickDrop").val();
        var itemCode = $(".dailyProductQuantityWiseSales").find("select.itemCode").val();

        get_dailyProductQuantityWiseSalesChart(quickDrop, 'searching', itemCode);
    });
</script>
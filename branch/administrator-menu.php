...
if (isset($_POST["updateSubMenuFormBtn"])) {
    $updateSubMenuObj = updateAdministratorSubMenu($_POST);
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <select name="fldGrandParentMenu" class="form-control" required>
                                                        ...
                                                        <?php
                                                        $sql = "SELECT * FROM `tbl_branch_admin_menu` WHERE `fldParentMenuKey`='-0'";
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <select name="fldGrandParentMenu" class="form-control" required>
                                                            ...
                                                            <?php
                                                            $sql = "SELECT * FROM `tbl_branch_admin_menu` WHERE `fldParentMenuKey`='-0' AND `fldMenuStatus`='active'";
                                                            if ($res = mysqli_query($dbCon, $sql)) {
                                                                while ($row = mysqli_fetch_assoc($res)) {
                                                                    echo '<option value="' . $row['fldMenuKey'] . '">' . $row['fldMenuLabel'] . '</option>';
                                                                }

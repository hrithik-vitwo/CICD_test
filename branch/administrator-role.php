                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="action-btn p-0 m-0">
                                                                    <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $listRowKey; ?>" style="cursor: pointer;"><i class="fa fa-eye text-primary"></i></a>
                                                                    <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $listRowKey; ?>" style="cursor: pointer;"><i class="fa fa-edit text-success"></i></a>
                                                                    <form action="" method="POST">
                                                                        <input type="hidden" name="id" value="<?= $listRowKey ?>">
                                    ...
                                    <div class="tab-pane fade" id="addNewTabPan" role="tabpanel" aria-labelledby="addNewTab">
                                        <form action="" method="POST">
                                            <div class="form-group">
                                                <span class="text-muted">Role For: <b class='lddrttts'></b></span>
                                            ...
                                            <div class="form-group">
                                                <span class="text-muted">Select Menu & Sub-Menu:<b class='lddrttts'></b></span>
                                                <div class="row p-0 m-0 menu_access">

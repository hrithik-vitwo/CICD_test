    ...
    <section class="gstr-3B">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gstr-3B-filter">
                <a href="./gst-3B-summary.php" class="btn"><i class="fas fa-chart-bar mr-2"></i>Preview</a>
                <a href="./gst-3B-file-connect-portal.php" class="btn active"><i class="fa fa-list mr-2"></i>File</a>
            </div>
        </div>

    ...
    <section class="gstr-3B">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gstr-3B-filter">
                <a href="./gstr-3B-preview.php" class="btn"><i class="fas fa-chart-bar mr-2"></i>Preview</a>
                <a href="./gstr-3B-file-connect-portal.php" class="btn active"><i class="fa fa-list mr-2"></i>File</a>
            </div>
        </div>

        <div class="card bg-light">
            <div class="card-header p-3 rounded">
                <h3 class="text-sm text-white mb-0 pl-3">GST-3B file</h3>
            </div>
                    ...
                    <div class="col-lg-8 col-sm-8 col-sm-8">
                        ...
                        <div class="proceedToFile">
                            <div class="text">
                                ...
                                <a class="btn btn-primary" href="./gstr-3B-pending-save-data.php">Proceed</a>
                            </div>
                        </div>
                    </div>

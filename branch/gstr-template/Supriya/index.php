...
<div class="content-wrapper">
    <section class="gstr-1">
        <h4 class="text-lg font-bold mt-4 mb-4">GSTR-1 Filling</h4>
        <div class="head-btn-section mb-3">
            <div class="filter-list gst-one-filter">
                <a href="../../gstr-template/gst-1-action-center-preview.php" class="btn waves-effect waves-light"><i class="fas fa-chart-bar mr-2"></i>Preview</a>
                <a href="./gst-1-action-center-pending.php" class="btn active waves-effect waves-light"><i class="fa fa-list mr-2"></i>Pending Filling</a>
            </div>
        </div>
        ...
        <div class="card bg-light">
            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-8 col-sm-8 col-sm-8" id="componentViewDiv">
...
<script>
    function getGstr1CurrentStage() {
        $.ajax({
            type: "POST",
            url: `ajaxs/view/ajax-view-provider-gstr1.php`,
            beforeSend: function() {
    ...
    //    jqury for auth connect page 

    $(document).on("click", "#nextStage", function() {
        $.ajax({
            type: "POST",
            url: `ajaxs/view/components/auth-connect.php`,
            beforeSend: function() {
                $("#componentViewDiv").html("Loading...");

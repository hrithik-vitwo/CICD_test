        ...
        <section class="gstr-1">
            ...
            <div class="head-btn-section mb-3">
                <div class="filter-list gst-one-filter">
                    <a href="#" class="btn active"><i class="fas fa-chart-bar mr-2"></i>Preview</a>
                    <a href="./gst-1-action-center_pending.php" class="btn"><i class="fa fa-list mr-2"></i>Pending Filling</a>
                </div>
            </div>

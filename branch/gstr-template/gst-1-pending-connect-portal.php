    ...
    <section class="gstr-1">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gst-one-filter">
                ...
                <a href="gst-1-pending-connect-portal.php" class="btn active" id="pedingFillingTab"><i class="fa fa-list mr-2"></i>Pending Filling</a>
            </div>
        </div>
                    ...
                    <div class="col-lg-8 col-sm-8 col-sm-8">
                        ...
                        <div class="proceedToFile">
                            <div class="text">
                                ...
                                <a class="btn btn-primary" href="./gst-1-pending-save-data.php">Proceed</a>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type: "POST",
            url: "../gstr/ajax/ajax-auth-gst-portal.php",

    ...
    <section class="gstr-1">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gst-one-filter">
                <a href="./gst-1-graphical-view.php" class="btn"><i class="fas fa-chart-bar mr-2"></i>Graphical View</a>
                <a href="./gst-1-concised-view.php" class="btn active"><i class="fa fa-list mr-2"></i>Concised View</a>
            </div>
        </div>
                ...
                <table id="datatable" width="100" class="table table-hover defaultDataTable gst-consised-view">
                    ...
                    <tbody>
                        ...
                        $statusArr = [
                            ...
                            2 => [
                                'name' => 'Pending for push data',
                                'style' => 'status bg-warning'
                            ],
                            3 => [
                                'name' => 'pending for push reset data',
                                'style' => 'status bg-warning'
                            ],
                            4 => [
                                'name' => 'Filed',
                        ...
                        foreach ($gsr1CompTableDatasqlObj['data'] as $key => $gsr1Onedata) {
                            ...
                            $isFiled = ($gsr1Onedata['gstr1_return_file_status'] == 5) ? 1 : 0;
                            $getLastGstr1FileDay = $gsr1Onedata['gstr1_return_period'];
                            $start = (date("01-m-Y", strtotime(date('d-m-Y'))));
                            $end = date("t-m-Y", strtotime(date('d-m-Y')));
                            $action = [
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $approved_by ?></td>
                                <td>
                                    <a style="cursor:pointer" href="./gst-1-action-center-preview.php?action=<?= (base64_encode(json_encode($action))) ?>" class="btn btn-sm status bg-primary">Preview</a>
                                    <?php if ($gsr1Onedata['gstr1_return_file_status'] == 0 || $gsr1Onedata['gstr1_return_file_status'] == 1 || $gsr1Onedata['gstr1_return_file_status'] == 2 || $gsr1Onedata['gstr1_return_file_status'] == 3) { ?>

    ...
    <section class="gstr-3B">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gstr-3B-filter">
                <a href="./gst-3B-graphical-view.php" class="btn"><i class="fas fa-chart-bar mr-2"></i>Graphical View</a>
                <a href="./gst-3B-concised-view.php" class="btn active"><i class="fa fa-list mr-2"></i>Concised View</a>
            </div>

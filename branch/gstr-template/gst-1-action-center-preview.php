...
<div class="content-wrapper">
    <section class="gstr-1">
        <h4 class="text-lg font-bold mt-4 mb-4">GSTR-1 Preview <small>(<?= $queryParams->startDate?> to <?= $queryParams->endDate?>)</small></h4>
        <div class="head-btn-section mb-3">
            <div class="filter-list gst-one-filter">
               ...
               <?php if($queryParams->isFiled ==0){?> 
                <a href="./Supriya/index.php?action=<?=base64_encode(json_encode($queryParams))?>" class="btn"><i class="fa fa-list mr-2"></i>Pending Filling</a>
               <?php } ?>
            </div>

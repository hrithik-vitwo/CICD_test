    ...
    <section class="gstr-3B">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gstr-3B-filter">
                <a href="./gstr-3B-action-center_preview.php" class="btn"><i class="fas fa-chart-bar mr-2"></i>Preview</a>
                <a href="./gstr-3B-action-center_pending.php" class="btn active"><i class="fa fa-list mr-2"></i>Pending Filling</a>
            </div>

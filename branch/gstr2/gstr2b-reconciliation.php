...
require_once("controller/gstr2b-reconciliation.controller.php");
// administratorAuth();
?>
<style>
    .filter-list a {
...
<div class="content-wrapper" style="background-color: #ffffff !important;">
    ...
    $portalInvoiceData = $getGstr2bDataObj["data"];
    ...
    $localInvoiceData = $localInvoiceObj["data"];
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="div w-100 p-0 d-flex justify-content-between">
                                <div class="m-1 md-12">
                                    <p>Carry Forwared</p>
                                    <p style="font-size: 20px;"><i class="fas fa-rupee-sign"></i> 0.00</p>
                                </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="robo-element">
                        ...
                        <p class="text-primary font-bold">Hi! I am ViTWO, your reconcile assistant<br><br>Would you like to reconcile your vendor invoices with GST portal?<br><br>If yes, make sure the registered mobile is with you!</p>
...
<script>
    var localInvoiceData;
    var portalInvoiceData;
    $(document).ready(function() {
        ...
        localInvoiceData = JSON.parse(JSON.stringify(<?= json_encode($localInvoiceData, true) ?>));
        portalInvoiceData = JSON.parse(JSON.stringify(<?= json_encode($portalInvoiceData, true) ?>));

        console.log(localInvoiceData, portalInvoiceData);

        console.log(calculateWeight(localInvoiceData, portalInvoiceData));
    });
</script>
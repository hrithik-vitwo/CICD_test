...
<div class="content-wrapper">
    <section class="gstr-1">
        <h4 class="text-lg font-bold mt-4 mb-4">GSTR-3B Filling <span class="h6">(<?= $queryParams->startDate?> to <?= $queryParams->endDate?>)</span></h4>
...
?>
<script>
    function getGstr3BCurrentStage() {
        $.ajax({
            type: "GET",
            url: `ajaxs/view/ajax-view-provider-gstr3b.php?action=<?= $_GET['action'] ?>`,

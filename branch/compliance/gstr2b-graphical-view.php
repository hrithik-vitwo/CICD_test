    ...
    <section class="gstr-1">
        ...
        <div class="head-btn-section mb-3">
            <div class="filter-list gst-one-filter">
                <a href="" class="btn active"><i class="fas fa-chart-bar mr-2"></i>Graphical View</a>
                <a href="gstr2b-concised-view.php" class="btn"><i class="fa fa-list mr-2"></i>Concised View</a>
            </div>

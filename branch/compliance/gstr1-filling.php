...
<div class="content-wrapper">
    <section class="gstr-1">
        <h4 class="text-lg font-bold mt-4 mb-4">GSTR-1 Filling <span class="h6">(<?= $queryParams->startDate?> to <?= $queryParams->endDate?>)</span></h4>
        <div class="head-btn-section mb-3">
            <div class="filter-list gst-one-filter">
                <a href="gstr1-preview.php?action=<?= base64_encode(json_encode($queryParams)) ?>" class="btn waves-effect waves-light"><i class="fas fa-chart-bar mr-2"></i>Preview</a>
                <a href="" class="btn active waves-effect waves-light"><i class="fa fa-list mr-2"></i>Pending Filling</a>
            </div>
            <div>
        ...
        <div class="card bg-light">
            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-9 col-sm-9 col-sm-9" id="componentViewDiv">
                        <!-- The elements will come here from ajax  -->
                    </div>
                    <div class="col-lg-3 col-sm-3 col-sm-3">
                        <div class="card w-100 h-100 ml-auto timeline-card mb-0">
                            <div class="card-body">
                                <div id="content">
                                    <ul class="timeline">
                                        <li class="event fileGstr1Stage" id="fileGstr1StageConnect">
                                            <h3>Connect</h3>
                                        </li>
                                        <li class="event fileGstr1Stage" id="fileGstr1StageSaveFile">
                                            <h3>Save File</h3>
                                        </li>
                                        <li class="event fileGstr1Stage" id="fileGstr1StageProceedFile">
                                            <h3>Proceed File</h3>
                                        </li>
                                        <li class="event fileGstr1Stage" id="fileGstr1StageGenerateEvc">
                                            <h3>Generate EVC</h3>
                                        </li>
                                        <li class="event fileGstr1Stage" id="fileGstr1StageFile">
                                            <h3>Verify Evc & File</h3>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
?>
<script>
    function getGstr1CurrentStage() {
        $.ajax({
            type: "POST",
            url: `ajaxs/view/ajax-view-provider-gstr1.php?action=<?= $_GET['action'] ?>`,
            beforeSend: function() {
            ...
            success: function(response) {
                ...
                $("#componentViewDiv").html(response);
            },
            complete: function() {

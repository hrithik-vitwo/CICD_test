...
<div class="content-wrapper">
    <section class="gstr-1">
        <h4 class="text-lg font-bold mt-4 mb-4">GSTR-2B Pull Data <span class="h6">(<?= $queryParams->startDate?> to <?= $queryParams->endDate?>)</span></h4>
        ...
        <div class="card bg-light">
            <div class="card-header p-3 rounded">
                <h3 class="text-sm text-white mb-0 pl-3"></h3>
            </div>
                    ...
                    <div class="col-lg-3 col-sm-3 col-sm-3">
                        <div class="card w-100 h-100 ml-auto timeline-card mb-0">
                            <div class="card-body">
                                <div id="content">
                                    <ul class="timeline">
                                        <li class="event fileGstr1Stage" id="fileGstr2bStageConnect">
                                            <h3>Connect</h3>
                                        </li>
                                        <li class="event fileGstr1Stage" id="fileGstr2bStagePullFile">
                                            <h3>Pull Data</h3>
                                        </li>
...
?>
<script>
    function getGstr2BCurrentStage() {
        $.ajax({
            type: "GET",
            url: `ajaxs/view/ajax-view-provider-gstr2b.php?action=<?= $_GET['action'] ?>`,
            beforeSend: function() {

...
<head>
    ...
    <style>
        ...
        .welcome-section h2 span select {
            background: transparent;
            border: 0;
            color: #fff;
            font-weight: 600;
        ...
        .welcome-section h2 span select:focus-visible {
            outline: 0;
        }
...
<body class="hold-transition login-page">
    ...
    <section class="login-screen">
        <video autoplay muted loop>
            <source src="<?= BASE_URL?>public/assets/gif/login-bg.webm" type="video/mp4">
        </video>
                    ...
                    <div class="left-vector-bg">
                        <div class="container">
                            <div class="logo-section">
                                <img src="../public/main-assets/images/logo/Vitwo-AI-LOGO.png" width="100" alt="vitwo-ai-logo">
                            </div>
                            <h2>
                                Experience the Power of Intelligence & Automation
                            </h2>
                            <div class="viit-desc">
                                <img src="<?= BASE_URL?>public/assets/img/vitt/vittnew2.png" width="50" alt="">
                                <p>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/sales-and-distribution.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Sales & Distribution
                                                    </span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/material-management.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Material Master
                                                    </span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/vendor-management.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Vendor Management
                                                    </span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/product-planning.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Production Planning
                                                    </span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/account-and-finance.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Accounting
                                                    </span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/wms.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Warehouse Management
                                                    </span>
                                                    <p>
                                                        Experience the power of centralised control with ViTWO ai’s Storage Module. From managing storage locations during stock transfers to overseeing GRN and production postings, take charge effortlessly
                                                    </p>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="swiper-slide">
                                                <div class="module-body">
                                                    <div class="icon">
                                                        <img src="<?= BASE_URL?>public/assets/img/sidebar/acc-report.png" width="30" alt="">
                                                    </div>
                                                    <span class="title">
                                                        Analytics
                                                    </span>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 right-col wow bounceInRight">
                    <form class="form-login" action="" method="post" onsubmit="return validate();">
                        ...
                        <div class="welcome-section">
                            <h2>
                                Welcome ,
                                <p>You are logging in to the <b>Branch</b></p>
                            </h2>
                        </div>
    ...
    <!-- <script>
        document.getElementById("selectOption").addEventListener("change", function() {
            ...
            if (selectedValue === "branchLocation") {
                window.location.href = "<?= COMPANY_URL ?>";
            } else if (selectedValue === "companyAdmin") {

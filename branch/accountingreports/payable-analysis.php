                            ...
                            <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                ...
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                        ...
                                        $sql_list = "SELECT vendorId,vendorName,DATEDIFF(dueDate,CURDATE())AS due_days,COUNT(*) AS count_,SUM(dueAmt) AS total_due_amount FROM erp_grninvoice AS iv WHERE companyId=$company_id AND branchId=$branch_id AND postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND dueAmt!=0 AND dueDate>CURDATE() GROUP BY vendorId,vendorName,due_days ORDER BY due_days,vendorName,total_due_amount desc;";
                                            ...
                                            <table id="dataTable" class="table table-hover transactional-book-table" style="width: 100%; position: relative;">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($array['making'] as $key => $data) {
                                                        ...
                                                        $overdue_sql = queryGet("SELECT SUM(dueAmt) AS total_due_amount FROM erp_grninvoice WHERE companyId = $company_id AND branchId=$branch_id AND vendorId=$vendor_id AND postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND dueAmt!=0 AND dueDate < CURRENT_DATE;");
                                                        //console($overdue_sql);
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"><?= decimalValuePreview($overdue) ?> </td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"> <?= decimalValuePreview($thirty);  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"> <?php echo decimalValuePreview($sixty); ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"> <?php echo decimalValuePreview($ninety); ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"> <?php echo decimalValuePreview($oneeighty); ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"> <?php echo decimalValuePreview($above); ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"> <?php echo decimalValuePreview($total_sum); ?></td>
                                                            <?php }
                                                            ?>
                                                        </tr>
                                                    <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($overdue_total) ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($thirty_total) ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($sixty_total) ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($ninety_total) ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($oneeighty_total) ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($total_above) ?></td>
                                                        <?php }
                                                        $m++;
                                                        if (in_array($m, $settingsCheckbox)) { ?>
                                                            <td class="text-right"><?= decimalValuePreview($total_all) ?></td>
                                                        <?php }
                                                        ?>
                                                    </tr>
                                                </tbody>

            ...
            <div class="card card-tabs mb-0" style="border-radius: 20px;">
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                  ...
                  $sql_list = "SELECT filingDate,invDate,vendorGstin,vendorName,invoiceNo,invAmount,taxAmount,cgstAmount,sgstAmount,igstAmount,cessAmount,reconDate FROM erp_branch_gstr2b_portal_invoices WHERE itcAvl='N' AND branch_id=$branch_id AND invDate BETWEEN '" . $f_date . "' AND '" . $to_date . "';";

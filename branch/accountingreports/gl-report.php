                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td><?= decimalValuePreview($data['Amount']);  ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    ON
                        table1.glId = coa.id
                    WHERE
                        table1.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "'
                    GROUP BY
                        coa.gl_code,
                        coa.gl_label,
                        table1.Type
                    ...
                    ((SELECT subgl,SUM(closing_val) AS total_amount FROM erp_opening_closing_balance WHERE company_id=$company_id AND branch_id = $branch_id AND DATE_FORMAT(date,'%m')=DATE_FORMAT(DATE_SUB('" . $f_date . "',INTERVAL 1 MONTH),'%m') GROUP BY subgl)
                    UNION
                    ...
                    WHERE
                    table1.postingDate BETWEEN DATE_SUB('" . $f_date . "',INTERVAL (DATE_FORMAT('" . $f_date . "','%d')-1) DAY) AND DATE_SUB('" . $f_date . "',INTERVAL 1 DAY)
                    GROUP BY
                        ...
                        <tbody class="">
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?= decimalValuePreview($data['debit_amount']); ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?=decimalValuePreview($data['credit_amount']); ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?=decimalValuePreview($data['open_balance']) ?></td>
                              <?php } ?>
                            </tr>
                          <?php
                          }

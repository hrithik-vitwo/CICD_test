                            ...
                            <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                ...
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                        ...
                                        <?php
                                        $cond = '';
                                        $sql_list = "SELECT erp_customer.customer_id AS customer_id,erp_customer.trade_name,table1.due_days,table1.count_ AS num_of_invoice,total_due_amount FROM (SELECT customer_id,DATEDIFF((DATE_ADD(invoice_date, INTERVAL credit_period DAY)),CURDATE())AS due_days,COUNT(*) AS count_,SUM(due_amount) AS total_due_amount FROM erp_branch_sales_order_invoices WHERE company_id=$company_id AND branch_id=$branch_id AND invoice_date BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND due_amount!=0 AND (DATE_ADD(invoice_date, INTERVAL credit_period DAY))>CURDATE() GROUP BY customer_id,due_days) AS table1 LEFT JOIN erp_customer ON table1.customer_id=erp_customer.customer_id ORDER BY trade_name,table1.due_days,total_due_amount desc";
                                            ...
                                            <table id="dataTable" class="table table-hover transactional-book-table" style="width: 100%; position: relative;">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($array['making'] as $key => $data) {
                                                       ...
                                                       $overdue_sql = queryGet("SELECT SUM(invoices.due_amount) AS overdue_amount FROM erp_branch_sales_order_invoices AS invoices WHERE invoices.company_id=1 AND invoices.branch_id=1 AND DATE_ADD(invoices.invoice_date, INTERVAL invoices.credit_period DAY) < CURRENT_DATE AND customer_id=$customer_id");
                                                    //console($overdue_sql);
                                                ...
                                                <tfoot class="individual-search">
                                                    <tr>
                                                        ...
                                                        if (in_array($j, $settingsCheckbox_concised_view)) { ?>
                                                            ...
                                                            <?p
                                                            $j++;hp }
                                                        if (in_array($j++, ettingsCheckbox_concised_view)) { ?>
                                                            <th>IGST</th>
                                                            <?p
                                                            $j++;hp }
                                                        if (in_array($j++, ettingsCheckbox_concised_view)) { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-12 d-flex">
                                                    <div class="card flex-fill reports-card">
                                                        <div class="card-body">
                                                            <div id="columnChartContainer" class="chartContainer"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-12 d-flex">
                                                    <div class="card flex-fill reports-card">
                                                        <div class="card-body">
                                                            <div id="pieChartContainer" class="chartContainer"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    // Data processing and formatting code remains unchanged
    ...
    am4core.ready(function() {
         ...
         * Pie Chart
         */
        var pieChart = am4core.create("pieChartContainer", am4charts.PieChart3D);
        pieChart.data = data;

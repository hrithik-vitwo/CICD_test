              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT location.othersLocation_name AS location_name,grn.grnIvCode AS doc_num,grn.postingDate AS posting_date,grn.vendorDocumentNo AS vendor_doc_num,grn.vendorDocumentDate AS vendor_doc_date,grn.vendorCode AS vendor_code,grn.vendorName AS vendor_name,grn.grnType AS type,grn.grnSubTotal AS base_amount,grn.grnTotalCgst AS cgst,grn.grnTotalSgst AS sgst,grn.grnTotalIgst AS igst,grn.grnTotalTds AS tds,grn.grnTotalAmount AS total_amount,grn.dueAmt AS due_amount,grn.dueDate AS due_date,grn.grnCreatedAt AS created_at,grn.grnCreatedBy AS created_by,grn.grnUpdatedAt AS updated_at,grn.grnUpdatedBy AS updated_by FROM erp_grninvoice AS grn LEFT JOIN erp_branch_otherslocation AS location ON grn.locationId=location.othersLocation_id WHERE grn.companyId=$company_id AND grn.branchId=$branch_id AND grn.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND grn.grnStatus='active';";
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td class="text-right"><?= decimalValuePreview($data['base_amount']);  ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT grn.vendorCode AS vendor_code,grn.vendorName AS vendor_name,SUM(grn.grnTotalAmount) AS total_amount,SUM(grn.dueAmt) AS total_due_amount FROM erp_grninvoice AS grn LEFT JOIN erp_branch_otherslocation AS location ON grn.locationId=location.othersLocation_id WHERE grn.companyId=$company_id AND grn.branchId=$branch_id AND grn.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND grn.grnStatus='active' GROUP BY vendor_code,vendor_name;";
                        ...
                        <tbody class="">
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td><p class="pre-normal"> <?php echo $data['vendor_name']; ?></p></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?= decimalValuePreview($data['total_amount']);  ?></td>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?= decimalValuePreview($data['total_due_amount']);  ?></td>
                              <?php } ?>
                            </tr>
                          <?php
                          }
  ...
  am4core.ready(function() {
    ...
    for (elem of chartData.data) {
      finalData.push({
        ...
        "receivable_amount": Number(elem.total_due_amount),

                      ...
                      <tbody class="">
                        ...
                        ?>
                          <tr>
                            ...
                            $i++;
                            if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                              <td><p class="text-right"><?= decimalValuePreview($data['amount']) ?></p></td>
                            <?php } ?>
                          </tr>
                        <?php
                        }

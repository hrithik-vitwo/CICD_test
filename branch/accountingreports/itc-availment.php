                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  ...
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    ...
                    <div class="label-select">
                      <h3 class="card-title mb-0">ITC Availment</h3>
                    </div>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT loc.othersLocation_name AS loc_name,invoices.grnIvCode AS posting_doc_num,invoices.grnType AS type,invoices.grnPoNumber AS po_num,invoices.vendorCode AS vendor_code,invoices.vendorName AS vendor_name,invoices.vendorDocumentNo AS vendor_doc_num,invoices.vendorDocumentDate AS vednor_doc_date,invoices.postingDate AS posting_date,goods.goodCode AS item_code,goods.goodName AS item_name,goods.goodHsn AS hsn,goods.receivedQty AS qty,goods.unitPrice AS rate,(goods.receivedQty*goods.unitPrice) AS base_value,goods.cgst AS cgst,goods.sgst AS sgst,goods.igst AS igst,goods.totalAmount AS total_amount,invoices.grnCreatedAt AS created_at,invoices.grnCreatedBy AS created_by,invoices.grnUpdatedAt AS updated_at,invoices.grnUpdatedBy AS updated_by FROM erp_grninvoice AS invoices INNER JOIN erp_grninvoice_goods AS goods ON invoices.grnIvId=goods.grnIvId LEFT JOIN erp_branch_otherslocation AS loc ON invoices.locationId = loc.othersLocation_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND invoices.grnStatus='active' AND invoices.reconciliationStatus NOT IN(2,3) ORDER BY posting_date desc;";
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td class="text-right"><?php echo ($data['base_value']);  ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT goods.goodCode AS item_code,goods.goodName AS item_name,goods.goodHsn AS hsn,SUM(goods.receivedQty) AS total_qty,AVG(goods.unitPrice) AS avg_rate,SUM(goods.receivedQty*goods.unitPrice) AS total_base_value,SUM(goods.cgst) AS cgst,SUM(goods.sgst) AS sgst,SUM(goods.igst) AS igst,SUM(goods.totalAmount) AS total_amount FROM erp_grninvoice AS invoices INNER JOIN erp_grninvoice_goods AS goods ON invoices.grnIvId=goods.grnIvId WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND invoices.grnStatus='active' AND invoices.reconciliationStatus NOT IN(2,3) GROUP BY item_code,item_name,hsn;";
                        ...
                        <tbody class="">
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"> <?php echo $data['avg_rate']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"> <?php echo $data['total_base_value']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"> <?php echo $data['cgst']; ?></td>
                      ...
                      <div class="row">
                        <div class="col-md-12 col-sm-12 d-flex">
                          <div class="card flex-fill reports-card">
                            ...
                            <div class="card-body">
                              <div id="chartDivITCAvailment" class="chartContainer"></div>
                            </div>
                          </div>
                        </div>
                      </div>
...
<script>
  ...
  am4core.ready(function() {
    ...
    var chart = am4core.create("chartDivITCAvailment", am4charts.PieChart3D);
    ...
    for (elem of chartData.data) {
      finalData[0].value += Number(elem.cgst);
      finalData[1].value += Number(elem.sgst);
      finalData[2].value += Number(elem.igst);
    };

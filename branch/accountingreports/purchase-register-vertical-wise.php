          ...
          <div class="col-12 mt-2 p-0">
            <div class="card card-tabs reports-card">
                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  ...
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    ...
                    <div class="label-select">
                      <h3 class="card-title mb-0">Purchase Register Vertical Wise</h3>
                    </div>
                    ...
                    <div class="fy-custom-section">
                        ...
                        <div class="dropdown-fyear">
                          <select name="fydropdown" id="fYDropdown" class="form-control fy-dropdown">
                            ...
                            foreach ($variant_sql['data'] as $key => $data) {
                              ...
                              ?>
                              <option value="<?= $data['year_variant_id'] ?>" data-start="<?= $startDate ?>"
                                data-end="<?= $endDate ?>" <?php if (($_POST['drop_val'] == 'fYDropdown' && $_POST['drop_id'] == $data['year_variant_id'])) {
                                    echo "selected";
                            ...
                            <option value="customrange" <?php if ($_POST['drop_id'] == '') {
                              ...
                              <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#customRange">Custom Range</button>
                            </option>
                          </select>
                      ...
                      <div class="customrange-section">
                        ...
                        <form method="POST" action="" class="custom-Range" id="date_form" name="date_form">
                          ...
                          <button type="submit" class="btn btn-primary float-right" id="rangeid"
                            name="add_date_form">Apply</button>
                        </form>
              ...
              <div class="daybook-filter-list filter-list">
                <a href="<?= $_SERVER['PHP_SELF']; ?>" class="btn  waves-effect waves-light"><i
                    class="fa fa-stream mr-2"></i>Visual Representation</a>
                <a href="<?= $_SERVER['PHP_SELF']; ?>?concised-view" class="btn waves-effect waves-light"><i
                    class="fa fa-clock mr-2 "></i>Concised View</a>
                <a href="<?= $_SERVER['PHP_SELF']; ?>?detailed-view" class="btn active waves-effect waves-light"><i
                    class="fa fa-list mr-2 active"></i>Detailed View</a>
              </div>
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                    ...
                    <a type="button" class="btn add-col setting-menu" data-toggle="modal" data-target="#myModal2"> <i
                        class="fa fa-cog po-list-icon" aria-hidden="true"></i></a>
                    ...
                    $sql_list = "SELECT loc.othersLocation_name,func.functionalities_name,invoices.grnIvCode,invoices.vendorCode,invoices.vendorName,invoices.postingDate,invoices.grnSubTotal,invoices.grnTotalCgst,invoices.grnTotalSgst,invoices.grnTotalIgst,invoices.grnTotalTds,invoices.grnTotalAmount AS total_amount FROM erp_grninvoice AS invoices LEFT JOIN erp_company_functionalities AS func ON invoices.functionalAreaId=func.functionalities_id LEFT JOIN erp_branch_otherslocation AS loc ON invoices.locationId=loc.othersLocation_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.grnStatus='active' AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' ORDER BY invoices.postingDate DESC;";

                    $queryset = queryGet($sql_list, true);
                    // console($queryset);
                    $num_list = $queryset['numRows'];

                    $settingsTable = getTableSettings(TBL_COMPANY_ADMIN_TABLESETTINGS, "ERP_REPORT_DETAILED_VIEW_" . $pageName, $_SESSION["logedBranchAdminInfo"]["adminId"]);
                        ...
                        <tbody>
                          ...
                          foreach ($datas as $data) {
                            ...
                            <tr>
                              ...
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo $data['othersLocation_name']; ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo $data['functionalities_name']; ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo $data['grnIvCode']; ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo $data['vendorCode']; ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                              ...
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo formatDateORDateTime($data['postingDate']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['grnSubTotal']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['grnTotalCgst']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['grnTotalSgst']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['grnTotalIgst']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td>
                                  <?php echo ($data['grnTotalTds']); ?>
                                </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                      ...
                      <div class="modal-body" style="max-height: 450px;">
                        ...
                        <div class="modal-body">
                          ...
                          <div id="main2">
                            ...
                            <table>
                              <tr>
                                <td valign="top" style="width: 165px"><input type="checkbox" <?php echo (in_array($p, $settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]"
                                    id="settingsCheckbox1" value="<?php echo $p; ?>" />
                                  SL NO.</td>
                              </tr>
                              <tr>
                                <td valign="top" style="width: 165px"><input type="checkbox" <?php $p++;
                                echo (in_array($p, $settingsCheckbox) ? 'checked="checked"' : ''); ?>
                                    name="settingsCheckbox[]" id="settingsCheckbox1" value="<?php echo $p; ?>" />
                                  Location Name</td>
                              </tr>
                              <tr>
                                <td valign="top" style="width: 165px"><input type="checkbox" <?php $p++;
            ...
            <div class="col-12 mt-2 p-0">
              <div class="card card-tabs reports-card">
                ...
                <div class="daybook-filter-list filter-list">
                  <a href="<?= $_SERVER['PHP_SELF']; ?>" class="btn waves-effect waves-light"><i
                      class="fa fa-stream mr-2"></i>Visual Representation</a>
                  <a href="<?= $_SERVER['PHP_SELF']; ?>?concised-view" class="btn active waves-effect waves-light"><i
                      class="fa fa-clock mr-2  active"></i>Concised View</a>
                  <a href="<?= $_SERVER['PHP_SELF']; ?>?detailed-view" class="btn  waves-effect waves-light"><i
                      class="fa fa-list mr-2 "></i>Detailed View</a>
                </div>
                <div class="card card-tabs mb-0" style="border-radius: 20px;">
                  ...
                  <div class="tab-content" id="custom-tabs-two-tabContent">
                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                      ...
                      $sql_list = "SELECT loc.othersLocation_name,func.functionalities_name,SUM(invoices.grnTotalAmount) AS total_amount FROM erp_grninvoice AS invoices LEFT JOIN erp_company_functionalities AS func ON invoices.functionalAreaId=func.functionalities_id LEFT JOIN erp_branch_otherslocation AS loc ON invoices.locationId=loc.othersLocation_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.grnStatus='active' AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' GROUP BY func.functionalities_name,loc.othersLocation_name;";

                      $queryset = queryGet($sql_list, true);
                      // console($queryset);
                      $num_list = $queryset['numRows'];

                      $settingsTable = getTableSettings(TBL_COMPANY_ADMIN_TABLESETTINGS, "ERP_REPORT_CONCISED_VIEW_" . $pageName, $_SESSION["logedBranchAdminInfo"]["adminId"]);
                      $settingsCh = ($settingsTable['data'][0]['settingsCheckbox']);
              ...
              <div class="modal" id="myModal2">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form name="table_settings_concised_view" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
                      onsubmit="return table_settings_concised_view();">
                      <div class="modal-body" style="max-height: 450px;">
                        <input type="hidden" name="tablename" value="<?= TBL_COMPANY_ADMIN_TABLESETTINGS; ?>" />
                        ...
                        <div class="modal-body">
                          ...
                          <div id="main2">
                            ...
                            <table>
                              <tr>
                                <td valign="top" style="width: 165px"><input type="checkbox" <?php echo (in_array($p, $settingsCheckbox_concised_view) ? 'checked="checked"' : ''); ?>
                                    name="settingsCheckbox[]" id="settingsCheckbox_concised_view1"
                                    value="<?php echo $p; ?>" />
                                  SL NO.</td>
                              </tr>
                              <tr>
                                <td valign="top" style="width: 165px"><input type="checkbox" <?php $p++;
                                echo (in_array($p, $settingsCheckbox_concised_view) ? 'checked="checked"' : ''); ?>
                                    name="settingsCheckbox[]" id="settingsCheckbox_concised_view1"
                                    value="<?php echo $p; ?>" />
                                    Location Name</td>
                              </tr>
          ...
          <div class="row p-0 m-0">
            <div class="col-12 mt-2 p-0">
              <div class="card card-tabs reports-card">
                ...
                <div class="daybook-filter-list filter-list">
                  <a href="<?= $_SERVER['PHP_SELF']; ?>" class="btn active waves-effect waves-light"><i
                      class="fa fa-stream mr-2  active"></i>Visual Representation</a>
                  <a href="<?= $_SERVER['PHP_SELF']; ?>?concised-view" class="btn waves-effect waves-light"><i
                      class="fa fa-clock mr-2"></i>Concised View</a>
                  <a href="<?= $_SERVER['PHP_SELF']; ?>?detailed-view" class="btn  waves-effect waves-light"><i
                      class="fa fa-list mr-2 "></i>Detailed View</a>
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                    ...
                    $sql_list = "SELECT func.functionalities_name,SUM(invoices.grnTotalAmount) AS total_amount FROM erp_grninvoice AS invoices LEFT JOIN erp_company_functionalities AS func ON invoices.functionalAreaId=func.functionalities_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.grnStatus='active' AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' GROUP BY func.functionalities_name;";
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 d-flex">
                            <div class="card flex-fill reports-card">
                              ...
                              <div class="card-body">
                                <div id="chartDivPurchaseRegisterVerticalWise" class="chartContainer"></div>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
  ...
  am4core.ready(function () {
    ...
    var chart = am4core.create("chartDivPurchaseRegisterVerticalWise", am4charts.XYChart);
    ...
    for (elem of chartData.data) {
      finalData.push({
        "functionalities_name": elem.functionalities_name,
    ...
    categoryAxis.dataFields.category = "functionalities_name";
    ...
    series.dataFields.categoryX = "functionalities_name";

                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <div class="label-select">
                      <h3 class="card-title mb-0">TDS Report Section Wise</h3>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT tds_table.section, SUM((goods.receivedQty*goods.unitPrice)*(goods.tds/100)) AS total_amount FROM erp_grninvoice_goods AS goods INNER JOIN (SELECT items.itemId,items.itemCode , items.itemName , tds.section ,tds.TDSRate FROM erp_inventory_items AS items INNER JOIN erp_tds_details AS tds ON items.tds=tds.id WHERE items.company_id=$company_id) AS tds_table ON goods.goodId=tds_table.itemId LEFT JOIN erp_grninvoice AS invoices ON goods.grnIvId=invoices.grnIvId WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.postingDate BETWEEN '2022-04-01' AND '2023-03-31' AND goods.grnGoodStatus='active' GROUP BY tds_table.section;";

                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <div class="label-select">
                      <h3 class="card-title mb-0">Sales Register Location Customer Wise</h3>
                      ...
                      <div class="row">
                        <div class="col-md-12 col-sm-12 d-flex">
                          <div class="card flex-fill reports-card">
                            ...
                            <div class="card-body">
                              <div id="chartDivSalesRegisterLocationCustomerWise" class="chartContainer"></div>
                            </div>
                          </div>
                        </div>
                      </div>
...
<script>
  ...
  am4core.ready(function() {
    ...
    var chart = am4core.create("chartDivSalesRegisterLocationCustomerWise", am4charts.XYChart);
    ...
    for (elem of chartData.data) {
      finalData.push({
        ...
        "receivable_amount": elem.due_amount,
    ...
    series.tooltipText = "Receivable Amount : [bold]{valueY}[/]";

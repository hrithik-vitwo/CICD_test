              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT invoices.vendorCode,invoices.vendorName,vendor.vendor_pan, SUM((goods.receivedQty*goods.unitPrice)*(goods.tds/100)) AS total_tds_amount FROM erp_grninvoice AS invoices INNER JOIN erp_grninvoice_goods AS goods ON invoices.grnIvId=goods.grnIvId LEFT JOIN erp_vendor_details AS vendor ON invoices.vendorId=vendor.vendor_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.postingDate BETWEEN '2022-04-01' AND '2023-03-31' AND goods.grnGoodStatus='active' GROUP BY invoices.vendorCode,invoices.vendorName,vendor.vendor_pan;";
                        ...
                        <tbody class="">
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td> <?php echo $data['vendor_pan']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td><?php echo $data['total_tds_amount']; ?></td>
                              <?php } ?>
                            </tr>
                          <?php
                          }

...
// $branchSoPendingList = $BranchSoObj->fetchBranchSoPendingListing()['data'];
...
<style>
  ...
  .sales-order-pending-modal .modal-header {
  ...
  @media (max-width: 575px) {
    .sales-order-pending-modal .nav.nav-tabs li.nav-item a.nav-link {
      padding: 5px;
    }

    .sales-order-pending-modal .nav.nav-tabs {
            ...
            <div class="p-0 pt-1 my-2">
              <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                  <h3 class="card-title">Manage SO Pending List</h3>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                    ...
                    $sql_list = "SELECT * FROM `" . ERP_BRANCH_SALES_ORDER . "` WHERE 1 " . $cond . "  AND approvalStatus=14 AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' " . $sts . "  ORDER BY so_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                    $qry_list = mysqli_query($dbCon, $sql_list);
                    $num_list = mysqli_num_rows($qry_list);


                    $countShow = "SELECT count(*) FROM `" . ERP_BRANCH_SALES_ORDER . "` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' AND approvalStatus=14 " . $sts . " ";
                    $countQry = mysqli_query($dbCon, $countShow);
                    $rowCount = mysqli_fetch_array($countQry);

                    $count = $rowCount[0];
                    $cnt = $GLOBALS['start'] + 1;
                    $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_BRANCH_SALES_ORDER-PENDING", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                        ...
                        <tbody class="tableBody">
                          ...
                          foreach ($qry_list as $oneSoList) {
                            ...
                            if (fetchStatusMasterByCode($oneSoList['approvalStatus'])['data']['label'] == "open") {
                              ...
                              $approvalStatus = '<div class="satus-warning">EXCEPTIONAL</div>';
                            }
                          ?>
                            ...
                            <div class="modal fade right customer-modal sales-order-pending-modal" id="fluidModalRightSuccessDemo_<?= $oneSoList['so_number'] ?>" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-header">
                                    ...
                                    <div class="customer-head-info mb-0 mt-2">
                                      <div class="customer-name-code">
                                        ...
                                        <p class="text-xs">(<?= number_to_words_indian_rupees($oneSoList['totalAmount']) ?>)</p>
                                  ...
                                  <span aria-hidden="true" class="white-text">×</span>
                                    ...
                                    <div class="display-flex-space-between mt-2 mb-4">
                                      ...
                                      <?php } else { ?>
                                        <a href="#" class="btn btn-sm" title="Create Delivery" title="Create Delivery"><i class="fa fa-plus po-list-icon"></i></a>
                                      <?php } ?> -->
                                  ...
                                  <div class="modal-body">
                                    <div class="tab-content" id="myTabContent">
                                      ...
                                      <div class="tab-pane fade show active" id="home<?= $oneSoList['so_number'] ?>" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <?php
                                        // if ($oneSoList['goodsType'] == "service") { 
                                        ?>
                                        <!-- <a class="btn btn-primary MRPTab float-right" style="cursor: pointer; margin-top: -60px;" id="MRPTab_<?= $oneSoList['so_id'] ?>">
                                          <i class="fa fa-plus mr-2" style="border-radius: 50%; background: #fff; padding: 5px; color: #198754;"></i>
                                          MRP
                                        </a> -->
                                        <?php
                                        //  } else { 
                                        ?>
                                        <a class="btn btn-success approvalTab float-right" style="cursor: pointer; margin-top: -60px;" id="approvalTab_<?= $oneSoList['so_id'] ?>">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                      ...
                      <input type="hidden" name="pageTableName" value="ERP_BRANCH_SALES_ORDER-PENDING" />
                      <div class="modal-body">

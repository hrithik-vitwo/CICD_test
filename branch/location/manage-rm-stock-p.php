...
<script>
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookiesrmStock');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-rm-stock.php",
                dataType: 'json',
                data: {
                    act: 'rmStock',
                    comid: comid,
                        ...
                        if (checkboxSettings !== null) {
                            ...
                            $(".settingsCheckbox_detailed").each(function(index) {
                                ...
                                if (checkedColumns.includes(columnVal)) {
                                    ...
                                    if (dataTable.column(index).visible() === false) {
                                        dataTable.column(index).visible(true);
                                    }
                                } else {
                                    if (!notVisibleColArr.includes(index)) {

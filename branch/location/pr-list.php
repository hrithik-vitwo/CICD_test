            ...
            <div class="container-fluid">
                ...
                <div class="row p-0 m-0">
                    <div class="col-12 mt-2 p-0">
                        <div class="p-0 pt-1 my-2">
                            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                <li class="pt-2 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                ...
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    ?>
                                        ...
                                        <form action="manage-purchases-orders.php" method="GET" name="">
                                            ...
                                            <button type="submit" class="btn btn-primary create-purchase-order-btn">Create Purchase Order</button>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <?php }
                                                            if (in_array(7, $settingsCheckbox)) { ?>
                                                                <td><?=decimalQuantityPreview($onePrList['itemQuantity'])?></td>
                                                            <?php }
                                                            if (in_array(8, $settingsCheckbox)) { ?>
                                                                <td><?=decimalQuantityPreview( $onePrList['remainingQty'] )?></td>
                                                            <?php } ?>

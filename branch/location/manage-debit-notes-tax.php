                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($columnMapping as $columnIndex => $column) {
                                                                            if ($columnIndex === 0 || $columnIndex === 5 ||$columnIndex === 8 || $columnIndex === 9 || $columnIndex === 10) {
                                                                                continue;
                                                                            } ?>
                                                                            <tr>
                                                                                <td>
            ...
            success: function(value) {
                ...
                if (responseObj.countryCode === '103') {
                    if (igst == 0 && cgst!=0 && sgst!=0) {
                        ...
                        $("#igstP").hide();
                        $("#igst").hide();
                        $("#cgstVal").show().html("INR" + " " + decimalAmount(cgst));
                        $("#sgstVal").show().html("INR" + " " + decimalAmount(sgst));
                    } else if(igst!=0 &&(cgst==0 && sgst==0) ) {
                        $("#csgst").hide();
                        $('#csgstVal').hide();
                        $("#igstP").show();
                        $("#igst").show();
                        $("#igst").show().html("INR" + " " + decimalAmount(igst));
                    }

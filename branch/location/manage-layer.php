    ...
    if (!isset($_COOKIE["cookieLayer"])) {
        ...
        if ($settingsCheckbox_concised_view) {
            setcookie("cookieLayer", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
        }
    }
    ...
    $columnMapping = [
        ...
        [
            'name' => 'Layer Name',
            'slag' => 'layer.layer_name',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Layer Description',
            'slag' => 'layer.layer_desc',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Rack Name',
            'slag' => 'erpRack.rack_name',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Created By',
            'slag' => 'layer.created_by',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ]
                                        ...
                                        <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                            <div class="left-block">
                                                <div class="label-select">
                                                    <h3 class="card-title mb-0">Manage Layer</h3>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                                ...
                                                <div class="exportgroup">
                                                    ...
                                                    <ul class="export-options">
                                                        <li>
                                                            <button class="ion-paginationlistLayer">
                                                                <ion-icon name="list-outline" class="ion-paginationlistLayer md hydrated" role="img" aria-label="list outline"></ion-icon>Exports
                                                            </button>
                                                        </li>
                                                        <li>

                                                            <button class="ion-fulllistLayer">
                                                                <ion-icon name="list-outline" class="ion-fulllistLayer md hydrated" role="img" aria-label="list outline"></ion-icon>Download
                                                            </button>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <a href="manage-layer-actions.php?create" class="btn btn-create" type="button">
                                                    ...
                                                    <div class="modal-header">
                                                        <div class="top-details">
                                                            <div class="left">
                                                                ...
                                                                <p class="info-detail po-number"><ion-icon name="information-outline"></ion-icon><span class="rackName"> </span></p>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        <div class="items-table">
                                                                            ...
                                                                            <div class="customer-details">
                                                                                <div class="details warehouse-address">
                                                                                    <label for="">Layer Description</label>
                                                                                    <p id="layerDescription"></p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <li>
                                                                        <details open>
                                                                            ...
                                                                            <ul>
                                                                                <li>
                                                                                    <details>
                                                                                        <summary><span class="font-weight-bold">S Location :</span> <span id="storagelocationName"></span>
                                                                                        </summary>
                                                                                        <ul>
                                                                                            <li>
                                                                                                <details>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-mange-layer.php",
                    dataType: 'json',
                    data: {
                        act: 'raclog',
                        comid: comid,
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            $.each(responseObj, function(index, value) {
                                dataTable.row.add([
                                    value.sl_no,
                                    `<a href="#" class="soModal" data-id="${value['layer.layer_id']}">${value['layer.layer_name']}</a>`,
                                    value['layer.layer_desc'],
                                    value['erpRack.rack_name'],
                                    value['layer.created_by'],
                                    ` <div class="dropout">
                                        <button class="more">
                                            <span></span>
                                            <span></span>
                                        ...
                                        <ul>
                                        <li>
                                            <button id="editBtn" data-id="${btoa(value['layer.layer_id'])}" data-toggle="modal" data-target="#editModal"><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                        </li>
                            
                                        <li>
                                            <button class="soModal" data-toggle="modal" data-id="${value['layer.layer_id']}" data-target="#viewGlobalModal"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>
                                        <li>
                            ...
                            var checkboxSettings = Cookies.get('cookieLayer');
            ...
            $(document).on("click", ".ion-paginationlistLayer", function(e) {
                $.ajax({
                    type: "POST",
                    ...
                    data: {
                        ...
                        sql_data_checkbox: Cookies.get('cookieLayer')
                    },
                    beforeSend: function() {
                        // console.log(sql_data_checkbox);
                        $('#loaderModal').show();
                        $('.ion-paginationlistLayer').prop('disabled', true)
                    },
                    ...
                    complete: function() {
                        ...
                        $('#loaderModal').hide();
                        $('.ion-paginationlistLayer').prop('disabled', false)
                    }
                })

            });
            $(document).on("click", ".ion-fulllistLayer", function(e) {
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-mange-layer.php",
                    dataType: "json",
                    ...
                    beforeSend: function() {
                        // console.log(sql_data_checkbox);
                        $('#loaderModal').show();
                        $('.ion-fulllistLayer').prop('disabled', true)
                    },
                    success: function(response) {
                    ...
                    complete: function() {
                        // Hide loader modal after request completes
                        $('#loaderModal').hide();
                        $('.ion-fulllistLayer').prop('disabled', false);
                    }
                })
    ...
    <script>
        $(document).on("click", ".soModal", function() {
            ...
            // $('.auditTrail').attr("data-ccode", layer_id);

            $.ajax({
                type: "GET",
                url: "ajaxs/modals/wms/ajax-manage-layer-modal.php",
                dataType: 'json',
                data: {
                    layer_id: layer_id
                },
                ...
                success: function(value) {
                    ...
                    let data = value.data;
                    $layer_code = data.layer_code ?? data.layer_id;
                    $('.auditTrail').attr("data-ccode", $layer_code);
                    $('#createdBy').html(data.createdBy)
                    $('#createdat').html(data.created_at)
                    $('#updatedBy').html(data.updated_by)
                    $('#updatedat').html(data.updated_at)
                    $('.layerName').html(data.layer_name)
                    $('#layerDescription').html(data.layer_desc)
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            let url = "<?php echo  BRANCH_URL . 'location/manage-layer-actions.php?edit=' ?>" + prId;

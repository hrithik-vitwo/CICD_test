    ...
    <tr class="rowDel itemRow" id="delItemRowBtn_<?= $getItemObj['data']['itemId'] ?>">
        ...
        <td class="inp-td pos-input-td">
            <div class="d-flex justify-content-center">
                ...
                <input type="text" name="listItem[<?= $randCode ?>][unitPrice]" value="<?= $itemUnitPrice ?>" class="inp-design form-control text-right full-width-center originalChangeItemUnitPriceInp" id="originalChangeItemUnitPriceInp_<?= $randCode ?>_<?= $itemId ?>">
                <input type="hidden" name="listItem[<?= $randCode ?>][itemTargetPrice]" value="<?= $itemUnitPrice ?>" class="inp-design form-control text-right full-width-center originalChangeItemUnitPriceInp" id="originalChangeItemUnitPriceInp_<?= $randCode ?>_<?= $itemId ?>">
        ...
        <td class="inp-td pos-input-td text-center">
            <div class="d-flex justify-content-center">
                ...
                <input type="number" name="listItem[<?= $randCode ?>][qty]" value="<?= $itemQty ?>" class="inp-design form-control text-center full-width itemQty itemQtyWidth" id="itemQty_<?= $randCode ?>_<?= $itemId ?>">
        ...
        <!-- item total price 👇🏾 -->
        <td class="text-right">
            <input type="hidden" name="listItem[<?= $randCode ?>][totalPrice]" value="<?= number_format($itemTotalPrice, 2) ?>" class="form-control full-width-center itemTotalPrice" id="itemTotalPrice_<?= $randCode ?>" readonly>

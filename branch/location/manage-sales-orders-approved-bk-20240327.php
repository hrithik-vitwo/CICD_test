...
// $branchSoPendingList = $BranchSoObj->fetchBranchSoApprovedListing()['data'];
...
<?php } else { ?>
            ...
            <div class="p-0 pt-1 my-2">
              <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                  <h3 class="card-title">Manage SO Open List</h3>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                    ...
                    $sql_list = "SELECT * FROM `" . ERP_BRANCH_SALES_ORDER . "` WHERE 1 " . $cond . " AND approvalStatus=9 AND  company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' " . $sts . "  ORDER BY so_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";

                    $qry_list = mysqli_query($dbCon, $sql_list);
                    $num_list = mysqli_num_rows($qry_list);


                    $countShow = "SELECT count(*) FROM `" . ERP_BRANCH_SALES_ORDER . "` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' AND approvalStatus=9 " . $sts . " ";
                    ...
                    $count = $rowCount[0];
                    $cnt = $GLOBALS['start'] + 1;
                    $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_BRANCH_SALES_ORDER-APPROVED", $_SESSION["logedBranchAdminInfo"]["adminId"]);
  ...
  <i class="fa fa-user"></i>
                                  ...
                                  <span aria-hidden="true" class="white-text">×</span>
                                    ...
                                    <div class="display-flex-space-between mt-2 mb-4">
                                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home<?= $oneSoList['so_id'] ?>" role="tab" aria-controls="home" aria-selected="true">Item Info</a>
                                        </li>
                                        <li class="nav-item">
                                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile<?= $oneSoList['so_id'] ?>" role="tab" aria-controls="profile" aria-selected="false">Customer Info</a>
                                        </li>
                                        <!-- -------------------Audit History Button Start------------------------- -->
                                        <li class="nav-item">
                                          <a class="nav-link auditTrail" id="history-tab<?= str_replace('/', '-', $oneSoList['so_id']) ?>" data-toggle="tab" data-ccode="<?= str_replace('/', '-', $oneSoList['so_id']) ?>" href="#history<?= str_replace('/', '-', $oneSoList['so_id']) ?>" role="tab" aria-controls="history<?= str_replace('/', '-', $oneSoList['so_id']) ?>" aria-selected="false"><i class="fa fa-history mr-2"></i> Trail</a>
                                        </li>
                                      ...
                                      <?php } else { ?>
                                        <a href="#" class="btn btn-sm" title="Create Delivery"><i class="fa fa-plus po-list-icon"></i></a>
                                      <?php } ?>
                                  ...
                                  <div class="modal-body">
                                    <div class="tab-content" id="myTabContent">
                                      <div class="tab-pane fade show active" id="home<?= $oneSoList['so_id'] ?>" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="nav-action" id="settings">
                                          <?php if ($oneSoList['approvalStatus'] == 9) { ?>
                                            <a title="Delivery Creation" href="manage-sales-orders-delivery.php?create-sales-order-delivery=<?= base64_encode($oneSoList['so_id']) ?>" name="vendorEditBtn">
                                              <i class="fa fa-box"></i>
                                            </a>
                                          <?php } else { ?>
                                        ...
                                        <div class="nav-action" id="thumb">
                                          <a title="Notify Me" href="manage-sales-orders-delivery.php?create-sales-order-delivery=<?= base64_encode($oneSoList['so_id']) ?>" name="vendorEditBtn">
                                            <i class="fa fa-bell"></i>
                                          </a>
                                        </div>
                                        <div class="nav-action" id="create">
                                          <a title="Edit" href="manage-sales-orders-delivery.php?create-sales-order-delivery=<?= base64_encode($oneSoList['so_id']) ?>" name="vendorEditBtn">
                                            <i class="fa fa-edit"></i>
                                          </a>
                                        </div>
                                        <div class="nav-action trash" id="share">
                                          <a title="Delete" href="manage-sales-orders-delivery.php?create-sales-order-delivery=<?= base64_encode($oneSoList['so_id']) ?>" name="vendorEditBtn">
                                      ...
                                      <div class="tab-pane fade" id="profile<?= $oneSoList['so_id'] ?>" role="tabpanel" aria-labelledby="profile-tab">
                                                ...
                                                <div class="card h-100">
                                                  <div class="card-body p-3" style="height: 245px !important;">
                                                    <div class="display-flex-space-between">
                                                      <p class="font-bold text-xs">Code :</p>
                                                    ...
                                                    <div class="display-flex-space-between">
                                                      ...
                                                      <p class="font-bold text-xs"> <?= $customerDetails['customer_pan'] ?></p>
                                                    </div>
                                                    <div class="display-flex-space-between">
                                                      <p class="font-bold text-xs">Address :</p>
                                                      <p class="font-bold text-xs w-75"><?= $customerAddressDetails['customer_address_building_no'] . ', ' . $customerAddressDetails['customer_address_flat_no'] . ', ' . $customerAddressDetails['customer_address_street_name'] . ', ' . $customerAddressDetails['customer_address_pin_code'] . ', ' . $customerAddressDetails['customer_address_location'] . ', ' . $customerAddressDetails['customer_address_city'] . ', ' . $customerAddressDetails['customer_address_district'] . ', ' . $customerAddressDetails['customer_address_state'] ?></p>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                      ...
                                      <div class="tab-pane fade" id="history<?= str_replace('/', '-', $oneSoList['so_id']) ?>" role="tabpanel" aria-labelledby="history-tab">
                                        ...
                                        <hr>
                                        <div class="audit-body-section mt-2 mb-3 auditTrailBodyContent<?= $oneSoList['so_id'] ?>">
                                          <ol class="timeline">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                      ...
                      <input type="hidden" name="pageTableName" value="ERP_BRANCH_SALES_ORDER-APPROVED" />
                      <div class="modal-body">

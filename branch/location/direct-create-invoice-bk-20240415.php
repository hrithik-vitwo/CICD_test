      ...
      <div class="row main-create-template">
        <div class="col-lg-6 col-md-6 col-sm-12">
          <div class="card direct-create-invoice-card so-creation-card">
            ...
            <div class="card-body others-info vendor-info so-card-body <?php if ($edit_invoice) {
                                                                          echo "displayOverLay";
                                                                        } ?>">
                  ...
                  <div class="row customer-info-form-view">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="input-box customer-select">
                        ...
                        <?php if (isset($_GET['quotation']) || isset($_GET['quotation_to_so']) || isset($_GET['so_to_invoice']) || isset($_GET['party_order_to_so']) || isset($_GET['party_order_to_quotation']) || isset($_GET['pgi_to_invoice']) ||  isset($_GET['edit_invoice'])) { ?>
                          ...
                          ?>
                          <input type="text" name="customerId" id="customerDropDown" class="form-control" value="<?= $customerName ?>" readonly>
                        <?php } else if (isset($_GET['repost_invoice'])) {
                          $getCustomerObj = $CustomersObj->getDataCustomerDetails($customerId);
                          $customerName = $getCustomerObj['data'][0]['trade_name'];
                          $customer_code = $getCustomerObj['data'][0]['customer_code']; ?>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <?php } else { ?>
                    <div class="row others-info-form-view" style="row-gap: 5px; justify-content: center;">
                      ...
                      <div class="row dotted-border-area">
                        ...
                        <?php } else { ?>
                          ...
                          <?php if (isset($_GET['proforma_invoice'])) { ?>
                      ...
                      <div class="row dotted-border-area">
                        ...
                        <?php if (!isset($_GET['quotation_to_so']) && !isset($_GET['sales_order_creation']) && !isset($_GET['quotation_createion']) && !isset($_GET['party_order_to_so']) && !isset($_GET['party_order_to_quotation']) && !isset($_GET['proforma_invoice'])) { ?>
                          <!-- invoice formate -->
                          <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                                                                    echo "displayOverLay";
                                                                  } ?>">
                            ...
                            <div class="display-flex" style="justify-content: flex-end;">
                              ...
                              <!-- <input type="text" name="manualInvoiceNo" id="manualInvoiceNo" class="form-control" placeholder="Manual Invoice No" value=""> -->
                            </div>
                          </div>
                          <!-- <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="row">
                      <?php if (!isset($_GET['quotation_to_so']) && !isset($_GET['sales_order_creation']) && !isset($_GET['quotation_createion']) && !isset($_GET['party_order_to_so']) && !isset($_GET['party_order_to_quotation'])) { ?>
            ...
            <div class="head-item-table">
              <div class="advanced-serach">
                ...
                <div class="nav-action quick-add-input d-flex" id="quick-add-input">
                  <?php if ($sales_order_creation || $quotation_createion || $quotation_to_so || $party_order_to_so || $party_order_to_quotation) { ?>
                  ...
                  <thead>
                    <tr>
                      ...
                      <?php } else { ?>
                        <th>Stock</th>
                      <?php }
                      if (isset($_GET['so_to_invoice']) || isset($_GET['quotation']) || isset($_GET['quotation_to_so']) || isset($_GET['party_order_to_so']) || isset($_GET['party_order_to_quotation']) || isset($_GET['pgi_to_invoice'])) { ?>
                        <th>Order Qty</th>
                      <?php } ?>
                      <!-- <th>Qty</th> -->
                      <?php if (isset($_GET['joborder_to_invoice'])) { ?>
...
<script>
  $(document).ready(function() {
    ...
    function itemAutoAdd(itemIdArry) {
      ...
      // to toggle FOB
      if (param === "?sales_order_creation" || param === "?quotation_to_so" || param === "?party_order_to_so" || param === "?party_order_to_quotation") {
        $(".fob-section").show();
      } else {
        $(".fob-section").hide();
      }
      ...
      if (itemIdArry != '') {
        ...
        $.each(itemIdArryTo, function(index, value) {
          if (value.inventory_item_id > 0) {
            $.ajax({
              type: "GET",
              url: `ajaxs/so/ajax-items-list-direct-new.php`,
              data: {
                act: "listItem",
    ...
    function discount_varients(rowNo, customer_id, item_id, days) {
      ...
      $.ajax({
        type: "GET",
        url: `ajaxs/so/ajax-item-discount.php`,
        data: {
          ...
          $.each(obj, function(index, item) {
            ...
            if (item.discount_type == 'value') {
              ...
              var div = `<div class="discount-card">
                            <input type="radio" class="discount_radio" name="discount" id="discount_radio" data-attr="` + rand + `" value="` + item.discount_value + `">
      ...
      $(`.discountView_${rowNo}`).on('click', '.discount_radio', function() {
        ...
        if (discount_type == 'percentage') {
          ...
          if (percentage_amount > max_val) {
            ...
            calculateOneItemAmounts(rowNo);
            // itemMaxDiscount(rowNo, percentage_val);
    ...
    function calculateGrandTotalAmount() {
      ...
      if (compInvoiceType === "CBW" || compInvoiceType === "LUT" || compInvoiceType === "SEWOP" || compInvoiceType === "E") {
        ...
        //  console(totalDiscountAmountOriginal);

...
// API endpoint URL
$url = 'https://console.claimz.in/admin-api/api/employee-epf';
                    ...
                    <div class="card card-tabs" style="border-radius: 20px;">
                        ...
                        <div class="tab-content" id="custom-tabs-two-tabContent">
                            <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                ...
                                $cnt = $GLOBALS['start'] + 1;
                                $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_PF", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr style="cursor:pointer">
                                                ...
                                                <?php }
                                                if (in_array(4, $settingsCheckbox)) { ?>
                                                    <td><?= $data['epf_wages'] ?></td>

                                                <?php }
                                                if (in_array(5, $settingsCheckbox)) { ?>
                                                    <td><?= $data['epf_contri_twelve'] ?></td>

                                                <?php }
                                                if (in_array(6, $settingsCheckbox)) { ?>

                                                    <td><?= $data['epf_contri_eight'] ?></td>

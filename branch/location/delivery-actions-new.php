...
if (isset($_POST['addNewSODeliveryFormSubmitBtn'])) {
  ...
  if ($branchSoDeliveryCreationObj['status'] == "success") {
    swalAlert($branchSoDeliveryCreationObj["status"],$branchSoDeliveryCreationObj['deliveryNo'],"Delivery Created Succesfully",$_SERVER['PHP_SELF']);
  } else {
...
?>
  <script>
    let url = `<?= BRANCH_URL ?>location/manage-sales-orders-delivery.php`;

                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Purchase Order - Service PO</h3>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fill_datatable(formDatas = '', pageNo = '', limit = '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-manage-po-service.php",
                    dataType: 'json',
                    data: {
                        act: 'poService',
                        comid: comid,
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            var checkboxSettings = Cookies.get('cookiesPoService');

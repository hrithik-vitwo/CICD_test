...
$compliance_invoice = $componentsjsn['compliance_invoice'];
// date checker
...
<div class="content-wrapper">
  <section class="content">
    <div class="container-fluid">
      <ol class="breadcrumb">
        ...
        <?php if ($sales_order_creation) { ?>
          ...
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Sales Orders</a></li>
        <?php } else if ($proforma_invoice) { ?>
          <li class="breadcrumb-item active"><a href="manage-proforma-invoice.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Proforma Invoice List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Proforma Invoice</a></li>
        ...
        <?php } else if (isset($_GET['quotation'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-invoices.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Invoice List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Quotation to Invoice</a></li>
        <?php } else if (isset($_GET['party_order_to_so'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-party-orders.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Party Order List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Party Order to Sales Order</a></li>
        <?php } else if (isset($_GET['party_order_to_quotation'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-party-orders.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Party Quotation List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Party Order to Quotation</a></li>
        <?php } else if (isset($_GET['quotation_to_so'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-sales-orders.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Sales Order List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Quotation to Sales Order</a></li>
        ...
        <?php } else if (isset($_GET['repost_invoice'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-invoices.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Invoice List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Repost
              Invoice</a></li>
        <?php } else if (isset($_GET['edit_invoice'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-invoices.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Invoice List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Edit
              Invoice</a></li>
        <?php } else if (isset($_GET['edit_so'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-invoices.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>SO List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Edit
              SO</a></li>
        <?php } else if (isset($_GET['proforma_to_so'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-sales-orders.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Sales Order List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Proforma to Sales Order</a></li>
        <?php } else if (isset($_GET['proforma_to_invoice'])) { ?>
          <li class="breadcrumb-item active"><a href="manage-proforma-invoice.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Proforma Invoice List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
              Proforma to Invoice</a></li>
        <?php } else { ?>
          <li class="breadcrumb-item active"><a href="manage-invoices.php" class="text-dark"><i
                class="fa fa-list po-list-icon"></i>Invoice List</a></li>
          <li class="breadcrumb-item active"><a href="#" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create
    ...
    <form action="" method="POST" id="addNewSOForm" enctype="multipart/form-data">
      ...
      <input type="hidden" name="compliance_invoice" id="compliance_invoice" value="<?= $compliance_invoice ?>">
                      ...
                      <div class="input-box customer-select">
                        ...
                        <?php if (isset($_GET['quotation']) || isset($_GET['quotation_to_so']) || isset($_GET['so_to_invoice']) || isset($_GET['party_order_to_so']) || isset($_GET['party_order_to_quotation']) || isset($_GET['pgi_to_invoice']) || isset($_GET['edit_invoice']) || $_GET['edit_so'] || isset($_GET['proforma_to_so']) || isset($_GET['proforma_to_invoice'])) { ?>
                          ...
                          <input type="text" name="customerName" class="form-control" value="<?= $customerName ?>"
                            readonly>
                          <input type="hidden" name="customerId" id="customerDropDown" class="form-control"
                        ...
                        ?>
                          <select name="customerId" id="customerDropDown" class="form-control select2" required>
                            ...
                            <option value="<?= $customer_id ?>" selected><?= $customer_code ?> | <?= $customerName ?>
                            </option>
                          </select>
                        <?php } else { ?>
                          <select name="customerId" id="customerDropDown" class="form-control select2" required>
                    ...
                    <div>
                      <div class="form-input">
                        ...
                        <select name="placeOfSupply" class="form-control select2" id="placeOfSupply1" required>
                          ...
                          ?>
                            <option value="<?= ltrim($one['gstStateCode'], '0') ?>"><?= $one['gstStateCode'] ?> -
                              <?= $one['gstStateName'] ?>
                            </option>
                          <?php } ?>
                        </select>
                  ...
                  <?php if ($repost_invoice) { ?>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                      ...
                      <div>
                        ...
                        <input type="hidden" name="repostInvoiceId" class="form-control" id="repostInvoiceId"
                          value="<?= base64_decode($_GET['repost_invoice']) ?>" />
                        <input type="hidden" name="repostInvoiceNo" value="<?= $repost_invoice_no ?>" id="repostInvoiceNo"
                  ...
                  <?php if ($quotation_createion) { ?>
                    <div class="row others-info-form-view" style="row-gap: 5px; justify-content: center;">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div>
                          <input type="date" name="postingDate" value="" id="postingDate" class="form-control"
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-input">
                          <label for="date">Valid Till: <span class="text-danger">*</span></label>
                          <input type="date" class="form-control" id="dateInputvalid" name="validitydate"
                      ...
                      <?php } elseif (!isset($_GET['sales_order_creation'])) { ?>
                      ...
                      <?php } else { ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="form-input">
                            <label for="">Credit Period (Days)<span class="text-danger">*</span></label>
                            <input type="text" name="creditPeriod" class="form-control" id="inputCreditPeriod"
                              placeholder="Credit Period " value="<?= $CreditPeriod; ?>" required />
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="form-input">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <label for="" class="">Remark </label>
                          <textarea name="extra_remark" id="extra_remark" placeholder="Remarks" class="form-control"
                            rows="2"><?php echo $extraremarks; ?></textarea>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <?php
                          $declarationText = '';
                          ...
                          ?>
                          <label for="" class="">Declaration </label>
                          <textarea name="declaration_note" id="declaration_note" placeholder="Declaration"
                            class="form-control" rows="2"><?= $declarationText ?></textarea>
                        </div>
                      ...
                      <?php if ($sales_order_creation || $quotation_to_so || $proforma_to_so) { ?>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          ...
                          <div>
                            ...
                            ?>
                            <input type="date" value="<?= $min ?>" name="soDate" id="soDate" class="form-control"
                              min="<?= $min ?>" max="<?= $max ?>" required />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          ...
                          <div>
                            <input type="time" name="postingTime" id="postingTime" value="<?= date("H:i") ?>"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          ...
                          <div>
                            <input type="date" value="<?= date("Y-m-d") ?>" name="deliveryDate" id="deliveryDate"
                              class="form-control" required />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <div class="form-input">
                            ...
                            <input type="text" name="customerPO" class="form-control" placeholder="Customer Order Number"
                              required />
                          </div>
                        </div>
                      ...
                      ?>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          ...
                          <div>
                            ...
                            ?>
                            <input type="date" value="<?= $invoiceList['data'][0]['so_date'] ?>" name="soDate" id="soDate"
                              class="form-control" min="<?= $min ?>" max="<?= $max ?>" required />
                            <span class="input-group-addon soDateMsg"></span>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <label>Posting Time: <span class="text-danger">*</span></label>
                          <div>
                            <input type="time" name="postingTime" id="postingTime"
                              value="<?= $invoiceList['data'][0]['soPostingTime'] ?>" class="form-control" required />
                            <span class="input-group-addon postingTimeMsg"></span>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <label>Delivery Date: <span class="text-danger">*</span></label>
                          <div>
                            <input type="date" value="<?= $invoiceList['data'][0]['delivery_date'] ?>" name="deliveryDate"
                              id="deliveryDate" class="form-control" required />
                            <span class="input-group-addon deliveryDateMsg"></span>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <div class="form-input">
                            ...
                            <input type="date" class="form-control" id="dateInputvalid" name="validitydate"
                              min="<?php echo date('Y-m-d'); ?>" value="<?= $invoiceList['data'][0]['validityperiod'] ?>"
                              required>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <div class="form-input">
                            <label for=""> Customer Order Number <span class="text-danger">*</span></label>
                            <input type="text" name="customerPO" value="<?= $invoiceList['data'][0]['customer_po_no'] ?>"
                              class="form-control" placeholder="Customer Order Number" required />
                          </div>
                        </div>
                      <?php
                        ...
                        <?php if ($_GET['party_order_to_so']) { ?>
                          <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                            ...
                            <label>Posting Date: <span class="text-danger">*</span></label>
                            <div>
                              <input type="date" value="<?= date("Y-m-d") ?>" name="soDate" id="soDate" min=<?= $min ?>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                            ...
                            <label>Posting Time: <span class="text-danger">*</span></label>
                            <div>
                              <input type="time" value="<?= date("H:i") ?>" name="postingTime" id="postingTime"
                                class="form-control" required />
                              <span class="input-group-addon"></span>
                            </div>
                          </div>
                        ...
                        <?php } else { ?>
                          <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                            ...
                            <div>
                              ...
                              ?>
                              <input type="date" name="invoiceDate" id="invoiceDate" class="form-control" min="<?= $min ?>"
                                max="<?= $max ?>" <?= $disabled ?> required />
                              <p id="invdatelabel"></p>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                            ...
                            <div>
                              <input type="time" value="<?= date("H:i") ?>" name="invoiceTime" id="invoiceTime"
                                class="form-control" required />
                              <span class="input-group-addon"></span>
                            </div>
                          </div>
                    ...
                    <div class="row dotted-border-area">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-input">
                          ...
                          <select name="profitCenter" class="selct-vendor-dropdown select2 form-control"
                            id="profitCenterDropDown" required readonly>
                      ...
                      <?php if (!isset($_GET['quotation_to_so']) && !isset($_GET['sales_order_creation']) && !isset($_GET['quotation_createion']) && !isset($_GET['party_order_to_so']) && !isset($_GET['party_order_to_quotation']) && !isset($_GET['proforma_invoice']) && !isset($_GET['edit_so']) && !isset($_GET['proforma_to_so'])) { ?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                          ...
                          <div class="type-flex">
                            <div class="form-input invoice-varient-form">
                              ...
                              <?php if (isset($_GET['repost_invoice'])) { ?>
                                <input type="hidden" name="repostInvoiceId" class="form-control" id="repostInvoiceId"
                                  value="<?= base64_decode($_GET['repost_invoice']) ?>" />
                                <input type="hidden" name="iv_varient" class="form-control" id="repostInvoiceId"
                                  value="<?= ($inv_variant_id) ?>" />
                                <input type="text" name="repostInvoiceNo" class="form-control" id="repostInvoiceNo"
                                  value="<?= $repost_invoice_no ?>" placeholder="Repost Invoice No" readonly />
                              <?php } else { ?>
                            ...
                            <div class="form-input type-select-form">
                              <label for=""></label>
                              <select class="form-control invoiceNumberType" name="invoiceNumberType"
                                id="invoiceNumberType">
                          ...
                          <div class="invoice-field my-2">
                            <p class="label-bold text-italic" id="liveInvoice" style="white-space: pre-line;"><span
                                class="mr-1">e.i- </span> <span class="ivnumberexample text-sm"><?= $ivselecetd; ?></span>
                            </p>
                            <input class="form-control" type="text" id="ivnumberManual" name="ivnumberManual"
                              style="display: none;" placeholder="Enter Inv No:- ">
                          </div>
                        </div>
                        <!-- <div class="col-lg-6 col-md-6 col-sm-6">
                          <label for="" class="">Remark </label>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 <?php if ($edit_invoice) {
                        ...
                        <div class="dynamic-currency-conversion">
                          <div class="row">
                              ...
                              <div class="form-input">
                                ...
                                <?php if (isset($_GET['quotation']) || isset($_GET['proforma_to_invoice'])) { ?>
                                  <input type="text" class="form-control" id="curr_rate" name="curr_rate"
                                    value="<?= floatval($quotationList['data']['conversion_rate']) ?>">
                                <?php } else { ?>
                                  <input type="text" class="form-control" id="curr_rate" name="curr_rate" value="1">
                                <?php } ?>
                              </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-input">
                                ...
                                <?php $curr = queryGet("SELECT * FROM `erp_currency_type` ORDER BY currency_name ASC ", true); ?>
                                <?php if (isset($_GET['quotation']) || isset($_GET['proforma_to_invoice'])) { ?>
                                  <select name="currency" class="form-control currencyDropdown rupee-symbol select2"
                                    id="currencyDropdown">
                                    <?php
                                    foreach ($curr['data'] as $data) {
                                    ?>
                          ...
                          <div class="display-flex" style="justify-content: flex-end;">
                            <p class="label-bold text-italic" style="white-space: pre-line;"><span
                                class="mr-1">*</span>Transaction Currency is <b><?= $currencyName ?></b></p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row dotted-border-area">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4">
                        <div style="display: flex; justify-content: space-between; align-items: center">
                          ...
                          <button type="button" data-toggle="modal" data-target="#configModal"
                            style="border: none; font-size: 10px; padding: 0px 5px; margin-bottom: 5px;"
                        ...
                        <select name="companyConfigId" class="form-control" id="config">
                          ...
                          <?php foreach ($configList['data'] as $config) { ?>
                            <option value="<?= $config['config_id'] ?>"><?= $config['name'] ?> /<?= $config['email'] ?> /
                              <?= $config['phone'] ?>
                            </option>
                          <?php } ?>
                        </select>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="form-input">
                              ...
                              <input type="name" class="form-control" name="configName" id="configName"
                                placeholder="Name">
                            </div>
                            ...
                            <div class="form-input">
                              ...
                              <input type="email" class="form-control" name="configEmail" id="configEmail"
                                placeholder="Email">
                            </div>

                            <div class="form-input">
                              <label for="">Phone</label>
                              <input type="number" class="form-control" name="configPhone" id="configPhone"
                                placeholder="Phone">
                            </div>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                              id="handleConfigClose">Close</button>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="card items-select-table mt-4 <?php if ($edit_invoice) {
                ...
                <div class="nav-action quick-add-input d-flex" id="quick-add-input">
                  <?php if ($sales_order_creation || $quotation_createion || $quotation_to_so || $party_order_to_so || $party_order_to_quotation || $proforma_to_so) { ?>
                    <div class="d-flex align-items-center gap-2">
                      <label for="" class="text-nowrap" style="width: 100%;">Order For <span
                  ...
                  <div class="itemDropdownDiv orderFor" style="display: none;">
                    <input name="orderFor" checked class="orderForRadio" type="radio" value="service"
                      id="orderForService" />
                    <label for="orderForService" style="width: 100%; cursor:pointer;user-select: none;">Order for
                  ...
                  <div class="itemDropdownDiv orderFor" style="display: none;">
                    ...
                    <label for="orderForProject" style="width: 100%; cursor:pointer;user-select: none;">Order for
            ...
            <!-- Recurring Modal -->
            <div class="modal fade" id="recurringModal" data-bs-backdrop="true" data-bs-keyboard="false" tabindex="-1"
              aria-labelledby="recurringModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content itemModalContent">
                  <div class="modal-header card-header p-3 rounded">
                    ...
                    <button type="button" class="close text-white subscriptionClose" data-dismiss="modal"
                    ...
                    <div class="row">
                      ...
                      <div class="col-8">
                        <div class="form-input">
                          ...
                          <input type="date" class="form-control" value="<?= date("Y-m-d") ?>" name="startOn"
                            id="startOn">
                        </div>
                      </div>
                      <div class="col-4">
                      ...
                      <div class="col-4">
                        <button type="button" class="btn btn-primary mt-2 subscriptionClose" data-dismiss="modal"
                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php } else { ?>
                        <td colspan="12" class="text-right p-2" style="border: none; background: none;"> </td>
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 totalCal"
                        style="border: none; background: none;padding: 0px !important;">Sub Total</sup></td>
                      ...
                      <td class="text-right pr-2" style="border: none; background: none;">
                        ...
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                            id="convertedGrandSubTotalAmt">0.00</span>)
                        </small>
                      </td>
                    </tr>
                    <!-- trade discount -->
                    <tr>
                      ...
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 totalCal"
                        style="border: none; background: none;padding: 0px !important;">Trade Discount</td>
                      ...
                      <td class="text-right pr-2" style="border: none; background: none;">
                        <small class="text-large font-weight-bold text-success">
                          <span class="rupee-symbol"><?= $currencyName ?> </span><span
                            id="grandTotalDiscount">0.00</span>
                        </small>
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                            id="convertedGrandTotalDiscountAmount">0.00</span>)
                        </small>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 totalCal"
                        style="border: none; background: none;padding: 0px !important;">Cash Discount</td>
                      <input type="hidden" name="grandTotalCashDiscountAmtInp" id="grandTotalCashDiscountAmtInp"
                        value="0">
                      <td class="text-right pr-2" style="border: none; background: none;">
                        <small class="text-large font-weight-bold text-success">
                          <span class="rupee-symbol"><?= $currencyName ?> </span><span
                            id="grandTotalCashDiscount">0.00</span>
                        </small>
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                            id="convertedGrandTotalCashDiscountAmount">0.00</span>)
                        </small>
                      </td>
                    </tr>
                    ...
                    <tr class="p-2 igstTr" style="display:none">
                      ...
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 totalCal"
                        style="border: none; background: none;padding: 0px !important;">IGST</td>
                      <input type="hidden" name="grandTaxAmtInp" id="grandTaxAmtInp" value="0">
                      <td class="text-right pr-2" style="border: none; background: none;">
                        <small class="text-large font-weight-bold text-success">
                          <span class="rupee-symbol"><?= $currencyName ?> </span><span id="grandTaxAmt"><?= decimalValuePreview(0) ?></span>
                        </small>
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                            id="convertedGrandTaxAmount">0.00</span>)
                        </small>
                      </td>
                    </tr>
                    <tr class="p-2 cgstTr" style="display:none">
                      ...
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 totalCal"
                        style="border: none; background: none;padding: 0px !important;">CGST</td>
                      ...
                      <td class="text-right pr-2" style="border: none; background: none;">
                        ...
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                            class="convertedGrandSgstCgstAmt">0.00</span>)
                        </small>
                      </td>
                    </tr>
                    <tr class="p-2 sgstTr" style="display:none">
                      ...
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 totalCal"
                        style="border: none; background: none;padding: 0px !important;">SGST</td>
                      <!-- <input type="hidden" name="grandSgstCgstAmtInp" id="grandSgstCgstAmtInp" value="0"> -->
                      <td class="text-right pr-2" style="border: none; background: none;">
                        <small class="text-large font-weight-bold text-success">
                          <span class="rupee-symbol"><?= $currencyName ?> </span><span
                            ...
                            <div class="col-6 pr-0">
                              <div id="tcsAmtshowhidediv">
                                <div class="col-lg-12 col-md-12 col-sm-12 px-0 d-flex gap-2">
                                  ...
                                  <div class="d-flex gap-2">
                                    <input type="number" step="any" class="inputAmountClass" id="tcs_amount" value=" "
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 px-0">
                              <div class="round-off-section p-0">
                                <div class="round-off-head d-flex gap-2">
                                  <input type="checkbox" class="checkbox" name="round_off_checkbox"
                                    id="round_off_checkbox">
                                  <label style="user-select: none" class="text-xs" for="round_off_checkbox">Adjust
                                    Amount</label>
                                </div>
                                <div id="round_off_hide">
                                  <div class="row round-off calculte-input px-0">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                      <div class="adjust-currency d-flex gap-2">
                                        ...
                                        <input type="number" step="any" id="round_value" class="inputAmountClass"
                                  ...
                                  <div class="row" style="width: 100%;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 px-0">
                                      <div
                                        class="totaldueamount d-flex justify-content-between border-top border-white pt-2">
                                        <p class="font-bold">Adjusted Amount</p>
                                        <input type="hidden" name="paymentDetails[adjustedCollectAmount]"
                                          class="adjustedCollectAmountInp">
                                        <input type="hidden" name="paymentDetails[roundOffValue]" value="0"
                                          class="roundOffValueHidden">
                                        <div style="border-top: 2px double; padding: 2px;">
                                          <p class="text-success font-bold rupee-symbol">₹ <span
                                              class="adjustedDueAmt">0</span></p>
                                          <small class="text-small font-weight-bold text-primary convertedDiv">
                                            (<span
                                              class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                                              class="convertedAdjustedDueAmt">0.00</span>)
                                          </small>
                                        </div>
                                      </div>
                                    </div>
                    ...
                    <tr class="p-2">
                      ...
                      <?php } else { ?>
                        <td colspan="12" class="text-right p-2" style="border: none; background: none;"> </td>
                      <?php } ?>
                      <td colspan="0" class="text-left p-2 font-weight-bold totalCal"
                        style="border-top: 3px double !important; background: none;padding: 0px !important;">Total
                        Amount</td>
                      <input type="hidden" name="grandTotalAmtInp" id="grandTotalAmtInp" class="grandTotalAmounttInp"
                        value="0">
                      <td class="font-weight-bold text-right pr-2"
                        style="border-top: 3px double !important; background: none;">
                        <small class="text-large font-weight-bold text-success">
                          <span class="rupee-symbol"><?= $currencyName ?> </span><span id="grandTotalAmt"
                            class="grandTotalAmount">0.00</span>
                        </small>
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"><?= $currencyName ?></span><span
                            id="convertedGrandTotalAmt">0.00</span>)
                        </small>
                      </td>
                    </tr>
                  </tbody>
          ...
          ?>
            <div class="row tc-section"
              style="margin: 0px 0px 20px 0px;padding: 10px 0px;border-radius: 10px;box-shadow: 0 0 15px #d8d8d8b3;border: 1px solid #d0d0d0;">
              <div class="d-flex">
                <p> Select Terms & Conditions</p>
                <select name="terms_and_condition" class="selct-terms-and-condition select2 form-control"
                ...
                <button type="button" class="btn-view btn btn-primary previewBtn" data-toggle="modal"
            ...
            <div class="modal modal-left left-item-modal fade previewModal discountViewModal discountViewModal"
              id="previewModal" tabindex="-1" role="dialog" aria-labelledby="left_modal">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
          ...
          <div class="card p-3 items-select-table modal-add-row_537" id="otherCostCard" style="display: none;">
            ...
            <div class="row othe-cost-infor">
                ...
                <div class="form-input">
                  ...
                  <select name="otherCostDetails[12345][services]" class="selct-vendor-dropdown" id="servicesDropDown">
                    ...
                    <?php foreach ($serviceList as $service) { ?>
                      <option
                        value="<?= $service["itemId"] ?>_<?= $service["itemCode"] ?>_<?= $service["itemName"] ?>_<?= $service["service_unit"] ?>">
                        <?= $service['itemName'] ?><small>(<?= $service['itemCode'] ?>)[<?= $service['goodsType'] ?>]</small>
                      </option>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="col-lg-5 col-md-12 col-sm-12">
                <div class="form-input">
                  <label for="">Qty</label>
                  <input step="any" type="number" class="form-control" placeholder="Qty"
                    name="otherCostDetails[12345][qty]">
                </div>
              </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <button type="submit" name="addNewInvoiceFormSubmitBtn" onclick="return confirm('Are you sure to submitted?')"
            id="directInvoiceCreationBtn" class="btn btn-primary items-search-btn float-right">Submit</button>
        </div>
      </div>
    </form>
  </section>
...
<!-- Modal -->
<div class="modal fade add-customer-modal" id="addNewCustomerModal" data-bs-backdrop="static" data-bs-keyboard="false"
  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content card">
      <div class="modal-header card-header py-2 px-3">
        <h4 class="modal-title font-monospace text-md text-white" id="exampleModalLabel"><i
            class="fa fa-plus"></i>&nbsp;Add Customer</h4>
        <button type="button" class="close text-white" data-dismiss="modal" id="addCustomerCloseBtn"
          aria-label="Close">x</button>
      </div>
      <div id="notesModalBody" class="modal-body card-body">
        ...
        <div class="row">
          <div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
            <div class="multisteps-form__progress">
              <button class="multisteps-form__progress-btn js-active" type="button" title="User Info">Basic
                Details</button>
              <button class="multisteps-form__progress-btn" type="button" title="Comments" id="poc_btn" disabled>POC
                Details</button>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 col-lg-8 m-auto">
            <form class="multisteps-form__form" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="add_frm"
              name="add_frm">
              <input type="hidden" name="createdatamultiform" id="createdatamultiform" value="">
              <input type="hidden" name="company_id" id="company_id"
                value="<?= $_SESSION["logedBranchAdminInfo"]["fldAdminCompanyId"]; ?>">
              <input type="hidden" name="company_branch_id" id="company_branch_id"
                value="<?= $_SESSION["logedBranchAdminInfo"]["fldAdminBranchId"]; ?>">
                ...
                <div class="card vendor-details-card mb-0">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-input selDiv">
                            ...
                            <select id="state" name="state" class="form-control stateDropDown">
                              ...
                              foreach ($stateNameList as $one) {
                              ?>
                                <option value="<?= ($one['gstStateName']) ?>"><?= $one['gstStateCode'] ?> -
                                  <?= $one['gstStateName'] ?>
                                </option>
                              <?php } ?>
                            </select>
                        ...
                        <div class="col-md-4">
                          <div class="form-input">
                            ...
                            <select id="company_currency" name="company_currency"
                              class="form-control mt-0 form-control-border borderColor">
                              ...
                              ?>
                                  <option value="<?php echo $listRow['currency_id']; ?>">
                                    <?php echo $listRow['currency_name']; ?>
                                  </option>
                              <?php }
                              } ?>
                            </select>
                        ...
                        <div class="col-md-6" style="display:none;">
                          <div class="form-input">
                            ...
                            <input type="hidden" class="form-control" name="opening_balance"
                              id="customer_opening_balance" value="0">
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-input">
                            ...
                            <input type="text" class="form-control" name="credit_period" id="customer_credit_period"
                              value="">
                  ...
                  <div class="card-footer">
                    <div class="button-row d-flex">
                      <button class="btn btn-primary ml-auto js-btn-next" id="customerRegFrmNextBtn" type="button"
                        data-toggle="modal" data-target="#visitingCard" title="Next">Next</button>
                    </div>
                  </div>
                </div>
              </div>
              <!--single form panel-->
              <div class="modal fade" id="visitingCard" style="z-index: 999999;" tabindex="-1" role="dialog"
                          ...
                          <div class="card visiting-card-upload">
                            ...
                            <div class="card-body">
                              <div class="drag-file-area">
                                ...
                                <br>
                                <input type="file" class="form-control" id="visitingFileInput" name=""
                                  placeholder="Visiting Card Upload" required />
                              </div>
                              <div class="file-block">
                                <div class="progress-bar"> </div>
                              </div>
                              <button type="button" class="upload-button btn btn-primary visiting_card_btn" name=""
                                id="visiting_card_btn"> Upload </button>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="card vendor-details-card mb-0">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            ...
                            <input type="text" class="form-control" name="customer_authorised_person_name"
                              id="adminName" value="">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            ...
                            <input type="text" class="form-control" name="customer_authorised_person_designation"
                              id="customer_authorised_person_designation" value="">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            ...
                            <input type="text" class="form-control" name="customer_authorised_person_phone"
                              id="adminPhone" value="">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            ...
                            <input type="text" class="form-control" name="customer_authorised_alt_phone"
                              id="customer_authorised_person_phone" value="">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            <label>Email*</label>
                            <input type="email" class="form-control" name="customer_authorised_person_email"
                              id="adminEmail" value="">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            ...
                            <input type="email" class="form-control" name="customer_authorised_alt_email"
                              id="customer_authorised_person_email" value="">
                        ...
                        <div class="col-md-6">
                          <div class="form-input">
                            ...
                            <input type="text" class="form-control" name="adminPassword" id="adminPassword"
                              value="<?php echo rand(00000, 999999) ?>">
                        ...
                        <div class="col-md-3">
                          <div class="form-input">
                            ...
                            <select id="customer_visible_to_all" name="customer_visible_to_all"
                              class="select2 form-control mt-0 borderColor">
                  ...
                  <div class="card-footer">
                    <div class="button-row d-flex">
                      ...
                      <button class="btn ml-auto btn-danger add_data" type="button" title="Save As Draft"
                        value="add_draft">Save As Draft</button>
                      <button id="customerCreateBtn" class="btn btn-primary ml-auto add_data" type="button"
                        title="Final Submit" value="add_post">Final Submit</button>
                    </div>
                  </div>
                </div>
...
<script>
  $(document).ready(function() {
    ...
    let validityDate = $("#dateInputvalid");
    let submitBtn = $("#directInvoiceCreationBtn");
    let deliveryDateMsg = $(".deliveryDateMsg");

    let url_param = window.location.search;

    if (url_param === "?party_order_to_so" || url_param.startsWith("?party_order_to_so=")) {
      console.log("party_order_to_so detected in URL.");

      validityDate.prop("readonly", true);
      submitBtn.prop("disabled", true);

      function validateDates() {
        let deliveryValue = deliveryDate.val();
        let validityValue = validityDate.val();

        if (deliveryValue) {
          validityDate.prop("readonly", false).attr("min", deliveryValue);
        } else {
          validityDate.prop("readonly", true).val("");
        }

        if (deliveryValue && validityValue) {
          if (validityValue >= deliveryValue) {
            submitBtn.prop("disabled", false);
            deliveryDateMsg.text("");
          } else {
            submitBtn.prop("disabled", true);
            deliveryDateMsg.text("Validity date must be greater than or equal to delivery date")
              .css({
                "color": "red",
                "font-size": "10px"
              });
      ...
      validateDates(); // Run validation on page load
      deliveryDate.on("change input", validateDates);
      validityDate.on("change input", validateDates);
    } else {
      console.log("party_order_to_so NOT found. Skipping validation.");
    }


    // function appendStepToElements(decimalPlaces, className) {
    //   // alert("function has called" )
    //   console.log("decimalPlaces is " + decimalPlaces + "classname is " + className);
    //   if (decimalPlaces < 0) {
    //     console.error("Decimal places must be non-negative.");
    //     return;
    //   }

    //   var stepValue = (1 / Math.pow(10, decimalPlaces)).toFixed(decimalPlaces);
    ...
    // Example usage:
    // This will set the step attribute to "0.00001" for all elements with the class "decimal-input".
    ...
    function itemAutoAdd(itemIdArry) {
      ...
      if (itemIdArry != '') {
        console.log({
          itemIdArry: itemIdArry
        })
        // let sanitizedJSONData = itemIdArry.replace(
        //   /[\x00-\x1F\x7F-\x9F]|"discountGroup":\s*("(?:\[[^"]*\])"|"null")/g,
        //   (match, p1) => {
        //     if (p1 !== undefined) {
        //       return p1 === '"null"' ? `"discountGroup": null` : `"discountGroup": ${p1}`;
        //     }
        //     return ''; // Removes control characters
        //   }
        // );
        // var itemIdArryTo = JSON.parse(sanitizedJSONData);
        var itemIdArryTo = JSON.parse(itemIdArry, (key, value) => {
          if (value === "null") return null; // Convert string "null" to actual null
        ...
        $.each(itemIdArryTo, function(index, value) {
          if (value.inventory_item_id > 0) {
            $.ajax({
              ...
              success: function(response) {
                // $(`#spanItemsTable`).html(`Fethching Items...`);
                //  alert(response);
                // console.log(response)
                ...
                $(`#spanItemsTable`).html(``);
                // let qtybase = <?= $decimalQuantity ?>;
                // appendStepToElements(qtybase, 'itemQty');
    ...
    itemAutoAdd(<?= json_encode($itemIdJson) ?>);
    // get item details by id
          ...
          success: function(response) {
            ...
            if (branchGstin === "") {
              for (elem of $(".itemTotalTax")) {
                ...
                $(`#itemTaxPercentage_${rowNo}`).html(inputQuantity(0));
    ...
    function discount_varients(rowNo, customer_id, item_id, days) {
      //console.log(days);
      let itemVal = helperQuantity($(`#itemBaseAmountInp_${rowNo}`).val());
      // alert(itemVal);
      ...
      $(`.discountView_${rowNo}`).on('click', '.discount_radio', function() {
        // alert("called"); // Show value of the clicked radio button
        ...
        var percentage_val = helperAmount($(`#percentage_val_${random}`).val());
        ...
        //alert(discount_type);
        var max_val = helperAmount($(`#max_val_${random}`).val());
        // alert(max_val);
        ...
        $(`#itemTradeDiscountPercentageSpan_${rowNo}`).text(`${decimalAmount(percentage_val)}`);
        ...
        if (discount_type == 'percentage') {
          ...
          if (max_val > 0 && max_val !== null) {
            if (percentage_amount > max_val) {
              ...
              $(`#itemDiscount_${rowNo}`).val(decimalQuantity(percentage_val));
              ...
              var dis = helperAmount($(`#itemTotalDiscount1_${rowNo}`).val());
            ...
            console.log("percentage_val =>" + percentage_val)
            console.log("percentage =>" + percentage)
            console.log("percentage amount =>" + percentage_amount)
          ...
          $(`#itemDiscount_${rowNo}`).val(decimalAmount(percent));
          $(`#itemDiscountVarientId_${rowNo}`).val(discount_varient_id);
          $(`#itemTotalDiscountHidden_${rowNo}`).val(decimalAmount(percentage_val));
          $(`#itemTotalDiscount_${rowNo}`).html(decimalAmount(percentage_val));
          $(`#itemTradeDiscountAmountInp_${rowNo}`).val(decimalAmount(percentage_val));
    ...
    function tcsTotal(total_value, tcsAmount) {
      let final_value = 0;
      final_value = helperAmount(total_value + tcsAmount);
      console.log("final_value" + final_value)
      $("#grandTotalAmt").html(decimalAmount(final_value));
      $('.tcsValueInp').val(decimalAmount(tcsAmount))
      // $(".grandTotalAmounttInp").html(final_value);
      $(".adjustedCollectAmountInp").val(decimalAmount(final_value));
      $("#grandTotalAmtInp").html(decimalAmount(final_value));
    ...
    //   $(`#convertedItemTradeDiscountAmountSpan_${rowNo}`).text(convertedTradeDiscountAmount);
    //   $(`#convertedGrossAmountSpan_${rowNo}`).text(convertedGrossAmount);
    //   $(`#convertedCashDiscountAmountSpan_${rowNo}`).text(convertedCashDiscountAmount);
    //   $(`#convertedTaxableAmountSpan_${rowNo}`).text(convertedTaxableAmount);
    ...
    //   let taxableAmount = grossAmount - cashDiscountAmount;
    ...
    //   // $(`#itemGrossAmountSpan_${rowNo}`).text(grossAmount);
    //   $(`#itemGrossAmountSpan_${rowNo}`).text(basicPrice - totalDiscount);
    //   $(`#itemGrossAmountInCashDiscount_${rowNo}`).text(basicPrice - totalDiscount);
    ...
    //   $(`#itemTaxableAmountSpan_${rowNo}`).text(grossAmount - cashDiscountAmount);    

    //   $(`#itemBaseAmountInp_${rowNo}`).val(basicPrice);
    //   $(`#itemBaseAmountInCashDiscount_${rowNo}`).html(basicPrice);
    //   $(`#baseAmountRadio_${rowNo}`).val(basicPrice);
    ...
    //   $(`#convertedItemCashDiscountAmountSpan_${rowNo}`).html(convertedTotalCashDiscount);
    ...
    // one item calculation 
    function calculateOneItemAmounts(rowNo) {
      console.log("calculateOneItemAmounts is called")
      let param = window.location.search.split("=")[0];
      let baseAmountIsCheck = $(`#baseAmountRadio_${rowNo}`).is(":checked");
      console.log('window.location.search.split("=")[0]', param);
      ...
      console.log({
        ...
        cashDiscountAmount,
        convertedBasicPrice,
        convertedCashDiscountAmount,
        convertedCurrencyValue,
        convertedGrossAmount,
        convertedItemUnitPrice,
        convertedPriceWithDiscount,
        convertedTaxableAmount,
        convertedTotalCashDiscount,
        convertedTotalDiscount,
        convertedTotalItemPrice,
        convertedTotalTax,
        convertedTradeDiscountAmount,
        grossAmount,
        itemBaseAmountInp: $(`#itemBaseAmountInp_${rowNo}`).val(),
        itemBaseAmountSpan: $(`#itemBaseAmountSpan_${rowNo}`).text(),
        itemBaseAmountInCashDiscount: $(`#itemBaseAmountInCashDiscount_${rowNo}`).html(),
        itemBaseAmountRadio: $(`#baseAmountRadio_${rowNo}`).val(),
        itemCashDiscount,
        itemCashDiscountAmount,
        itemCashDiscountAmountInp,
        itemCashDiscountAmountSpan: $(`#itemCashDiscountAmountSpan_${rowNo}`).text(),
        itemCashDiscountAmountHiddenInp: $(`#itemCashDiscountAmountHiddenInp_${rowNo}`).val(),
        itemCashDiscountPercentageSpan,
        itemDiscount,
        itemDiscountVarientId,
        itemGrossAmount,
        itemGrossAmountSpan: $(`#itemGrossAmountSpan_${rowNo}`).text(),
        itemQty,
        itemTax,
        itemTaxableAmount,
        itemTaxableAmountSpan: $(`#itemTaxableAmountSpan_${rowNo}`).text(),
        itemTotalDiscount: $(`#itemTotalDiscount_${rowNo}`).html(),
        itemTotalDiscountHidden: $(`#itemTotalDiscountHidden_${rowNo}`).val(),
        itemTotalDiscount1: $(`#itemTotalDiscount1_${rowNo}`).val(),
        itemTotalPrice: $(`#itemTotalPrice_${rowNo}`).val(),
        itemTotalPrice1: $(`#itemTotalPrice1_${rowNo}`).html(),
        itemTotalTax: $(`#itemTotalTax_${rowNo}`).html(),
        itemTotalTax1: $(`#itemTotalTax1_${rowNo}`).val(),
        itemTradeDiscountAmount,
        itemTradeDiscountAmountInp,
        itemTradeDiscountAmountSpan: $(`#itemTradeDiscountAmountSpan_${rowNo}`).text(),
        itemTradeDiscountName,
        itemTradeDiscountPercentageSpan,
        originalItemUnitPrice,
        param,
        priceWithDiscount,
        ...
        totalDiscount,
        totalItemPrice,
        totalItemAmountModal: $(`#totalItemAmountModal_${rowNo}`).html(),
        totalTax
      });
    ...
    function calculateGrandTotalAmount() {
      ...
      //   totalDiscountAmount += ($(this).html().replace(/,/g, "")) || 0;
      // });
      ...
      if (compInvoiceType === "CBW" || compInvoiceType === "LUT" || compInvoiceType === "SEWOP" || compInvoiceType === "E") {
        // alert(111111111111);
        $(".grandSgstCgstAmt").html(decimalAmount(0));
        $(".convertedGrandSgstCgstAmt").html(decimalAmount(0));

        $("#grandTaxAmt").html(decimalAmount(0));
        $("#convertedGrandTaxAmount").html(decimalAmount(0));

        $("#grandTaxAmtInp").val(decimalAmount(0));
        ...
        // alert('ok');
        $(".grandSgstCgstAmt").html(decimalAmount(totalTaxAmount / 2));
        // alert(1);
        $(".convertedGrandSgstCgstAmt").html(decimalAmount(convertedItemTaxAmountSpan / 2));
        // alert(2);
    ...
    function currency_conversion() {
      for (elem of $(".convertedItemUnitPriceSpan")) {
        let rowNo = ($(elem).attr("id")).split("_")[1];
        let newVal = helperAmount($("#curr_rate").val() * $(`#originalChangeItemUnitPriceInp_${rowNo}`).val());
    ...
    function itemMaxDiscount(rowNo, keyValue = 0) {
      ...
      if (helperAmount(keyValue) > helperAmount(itemMaxDis)) {
    ...
    $(document).on("keyup", ".itemQty", function() {
      ...
      let itemVal = helperQuantity($(`#itemQty_${rowNo}`).val()) > 0 ? helperQuantity($(`#itemQty_${rowNo}`).val()) : 0;
      let itemTradeDiscountAmount = helperAmount($(`#itemTradeDiscountAmountSpan_${rowNo}`).text()) || 0;
      let itemCashDiscountAmount = helperAmount($(`#itemCashDiscountAmountSpan_${rowNo}`).text()) || 0;
      let originalItemUnitPrice = helperAmount($(`#originalChangeItemUnitPriceInp_${rowNo}`).val()) || 0;
      let basicPrice = helperAmount(originalItemUnitPrice * itemVal);



      // Check if the corresponding "checkQty_" element exists
      if ($(`#checkQty_${rowNo}`).length > 0) {
        let checkQty = helperQuantity($(`#checkQty_${rowNo}`).val()) > 0 ? helperQuantity($(`#checkQty_${rowNo}`).val()) : 0;
        ...
        // if (checkQty) {
        let splitQty = helperQuantity($(`#checkQty_${rowNo}`).val()) > 0 ? helperQuantity($(`#checkQty_${rowNo}`).val()) : 0;
      ...
      if (param !== "?create_service_invoice") {
        if (flag > 0) {
          ...
          $.ajax({
            ...
            //   // console.log("Full stock response:", stock);

            //   if (stock.numRows > 0) {
            //     let sumOfBatches = stock.sumOfBatches;
            //     $(".checkQtySpan").each(function() {
            //       let id = $(this).attr("id");
            //       let randCode = id.split("checkQtySpan_")[1];

            //       $(`#itemQty_${randCode}`).val(inputQuantity(0));
            //       $(`#checkQty_${randCode}`).val(sumOfBatches);
            //       $(`#checkQtySpan_${randCode}`).html(inputQuantity(sumOfBatches));
            //       $(`#fifo_${randCode}`).prop("checked", true);
            //       $(`#itemSellType_${randCode}`).html("FIFO");
            //       $(`.enterQty`).val('');
            //     });
            //   } else {
            //     $(".checkQtySpan").each(function() {
            ...
            //       $(`#checkQty_${randCode}`).val(0);
            //       $(`#checkQtySpan_${randCode}`).html(inputQuantity(0));
            //     });
            //   }
            // }
    ...
    $("#compInvoiceType").on("change", function() {
      ...
      for (elem of $(".itemTotalTax")) {
        ...
        if (compInvoiceType === "CBW" || compInvoiceType === "LUT" || compInvoiceType === "SEWOP" || compInvoiceType === "E") {
          ...
          $(`#itemTaxPercentage_${rowNo}`).html(inputQuantity(itemTaxBkup));
        }
    ...
    function cashDiscountFunc(rowNo, keyValue) {
      ...
      $(`#itemCashDiscountPercentageInp_${rowNo}`).val(`${decimalAmount(keyValue)}`);
      $(`#itemCashDiscountPercentageSpan_${rowNo}`).text(`${decimalAmount(keyValue)}`);
      ...
      $(`#itemTaxableAmountSpan_${rowNo}`).text(decimalAmount(helperAmount(itemGrossAmount) - discountAmt));
    }
    ...
    $(document).on("keyup", ".itemDiscount", function() {
      ...
      $(`#itemTradeDiscountPercentageInp_${rowNo}`).val(decimalAmount(keyValue));
      $(`#itemTradeDiscountPercentageSpan_${rowNo}`).text(decimalAmount(keyValue));
    ...
    $(document).on("blur", ".itemTotalDiscount1", function() {
      ...
      $(`#itemDiscount_${rowNo}`).val(decimalAmount(discountPercentage));
    ...
    function totalquentitydiscut(rdcode) {
      ...
      $("#itemQty_" + rdcode).val(inputQuantity(0));
...
<script>
  $(document).ready(function() {
    ...
    if (status) {
      document.getElementById("directInvoiceCreationBtn").disabled = true;
      $("#invdatelabel").html(`<p class="text-danger text-xs" id="invdatelabel">Month variant not matched with current month</p>`);
    }
  });
</script>
...
<script>
  $(document).ready(function() {
    // Convert PHP array to JSON string safely
    let arry = <?= json_encode($itemIdJson) ?>;
    ...
    // First, parse the JSON safely
    let parsedData = JSON.parse(arry, (key, value) => {
      if (value === "null") return null; // Convert string "null" to actual null
      if (typeof value === "string" && value.startsWith("[") && value.endsWith("]")) {
        try {
          return JSON.parse(value); // Convert stringified array to real array
    ...
    // let sanitizedJSONString = arry.replace(
    //   /[\x00-\x1F\x7F-\x9F]|"discountGroup":\s*("(?:\[[^"]*\])"|"null")/g,
    //   (match, p1) => {
    //     if (p1 !== undefined) {
    //       if (p1 === '"null"') {
    ...
    //       } else {
    //         // p1 is something like "[\"1\"]"
    //         try {
    //           // Convert p1 (a JSON string) into a JavaScript array
    //           let arr = JSON.parse(p1);
    //           // Re-stringify the array to get valid JSON syntax (e.g., ["1"])
    //           return `"discountGroup": ${JSON.stringify(arr)}`;
    //         } catch (e) {
    //           // In case parsing fails, return the original value
    //           return `"discountGroup": ${p1}`;
    //         }
    //       }
    //     }
    ...
    // console.log({
    //   sanitizedJSONData: sanitizedJSONString,
    //   json_parse : JSON.parse(sanitizedJSONString),
    //   type: typeof (sanitizedJSONString)
    // });

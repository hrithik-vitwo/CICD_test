  ...
  <div class="content-wrapper">
    <section class="content">
      <form action="" method="POST">
        <div class="container-fluid" style="padding: 30px 10px !important;">
          ...
          <div class="invoice-template">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-6 col-parent">
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-child border-bottom-0 ">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-6 col-parent" style="border-right: 1px solid #000;">
                ...
                <div class="row qrStyle">
                  <img width="120" src="https://www.scandit.com/wp-content/uploads/2019/08/Symbology-QR-code.svg" alt="qr">
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-6 col-child border-top-0 border-right-0">
                ...
                <div class="d-flex">
                  <p>Company’s PAN : </p>
                  <p class="font-bold"><?= $companyData['company_pan'] ?></p>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-6 col-child ">
                ...
                <?php if ($companyData['signature'] != null || $companyData['signature'] != "") { ?>
                  <p class="text-center sign-img">
                    <img src="<?=BASE_URL?>public/storage/signature/<?= $companyData['signature'] ?>" alt="signature">
                  </p>
                <?php }else{ echo "no"; } ?>
              </div>
            </div>

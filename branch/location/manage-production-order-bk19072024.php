                                ...
                                <table class="table table-sales-order">
                                    ...
                                    <tbody id="itemsTable">
                                        <tr>
                                            ...
                                            <td width="10%">
                                                <input type="number" placeholder="0.00" step="any" name="item_qty" class="form-control" min="1">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<?php
    ...
    if (isset($_GET["stage"]) && $_GET["stage"] == "test") {
        require_once("components/production/production-order-list-test.php");
    } else {
        // require_once("components/production/production-order-list.php");
        require_once("components/production/production-order-list-test.php");
    }
}

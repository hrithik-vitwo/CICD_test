...
if (isset($_POST["createWarehouse"])) {
  ...
  $addNewObj = $warehouseController->createWarehouse($_POST, $branch_id, $company_id, $location_id, $created_by);
        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Warehouse</a></li>
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Warehouse</a></li>
            </ol>
          </div>
              ...
              <div id="accordion">
                ...
                <div class="card card-success">
                  ...
                  <div class="card-header cardHeader">
                    <h4 class="card-title w-100"> <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseThree"> Warehouse Details </a> </h4>
                  </div>
                  <div id="collapseThree">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="address" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="lat" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="lng" class="m-input">
                  ...
                  <div id="collapseThree">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="name" class="m-input" value="<?= $row['warehouse_name'] ?>">
                            <label>Warehouse Name</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="address" class="m-input" value="<?= $row['warehouse_address'] ?>">
                            <label>Warehouse Address</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
                          <div class="input-group">
                            <input type="text" name="description" class="m-input" value="<?= $row['warehouse_description'] ?>">
                            <label>Warehouse Description</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="lat" class="m-input" value="<?= $row['warehouse_lat'] ?>">
                            <label>Warehouse Latitude</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="lng" class="m-input" value="<?= $row['warehouse_lng'] ?>">
                            <label>Warehouse Longitude</label>
                          </div>
                        </div>
            ...
            <div class="card card-tabs" style="border-radius: 20px;">
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                  ...
                  $sql_list = "SELECT * FROM " . ERP_WAREHOUSE . " WHERE 1 AND `company_id`=$company_id AND `branch_id`=$branch_id AND `location_id`=$location_id " . $cond . " " . $sts . "  ORDER BY warehouse_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                  $qry_list = mysqli_query($dbCon, $sql_list);
                  $num_list = mysqli_num_rows($qry_list);


                  $countShow = "SELECT count(*) FROM " . ERP_WAREHOUSE . " WHERE 1 AND `company_id`=$company_id AND `branch_id`=$branch_id AND `location_id`=$location_id  " . $cond . " ";
                  $countQry = mysqli_query($dbCon, $countShow);
                  $rowCount = mysqli_fetch_array($countQry);
                  $count = $rowCount[0];
                  $cnt = $GLOBALS['start'] + 1;
                  $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_WAREHOUSE", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                  ...
                  if ($num_list > 0) { ?>
                    <table class="table defaultDataTable table-hover text-nowrap p-0 m-0">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr style="cursor:pointer" data-toggle="modal" data-target="#fluidModalRightSuccessDemo_<?= $row['warehouse_id'] ?>">
                            <td><?= $cnt++ ?></td>
                            <?php if (in_array(1, $settingsCheckbox)) { ?>
                            ...
                            <?php }
                            if (in_array(5, $settingsCheckbox)) { ?>
                              <td><?= $row['warehouse_lat'] ?></td>
                            <?php }
                            if (in_array(6, $settingsCheckbox)) { ?>
                              <td><?= $row['warehouse_lng'] ?></td>
                            <?php } ?>
                            <td>
                          ...
                          <div class="modal fade right customer-modal" id="fluidModalRightSuccessDemo_<?= $row['warehouse_id'] ?>" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog modal-full-height modal-right modal-notify modal-success" role="document">
                              <!--Content-->
                              <div class="modal-content">
                                <!--Header-->
                                <div class="modal-header">
                                  <p class="heading lead"><?= $warehouse_name ?></p>
                                  <div class="display-flex-space-between mt-4 mb-3">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                      <li class="nav-item">
                                        <a class="nav-link active" id="home-tab<?= str_replace('/', '-',$row['warehouse_code']) ?>" data-toggle="tab" href="#home<?= str_replace('/', '-',$row['warehouse_code']) ?>" role="tab" aria-controls="home" aria-selected="true">Info</a>
                                      </li>
                                      <!-- -------------------Audit History Button Start------------------------- -->
                                      <li class="nav-item">
                                        <a class="nav-link auditTrail" id="history-tab<?= str_replace('/', '-',$row['warehouse_code']) ?>" data-toggle="tab" data-ccode="<?= str_replace('/', '-',$row['warehouse_code']) ?>" href="#history<?= str_replace('/', '-',$row['warehouse_code']) ?>" role="tab" aria-controls="history<?= str_replace('/', '-',$row['warehouse_code']) ?>" aria-selected="false"><i class="fa fa-history mr-2"></i>Trail</a>
                                      </li>
                                      <!-- -------------------Audit History Button End------------------------- -->
                                    </ul>
                                    <div class="action-btns display-flex-gap" id="action-navbar">
                                      <?php
                                      $warehouse_id = base64_encode($row['warehouse_id']);
                                      ?>
                                      <form action="" method="POST">
                                        <a href="warehouse.php?edit=<?= $warehouse_id ?>" name="customerEditBtn">
                                ...
                                <div class="modal-body" style="padding: 0;">
                                  ...
                                  <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home<?= str_replace('/', '-',$row['warehouse_code']) ?>" role="tabpanel" aria-labelledby="home-tab">
                                      <div class="col-md-12">
                                      ...
                                      <div class="row px-3 p-0 m-0" style="place-items: self-start;">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Warehouse Name: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Warehouse Code: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            ...
                                            <div class="col-md-6">
                                              <span><?= $warehouse_description ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Latitude : </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $warehouse_lat ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="tab-pane fade" id="history<?= str_replace('/', '-',$row['warehouse_code']) ?>" role="tabpanel" aria-labelledby="history-tab">
                                      ...
                                      <hr>
                                      <div class="audit-body-section mt-2 mb-3 auditTrailBodyContent<?= str_replace('/', '-',$row['warehouse_code']) ?> ?>">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                      ...
                      <input type="hidden" name="pageTableName" value="ERP_WAREHOUSE" />
                      <div class="modal-body">

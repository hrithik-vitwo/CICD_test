...
<head>
    ...
    <title>Round Off Data Sanitization</title>
</head>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="content-header">
                    <h2>Round Off Data Sanitization</h2>
                </div>
...
<script>
    function loadData() {
        $.ajax({
            type: "GET",
            url: `<?= LOCATION_URL ?>ajaxs/ajax-api-roundoff-data-sanitization.php`,
            data: {
                act: "invData",
            },
            beforeSend: function() {
                        ...
                        if (roundoff == 0) {
                            ...
                            if (leftSide+roundoff == rigtSide) {
                                ...
                                if ((leftSide + roundoff) != total) {
                                    ...
                                    if(leftSide+roundoff == total+roundoff) {

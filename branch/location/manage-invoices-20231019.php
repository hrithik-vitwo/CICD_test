                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane show active" id="preview<?= str_replace('/', '-', $oneSoList['invoice_no']) ?>">
                          ...
                          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" data-toggle="pill" href="#companyCurrency<?= str_replace('/', '-', $oneSoList['so_invoice_id']) ?>"><?= $currencyName ?></a>
                            </li>
                            <?php if ($oneSoList['currency_name'] != $currencyName) { ?>
                              <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#customerCurrency<?= str_replace('/', '-', $oneSoList['so_invoice_id']) ?>">
                                  <?= $oneSoList['currency_name']; ?>
                                </a>
                              </li>
                            <?php } ?>
                          </ul>
                          ...
                          <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="companyCurrency<?= str_replace('/', '-', $oneSoList['so_invoice_id']) ?>">
                              <!-- company 💰🏢💰🏢 currency name start here... -->
                              <div class="card classic-view bg-transparent">
                                <div class="card-body classic-view-so-table invoicePrintView" style="overflow: auto;">
                              ...
                              <div class="card classic-view bg-transparent">
                                <?php
                                $templateInvoiceControllerObj->printInvoice($oneSoList['so_invoice_id']);
                                ?>
                              </div>
                              <!-- company 💰🏢💰🏢 currency name end here... -->
                            </div>
                            <div class="tab-pane fade" id="customerCurrency<?= str_replace('/', '-', $oneSoList['so_invoice_id']) ?>">
                              <!-- customer ⚒️👷🏾‍♂️⚒️👷🏾‍♂️⚒️👷🏾‍♂️ currency name start here... -->
                              <div class="card classic-view bg-transparent">
                                <div class="card-body classic-view-so-table" style="overflow: auto;">
                                  <a href="classic-view/invoice-preview-print.php?invoice_id=<?= base64_encode($oneSoList['so_invoice_id']) ?>&conversion=<?= $oneSoList['conversion_rate'] ?>" class="btn btn-primary classic-view-btn float-right" target="_blank">Print</a>
                                  <div class="printable-view">
                                    <h3 class="h3-title text-center font-bold text-sm mb-4">Tax Invoice</h3>
                              ...
                              <!-- customer ⚒️👷🏾‍♂️⚒️👷🏾‍♂️⚒️👷🏾‍♂️ currency name end here... -->
                            </div>
                          </div>
                        </div>

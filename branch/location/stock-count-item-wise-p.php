                                        ...
                                        <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                            <div class="left-block">
                                                <div class="label-select">
                                                    <h3 class="card-title mb-0">Stock Count Item Wise</h3>
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookiesStockCountItemWise');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-stock-count-item-wise.php",
                dataType: 'json',
                data: {
                    act: 'stockCount',
                    comid: comid,

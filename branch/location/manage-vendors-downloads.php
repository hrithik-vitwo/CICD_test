...
if (!isset($_COOKIE["cookiemanagevendorsDownload"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiemanagevendorsDownload", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
...
$columnMapping = [
    ...
    [
        'name' => 'Vendor Code',
        'slag' => 'vend.vendor_code',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Trade Name',
        'slag' => 'vend.trade_name',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => ''
    ],
    [
        'name' => 'legal Name',
        'slag' => 'vend.legal_name',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => ''
    ],
    [
        'name' => 'Vendor Pan',
        'slag' => 'vend.vendor_pan',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => ''
    ],
    [
        'name' => 'GSTIN',
        'slag' => 'vend.vendor_gstin',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Constitution of Business',
        'slag' => 'vend.constitution_of_business',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Opening Balance',
        'slag' => 'vend.vendor_opening_balance',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Auth Person Name',
        'slag' => 'vend.vendor_authorised_person_name',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Email',
        'slag' => 'vend.vendor_authorised_person_email',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Phone',
        'slag' => 'vend.vendor_authorised_person_phone',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Alt Phone',
        'slag' => 'vend.vendor_authorised_alt_phone',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Auth person designation',
        'slag' => 'vend.vendor_authorised_person_designation',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Currency',
        'slag' => 'currType.currency_name',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Visibility to all',
        'slag' => 'vend.vendor_visible_to_all',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'website',
        'slag' => 'vend.vendor_website',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Credit period',
        'slag' => 'vend.vendor_credit_period',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Address Primary Flag',
        'slag' => 'address.vendor_business_primary_flag',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Vendor Address Building No',
        'slag' => 'address.vendor_business_building_no',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Vendor Address Flat No',
        'slag' => 'address.vendor_business_flat_no',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Vendor Address city',
        'slag' => 'address.vendor_business_city',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Vendor Address Bussiness Location',
        'slag' => 'address.vendor_business_location',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Vendor Address Street Name',
        'slag' => 'address.vendor_business_street_name',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Vendor Address Pin Code',
        'slag' => 'address.vendor_business_pin_code',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
                                                        ...
                                                        <div class="filter-action filter-mobile-search mobile-page">
                                                            ...
                                                            <div class="exportgroup mobile-page mobile-export">
                                                                ...
                                                                <ul class="export-options">
                                                                    <li>
                                                                        <button class="ion-paginationlistVendorsList">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-paginationlistVendorsList md hydrated"
                                                                                role="img"
                                                                                aria-label="list outline"></ion-icon>Export
                                                                        </button>
                                                                    </li>
                                                                    <li>
                                                                        <button class="ion-fulllistVendorsList">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-fulllistVendorsList md hydrated"
                                            ...
                                            <div class="exportgroup">
                                                ...
                                                <ul class="export-options">
                                                    ...
                                                    <li>
                                                        ...
                                                        <button class="ion-fulllistVendorsList">
                                                            <ion-icon name="list-outline"
                                                                class="ion-fulllistVendorsList md hydrated" role="img"
                                                                aria-label="list outline"></ion-icon>Download
                                                        </button>
                                                    </li>
                                                </ul>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div id="main2">
                                                                        ...
                                                                        <table class="colomnTable">
                                                                            <?php
                                                                            $cookieTableStockReport = json_decode($_COOKIE["cookiemanagevendorsDownload"], true) ?? [];
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($columnMapping as $columnIndex => $column) {
                                                                            if ($columnIndex === 0 ||$columnIndex === 7 || $columnIndex === 17) {
                                                                                continue;
                                                                            } ?>
                                                                        <tr>
                                                                            <td>
                                                            ...
                                                            <div class="top-details">
                                                                ...
                                                                <div class="right">
                                                                    ...
                                                                    <p class="info-detail default-address"><ion-icon
                                                                            name="location-outline"></ion-icon><span
                                                                            id="default_address">
                                                        ...
                                                        <div class="modal-body">
                                                            <nav>
                                                                <div class="nav nav-tabs global-view-navTabs"
                                                                    ...
                                                                    <button
                                                                        class="nav-link classicview-btn classicview-link"
                                                                        id="nav-classicview-tab" data-id=""
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#nav-classicview" type="button"
                                                                        role="tab" aria-controls="nav-classicview"
                                                                        aria-selected="true"><ion-icon
                                                                            name="print-outline"></ion-icon>Print
                                                                        Preview</button>
                                                                    <button class="nav-link auditTrail"
                                                                        id="nav-trail-tab" data-bs-toggle="tab"
                                                                        data-bs-target="#nav-trail" data-ccode=""
                                                            ...
                                                            <div class="tab-content global-tab-content"
                                                                ...
                                                                <div class="tab-pane fade transactional-data-tabpane show active"
                                                                    ...
                                                                    <div class="row">
                                                                                ...
                                                                                <div class="customer-details">
                                                                                    ...
                                                                                    <div class="address-contact">
                                                                                        ...
                                                                                        <div class="contact-customer">
                                                                                            <div
                                                                                                class="details dotted-border-area">
                                                                                                <label
                                                                                                    for="">Contacts</label>
                                                                                                <p> <ion-icon
                                                                        ...
                                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                                            <div class="items-view items-calculation"
                                                                                id="item-div-main">
                                                                                <div class="card item-cards">
                                                                                    <div class="card-body">
                                                                                        <div
                                                                                            class="row-section row-first">
                                                                                            <div class="left-info">
                                                                                                <ion-icon
                                                                                        ...
                                                                                        <hr>
                                                                                        <div
                                                                                            class="row-section row-total-amount">
                                                                                            <div class="left-info">
                                                                                                <div class="item-info">
                                                                                                    <p class="total">
                                                                                                        Total Amount</p>
                                                                ...
                                                                <div class="tab-pane classicview-pane fade"
                                                                    id="nav-classicview" role="tabpanel"
                                                                    aria-labelledby="nav-classicview-tab">
                                                                    <a href=""
                                                                        class="btn btn-primary classic-view-btn float-right"
                                                                    ...
                                                                    <div class="inner-content">
                                                                        <div class="audit-head-section mb-3 mt-3 ">
                                                                            <p class="text-xs font-italic"><span
                                                                                    ...
                                                                                    by </span><span
                                                                                    class="created_by_trail"></span></p>
                                                                            <p class="text-xs font-italic"> <span
                                                                                    class="font-bold text-normal">Last
                                                                                    Updated by</span><span
                                                                                    class="updated_by"> </span></p>
                                                                        </div>
                                                                        <hr>
                                                                        <div
...
<script>
    ...
    $(document).ready(function () {
        ...
        function full_datatable() {
            ...
            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-vendors-downloads.php",
                dataType: 'json',
                data: {
                    act: 'alldata',
                },
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookiemanagevendorsDownload');
                ...
                success: function (response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function (index, value) {
                            ...
                            if (value.vendor_status == "guest" || value.vendor_status == "inactive") {
                            ...
                            let actions = `<li>
                                            <button class="soModal" data-toggle="modal" data-id=${value.vendorId} data-code="${value['vend.vendor_code']}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                            </li>`;

                            dataTable.row.add([
                                value['sl_no'],
                                `<a href="#" data-id="${value['vendorId']}" data-code="${value['vend.vendor_code']}">${value['vend.vendor_code']}</a>`,
                                value['vend.trade_name'],
                                value['vend.legal_name'],
                                value['vend.vendor_pan'],
                                value['vend.vendor_gstin'],
                                value['vend.constitution_of_business'],
                                value['vend.vendor_opening_balance'],
                                value['vend.vendor_authorised_person_name'],
                                value['vend.vendor_authorised_person_email'],
                                value['vend.vendor_authorised_person_phone'],
                                value['vend.vendor_authorised_alt_phone'],
                                value['vend.vendor_authorised_person_designation'],
                                value['currType.currency_name'],
                                value['vend.vendor_visible_to_all'],
                                value['vend.vendor_website'],
                                value['vend.vendor_credit_period'],
                                value['address.vendor_business_primary_flag'],
                                value['address.vendor_business_building_no'],
                                value['address.vendor_business_flat_no'],
                                value['address.vendor_business_city'],
                                value['address.vendor_business_location'],
                                value['address.vendor_business_street_name'],
                                value['address.vendor_business_pin_code'],
                                mailStatus,
                                status,
                                ` <div class="dropout">
                                    <button class="more">
        ...
        $(document).on("click", ".ion-paginationlistVendorsList", function (e) {
        console.log("called")
            $.ajax({
                type: "POST",
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiemanagevendorsDownload')
                },
                // beforeSend:function(){
        ...
        // $(document).on("click", ".ion-fulllistVendorsList", function (e) {
        //     $.ajax({
        //         type: "POST",
        //         url: "../common/exportexcel-new.php",
        //         dataType: "json",
    ...
    $(document).on("click", ".soModal", function () {
        ...
        $.ajax({
            ...
            success: function (value) {
                ...
                $("#postingDate").html(" : " + formatDate(responseObj.dataObj.so_date));
                ...
                $("#custOrderNo").html(" : " + responseObj.dataObj.customer_po_no);
                // $("#refDoc").html(" : " + responseObj.dataObj.fileName);
                ...
                if (disCount == 0) {
                    ...
                    taxableAmt = parseFloat(subTotal) - parseFloat(disCount);
                }

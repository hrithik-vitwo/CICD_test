...
if ($_POST['action'] == "dn") {
    ...
    $addDebit = debit_note_add_taxrule($_POST + $_FILES);
    // console($_POST);

    if ($addDebit['status'] == "success") {
        swalAlert($addDebit["status"], $addDebit['debit_note_no'], $addDebit["message"], BRANCH_URL . 'location/manage-debit-notes.php');
    } else {
        swalAlert('warning', 'Warning', $addDebit["message"], BRANCH_URL . 'location/manage-debit-notes.php');
    }
}
?>
<style>
...
if (isset($_GET['dnId']) || $_POST['action'] == "cn") {
    $dnId =  base64_decode($_GET['dnId']);
    $supply_address = '';
    $select_dn = queryGet("SELECT * FROM `erp_debit_note` WHERE `dr_note_id` = $dnId");
    $debitNoteReference = $select_dn['data']['debitNoteReference'];
    //   console($select_dn);
    $billing_address = $select_dn['data']['billing_address'];
    $supply_address = $select_dn['data']['source_address'];
    ...
    //echo $select_dn['data']['debitor_type'];
    if ($select_dn['data']['debitor_type'] == 'customer') {
        ...
        // debitNoteReference
        $ref_sql = queryGet("SELECT * FROM `erp_branch_sales_order_invoices` WHERE `so_invoice_id`=$debitNoteReference");
        //  /   console($ref_sql);
        ...
        $ref_sql = queryGet("SELECT * FROM `erp_grninvoice` WHERE `grnIvId`=$debitNoteReference");
    ...
    $dn_items = queryGet("SELECT *,dnItem.tds as dtds FROM `debit_note_item` as dnItem LEFT JOIN `erp_inventory_items` as items ON items.itemId = dnItem.item_id WHERE dnItem.`debit_note_id` = $dnId", true);
    //console($dn_items);
        ...
        <section class="content">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Repost Debit Note</a></li>
                ...
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" id="drnote" name="drnote" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="repost_serialized" value="<?= base64_encode($select_dn['data']['debit_note_no_serialized']); ?>">
                    <input type="hidden" name="reverse_dn_id" value="<?= $select_dn['data']['dr_note_id'] ?>">
                    <input type="hidden" name="last_iv_varient" value="<?= $select_dn['data']['variant_id'] ?>">

                    <?php
                    $dr_id = $select_dn['data']['dr_note_id'];
                    $variant_id = $select_dn['data']['variant_id'];
                    $debit_note_no = $select_dn['data']['debit_note_no'];
                    $dates = date_select($variant_id, $dr_id);
                                                            ...
                                                            <fieldset>
                                                                <div class="selection-radio">
                                                                    <div class="customer-select">
                                                                        <input type="radio" class="customerClass" id="select_customer_vendor" name="select_customer_vendor" value="Customer" <?php if ($select_dn['data']['debitor_type'] == 'customer') {
                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                } ?>>
                                                                        <label for="customer" class="mb-0">Customer</label>
                                                                    </div>
                                                                    <div class="vendor-select">
                                                                        <input type="radio" class="vendorClass" id="select_customer_vendor" name="select_customer_vendor" value="Vendor" <?php if ($select_dn['data']['debitor_type'] == 'vendor') {
                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                            } ?>>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        <div class="form-input">
                                                            ...
                                                            <select name="vendor_customer" id="vendor_customer" class="form-control select2">
                                                                ...
                                                                <option value="<?= $select_dn['data']['party_id'] ?>|<?= $select_dn['data']['debitor_type'] ?>"><?= $select_dn['data']['debitor_type'] ?> || <?= $select_dn['data']['party_name'] ?></option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 px-4">
                                                <div class="row credit-note-basic">
                                                    ...
                                                    <div class="col-lg-8 col-md-12 col-sm-12">
                                                        ...
                                                        <div class="form-input">
                                                            <label for="">Debit Note Number <span class="text-danger">*</span></label>
                                                            <input type="text" name="iv_varient" class="form-control" id='iv_varient' value="<?= $select_dn['data']['debit_note_no'] ?>" readonly>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        <div class="form-input">
                                                            <label for="">Party Debit Date <span class="text-danger">*</span>
                                                            ...
                                                            if ($dateStatus == 0) {
                                                            ?>
                                                                <input type="date" name="posting_date" class="form-control" id='partyDebitDate' value="" readonly>
                                                            <?php
                                                            } else {
                                                            ?>
                                                                <input type="date" name="posting_date" class="form-control" id='partyDebitDate' max="<?= $end_date ?>" min="<?= $start_date ?>" value="<?= $start_date ?>">
                                                            <?php
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        <div class="form-input">
                                                            ...
                                                            <select name="reasons" id="reasons" class="form-control">
                                                                ...
                                                                <option value="Sales Return" <?php if ($select_dn['data']['reason'] == "Sales Return") {
                                                                                                    echo 'selected';
                                                                                                } ?>>Sales Return</option>
                                                                <option value="Post Sale Discount" <?php if ($select_dn['data']['reason'] == "Post Sale Discount") {
                                                                                                        echo 'selected';
                                                                                                    } ?>>Post Sale Discount</option>
                                                                <option value="Deficiency in Service" <?php if ($select_dn['data']['reason'] == "Deficiency in Service") {
                                                                                                            echo 'selected';
                                                                                                        } ?>>Deficiency in Service</option>
                                                                <option value="Correction in invoice" <?php if ($select_dn['data']['reason'] == "Correction in invoice") {
                                                                                                            echo 'selected';
                                                                                                        } ?>>Correction in invoice</option>
                                                                <option value="Change in POS" <?php if ($select_dn['data']['reason'] == "Change in POS") {
                                                                                                    echo 'selected';
                                                                                                } ?>>Change in POS</option>
                                                                <option value="Finalization in provisional assesment" <?php if ($select_dn['data']['reason'] == "Finalization in provisional assesment") {
                                                                                                                            echo 'selected';
                                                                                                                        } ?>>Finalization in provisional assesment</option>
                                                                <option value="Purchase Return" <?php if ($select_dn['data']['reason'] == "Purchase Return") {
                                                                                                    echo 'selected';
                                                                                                } ?>>Purchase Return</option>
                                                                <option value="Others" <?php if ($select_dn['data']['reason'] == "Others") {
                                                                                            echo 'selected';
                                                                                        } ?>>Others</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-input">
                                                            ...
                                                            <textarea name="note" id="" cols="55" rows="2" placeholder="notes...." class="form-control"><?= $select_dn['data']['remark'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-nowrap mb-0 debit-note-table credit-notes-table" id="inv_items">
                                                ...
                                                <tbody class="add-row inv_items">
                                                    ...
                                                    <?php
                                                    foreach ($dn_items['data'] as $items) {
                                                        $rand = rand(100, 1000);
                                                    ...
                                                    ?>
                                                        <tr class="items_row" id="<?= $rand ?>">
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                <div class="d-flex gap-3 position-relative py-3">
                                                                    ...
                                                                    <span class="custom_batch_<?= $rand ?> <?php if ($goodsType == 5 || $goodsType == 7) {
                                                                        ...
                                                                        $partyDebitDate = $select_dn['data']['postingDate'];
                                                                        $randCode = $rand;
                                                            ...
                                                            <td class="text-right"><input type="number" name="item[<?= $rand ?>][rate]" class="form-control price" id="price_<?= $rand ?>" value="<?= $items['item_rate'] ?>"></td>
                                                            ...
                                                            <td class="text-right  customertds"><input type="number" name="item[<?= $rand ?>][total_tds_per]" class="form-control itemTds inputAmountClass" id="total_tds_per_<?= $rand ?>" value="<?= inputValue($items['dtds']) ?>">
                                                            </td>
                                                ...
                                                <tr id="disrow">
                                                    ...
                                                    <td colspan="2" class="text-right"><span style="" id="total_discount_c"><?= inputValue(0) ?></span>
                                                        <!-- <input type="number" step="any" id="total_discount1" style="float: right;" class="form-control text-right" name="total_discount" value=""> -->
                                                        <input type="hidden" step="any" id="total_discount" style="float: right;" class="form-control text-right inputAmountClass" name="total_discount" value="">
                                                ...
                                                <tr id="tdsrow" style="display: none;">
                                                    ...
                                                    <td colspan="2" class="text-right" id="total_tds_c">
                                                        <input type="number" step="any" style="float: right;" id="total_tds" class="form-control text-right inputAmountClass" name="total_tds" value="0.0">
                                                ...
                                                <tr id="subtotalTr">
                                                    ...
                                                    <td colspan="2" class="text-right" id="total_tcs_c">
                                                        <input t type="number" step="any" id="total_tcs" style="float: right;" class="form-control text-right inputAmountClass" name="total_tcs" value="0.0">
                                                ...
                                                <tr id="subtotalTr">
                                                    ...
                                                    <td colspan="2" class="text-right" id="total_round_off_c">
                                                        <div class="adjust-currency d-flex gap-2 " style="float: right;">
                                                            ...
                                                            <input type="number" name="round_value" step="any" id="round_value" value="" class="form-control text-right inputAmountClass">
                                                        </div>
...
<?php
    ...
    $url = BRANCH_URL . 'location/manage-debit-notes.php';
?>
    <script>
...
<td class="text-right customertds" id="customertds">     
                                                     <input type="number" name="item[${rand}][total_tds_per]" class="form-control itemTds inputAmountClass" id="total_tds_per_${rand}" value="">
...
<script>
    ...
    function select_vendor_customer() {
    ...
    $(document).on("change", "#bill", function() {
        ...
        var partyDebitDate = $('#partyDebitDate').val();
        // alert(id);
        ...
        $.ajax({
            ...
            url: `ajaxs/debit-note/ajax-bill-details-rule-book.php`,
            data: {

                bill_id: bill_id,
                attr: attr,
                act: "bill",
                partyDebitDate: partyDebitDate,
            },
            beforeSend: function() {
    ...
    function getItemStockAsPerDate() {
        var invoicedate = $('#partyDebitDate').val();
        var rowData = {};
    ...
    function calculateAllItemTax() {
        ...
        if (country_id == '103') {
            if (source == dest) {
                // alert(1);
                tax_each = totalTax / 2;
                $('#CGST').html(inputValue(tax_each));
                $('#SGST').html(inputValue(tax_each));
                // $('#igst_span').html(0);
                // $('#sgst').val(tax_each);
                // $('#cgst').val(tax_each);
                // $('#igst').val(0);
                $('#hidden_CGST').html(totalTax);
                $('#hidden_SGST').html(totalTax);
                ...
                // $('#sgst').val(0);
                // $('#cgst').val(0);
                $('#IGST').html(inputValue(totalTax));
                $('#hidden_IGST').html(totalTax);
            }
        } else {
            $('#GST').html(totalTax);
            $('#hidden_GST').val(totalTax);
        }
...
<script>
    ...
    // let vendorCustSelect = $('#vendor_customer').find(':selected').val();
    // alert(vendorCustSelect);
    ...
    // partyCredit date *****************************************
    $("#partyDebitDate").on("change", function(e) {
        // dynamic value
    ...
    function taxGenerate(bilingId, shippingId) {
        ...
        $.ajax({
            type: 'GET',
            url: `ajaxs/debit-note/ajax-genarate-dn-tax.php`,
            data: {
                act: 'getTaxComponent',

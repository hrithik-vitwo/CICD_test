                ...
                <div class="row p-0 m-0">
                    <div class="col-12 mt-2 p-0">
                        ...
                        <div class="filter-list">
                            <a href="stock-count.php" class="btn  waves-effect waves-light"><i class="fa fa-stream mr-2"></i>Batch Wise Stock Log</a>
                            <a href="stock-count.php?item" class="btn active waves-effect waves-light"><i class="fa fa-stream mr-2 active"></i>Item Wise Stock Log</a>
                        </div>
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        ...
                                        log.itemId DESC;", true);
                                            ...
                                            <div class="stock-action-bts mt-2 mb-2">
                                                <button class="btn btn-primary" onclick="ExportToExcel('xlsx','export_item', 'export_item')"><i class="fa fa-download mr-2"></i>Export</button>
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#addnewFile"><i class="fa fa-plus mr-2"></i>Add New</button>
                                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row p-0 m-0">
                    <div class="col-12 mt-2 p-0">
                        ...
                        <div class="filter-list">
                            <a href="stock-count.php" class="btn active waves-effect waves-light"><i class="fa fa-stream mr-2 active"></i>Batch Wise Stock Log</a>
                            <a href="stock-count.php?item" class="btn  waves-effect waves-light"><i class="fa fa-stream mr-2 "></i>Item Wise Stock Log</a>
                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr style="cursor:pointer">
                                                            ...
                                                            <?php }
                                                            if (in_array(5, $settingsCheckbox)) { ?>
                                                                <td><?= decimalQuantityPreview($data['itemQty']) ?>
                                                                </td>
                                                            ...
                                                            <?php }
                                                            if (in_array(7, $settingsCheckbox)) { ?>
                                                                <td><?= decimalValuePreview($data['avg_price']) ?>

...
if (!isset($_COOKIE["cookiesEsi"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiesEsi", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        var checkboxSettings = Cookies.get('cookiesEsi');
        ...
        $(document).on("click", ".ion-paginationlistnew", function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiesEsi')
                },
                beforeSend: function() {

                  ...
                  <div class="form-input function-mapp-main">
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        ?>
                          <label for="" class="font-bold text-sm mb-4">Document Date : <?= formatDateWeb($opening_date) ?> &nbsp; [ This is the company opening date. You can not post before or beyond this date. ]</label>
                        <?php
                        } else {
                        ?>

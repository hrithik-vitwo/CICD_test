...
if (isset($_GET['dnId'])) {
    ...
    $dn_items = queryGet("SELECT * FROM `debit_note_item` as dnItem LEFT JOIN `erp_inventory_items` as items ON items.itemId = dnItem.item_id WHERE dnItem.`debit_note_id` = $dnId", true);
    //console($dn_items);
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 px-0">
                                                                <div class="round-off-section p-0">
                                                                    ...
                                                                    <div id="round_off_hide" display="display:none;">
                                                                        <div class="row round-off calculte-input px-0">
                                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                <div class="adjust-currency d-flex gap-2">
                                                                                    ...
                                                                                    <input type="number" step="any" id="round_value" name="round_value" value="" class="form-control text-center">
                                                                                </div>
                                                                            </div>
                                                                        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (itemData.status === "success") {
                    ...
                    $(`#checkQtyVal_${key}`).val(itemData['data']['sumofbatch']);

                                            ...
                                            <table class="table table-hover table-nowrap mb-0 debit-note-table credit-notes-table" id="inv_items">
                                                ...
                                                <tbody class="add-row inv_items">
                                                    ...
                                                    <tr class="items_row" id="<?= $rand ?>">
                                                        ...
                                                        <td class="text-right"><input type="number" name="item[<?= $rand ?>][rate]" class="form-control price" id="price_<?= $rand ?>" value="<?= inputValue($data['unitPrice']) ?>"></td>
                                                        <td>
                                                            <div class="tax-amount">
                                                                <div class="d-flex gap-2">
                                                                    <input type="number" class="form-control tax" name="item[<?= $rand ?>][tax]" id="tax_<?= $rand ?>" value="<?= inputValue($data['tax']) ?>">
...
<script>
    ...
    function calculateDrAmount() {
        ...
        // sum = sum.toFixed(2);
        $('.debit-total').html(inputValue(sum));
    }
    ...
    function calculateCrAmount() {
        ...
        // sum = sum.toFixed(2);
        $('.credit-total').html(inputValue(sum));
    }
    ...
    function calculateAllItemTax() {
        ...
        if (source == dest) {
            // alert(1);
            tax_each = totalTax / 2;
            $('#sgst_span').html(inputValue(tax_each));
            $('#cgst_span').html(inputValue(tax_each));
            $('#igst_span').html(inputValue(0));

            $('#sgst').val(inputValue(tax_each));
            $('#cgst').val(inputValue(tax_each));
            $('#igst').val(inputValue(0));


        } else {
            // alert(0);
            $('#sgst_span').html(inputValue(0));
            $('#cgst_span').html(inputValue(0));
            $('#igst_span').html(inputValue(totalTax));

            $('#sgst').val(inputValue(0));
            $('#cgst').val(inputValue(0));
            $('#igst').val(inputValue(totalTax));
    ...
    function calculateAllItemsGrandAmount() {
        ...
        $("#grandTotal").html(inputValue(grandTotal));
        ...
        $("#subTotal").html(inputValue(grandTotalBeforeDiscount));

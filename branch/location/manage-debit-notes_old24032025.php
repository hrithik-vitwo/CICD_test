                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <a href="debit-notes-creation.php?create" class="btn btn-create" type="button">
...
<script>
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-debit-notes.php",
                dataType: 'json',
                data: {
                    act: 'debitnotes',
                    comid: comid,
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                ` <div class="dropout">
                                    ...
                                    <ul>
                                    <li>
                                    <button data-toggle="modal"class="soModal"  data-id="${value.dr_note_id}" data-target="#viewGlobalModal"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                 </li>
                                ${reverseRepostButton}
                                    </ul>
                                </div>`
...
<script>
    ...
    $(document).on("click", ".soModal", function() {
        ...
        $.ajax({
            type: "GET",
            url: "ajaxs/modals/fa/ajax-debit-note-modal.php",
            dataType: 'json',
            data: {
                act: 'modaldata',
            ...
            success: function(value) {
                ...
                let igst = helperAmount(responseObj.crNoteobj.igst);
                let cgst = helperAmount(responseObj.crNoteobj.cgst);
                let sgst = helperAmount(responseObj.crNoteobj.sgst);
                ...
                $("#sub_total").html("INR" + " " + decimalAmount(subTotal));;
                $("#total_amount").html("INR" + " " + decimalAmount(totalAmount));
        ...
        // classic view ajax
        $("#classicViewPrint").attr('href', `classic-view/invoice-preview-print.php?dr_note_id=${btoa(dr_note_id)}`);
        $.ajax({
            type: "GET",
            url: "ajaxs/modals/fa/ajax-debit-note-modal.php",
            data: {
...
<script>
    ...
    $(document).on("click", ".repostDebitNote", function() {
        ...
        let url = `debit-notes-repost.php?dnId=${btoa(dnId)}`;

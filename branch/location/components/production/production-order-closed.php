                        ...
                        <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                            <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                ...
                                <div class="filter-list">
                                    ...
                                    <a href="manage-production-order.php?closed" class="btn active"><i class="fa fa-lock-open mr-2 active"></i>Closed</a>
                                </div>
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="details-input">
                                                                                        ...
                                                                                        <div class="text-left">
                                                                                            ...
                                                                                            <i class="text-muted">MRP Status:</i> <?= $listRow["mrp_status"] ?> <?= strtolower($listRow["mrp_status"]) == "created" ? ' <a href="" style="cursor:pointer" class="btn btn-sm"><ion-icon name="eye-outline"></ion-icon></a>' : "" ?>
                                                                                            <?php
                                                                                            if ($listRow["mrp_status"] == "Not Created") {
                                                                                                // console($goodsBomController->isBomCreated($listRow["itemId"]));
                                                                                                if (!$goodsBomController->isBomCreated($listRow["itemId"])) {

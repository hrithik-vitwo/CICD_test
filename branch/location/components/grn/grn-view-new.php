                            ...
                            <div class="doc-details">
                                ...
                                ?>
                                    <div class="form-input">
                                        ...
                                        &nbsp;
                                        <?php
                                        // if ($min < $originalvendorDocumentDate) {
                                ...
                                <?php } else { ?>
                                    <div class="form-input">
                                        ...
                                        <p><input type="date" id="invoicePostingDateId" name="invoicePostingDate" class="form-control" value="<?= $grnInvoice['data']["postingDate"] ?>" required></p>
                                        <p class="text-danger text-xs" id="postdatelabel"></p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="line-border-area">
                            ...
                            if (isset($grnDetails["vendorDocumentFile"]) && $grnDetails["vendorDocumentFile"] != "" && $grnDetails["vendorDocumentFile"] != NULL) {
                                ...
                                // $url = getFileUrlS3('upload/1/grn-invoice/' . $grnDetails["vendorDocumentFile"]);
                            ?>
                                    ...
                                    <tbody id="itemsTable">
                                        ...
                                        ?>
                                            ...
                                            <tr id="grnItemRowTr_<?= $sl ?>">
                                                ...
                                                <td class="text-right"><?= inputValue($oneItemDetails["unitPrice"], 2) ?></td>

                                                <td class="text-right" id="grnItemBaseUnit_<?= $sl ?>"><?= inputValue(($oneItemDetails["unitPrice"] * $oneItemDetails["receivedQty"]), 2) ?></td>
                                                ...
                                                <?php if ($companyCountry == 103) { ?>
                                                    ...
                                                    foreach ($taxComponents1 as $t) { ?>
                                                        <td class="text-right">
                                                            <div class="form-input">
                                                                <input type="number" step="any" name="grnItemList[<?= $sl ?>][item<?= (($t['gstType'])) ?>]" value="<?= ($t["taxAmount"]) ?>" id="grnItemUnit<?= ucfirst(strtolower($t['gstType'])) ?>Input_<?= $sl ?>" class="form-control text-xs w-auto dynamic item<?= ucfirst(strtolower($t['gstType'])) ?>">
                                                            </div>
                                                        </td>
                                                <?php
                                                    }
                                                ...
                                                <span style="display: none" class="text-right" id="grnItemUnitTDTotal_<?= $sl ?>"><?= inputValue($total_amount, 2) ?></span>
                                ...
                                <table class="total-calculate-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            <td class="text-right" style="background: none;"><?= inputValue($grnDetails["grnSubTotal"], 2) ?></td>
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            ?>
                                                <td class="text-right" style="background: none;">
                                                    <input type="number" step="any" name="totalInvoiceTCS" value="0" id="totalInvoiceTCS" class="form-control text-xs itemTCS">
                                                </td>
                                            <?php } else { ?>
                                                <td class="text-right" style="background: none;">
                                                    <input type="number" step="any" name="totalInvoiceTCS" readonly value="<?= inputValue(($grnInvoice['data']["grnTotalTcs"])) ?? 0 ?>" id="totalInvoiceTCS" class="form-control text-xs itemTCS">
                                                </td>
                                            <?php } ?>
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            if ($getGrnDetailsObj["data"]["iv_status"] == 0 && $getGrnDetailsObj["data"]["grnStatus"] == "active") {
                                            ?>
                                                <td class="text-right font-bold" id="tdGrandTotal" style="background: none; border: 0;s"><?= inputValue($grnDetails["grnTotalAmount"], 2) ?? 0 ?></td>
                                            <?php } else {
                                                if ($grnInvoice['data']["roundoff"] > 0) {
                                                    $r = $grnInvoice['data']["roundoff"] * -1;
                                                } else {
                                                    $r = $grnInvoice['data']["roundoff"] * -1;
                                                } ?>
                                                <td class="text-right font-bold" id="tdGrandTotal" style="background: none; border: 0;s"><?= inputValue($grnInvoice['data']["grnTotalAmount"] + $r) ?? 0 ?></td>
                                        ...
                                        ?>
                                            <tr class="itemTotals">
                                                ...
                                                <td class="text-right font-bold" id="" style="background: none; border: 0;">
                                                    <span id="final_roundoff_span"><?= inputValue($roundvalue) ?></span>
                                                    <input type="hidden" name="final_roundoff" id="final_roundoff" value="<?= inputValue($roundvalue) ?>">
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            if ($getGrnDetailsObj["data"]["iv_status"] == 0 && $getGrnDetailsObj["data"]["grnStatus"] == "active") {
                                            ?>
                                                <td class="text-right text-success font-bold" id="tdAdjustedTotal" style="background: none; border: 0;"><?= inputValue($grnDetails["grnTotalAmount"], 2) ?? 0 ?>
                                                <?php } else { ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("keyup", "#totalInvoiceSGST", function() {
                // let grandSubTotalAmt = 0;
                // $(".ItemInvoiceTotalPrice").each(function() {
                //     grandSubTotalAmt += (helperAmount($(this).val()) > 0) ? parseFloat($(this).val()) : 0;
                // });
                ...
                // let ToTaltcs = (parseFloat($(`#totalInvoiceTCS`).val()) > 0) ? parseFloat($(`#totalInvoiceTCS`).val()) : 0;

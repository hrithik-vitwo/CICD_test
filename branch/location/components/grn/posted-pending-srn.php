                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row grn-vendor-details">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="display-flex" id="rcm">
                                                <p class="label-bold"><input type="checkbox" name="rcm" value="1"></p>

                                                <p>Would you like to enable Reverse Charge Mechanism ?</p>
                            ...
                            <tbody id="itemsTable">
                                ...
                                ?>
                                    ...
                                    <tr id="grnItemRowTr_<?= $sl ?>">
                                        ...
                                        <td style="white-space: pre-wrap; width:60%;"><?= ucfirst($oneItemDetails["goodName"]) ?></td>
                                        ...
                                        <td><?= $oneItemDetails["goodQty"]." ". $oneItemDetails["itemUOM"] ?></td>
                                        ...
                                        <td class="text-right">
                                            <div class="form-input d-flex gap-2">
                                                <input type="number" step="any" name="grnItemList[<?= $sl ?>][itemTDS]" value="<?= number_format($oneItemDetails["tds"],2, '.', '') ?>" id="grnItemUnitTdsInput_<?= $sl ?>" class="form-control text-xs w-auto itemTds">
                                                <p class="text-xs">%</p>
                                            </div>
                                        </td>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            <td class="text-right" style="background: none;">
                                                <input type="number" step="any" name="totalInvoiceSGST" value="<?= number_format($grnDetails["grnTotalSgst"], 2, '.', '') ?>" id="totalInvoiceSGST" class="form-control text-xs itemUnitPrice">
                                            </td>
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            <td class="text-right" style="background: none;">
                                                <input type="number" step="any" name="totalInvoiceIGST" value="<?= number_format($grnDetails["grnTotalIgst"], 2, '.', '') ?>" id="totalInvoiceIGST" class="form-control text-xs itemUnitPrice">
                                            </td>
                                        ...
                                        <tr class="itemTotals">
                                            ...
                                            <td class="text-right font-bold" id="tdGrandTotal" style="background: none; border: 0;"><?= number_format($grnDetails["grnTotalAmount"],2) ?? 0 ?></td>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("keyup", "#totalInvoiceTDS", function() {
            let grandSubTotalAmt = 0;
            $(".ItemInvoiceTotalPrice").each(function() {
                grandSubTotalAmt += (parseFloat($(this).val()) > 0) ? parseFloat($(this).val()) : 0;
            });
        ...
        var rcm_eanble = <?= json_encode($flag) ?>;

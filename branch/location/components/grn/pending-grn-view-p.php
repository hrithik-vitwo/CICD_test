                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $removeItemHsn ?></td>
                                                        <td><input type="number" name="" class="form-control" step="any" id="removedItemQuantity_<?= $removedItemSl ?>" value="<?= $removeItemQuantity ?>"></td>
                                                        <td><input type="number" name="" class="form-control" step="any" id="removedItemUnitPrice_<?= $removedItemSl ?>" value="<?= $removeItemUnitPrice ?>"></td>
...
<script>
    ...
    $("#itemsDropDown").on("change", function() {
        ...
        let slNo = $('.grnslNo').last().html();
        let viewId = <?= json_encode($id) ?>;
        // alert("slNo" + slNo)
        
        $.ajax({
            type: "GET",
            url: `ajaxs/grn/ajax-grn-manual-item.php`,
            beforeSend: function() {
                // $("#itemsDropDown").html(`<option value="">Loading...</option>`);
            },
            data: {

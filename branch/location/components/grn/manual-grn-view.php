<?php
// console("11111111111111111111111111111111111111111111111111111111111111111111111");
                    ...
                    <div class="row grn-vendor-details">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="display-flex"><i class="fa fa-check"></i>&nbsp;<p class="label-bold">Document No :&nbsp;</p>
                                <p> &nbsp;
                                    <input type="text" name="documentNo" value="" class="form-control">
                                </p>
                            </div>
                            <div class="display-flex"><i class="fa fa-check"></i>&nbsp;<p class="label-bold">Document Date :&nbsp;</p>
                                <p><input type="date" name="documentDate" value="" class="form-control" required></p>
                            </div>
                ...
                <div class="card-body">
                    <div class="tab-content tab-col" id="custom-tabs-three-tabContent">
                        <div class="tab-pane fade show active iframe-preview-btn" id="uploaded-invoice-preview-div" role="tabpanel" aria-labelledby="invoice-po-div-tab">
                            <iframe src='<?= BASE_URL ?>uploads/1/grn-invoice/<?= $invoiceFile ?>#view=fitH' id="grnInvoicePreviewIfram" width="100%" height="220"></iframe>
            ...
            <tbody id="itemsTable">
                ...
                ?>
                    ...
                    <tr id="grnItemRowTr_<?= $sl ?>">
                        ...
                        <td>
                            <div class="form-input">
                                <input type="number" name="grnItemList[<?= $sl ?>][itemUnitPrice]" value="<?= $itemUnitPrice ?>" id="grnItemUnitPriceTdInput_<?= $sl ?>" class="form-control text-xs itemUnitPrice" required>
                            </div>
                        </td>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="itemTotals">
                            ...
                            <td class="text-right" id="grandSubTotalTd" style="background: none;"><?= number_format($totalSubtotal, 2) ?></td>
                        </tr>
                        ...
                        ?>
                            <tr class="itemTotals">
                                ...
                                <td class="text-right" style="background: none;"><?= number_format($totalCGST, 2) ?></td>
                            </tr>
                            <tr class="itemTotals">
                                <td colspan="9" style="background: none;">Total SGST</td>
                                <td class="text-right" style="background: none;"><?= number_format($totalSGST, 2) ?></td>
                            </tr>
                        <?php
                        } else {
                        ?>
                            <tr class="itemTotals">
                                ...
                                <td class="text-right" style="background: none;"><?= number_format($totalIGST, 2) ?></td>
                            </tr>
                        <?php
                        }
                        ...
                        <tr class="itemTotals">
                            ...
                            <td class="text-right" id="grandTotalTd" style="background: none;"><?= number_format($toalTotal, 2) ?></td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                  <label for="html">Map Item</label><br>
                  <input type="radio" id="allocate_radio" name="distribute" value="allocate">
                  <label for="css">Allocate Cost</label><br>

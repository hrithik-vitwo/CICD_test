                            ...
                            <div class="currency-conversion-section mt-3">
                                ...
                                <div class="dynamic-currency">
                                    ...
                                    <select id="selectCurrency" name="currency" class="form-control text-right">
                                        ...
                                        foreach ($curr['data'] as $data) {
                                        ?>
                                            <option value="<?= $data['currency_id'] ?>" data-currname = "<?= $data['currency_name'] ?>" <?php if($comp_currency == $data['currency_name']) { echo "selected"; } ?> ><?= $data['currency_name'] ?></option>
                                        <?php
                                        }
                                        ?>
                            ...
                            <div class="tab-pane fade quick-registration-vendor" id="vendor_list" role="tabpanel" aria-labelledby="invoice-po-list-tab">
                                <div class="container">
                                    <ul>
                                        ...
                                        <table class="table-sales-order srnPoEnableTable table defaultDataTable grn-table">
                                            <thead>
                                                <tr>
                                                    <th>Sl No.</th>
                                                    <th>Vendor Code</th>
            ...
            <tbody id="itemsTable">
                ...
                ?>
                    ...
                    <tr id="grnItemRowTr_<?= $sl ?>">
                        ...
                        <span class="text-right" style="display: none" id="grnItemInvoiceTotalPriceTdSpan_<?= $sl ?>"><?= number_format($itemTotalPrice, 2) ?> </span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="mapInvoiceItemCodeForm">
                    ...
                    <small class="text-muted mt-2">Service Description</small>
                    ...
                    <small class="text-muted mt-3">Select Service Code</small>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="changeInvoiceItemCodeForm">
                    ...
                    <small class="text-muted mt-3">Select Service Code</small>
                    <select class="form-control select2" name="modalItemCodeChange" id="modalItemCodeDropDownChange" required>
                        <?php
                        $goodsController = new GoodsController();
                        $rmGoodsObj = $goodsController->getAllGRNServices();
                        if ($rmGoodsObj["status"] == "success") {

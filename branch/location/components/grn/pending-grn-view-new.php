...
<style>
        ...
        .form-input {
            ...
            flex-grow: 1; /* Allow the dropdown to expand */
        }

        .select2-container {
            width: 100% !important; /* Ensure Select2 spans full width */
        }
    </style>
            ...
            <tbody id="itemsTable">
                ...
                ?>
                    ...
                    <tr id="grnItemRowTr_<?= $sl ?>">
                        ...
                        ?>
                        <input type="checkbox" id="check_box_<?= $sl ?>" name="check_box" class="checkbx" value="<?= $sl ?>"></td>
                        <?php } else{ ?>

                                        ...
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="vendor-blocks">
                                                ...
                                                <div class="doc-detail due-date grn-form-input-text">
                                                    ...
                                                    if ($dueDate == "" && $vendorCreditPeriod != "" && $selected_date != "") {
                                                        $tempDueDate = date_create($selected_date);
                                                        date_add($tempDueDate, date_interval_create_from_date_string($vendorCreditPeriod . " days"));
                                                        $dueDate = date_format($tempDueDate, "Y-m-d");
                                                    }
                                                    ?>
                                                    <label for=""> <ion-icon name="time-outline"></ion-icon>Due Date </label>
                                                    <input type="date" id="iv_due_date" name="invoiceDueDate[<?= $vendorId ?>]" value="<?= date("Y-m-d", strtotime($delivery_date)); ?>" class="form-control" min="<?= $selected_date ?>" required>
            ...
            <tbody id="itemsTable">
                ...
                ?>
                    ...
                    ?>
                        ...
                        <input type="hidden" id="grnItemQty_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemQty]" value="<?= inputQuantity($itemQty) ?>" />
                        <input type="hidden" class="ItemInvoiceTotalPriceStatic" id="ItemInvoiceTotalPriceStatic_<?= $sl ?>" value="<?= inputValue($itemUnitPrice * $itemQty) ?>" />
                        <input type="hidden" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemTax]" value="<?= inputQuantity($itemTax) ?>" />
                        ...
                        <input type="hidden" class="ItemInvoiceGrandTotalPrice" id="ItemInvoiceGrandTotalPrice_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemGrandTotalPrice]" value="<?= inputValue($itemTotalPrice) ?>" />
                        ...
                        <input type="hidden" class="ItemInvoiceTDSValue" id="ItemInvoiceTDSValue_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemInvoiceTDSValue]" value="<?= inputValue($tds_value) ?>" />
                        <input type="hidden" class="ItemInvoiceCGSTClass" id="ItemInvoiceCGST_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemCGST]" value="<?= inputValue($cgst) ?>" />
                        <input type="hidden" class="ItemInvoiceSGSTClass" id="ItemInvoiceSGST_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemSGST]" value="<?= inputValue($sgst) ?>" />
                        <input type="hidden" class="ItemInvoiceIGSTClass" id="ItemInvoiceIGST_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemIGST]" value="<?= inputValue($igst) ?>" />
                        <input type="hidden" id="ItemInvoiceCGSTNew_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemCGSTNew]" value="<?= inputValue($cgst) ?>" />
                        <input type="hidden" id="ItemInvoiceSGSTNew_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemSGSTNew]" value="<?= inputValue($sgst) ?>" />
                        <input type="hidden" id="ItemInvoiceIGSTNew_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemIGSTNew]" value="<?= inputValue($igst) ?>" />
                        ...
                        <input type="hidden" id="itemStockQty_<?= $sl ?>" value="<?= inputQuantity($itemQty) ?>" class="form-control" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemStockQty]">
                        ...
                        ?>
                            ...
                            <td>
                                <div class="form-input d-flex gap-2">
                                    <input step="any" type="number" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemReceivedQty]" value="<?= inputQuantity($itemQty) ?>" id="grnItemReceivedQtyTdInput_<?= $sl ?>" class="form-control text-xs received_quantity inputQuantityClass" required>
                                    ...
                                    <input type="hidden" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][poQty]" id="grnPoQty_<?= $sl ?>" value="<?= inputQuantity($itemQty) ?>">
                                    <p class="text-xs"><?= $internalItemUom ?></p>
                                </div>
                            </td>
                            <!-- <td class="text-right" id="grnItemInvoiceUnitPriceTdSpan_<?= $sl ?>"></td> -->
                            <td>
                                <div class="input-group input-group-sm m-0" style="flex-wrap: nowrap;">
                                    ...
                                    <input type="number" step="any" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemUnitPriceOtherCurrency]" value="<?= inputValue($itemUnitPrice) ?>" id="grnItemUnitPriceTdInput_<?= $sl ?>" class="form-control border py-3 text-right itemUnitPrice" required readonly>
                                    <input type="hidden" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemUnitPricehidden]" value="<?= inputValue($itemUnitPrice) ?>" id="grnItemUnitPriceTdInputhidden_<?= $sl ?>" class="form-control text-xs itemUnitPricehidden">
                                    <input type="hidden" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemUnitPrice]" value="<?= inputValue($itemUnitPrice) ?>" id="grnItemUnitPriceInrhidden_<?= $sl ?>" class="form-control text-xs grnItemUnitPriceInrhidden">
                                </div>
                            ...
                            <td class="text-right" id="grnItemInvoiceBaseAmtTdSpan_<?= $sl ?>"><?= $curr_name . " : " . inputValue($itemUnitPrice * $itemQty) ?>
                            ...
                            <td class="text-right" id="grnItemInvoiceCGSTTdSpan_<?= $sl ?>"><?= $curr_name . " : " . inputValue($cgst) ?>
                                <span class="text-small spanCgstPriceINR" id="spanCgstPriceINR_<?= $sl ?>"></span>
                            </td>
                            <td class="text-right" id="grnItemInvoiceSGSTTdSpan_<?= $sl ?>"><?= $curr_name . " : " . inputValue($sgst) ?>
                                <span class="text-small spanSgstPriceINR" id="spanSgstPriceINR_<?= $sl ?>"></span>
                            </td>
                            <td class="text-right" id="grnItemInvoiceIGSTTdSpan_<?= $sl ?>"><?= $curr_name . " : " . inputValue($igst) ?>
                            ...
                            <td>
                                <div class="form-input d-flex" style="align-items: center; gap: 7px;">
                                    <input type="number" step="any" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemTds]" value="<?= inputQuantity($tds) ?>" id="grnItemTdsTdInput_<?= $sl ?>" class="form-control text-xs itemTds inputAmountClass" required>
                                    <p class="text-xs">%</p>
                                </div>
                            </td>
                            <span style="display: none" class="text-right" id="grnItemInvoiceTotalPriceTdSpan_<?= $sl ?>"><?= inputValue($itemTotalPrice) ?> </span>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body multiBatchModelViewBody_<?= $sl ?>">
                                                <div class="qty-title d-flex justify-content-between mb-1 mb-3 pb-2 border-bottom">
                                                    <h6 class="modal-title text-xs font-bold">Total Quantity: <span class="totalItemAmountModal" id="totalItemAmountModal_<?= $sl ?>"><?= inputQuantity($itemQty) ?></span></h6>
                ...
                <table>
                    <tbody>
                        <tr class="itemTotals">
                            ...
                            <td class="text-right" id="grandSubTotalTd" style="background: none;"><?= $curr_name . " : " . inputValue($totalSubtotal) ?>
                        ...
                        //     if ($grandigst == 0) {
                        //         $toalTotal = $totalSubtotal + $grandcgst + $grandsgst + $grandigst;
                        //     } else {
                        //         $grandcgst = $grandigst / 2;
                        //         $totalSGST = $grandigst / 2;
                        //         $grandigst = 0;
                        //         $toalTotal = $totalSubtotal + $totalCGST + $totalSGST + $grandigst;
                        //     }
                        ...
                        <tr class="itemTotals">
                            ...
                            <td class="text-right" style="background: none;" id="grandCgstTd"><?= $curr_name . " : " . inputValue($totalCGST) ?>
                                <span class="text-small spanCgstGrandINR" id="spanCgstGrandINR"></span>
                            </td>
                        </tr>
                        <tr class="itemTotals">
                            <td colspan="9" style="background: none;">Total SGST</td>
                            <td class="text-right" style="background: none;" id="grandSgstTd"><?= $curr_name . " : " . inputValue($totalSGST) ?>
                        ...
                        <tr class="itemTotals">
                            ...
                            <td class="text-right" style="background: none;" id="grandIgstTd"><?= $curr_name . " : " . inputValue($totalIGST) ?>
                        ...
                        <tr class="itemTotals">
                            ...
                            <td class="text-right" id="grandTds" style="background: none;">-<?= inputValue($totalTdsValue) ?></td>
                        </tr>
                        <tr class="itemTotals">
                            <input type="hidden" id="totalCGST" name="totalInvoiceCGST" value="<?= inputValue($totalCGST) ?>">
                            <input type="hidden" id="totalSGST" name="totalInvoiceSGST" value="<?= inputValue($totalSGST) ?>">
                            <input type="hidden" id="totalIGST" name="totalInvoiceIGST" value="<?= inputValue($totalIGST) ?>">
                            <input type="hidden" id="totalTDS" name="totalInvoiceTDS" value="<?= inputValue($totalTdsValue) ?>">
                            <input type="hidden" id="grandSubTotal" name="totalInvoiceSubTotal" value="<?= inputValue($totalSubtotal) ?>">
                            <input type="hidden" id="grandTotal" name="totalInvoiceTotal" value="<?= inputValue($toalTotal) ?>">
                            <td colspan="9" style="background: none;">Total Amount</td>
                            <td class="text-right" id="grandTotalTd" style="background: none;"><?= $curr_name . " : " . inputValue($toalTotal) ?>
...
<!-- <script>
     document.addEventListener("DOMContentLoaded", function() {
        var selectElement = document.querySelector(".cost-center-select");
        var modal = document.getElementById("costCenterModal");
        var span = document.getElementsByClassName("close")[0];

        selectElement.addEventListener("change", function() {
            if (selectElement.value === "inventorise") {
                console.log("cliked...")
...
<script>
    ...
    //                         <div class="form-input">
    //                             <label>Batch Number</label>
    //                             <input type="text" name="grnItemList[${batchVendorId}][${slNumber}][multipleBatch][${multipleBatchRowNo}][batchNumber]" class="form-control multiBatch multiBatchRowNumber_${slNumber}" data-itemid="${slNumber}" value="GRNXXXXXXXXX" id="multiDeliveryDate_${multipleBatchRowNo}" placeholder="Batch Number" readonly>
    //                         </div>
    //                     </div>
            ...
            <div class="modal-add-row">
                <div class="row manual-grn-plus-modal modal-cog-right${isFirstRow ? ' dotted-border-area mx-1' : ''}">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="form-input">
                            <label>Quantity</label>
                            <input type="number"  step ="any" name="grnItemList[${batchVendorId}][${slNumber}][multipleBatch][${multipleBatchRowNo}][quantity]" class="form-control multiQuantity multiBatchRowQuantity_${slNumber}" data-itemid="${slNumber}" id="multiQuantity_${multipleBatchRowNo}" placeholder="quantity" value="${inputQuantity(qty)}" ${isFirstRow ? 'readonly':''}>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-input">
            ...
            <div class="modal-add-row">
                <div class="row manual-grn-plus-modal modal-cog-right${isFirstRow ? ' dotted-border-area mx-1' : ''}">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="form-input">
                            <label>Quantity</label>
                            <input type="number" step="any" name="grnItemList[${batchVendorId}][${slNumber}][multipleBatch][${multipleBatchRowNumber}][quantity]" class="form-control multiQuantity multiBatchRowQuantity_${slNumber}" data-itemid="${slNumber}" id="multiQuantity_${multipleBatchRowNumber}" placeholder="quantity" value="${inputQuantity(qty)}" ${isFirstRow ? 'readonly':''}>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="form-input">
    ...
    $(document).ready(function() {
        ...
        function multiplePo(poNumber, type, serial_number, listType) {
            ...
            if (type == "add") {
                ...
                $.ajax({
                    url: "ajaxs/grn/ajax-grn-po-items.php?po=" + poNumber + "&serial_number=" + serial_number + "&listtype=" + listType,
                    type: "GET",
                    beforeSend: function() {
                ...
                $.ajax({
                    ...
                    success: function(responseData) {
                        ...
                        $("#uploaded-invoice-preview-div").append(responseData);
                        setTimeout(function() {
        ...
        function multipleGrnList(grnNumber, type, serial_number, listType) {
            ...
            if (type == "add") {
                ...
                $.ajax({
                    url: "ajaxs/grn/ajax-posted-grn-items.php?grn=" + grnNumber + "&serial_number=" + serial_number + "&listtype=" + listType,
                    type: "GET",
                    beforeSend: function() {
                        console.log("Adding new items...");
                        $("#loaderGRN").show();
        ...
        //             $(`#ItemInvoiceTotalPrice_${id}`).val(base_after_freight);
        //             $(`#grnItemInvoiceBaseAmtTdSpan_${id}`).html(`${curr_name}: ${(base_after_freight).toFixed(2)}`);
        //             $(`#grnItemUnitPriceTdInput_${id}`).val(item_rate);

        //             calculateOneItemAmounts(id);

        //             $(`#grnItemReceivedQtyTdInput_${id}`).attr("disabled", "disabled");
        ...
        //         $(`#grnItemReceivedQtyTdInput_${freight_id}`).attr("disabled", "disabled");
        ...
        $(document).on("keyup", ".received_quantity", function() {
            ...
            let receivedQuantityValue = helperQuantity($input.val());
            let defaultValue = helperQuantity($input.attr('value'));
            ...
            $(`#totalItemAmountModal_${rowNo}`).html(inputQuantity(receivedQuantityValue));
        ...
        function calculateOneItemAmounts(rowNo) {
            ...
            let poQty = (helperQuantity($(`#grnPoQty_${rowNo}`).val()) > 0) ? helperQuantity($(`#grnPoQty_${rowNo}`).val()) : 0;
            var taxArray = [];
            ...
            if (isPresent) {
                for (let i = allocatedArrayFromHtml.length - 1; i >= 0; i--) {
                    if (allocatedArrayFromHtml[i].formItemId == mainItemId) {
                        ...
                        $(`#grnItemAllocatedCost_${to_item_line_id}`).html(inputValue(actual_cost));
        ...
        function createDeleteButton() {
            ...
            deleteButton.onclick = function() {
                ...
                $.ajax({
                    url: "ajaxs/grn/ajax-fetch-vendor-from-po.php?po=" + this.parentNode.textContent.trim(),
                    type: "GET",
                    beforeSend: function() {},
                    success: function(response) {
                        let vendorID = JSON.parse(response);
                        console.log(responseObj);
        ...
        $(document).on("click", ".distributeButtonClass", function() {
            ...
            if (!itemStatus && !temporaryItemStatus) {
                let freightprice = (helperAmount($(this).attr('data-value')) > 0) ? helperAmount($(this).attr('data-value')) : 0;
                let total_base = 0;
                $("input:checkbox[class=checkbx_" + buttonId + "]:checked").each(function() {
                    var id = $(this).val().split("_")[1];
                    let basic = (helperAmount($(`#basicAmtAllocate_${buttonId}_${id}`).html()) > 0) ? helperAmount($(`#basicAmtAllocate_${buttonId}_${id}`).html()) : 0;
                    total_base += basic;
                });

                $("input:checkbox[class=checkbx_" + buttonId + "]:checked").each(function() {
                    var id = $(this).val().split("_")[1];
                    let basic_each = (helperAmount($(`#basicAmtAllocate_${buttonId}_${id}`).html()) > 0) ? helperAmount($(`#basicAmtAllocate_${buttonId}_${id}`).html()) : 0;
                    let qty = (helperQuantity($(`#qtyAllocate_${buttonId}_${id}`).html()) > 0) ? helperQuantity($(`#qtyAllocate_${buttonId}_${id}`).html()) : 0;
                    let x = (basic_each * freightprice) / total_base;
                    let base_after_freight = basic_each + x;
                    let item_rate = base_after_freight / qty;

                    let invAmt = (helperAmount($(`#invtAmt_${buttonId}_${id}`).val()) > 0) ? helperAmount($(`#invtAmt_${buttonId}_${id}`).val()) : 0;

                    // console.log(id);

                    $(`#invtAmt_${buttonId}_${id}`).val(inputValue(invAmt + x));
                    // $(`#invtAmt_${id}`).val(item_rate);

                    let prev_alloc_cost = (helperAmount($(`#allocatedCost_${buttonId}_${id}`).html()) > 0) ? helperAmount($(`#allocatedCost_${buttonId}_${id}`).html()) : 0;

                    helperAmount($(`#allocatedCost_${buttonId}_${id}`).html(prev_alloc_cost + x));
        ...
        $(document).on("click", ".inventButtonClass", function() {
            ...
            if (!itemConfirmStatus) {
                ...
                $("input:checkbox[class=checkbx_" + buttonId + "]:checked").each(function() {
                    ...
                    let allocated_cost_modal = (helperAmount($(`#allocatedCost_${buttonId}_${id}`).html()) > 0) ? helperAmount($(`#allocatedCost_${buttonId}_${id}`).html()) : 0;

                    var curr_name = $("#selectCurrency").find(':selected').data("currname");
                    var currency_rate_value = $(`#currency_conversion_rate`).val();

                    $(`#grnItemAllocatedCost_${id}`).html(`${inputValue(allocated_cost_modal)}`);
        ...
        function calculateAndCheckBatchQuantity(rowNo, inputElement = null) {
            ...
            let itemQty = (helperQuantity($(`#totalItemAmountModal_${rowNo}`).html()) > 0) ? helperQuantity($(`#totalItemAmountModal_${rowNo}`).html()) : 0;
            let remainQuantity = itemQty - totalQty;
            if (remainQuantity > 0) {
                $(`#multiQuantity_${rowNo}`).val(inputQuantity(remainQuantity));
            } else {
        ...
        // function checkEmpty(rowNo) {
        //     $(`.multiBatchRowNumber_${rowNo}`).each(function(index) {
        //         if ($(this).val() == null || $(this).val() == '' || $(this).val() == undefined) {
        //             // alert("Hello, World!");
        //             $(`#saveAndClose_${rowNo}`).prop("disabled", true);
        //         } else {
        //             $(`#saveAndClose_${rowNo}`).removeAttr('disabled');
        //         }
        //     });
        // }
        ...
        $(document).on("click", ".dlt-popup", function() {
            ...
            $(`#multiQuantity_${id}`).val(inputQuantity(remainQuantity));

                            ...
                            <div class="line-border-area">
                                ...
                                <div class="doc-details">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <p class="font-bold"> <?= $grnDetails["vendorGstin"] ?? "" ?></p>
                                    </div>
                                    <div class="form-input">
                                ...
                                <div class="form-input mt-3" id="rcm">
                                    <div class="d-flex gap-1">
                                        <input type="checkbox" <?php if ($grnInvoice['rcm_enabled'] == 1) echo "checked ";  ?> name="rcm" value="1" id="rcmBtn">
                                        ...
                                        <tbody id="itemsTable">
                                            ...
                                            ?>
                                                ...
                                                <tr id="grnItemRowTr_<?= $sl ?>">
                                                    ...
                                                    <td><?= inputQuantity($oneItemDetails["receivedQty"]) ?></td>
                                    ...
                                    <table class="total-calculate-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="itemTotals">
                                                ...
                                                <td class="text-right" style="background: none;">
                                                    <input type="number" step="any" name="totalInvoiceIGST" value="<?= inputValue($grnDetails["grnTotalIgst"]) ?>" id="totalInvoiceIGST" class="form-control text-xs itemUnitPrice" readonly>
                                                </td>
                                            ...
                                            <tr class="itemTotals">
                                                ...
                                                ?>
                                                    <td class="text-right" style="background: none;">
                                                        <input type="number" step="any" name="totalInvoiceTCS" value="<?= inputValue(0) ?>" id="totalInvoiceTCS" class="form-control text-xs itemTCS">
                                                    </td>
                                                <?php } else { ?>
                                                    <td class="text-right" style="background: none;">
                                                        <input type="number" step="any" name="totalInvoiceTCS" readonly value="<?= inputValue(($grnInvoice["grnTotalTcs"])) ?? 0 ?>" id="totalInvoiceTCS" class="form-control text-xs itemTCS">
                                                    </td>
                                                <?php } ?>
                                            ...
                                            <tr class="itemTotals">
                                                ...
                                                <?php } else { ?>
                                                    <td class="text-right font-bold" id="tdGrandTotal" style="background: none; border: 0;s"><?= inputValue($grnInvoice["grnTotalAmount"]) ?? 0 ?></td>
                                                ...
                                                <td class="text-right font-bold" id="" style="background: none; border: 0;">
                                                    <div class="adjust-currency d-flex gap-3 justify-content-end">
                                                        ...
                                                        ?>
                                                            ...
                                                            <input type="number" step="any" name="roundOffGL" id="round_value" value="<?= inputValue(0) ?>" class="form-control text-center">

                                                        <?php
                                                        } else {
                                                        ?>
                                                            <input type="number" step="any" name="roundOffGL" id="round_value" disabled readonly value="<?= inputValue(($grnInvoice["roundoff"])) ?? 0 ?>" class="form-control text-center">
                                                        <?php
                                                        }
                                                        ?>
                                                    </div>
...
<?php if ($getGrnDetailsObj["data"]["iv_status"] != 1 && $getGrnDetailsObj["data"]["grnStatus"] == "active") { ?>
    <script>
        $(document).ready(function() {
            ...
            //     let roundValue = parseFloat($("#round_value").val()) || 0; // Default to 0 if empty
            //     let value = $("#tdGrandTotal").text();
            //     var convertedValue = 0;

            //     if (value.includes(",")) {
            //         convertedValue = parseFloat(value.replace(/,/g, "")); // Remove all commas
            //         // Output: 42352.56
            //     } else {
            //         convertedValue = parseFloat(value); // No change if no comma exists
            //     }
            ...
            //     $("#tdAdjustedTotal").html(final_value.toFixed(2)); // Update adjusted total
            // }

            function updateAdjustedTotal() {
                let total_value = parseFloat($("#totalInvoiceTotal").val()) || 0; // Default to 0 if empty
                let roundValue = parseFloat($("#round_value").val()) || 0; // Default to 0 if empty
                let sign = $('#round_sign').val();

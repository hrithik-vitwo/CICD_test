                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                value.sl_no,
                                `<a href="#" class="soModal"  data-id="${value.so_no}" data-toggle="modal" data-target="#viewGlobalModal">${ value.so_no}</a>`,
                                value.customer_po,
                                formatDate(value.delv_date),
                                formatDate(value.so_date),
                                formatDate(value.created_at),
                                value.goodType,
                                value.customer_code,
                                `<p class='item-name pre-normal'>${value.cus_name}</p>`,
                                value.total_amount,
                                ...
                                ` <div class="dropout">
                                    ...
                                    <li>
                                        <button class="soModal" data-toggle="modal" data-id=${value.so_no}><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                    </li>
                                    </ul>
                                </div>`
                            ]).draw(false);

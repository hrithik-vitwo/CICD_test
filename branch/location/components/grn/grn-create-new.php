...
<link rel="stylesheet" href="../../public/assets/dist/filepond-plugin-image-preview.min.css">
<link rel="stylesheet" href="../../public/assets/dist/filepond.min.css">
<script src="../../public/assets/dist/filepond-plugin-file-encode.min.js"></script>
<script src="../../public/assets/dist/filepond-plugin-file-validate-size.min.js"></script>
<script src="../../public/assets/dist/filepond-plugin-image-exif-orientation.min.js"></script>
<script src="../../public/assets/dist/filepond-plugin-image-preview.min.js"></script>
<script src="../../public/assets/dist/filepond.min.js"></script>
<script src="../../public/assets/dist/lottie-player.js"></script>

<!-- <script src="https://riversun.github.io/jsframe/jsframe.js"></script> -->
<link rel="stylesheet" href="../public/assets/ion-icon/ionicons.min.css">
...
<div class="loading-image" id="showme" style="display: none;">
    ...
    <h1>
        <a href="" class="typewrite" data-period="800" data-type='[ "Relax for a while !", "Back to your seat.....", "I will handle it" ]'>
...
<script>
    $(document).ready(function() {
        ...
        // let firstText = "Hit! me to execute"
        // let secondText = "Relax, Back to your seat for few minutes, I will handle it"
        // let uploadFlag = false;

        // $('#upload_grn_input').on('FilePond:addFile', function(e) {
        //     $("#robo_text").removeClass('invisible');
        //     $("#main_robo_text").text(firstText);
        //     uploadFlag = true;
        // });

        // $('#robo_gif').on('click', function(e) {
        //     if (uploadFlag) {
        //         $("#robo_icon").parent().append(secondText);
        //         $("#main_robo_text").text(secondText);
        //         $("#upload_grn_input").children("input").attr('disabled', 'disabled');
        //         $(".filepond--action-remove-item").attr('disabled', 'disabled');
        //         $('#upload_grn_input').filepond('allowReorder', false);
        //     }
        // });
        ...
        $("#upload_form").submit(function(e) {
            ...
            if (pondfilLength < 1) {
                ...
                $.ajax({
                    url: 'ajaxs/grn/ajax-multiple-grn.php',
                    type: "POST",
                    data: fd,
                    contentType: false,
                    cache: false,

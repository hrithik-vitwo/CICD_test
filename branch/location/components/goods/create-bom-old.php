    ...
    <div class="content-header mb-2 p-0  border-bottom">
        ...
        <div class="container-fluid">
            <div class="row m-0 p-0 py-1 justify-content-between">
                ...
                <div class="mr-0">
                    <a class="btn btn-sm btn-success ml-2" id="clickTheFormSaveBtn">Save</a>
                ...
                <div class="card-body p-2">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="itemId" value="<?= isset($_GET["bom"]) ? base64_decode($_GET["bom"]) : ""; ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?= date("d-m-Y"); ?>" name="preparedDate" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <span>Good Title</span>
                            <input type="text" value="Test good" placeholder="Good title" class="form-control" readonly>
                        </div>
                        <div class="col-md-6">
                            <span>Good Code</span>
                            <input type="text" value="4545451" placeholder="Good Code" class="form-control" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="card">
                        ...
                        <div class="card-body p-1">
                            <div class="customTable border rounded">
                                ...
                                <div class="goodItemsDiv">
                                    <div class="row m-0 border-top border-bottom justify-content-between" id="goodItemsDivRow_0">
                                        ...
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="number" name="goodItemRate[]" id="goodItemRate_0" placeholder="Item Rate" class="form-control m-0 goodItemRate">
                                        </div>
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="number" name="goodItemAmount[]" id="goodItemAmount_0" placeholder="Item Amount" class="form-control m-0 goodItemAmount">
                                        </div>
                                ...
                                <div class="goodActivitiesDiv">
                                    <div class="row m-0 border-top border-bottom justify-content-between">
                                        ...
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="number" name="goodActivityConsumption[]" id="goodActivityConsumption_0" placeholder="Activity Consumption" class="form-control m-0 goodActivityConsumption">
                                        </div>
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="text" name="goodActivityLhr[]" id="goodActivityLhr_0" placeholder="Activity LHR" class="form-control m-0" readonly>
                                        </div>
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="text" name="goodActivityMhr[]" id="goodActivityMhr_0" placeholder="Activity MHR" class="form-control m-0" readonly>
                                        </div>
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="text" name="goodActivityLhrMhr[]" id="goodActivityLhrMhr_0" placeholder="LHR+MHR" class="form-control m-0" readonly>
                                        </div>
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="number" name="goodActivityAmount[]" id="goodActivityAmount_0" placeholder="Total Amount" class="form-control m-0" readonly>
                                        </div>
                                        <div class="border-right p-1" style="width: 15%; height: 100%;">
                                ...
                                <div class="goodOthersDiv">
                                    <div class="row m-0 border-top border-bottom justify-content-between">
                                        ...
                                        <div class="border-right p-1" style="width: 10%;">
                                            <input type="number" name="goodOthersAmount[]" placeholder="Other Amount" class="form-control m-0">
                                        </div>
                                        <div class="border-right p-1" style="width: 15%; height: 100%;">
                                ...
                                <!-- <div class="grandTotalDiv col-md-6 ml-auto lr-0 p-0 border-left">
                                    ...
                                    <div class="row m-0 border-top border-bottom justify-content-between">
                                        ...
                                        <div class="border-right p-1 row m-0 align-items-center" style="width: 60%;">
                                            <input type="number" placeholder="e.g 20" class="form-control m-0">
                                        </div>
                                    </div>
                                    <div class="row m-0 border-top border-bottom justify-content-between">
                                        <div class="border-right p-1 row m-0 align-items-center justify-content-end" style="width: 40%;">
                            ...
                            <!-- <input type="submit" value="Save" class="btn btn-primary form-control my-3 col-md-6"> -->
                        </div>
                    </div>
                </div>
            </form>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function calculateActivityCost(rowNo=null){
                let lhrMhr = $(`#goodActivityLhrMhr_${rowNo}`).val();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (goodDataObj["status"] == "success") {
                                ...
                                $(`#goodItemRate_${rowNo}`).val(goodData["itemMovingAvgWeightedPrice"]);
                                $(`#goodItemAmount_${rowNo}`).val(goodData["itemMovingAvgWeightedPrice"]);
                            } else {
                                console.log(goodDataObj);
                            }
                        }
            ...
            $(document).on("click", ".addGoodItemsDivItemBtn", function() {
                ...
                $(".goodItemsDiv").append(`
                    <div class="row m-0 border-top border-bottom justify-content-between" id="goodItemsDivRow_${rowNo}">
                        ...
                        <div class="border-right p-1" style="width: 10%;">
                            <input type="text" name="goodItemConsumtion[]" id="goodItemConsumption_${rowNo}" placeholder="Item Consumtion" class="form-control m-0 goodItemConsumtion">
                        </div>
                        <div class="border-right p-1 d-flex" style="width: 10%;">
            ...
            $(document).on("click", ".addGoodActivitiesDivItemBtn", function() {
                ...
                $(".goodActivitiesDiv").append(`
                    <div class="row m-0 border-top border-bottom justify-content-between">
                        ...
                        <div class="border-right p-1" style="width: 10%;">
                            <input type="text" name="goodActivityLhr[]" id="goodActivityLhr_${rowNo}" placeholder="Activity LHR" class="form-control m-0 goodActivityLhr" readonly>
                        </div>
                        <div class="border-right p-1" style="width: 10%;">
                            <input type="text" name="goodActivityMhr[]" id="goodActivityMhr_${rowNo}" placeholder="Activity MHR" class="form-control m-0 goodActivityMhr" readonly>
                        </div>
                        <div class="border-right p-1" style="width: 10%;">
                        ...
                        <div class="border-right p-1" style="width: 10%;">
                            <input type="number" name="goodActivityAmount[]" id="goodActivityAmount_${rowNo}" placeholder="Total Amount" class="form-control m-0 goodActivityAmount" readonly>
                        </div>
                        <div class="border-right p-1" style="width: 15%; height: 100%;">
                            <textarea name="goodActivityRemark[]" placeholder="Activity Remark" rows="1" class="form-control m-0 p-2"></textarea>
                        </div>
            ...
            $(document).on("click", ".addGoodOthersDivItemBtn", function() {
                ...
                $(".goodOthersDiv").append(`
                    <div class="row m-0 border-top border-bottom justify-content-between">
                        ...
                        <div class="border-right p-1" style="width: 10%;">
                            <input type="number" name="goodOthersAmount[]" id="goodOthersAmount_${rowNo}" placeholder="Other Amount" class="form-control m-0">
                        </div>
                        <div class="border-right p-1" style="width: 15%; height: 100%;">
                            <textarea name="goodOthersRemark[]" placeholder="Other Remark" rows="1" class="form-control m-0 p-2"></textarea>
                        </div>

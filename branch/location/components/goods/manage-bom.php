                    ...
                    <div class="card card-tabs" style="border-radius: 20px;">
                        ...
                        <table class="table defaultDataTable table-hover">
                            ...
                            <tbody>
                                ...
                                $bomListObj = $goodsBomController->getAllBoms();
                                if ($bomListObj["status"] == "success") {
                                    foreach ($bomListObj["data"] as $oneBomRow) {?>
                                        <tr>
                                            <td><?= $oneBomRow["grnCode"] ?></td>
                                            <td><?= $oneBomRow["grnPoNumber"] ?></td>
                                            <td><?= $oneBomRow["vendorCode"] ?></td>
                                            <td><?= $oneBomRow["vendorDocumentNo"] ?></td>
                                            <td><?= $oneBomRow["vendorDocumentDate"] ?></td>
                                            <td><?= $oneBomRow["postingDate"] ?></td>
                                            <td><?= $oneBomRow["grnTotalAmount"] ?></td>

                                ...
                                <div class="p-0 pb-2" style="border-bottom: 1px solid #dbe5ee;">
                                    ...
                                    <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                        <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                            ...
                                            <?php require_once("assets-tabs.php"); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable_detailed_view thead tr').append('<th>Action</th> <th>Put to Use</th>');
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookiesassetsUnderCons');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "../ajaxs/ajax-assets-under-construction.php",
                dataType: 'json',
                data: {
                    act: 'assetsUnder',
                    comid: comid,

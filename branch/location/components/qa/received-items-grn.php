                            ...
                            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                    ...
                                    <div class="filter-list vendor-invoice-tab">
                                        <a href="<?= LOCATION_URL; ?>recieved-item.php?value=all" class="btn waves-effect waves-light active"><i class="fa fa-stream mr-2"></i>All</a>
                                    ...
                                    <div class="row filter-serach-row">
                                        ...
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            ...
                                            LIMIT  " . $GLOBALS['start'] . "," . $GLOBALS['show'] . ";";
                                                ...
                                                //     $sql_list = "SELECT 
                                                //     stocklog.*, stloc.*, grn.*, item.*, SUM(stocklog.itemQty) AS itemQty 

                            ...
                            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                    ...
                                    <div class="filter-list vendor-invoice-tab">
                                        ...
                                        <a href="<?= LOCATION_URL; ?>recieved-item.php?value=fg" class="btn waves-effect waves-light"><i class="fa fa-clock mr-2"></i>FG</a>
                                        ...
                                        <a href="<?= LOCATION_URL; ?>recieved-item.php?value=rejected" class="btn waves-effect waves-light active"><i class="fa fa-clock mr-2"></i>Rejected</a>
                                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <?php
                                                                ...
                                                                <td><?= formatDateWeb($one["bornDate"]) ?></td>
                                                                                ...
                                                                                <div class="modal-header">
                                                                                    <div class="qa-view-header d-flex justidy-content-between">
                                                                                        ...
                                                                                        <div class="qa-item-recieve-block">
                                                                                            <p class="text-sm my-2 font-bold">Total Received : <?= decimalQuantityPreview($one["itemQty"]) . " " . $one["uomName"] ?></p>
                                                                                            <div class="qa-item-recieve-block-sub-item">
                                                                                                <p class="text-sm my-2 font-bold">Checked :</p>
                                                                                                <div class="qa-checked-item">
                                                                                                    <p class="text-xs my-2" id="htmlpassed_<?= $sl ?>">Passed : <?= decimalQuantityPreview($get_last_updated_qty["data"]["passed"]) . " " . $one["uomName"] ?></p>
                                                                                                    <p class="text-xs my-2" id="htmlreject_<?= $sl ?>">Failed : <?= decimalQuantityPreview($get_last_updated_qty["data"]["rejected"]) . " " . $one["uomName"] ?></p>
                                                                                                </div>
                                                                                                <p class="text-xs my-2 font-bold" id="htmlremain_<?= $sl ?>">Checked Required : <?= decimalQuantityPreview($remaining_qty) . " " . $one["uomName"] ?></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                                        ...
                                                                                                        <div class="accordion-item">
                                                                                                            ...
                                                                                                            <div class="item-status d-flex gap-4">
                                                                                                                ...
                                                                                                                <!-- <label class="status-common status-release d-flex gap-2 radio-button-label">
                                                                                                                    ...
                                                                                                                    <span class="text-xs">Retested & Passed</span>
                                                                                                                </label>

                                                                                                                <label class="status-common status-release d-flex gap-2 radio-button-label">
                                                                                                                    <textarea type="text"  rows="4" cols="50" id="input_remarks_<?= $sl ?>" name="remarks" class="form-control"></textarea>
                                                                                                                ...
                                                                                                                <table class="table table-hover">
                                                                                                                    ...
                                                                                                                    <tbody>
                                                                                                                        ...
                                                                                                                        <?php
                                                                                                                        $sql_query_log = queryGet("SELECT * FROM `erp_qa_log` WHERE `companyId` = '$company_id' AND `branchId`='$branch_id' AND `locationId`='$location_id' AND `stock_log_id`='$stock_id' AND `rejected` > '0'", true);
                                                                                                                        $sl_no = 0;
                                                                                                                        ...
                                                                                                                        ?>
                                                                                                                            <tr>
                                                                                                                                <input type="hidden" name="" value="<?= $one_data["passed"] ?>" id="previous_passed_hidden_<?= $one_data["qa_log_Id"] ?>">
                                                                                                                                <input type="hidden" name="" value="<?= $one_data["rejected"] ?>" id="previous_rejected_hidden_<?= $one_data["qa_log_Id"] ?>">
                                                                                                                                <input type="hidden" name="" value="<?= $sl ?>" id="parent_serial_hidden_<?= $one_data["qa_log_Id"] ?>">
                                                                                                                                <td><?= $sl_no ?></td>
                                                                                                                                <td><?= $one_data["doc_no"] ?></td>
                                                                                                                                <td id="previous_passed_td_<?= $one_data["qa_log_Id"] ?>"><?= decimalQuantityPreview($one_data["passed"]) ?></td>
                                                                                                                                <td id="previous_rejected_td_<?= $one_data["qa_log_Id"] ?>"><?= decimalQuantityPreview($one_data["rejected"]) ?></td>
                                                                                                                                <td><?php
                                                                                                                                ...
                                                                                                                                <td><?= formatDateORDateTime($one_data["qaCreatedAt"]) ?></td>

                                                                                                                                <td><input type="number" id="input_passed_<?= $one_data["qa_log_Id"] ?>" name="passed" class="form-control"></td>
                                                                                                                                <td><textarea type="text"  rows="1" cols="50" id="input_remarks_<?= $one_data["qa_log_Id"] ?>" name="remarks" class="form-control"></textarea></td>
                                                                                                                ...
                                                                                                                <div class="accordion-body p-0">
                                                                                                                    <div class="card bg-transparent border border-rounded-3 mb-2">
                                                                                                                        <div class="card-body p-3">
                                                                                                                            ...
                                                                                                                            <div class="display-flex-space-between gap-4">
                                                                                                                                <p>Specifications </p>
                                                                                                                                <p>: </p>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    ?>
                                                                                                        <tr>
                                                                                                            <td><?= $sl_no ?></td>
                                                                                                            <td><?= $one_data["doc_no"] ?></td>
                                                                                                            <td><?= decimalQuantityPreview($one_data["passed"]) ?></td>
                                                                                                            <td><?= decimalQuantityPreview($one_data["rejected"]) ?></td>
                                                                                                            <td><?php
                                                                                                            if($one_data["status"] == "0")
                                                                                                             {
                                                                                                                echo "ToDo";
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (responseObj["status"] == "success") {
                                ...
                                $(`#previous_passed_td_${rowNo}`).html(updated_passed_value);
                                $(`#previous_rejected_td_${rowNo}`).html(updated_rejected_value);
                                ...
                                $(`#htmlpassed_${parent_serial_hidden}`).html("Total Passed Quantity : " + updated_total_passed_value);
                                $(`#htmlreject_${parent_serial_hidden}`).html("Total Failed Quantity : " + updated_total_reject_value);

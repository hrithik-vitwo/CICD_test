<style>
    ...
    .invertory-table thead tr:nth-child(1) th {
    ...
    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i class="fa fa-list po-list-icon"></i>Storage Wise Inventory</a></li>
        ...
        <div class="container-fluid">
            <div class="row p-0 m-0">
                <div class="col-12 mt-2 p-0">
                    <div class="card card-tabs" style="border-radius: 20px; overflow: auto">
                            ...
                            <thead>
                                <tr class="alert-light">
                                    ...
                                    if (in_array(6, $settingsCheckbox)) { ?>
                                        ...
                                        <th rowspan="2">Valuation Class</th>
                                    <?php
                                    }
                                    if (in_array(7, $settingsCheckbox)) { ?>

                                        <th rowspan="2">Price(MW)</th>
                                    <?php
                                    }
                                    ...
                                    if (in_array(9, $settingsCheckbox)) { ?>
                                        ...
                                        <th rowspan="2">Last Received On </th>
                                    <?php
                                    ...
                                    <th colspan="2">RM Warehouse</th>
                                    <th colspan="2">RM Production</th>
                                    <th colspan="2">SFG Stock</th>
                                    <th colspan="2">SFG Warehouse</th>
                                    <th colspan="2">SFG Market</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if (in_array(7, $settingsCheckbox)) { ?>
                                            ...
                                            <td class="text-right"><?= number_format($oneInvItem["movingWeightedPrice"], 2); ?> </td>
                                        <?php
                                        }
                                        if (in_array(8, $settingsCheckbox)) { ?>


                                            <td class="text-right"> <?= $oneInvItem["itemPrice"] ?> </td>
                                        <?php
                                        }
                                        if (in_array(9, $settingsCheckbox)) { ?>

                                            <td> <?= formatDateORDateTime($oneInvItem["updatedAt"], false); ?></td>
                                        <?php
                                        }
                                        ?>
                                        ...
                                        <td><?= $oneInvItem["rmWhOpen"] + $oneInvItem["rmWhReserve"] + $oneInvItem["rmProdOpen"] + $oneInvItem["rmProdReserve"] +  $oneInvItem["sfgStockOpen"] +  $oneInvItem["sfgStockReserve"]  + $oneInvItem["fgWhOpen"] +  $oneInvItem["fgWhReserve"]  + $oneInvItem["fgMktOpen"] +  $oneInvItem["fgMktReserve"]   ?></td>

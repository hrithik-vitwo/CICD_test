    ...
    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i class="fa fa-list po-list-icon"></i>FG Inventory</a></li>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if (in_array(9, $settingsCheckbox)) { ?>
                                            ...
                                            <td> <?= round($oneInvItem["movingWeightedPrice"] * $total_qty, 2); ?></td>
                                        <?php
                                        }
                                        if (in_array(10, $settingsCheckbox)) { ?>

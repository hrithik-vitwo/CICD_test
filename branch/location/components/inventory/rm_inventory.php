    ...
    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i class="fa fa-list po-list-icon"></i>RM Inventory</a></li>
                ...
                <div class="col-12 mt-2 p-0">
                    <div class="card card-tabs" style="border-radius: 20px;">
                        ...
                        <div>
                            ...
                            $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_RM_INVENTORY_ITEMS", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if (in_array(9, $settingsCheckbox)) { ?>
                                            ...
                                            <td> <?= number_format($oneInvItem["movingWeightedPrice"]*$total_qty, 2); ?></td>
                                        <?php
                                        }
                                        if (in_array(10, $settingsCheckbox)) { ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                ...
                <input type="hidden" name="pageTableName" value="ERP_RM_INVENTORY_ITEMS" />

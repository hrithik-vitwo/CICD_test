    ...
    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i class="fa fa-list po-list-icon"></i>SFG Inventory</a></li>
                ...
                <div class="col-12 mt-2 p-0">
                    <div class="card card-tabs" style="border-radius: 20px;">
                        ...
                        <div>
                            ...
                            $countShow = "SELECT count(*) FROM `" . ERP_INVENTORY_ITEMS . "` WHERE 1 " . $cond . "  AND `goodsType` = 2 AND  `company_id`=$company_id AND `branch_id`=$branch_id AND `location_id`=$location_id ";
                            ...
                            $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_SFG_INVENTORY_ITEMS", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                            ...
                            if (isset($_REQUEST['date'])) {
                                ...
                                $condstock .= " AND DATE_FORMAT(bornDate, '%Y %m %d') <= DATE_FORMAT('" . $date . "', '%Y %m %d')";
                            } else {
                                $date = $today;

                                $condstock .= " AND DATE_FORMAT(bornDate, '%Y %m %d') <= DATE_FORMAT('" . $today . "', '%Y %m %d')";
                            }
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if (in_array(2, $settingsCheckbox)) { ?>
                                            ...
                                            <td>
                                                <p class="pre-wrap"><?= ucfirst($oneInvItem["itemName"]) ?></p>
                                            </td>
                                        <?php
                                        }
                                        if (in_array(3, $settingsCheckbox)) { ?>
                                        ...
                                        if (in_array(8, $settingsCheckbox)) { ?>
                                            ...
                                            <td> <?= $oneInvItem["itemPrice"] ?> </td>
                                        <?php
                                        }
                                        if (in_array(9, $settingsCheckbox)) { ?>

                                            <td> <?= round($total_qty * $oneInvItem["movingWeightedPrice"], 2); ?></td>
                                        <?php
                                        }
                                        if (in_array(9, $settingsCheckbox)) { ?>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane fade show active" id="home_<?= $oneInvItem["stockSummaryId"] ?>" role="tabpanel" aria-labelledby="pills-contact-tab">
                                                                    ...
                                                                    <table class="table stock-details-table table-hover">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Type</th>
                                                                                <th>Open</th>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>RM warehouse</td>
                                                                                <td> <?= $stock_log_sql['data']['rmWhOpen_qty'] ?? 0  ?></td>
                                                                                <td> <?= $stock_log_sql['data']['rmWhReserve_qty'] ?? 0 ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>RM production</td>
                                                                                <td> <?= $stock_log_sql['data']['rmProdOpen_qty'] ?? 0 ?></td>
                                                                                <td> <?= $stock_log_sql['data']['rmProdReserve_qty'] ?? 0 ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>SFG Stock</td>
                                                                                <td>   <?= $stock_log_sql['data']["sfgStockOpen_qty"] ?? 0 ?></td>
                                                                                <td>   <?= $stock_log_sql['data']["sfgStockReserve_qty"] ?? 0 ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>FG warehouse</td>
                                                                                <td> <?= $stock_log_sql['data']["fgWhOpen_qty"] ?? 0 ?></td>
                                                                                <td>   <?= $stock_log_sql['data']["fgWhReserve_qty"] ?? 0 ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>FG Marketing</td>
                                                                                <td>   <?= $stock_log_sql['data']["fgMktOpen_qty"] ?? 0 ?></td>
                                                                                <td><?= $stock_log_sql['data']["fgMktReserve_qty"] ?? 0 ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>QA Location</td>
                                                                                <td><?=  $stock_log_sql['data']["QaLocation_qty"] ?? 0?></td>
                                                                                <td><?= 0 ?></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <!-- <div class="row">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            <div class="accordion accordion-flush warehouse-accordion p-0 my-2" id="accordionFlushExample">
                                                                                <div class="accordion-item">
                                                                                    <h2 class="accordion-header w-100" id="flush-headingOne">
                                                                                        <button class="accordion-button btn btn-primary warehouse-header  font-bold waves-effect waves-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWH1" aria-expanded="true" aria-controls="flush-collapseOne">
                                                                                            WH0001 | WH-1 </button>
                                                                                    </h2>
                                                                                    <div id="collapseWH1" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                                                                        <div class="accordion-body p-0">
                                                                                            <h1></h1>
                                                                                            <div class="card bg-transparent">
                                                                                                <div class="card-body px-0 mx-0" style="background-color: #f9f9f9;">
                                                                                                    <table class="table stock-details-table table-hover">
                                                                                                        <thead>
                                                                                                            <tr>
                                                                                                                <th>Type</th>
                                                                            ...
                                                                            <div class="accordion accordion-flush warehouse-accordion p-0 my-2" id="accordionFlushExample">
                                                                                <div class="accordion-item">
                                                                                    <h2 class="accordion-header w-100" id="flush-headingOne">
                                                                                        <button class="accordion-button btn btn-primary warehouse-header  font-bold waves-effect waves-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWH2" aria-expanded="true" aria-controls="flush-collapseOne">
                                                                                            WH0001 | WH-2 </button>
                                                                                    </h2>
                                                                                    <div id="collapseWH2" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                                                                        <div class="accordion-body p-0">
                                                                                            <h1></h1>
                                                                                            <div class="card bg-transparent">
                                                                                                <div class="card-body px-0 mx-0" style="background-color: #f9f9f9;">
                                                                            ...
                                                                            <div class="accordion accordion-flush warehouse-accordion p-0 my-2" id="accordionFlushExample">
                                                                                <div class="accordion-item">
                                                                                    <h2 class="accordion-header w-100" id="flush-headingOne">
                                                                                        <button class="accordion-button btn btn-primary warehouse-header  font-bold waves-effect waves-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWH3" aria-expanded="true" aria-controls="flush-collapseOne">
                                                                                            WH0001 | WH-3 </button>
                                                                                    </h2>
                                                                                    <div id="collapseWH3" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                                                                        <div class="accordion-body p-0">
                                                                                            <h1></h1>
                                                                                            <div class="card bg-transparent">
                                                                                                <div class="card-body px-0 mx-0" style="background-color: #f9f9f9;">
                                                                                                    <table class="table stock-details-table table-hover">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td>RM warehouse</td>
                                                                                                                <td><?= $oneInvItem["rmWhOpen"] ?></td>
                                                                                                                <td><?= $oneInvItem["rmWhReserve"] ?></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td>RM production</td>
                                                                                                                <td><?= $oneInvItem["rmProdOpen"] ?></td>
                                                                                                                <td><?= $oneInvItem["rmProdReserve"] ?></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td>SFG Stock</td>
                                                                                                                <td><?= $oneInvItem["sfgStockOpen"] ?></td>
                                                                                                                <td><?= $oneInvItem["sfgStockReserve"] ?></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td>FG warehouse</td>
                                                                                                                <td><?= $oneInvItem["fgWhOpen"] ?></td>
                                                                                                                <td><?= $oneInvItem["fgWhReserve"] ?></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td>FG Marketing</td>
                                                                                                                <td><?= $oneInvItem["fgMktOpen"] ?></td>
                                                                                                                <td><?= $oneInvItem["fgMktReserve"] ?></td>
                                                                                                            </tr>
                                                                                                        </tbody>
                                                                                                    </table>
                                                                                                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                ...
                <input type="hidden" name="pageTableName" value="ERP_SFG_INVENTORY_ITEMS" />

                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="paymentInvoiceDetails[<?= $invRowNo ?>][paymentINR]" id="hiddenInvoicePayAmt_<?= $invRowNo ?>" value="0">
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm m-0">
                                                    <div class="input-group-prepend">
                                                ...
                                                <input type="hidden" name="paymentInvoiceDetails[<?= $invRowNo ?>][paymentRemainINR]" id="hiddenInvoicePayAmtRemain_<?= $invRowNo ?>" value="0">
                                            </td>
                                            <td>

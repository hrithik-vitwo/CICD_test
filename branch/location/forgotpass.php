...
if(isset($_GET["logout"])){
    ...
    session_destroy();
    redirect(LOCATION_URL."login.php");
}
if(isset($_GET["logoutAdminFromBranch"])){
    unset($_SESSION["logedBranchAdminInfo"]);
    redirect(LOCATION_URL."manage-branches.php");
}
...
if(isset($_POST["signInBtnSbmt"])){
    ...
    if($loginObj["status"]=="success"){
     swalToast($loginObj["status"], $loginObj["message"],LOCATION_URL);
    }else{
                ...
                <form action="" method="post" onsubmit="return validate();">
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <p class="mt-2">
                                <a href="<?= LOCATION_URL;?>login.php">Back To Login</a>
                            </p>
                        </div>
                        <!-- /.col -->
                        <div class="col-4">

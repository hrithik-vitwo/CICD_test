                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Manage Settlement</h3>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="nav-overview-tabs" id="practionbtns">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <div class="d-flex editClosePodiv">
                                                                                <button class="btn btn-primary" id="editPobtn"><ion-icon name="create-outline"></ion-icon>Edit PR</button>
                                                                                <button class="btn btn-danger" id="closePobtn"><ion-icon name="close-outline"></ion-icon>Close PR</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row rfq-item-table">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                            <div class="items-table">
                                                                                <h4>Item Details</h4>
                                                                                <form action="purchase-to-pay-creations.php" method="GET" name="" id="prActionForm">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-settlement.php",
                dataType: 'json',
                data: { 
                    act: 'managePr',
                    comid: comid,
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                value.sl_no,
                                value.customerId,
                                `<p class="pre-normal">${value.customerName}</p>`,
                                value.transactionNo,
                                ...
                                //     <li>
                                //     <button class="soModal" data-toggle="modal" data-prcode=${ value.prCode} data-id=${value.purchaseRequestId}><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                //   </li>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "#closePobtn", function() {
            ...
            let url = "<?php echo  BRANCH_URL . 'location/manage-pr-creation.php?close-pr=' ?>" + prId;
            window.location.href = url;
        });
        ...
        $(document).on("click", "#addtoRfq", function(e) {
            ...
            var prCode = $('.soModal').data('id');
            var prid = $('.soModal').data('prcode');

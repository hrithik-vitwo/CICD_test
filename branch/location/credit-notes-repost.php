...
//     // console($addNewObj);
//     swalToast($addNewObj["data"], $addNewObj["message"], $_SERVER['PHP_SELF']);
// }
...
if (isset($_GET['cnId'])) {
    ...
    $cn_items = queryGet("SELECT * FROM `credit_note_item` as cn_items LEFT JOIN `erp_inventory_items` as items ON items.itemId = cn_items.item_id WHERE cn_items.`credit_note_id` = $cnId", true);
    // console($cn_items);
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" id="drnote" name="drnote" enctype="multipart/form-data">
                    ...
                    //    echo $dates['data']['prev_date'];
                    //    echo $dates['data']['next_date'];
                    //    echo 'ok';
                    //    echo $prev_date =  getMinDate($dates['data']['prev_date'], $dates['data']['next_date']);
                    // console($dates);
        ...
        var newRow = `<tr class="items_row" id="${rand}" >
                        ...
                        <td class="text-right">
                            <div >
                                ...
                                <input class="form-control" id="checkQtyVal_${rand}" type="hidden" name="item[${rand}][sumOfBatches]" value="">
                                </span>

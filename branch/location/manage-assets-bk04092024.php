...
if (isset($_POST['add_dep'])) {
    ...
    swalAlert($add_depreciation["status"], ucfirst($add_depreciation["status"]), $add_depreciation["message"]);

    // console($add_depreciation);
}
...
<style>
    ...
    ul#assetsTab.nav-pills {
        position: sticky;
        top: calc(50% - 172px);
    }

    div#assetsTabContent {
        padding: 10px 30px;
        margin-top: -2em;
    }

    div#assetsTabContent h3 {
        position: sticky;
        top: calc(150% - 627px);
        background-color: #fff;
        z-index: 99;
    ...
    div#assetsTabContent .card-header {
        padding: 0px 20px;
    ...
    div#assetsTabContent .card-body {
    ...
    div#assetsTabContent .card-body::-webkit-scrollbar {
        width: 0px;
        background-color: transparent;
    }

    div#assetsTabContent .card-body::-webkit-scrollbar-thumb:hover {
        background-color: rgba(0, 0, 0, 0.2);
        /* Change this value as per your requirement */
        border-radius: 20px;
    }

    div#assetsTabContent .card-body::-webkit-scrollbar-thumb {
        background-color: rgba(0, 0, 0, 0);
    }

    #assetsTab.nav-pills .nav-link {
        border-radius: 15px;
        background: transparent;
        border: 2px solid #dbe5ee00;
        color: #ffffff;
        font-size: 11px;
        font-weight: 600;
        text-align: center;
    ...
    #assetsTab.nav-pills .nav-item {
        border-bottom: 0;
    }

    #assetsTab.nav-pills .nav-link.active {
        background: #ffffff;
    ...
    .is-goods-asset .assets-modal .modal-header {
        height: 332px;
    }

    .is-goods-asset .assets-modal #action-navbar {
        overflow: hidden;
        position: relative;
        top: -21px;
    }
                                                ...
                                                <div class="col-lg-11 col-md-11 col-sm-11">
                                                    ...
                                                    <div class="filter-search">
                                                        ...
                                                        <div class="filter-list">
                                                            <a href="manage-assets.php" class="btn"><i class="fa fa-stream mr-2"></i>All Assets</a>
                                                            <a href="manage-assets.php?asset" class="btn active"><i class="fa fa-lock mr-2 active"></i>Assets in use</a>
                                                            <a href="manage-assets.php?assetC" class="btn "><i class="fa fa-lock mr-2 "></i>Assets under construction</a>
                                                        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="tab-content pt-0" id="custom-tabs-two-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                        ...
                                        $sql_list = "SELECT * FROM `erp_asset_use` as `uses`, `erp_inventory_items` as `items` WHERE 1 AND items.itemId = uses.asset_id AND items.`goodsType`=9 AND items.`company_id`=$company_id ORDER BY itemId desc;";
                                        ...
                                        $countShow = "SELECT count(*) FROM `erp_asset_use` as `uses`, `erp_inventory_items` as `items` WHERE 1 AND items.itemId = uses.asset_id AND items.`goodsType`=9 AND items.`company_id`=$company_id  ";
                                                ...
                                                <thead>
                                                    ...
                                                    <tr class="alert-light">
                                                        ...
                                                        if (in_array(8, $settingsCheckbox)) { ?>
                                                            ...
                                                            <th>Depriciated Price(latest price)</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="checkbox" name="check_dep" id="check_dep" value="<?= $row['use_asset_id'] ?>"></td>
                                                            ...
                                                            if (in_array(8, $settingsCheckbox)) { ?>
                                                                ...
                                                                <td><?= $row['depreciated_asset_value'] ?></td>
                                                        ...
                                                        <div class="modal fade hsn-dropdown-modal" id="dep_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" aria-hidden="true">
                                                            <div class="modal-dialog modal-full-height modal-notify modal-success" role="document">
                                                                <div class="modal-content card">
                                                                    ...
                                                                    <div class="modal-body card-body p-4" id="dep_modal_body" style="overflow: scroll;">
                                                        ...
                                                        <div class="modal fade hsn-dropdown-modal" id="addDepreciation_<?= $row['itemId'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" aria-hidden="true">
                                                            <div class="modal-dialog modal-full-height modal-notify modal-success" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                        ...
                                                        <div class="modal fade right assets-modal goods-modal customer-modal" id="fluidModalRightSuccessDemo_<?= $row['itemId'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-header pt-4">
                                                                        ...
                                                                        <div class="display-flex-space-between mb-3">
                                                                            <ul class="nav nav-pills" id="assetsTab" role="tablist">
                                                                                <li class="nav-item">
                                                                                    <a class="nav-link active" id="home" data-toggle="tab" href="#home<?= $row['use_asset_id'] ?>" role="tab" aria-controls="home" aria-selected="true"><ion-icon name="information-outline" class="mr-2"></ion-icon>Overview</a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a class="nav-link" id="profile" data-toggle="tab" href="#profile<?= $row['use_asset_id'] ?>" role="tab" aria-controls="profile" aria-selected="true" class="mr-2"><ion-icon name="repeat-outline" class="mr-2"></ion-icon>Depreciation History</a>
                                                                                </li>
                                                                            </ul>
                                                                    ...
                                                                    <div class="modal-body pt-3" style="padding: 0;">
                                                                        ...
                                                                        <div class="tab-content" id="assetsTabContent">
                                                                            ...
                                                                            <div class="tab-pane fade show active" id="home<?= $row['use_asset_id'] ?>" role="tabpanel" aria-labelledby="home-tab">
                                                                            ...
                                                                            <div class="tab-pane fade" id="profile<?= $row['use_asset_id'] ?>" role="tabpanel" aria-labelledby="profile-tab">

                                                                                <div class="row state-table" id="stateTable">
                                                                                    <div class="col-12">
                                                                                        <?php
                                                                                        $depDetail = queryGet("SELECT * FROM `erp_asset_depreciation` WHERE company_id = $company_id AND `branch_id`=$branch_id AND `location_id`=$location_id ORDER BY depreciation_code DESC", true);
                                                                                        // console($depDetail);
                                                                                        if ($depDetail['status'] == 'success') {
                                                                                        ?>
                                                                                            <div class="row head-state-table">
                                                                                                <div class="col-lg-1 col-md-1 col-sm-1 state-col-th">Dep. Date</div>
                                                                                                <div class="col-lg-1 col-md-1 col-sm-1 state-col-th">Dep. Code</div>
                                                                                                <div class="col-lg-2 col-md-2 col-sm-2 state-col-th text-right">Historical Price</div>
                                                                                                <div class="col-lg-2 col-md-2 col-sm-2 state-col-th text-right">Dep. on Value</div>
                                                                                                <div class="col-lg-2 col-md-2 col-sm-2 state-col-th text-right">Depreciation Value</div>
                                                                                                <div class="col-lg-2 col-md-2 col-sm-2 state-col-th text-right">Depreciated Value</div>
                                                                                                <div class="col-lg-1 col-md-1 col-sm-1 state-col-th">Status</div>
                                                                                                <div class="col-lg-1 col-md-1 col-sm-1 state-col-th">Action</div>
                                                                                            </div>

                                                                                            <?php
                                                                                            foreach ($depDetail['data'] as $depKey => $deprow) {
                                                                                            ?>
                                                                                                <div class="row body-state-table">
                                                                                                    <div class="col-lg-1 col-md-1 col-sm-1 state-col-td"><?= formatDate($deprow['posting_date']) ?></div>
                                                                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td"><?= $deprow['depreciation_code'] ?></div>
                                                                                                    <div class="col-lg-1 col-md-1 col-sm-1 state-col-td text-right"><?= $deprow['asset_value'] ?></div>
                                                                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"><?= $deprow['depreciation_on_value'] ?></div>
                                                                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"><?= $deprow['depreciated_value'] ?></div>
                                                                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"><?= $deprow['depreciation_value'] ?></div>
                                                                                                    <div class="col-lg-1 col-md-1 col-sm-1 state-col-td reverseDepreStatus"><?= $deprow['status'] ?></div>
                                                                                                    <div class="col-lg-1 col-md-1 col-sm-1 state-col-td reverseDepreciationDiv">
                                                                                                        <?php if ($deprow['status'] == 'active') { ?>
                                                                                                            <a style="cursor:pointer" data-id="<?= $deprow['asset_depreciation_id']; ?>" class="btn btn-sm reverseDepreciation" title="Reverse Latest Depreciation">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" style="width: 165px"><input type="checkbox" <?php echo (in_array(7, $settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox7" value="7" />
                                                        ...
                                                        Recent Price (after last depreciation)</td>
...
<?php
} elseif (isset($_GET['assetC'])) {
?>


    <div class="content-wrapper is-goods is-goods-assetC">
                                            ...
                                            <div class="row table-header-item">
                                                ...
                                                <div class="col-lg-11 col-md-11 col-sm-12">
                                                    ...
                                                    <div class="filter-search">
                                                        ...
                                                        <div class="filter-list">
                                                            <a href="manage-assets.php" class="btn"><i class="fa fa-stream mr-2"></i>All Assets</a>
                                                            <a href="manage-assets.php?asset" class="btn "><i class="fa fa-lock mr-2 "></i>Assets in use</a>
                                                            <a href="manage-assets.php?assetC" class="btn active "><i class="fa fa-lock mr-2 active"></i>Assets under construction</a>
                                                        </div>
                                                        <div class="dropdown filter-dropdown" id="filterDropdown">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="tab-content pt-0" id="custom-tabs-two-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                        ...
                                        $sql_list = "SELECT *,`items`.`createdAt` as `created`  FROM `erp_inventory_stocks_summary` as `stock` LEFT JOIN `erp_inventory_items` as `items` ON `stock`.`itemId` = `items`.`itemId` WHERE 1 AND `items`.`goodsType`=9 AND `stock`.`location_id`=$location_id ORDER BY `stock`.`stockSummaryId` desc";
                                        // console($sql_list);
                                        // console(queryGet($sql_list));
                                        $qry_list = mysqli_query($dbCon, $sql_list);
                                        ...
                                        $countShow = "SELECT count(*) FROM  `erp_inventory_stocks_summary` as `stock` LEFT JOIN `erp_inventory_items` as `items` ON `stock`.`itemId` = `items`.`itemId` WHERE 1 AND `items`.`goodsType`=9 AND `stock`.`location_id`=$location_id ";
                                            ...
                                            <table class="table defaultDataTable table-hover text-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($qry_list)) {
                                                        ...
                                                        $asset_sql = queryGet("SELECT * FROM `erp_inventory_stocks_log` WHERE `itemId`='" . $row['itemId'] . "' AND `locationId`= $location_id");
                                                        //   console($asset_sql);
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($check_asset['numRows'] > 0) {
                                                                ?>
                                                                    <button class="btn btn-success" type="button">In Use</button>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#addPut_<?= $row['itemId'] ?>">Put to use</button>
                                                        ...
                                                        <!-----add form modal start --->
                                                        <div class="modal fade hsn-dropdown-modal" id="addPut_<?= $row['itemId'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" aria-hidden="true">
                                                            <div class="modal-dialog modal-full-height modal-notify modal-success" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <form method="POST" action="">
                                                                            <input type="hidden" name="puttouse" id="puttouse" value="">
                                                                            <input type="hidden" name="item_id" value="<?= $row['itemId'] ?>">
                                                                            <input type="hidden" name="stock_log_id" value="<?= $asset_sql['data']['stockLogId'] ?>">
                                                                                                    ...
                                                                                                    <div class="row goods-info-form-view customer-info-form-view">
                                                                                                        ...
                                                                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="hidden" name="assetName" class="form-control" value="<?= $row['itemName'] ?>" readonly>
                                                                                                                <input type="text" name="assetCode" class="form-control" value="<?= $row['itemCode'] ?>" readonly>
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-6">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="text" name="rcvDate" class="form-control" value="<?= formatDateORDateTime($row['created'], false) ?>" readonly>
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-6">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="date" name="useDate" class="form-control">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="text" name="qty" id="asset_qty" class="form-control asset_qty_<?= $rand ?>" data-attr="<?= $rand ?>" value="<?= $row['remainingQty'] ?>">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="text" name="rate" id="asset_rate" class="form-control asset_rate_<?= $rand ?>" value="<?= $row['itemPrice'] ?>" data-attr="<?= $rand ?>">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="text" name="total" id="asset_value" class="form-control asset_value_<?= $rand ?>" value="<?php echo $row['itemPrice'] * $row['remaingQty']; ?>">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <label for=""><b>Depreciation Schedule</b></label>
                                                                                                                <label for="">First day of month</label>
                                                                                                                <input type="radio" name="dep_schedule" id="dep_schedule" class="dep_schedule<?= $rand ?>" value="first day of month">
                                                                                                                <label for="">15th of month</label>
                                                                                                                <input type="radio" name="dep_schedule" id="dep_schedule" class="dep_schedule<?= $rand ?>" value="15th of month">
                                                                                                                <label for="">Last Day of month</label>
                                                                                                                <input type="radio" name="dep_schedule" id="dep_schedule" class="dep_schedule<?= $rand ?>" value="last day of month">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <label for="">UOM</label>
                                                                                                                <select id="buomDrop" name="uom" class="form-control">
                                                                                                                    ...
                                                                                                                    ?>
                                                                                                                        ...
                                                                                                                        <option value="<?= $oneUomList['uomId'] ?>" <?php if ($oneUomList['uomId'] == $row['itemUom']) {
                                                                                                                                                                        echo "selected";
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="text" name="scrap" id="asset_scrap" class="form-control asset_scrap_<?= $rand ?>" value="5">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <input type="text" name="scrap_val" id="asset_scrap_val" class="form-control asset_scrap_val_<?= $rand ?>" value="<?= $scrap_val ?>">
                                                                                                        ...
                                                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                                            ...
                                                                                                            <div class="form-input">
                                                                                                                ...
                                                                                                                <?php
                                                                                                                $dep_key = $row['dep_key'];
                                                                                                                $dep_percentage_sql = queryGet("SELECT * FROM `erp_depreciation_table` WHERE `desp_key` = '" . $dep_key . "'");
                                                                                                                $dep_percentage = $dep_percentage_sql['data']['wdv'];
                                                                                                                //console($dep_percentage_sql);
                                                                                                                ?>

                                                                                                                <input type="text" name="dep_percentage" id="dep_percentage" class="form-control asset_scrap_<?= $rand ?>" value="<?= $dep_percentage ?>" readonly>
...
?>
    ...
    <div class="content-wrapper is-goods goods-asset">
                                            ...
                                            <div class="row table-header-item">
                                                ...
                                                <div class="col-lg-11 col-md-11 col-sm-12">
                                                    ...
                                                    <div class="filter-search">
                                                        ...
                                                        <div class="filter-list">
                                                            <a href="manage-assets.php" class="btn active"><i class="fa fa-stream mr-2 active"></i>All Assets</a>
                                                            <a href="manage-assets.php?asset" class="btn"><i class="fa fa-lock mr-2"></i>Assets in use</a>
                                                            <a href="manage-assets.php?assetC" class="btn "><i class="fa fa-lock mr-2 "></i>Assets under construction</a>
                                                        </div>
                                                        <div class="dropdown filter-dropdown" id="filterDropdown">
...
<script>
    function calculate_scrap_val(rand) {
        $random = rand;

        var rate = $(".asset_rate_" + ($random)).val();
        var scrap_rate = $(".asset_scrap_" + ($random)).val();
        var scrap_val = (Number(scrap_rate) / 100) * Number(rate);
        $(".asset_scrap_val_" + ($random)).val(scrap_val);
    ...
    function calculate_asset_val(rand) {
        $random = rand;

        var rate = $(".asset_rate_" + ($random)).val();
        //alert(rate);
        var qty = $(".asset_qty_" + ($random)).val();
        // alert(qty);
        var val = rate * qty;
        $(".asset_value_" + ($random)).val(val);
    }

    $(document).on("keyup", "#asset_qty", function() {
        var rand = $(this).data('attr');
        //  alert(rand);
        calculate_asset_val(rand);

    });
    $(document).on("keyup", "#asset_rate", function() {
        var rand = $(this).data('attr');
        calculate_scrap_val(rand);
        calculate_asset_val(rand);

    });
</script>
<script>
    $("#depreciate").on('click', function() {
         //alert("clicked")
        // $("check_dep")
        //  var checkedValue = $('input:checkbox[name=check_dep[]]:checked').val();

        var dep_keys = [];
        $("input:checkbox[name=check_dep]:checked").each(function() {
            dep_keys.push($(this).val());
        });
    ...
    $('.reverseDepreciation').click(function(e) {

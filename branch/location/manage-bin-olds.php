        ...
        <div class="col-md-12" style="padding-top: 15px">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i
                  class="fa fa-list po-list-icon"></i>Manage BIN</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark"><i
                  class="fa fa-plus po-list-icon"></i>Add BIN</a></li>
          </ol>
        </div>
      ...
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="SubmitForm" name="SubmitForm">
        ...
        <div class="row">
          <div class="col-md-7">
              ...
              <div class="card card-success">
                <div class="card-header cardHeader">
                  <h4 class="card-title w-100"> <a class="d-block w-100 text-dark" data-toggle="collapse"
                      href="#collapseThree"> BIN Details </a> </h4>
                </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <div class="input-group">
                          <?php
                             $warehouseList = $warehouseController->getAllLayer();
                            //console($warehouseList);
                            ?>
                          <select id="" name="layer_id" class="form-control form-control-border borderColor">
                            <option value="" data-goodType="">Select Layer</option>
                            <?php
                             
                              foreach ($warehouseList['data'] as $list) {
                              ?>

                            <option value="<?= $list['layer_id'] ?>"><?= $list['layer_name'] ?></option>
                ...
                <div class="row customer-info-head">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="head">
                      ...
                      <h4 class="text-white pt-2">Bin Details</h4>
                    </div>
                  </div>
                </div>
              </div>
              <div id="collapseThree">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-input">
                        <label for="date">Maximum Temperature</label>
                        <input type="text" name="max_temp" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-input">
                        <label for="date">Minimum Temperature</label>
                        <input type="text" name="min_temp" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-input">
                        <label for="date">Maximum weight capacity</label>
                        <input type="text" name="max_weight" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-input">
                        <label for="date">Maximun volume capacity</label>
                        <input type="text" name="max_vol" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-input">
                        <label for="date">Spec 1</label>
                        <input type="text" name="spec1" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-input">
                        <label for="date">Spec 2</label>
                        <input type="text" name="spec2" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-input">
                        <label for="date">Spec 3</label>
           ...
           <div class="col-md-5" style="max-height: 319px; overflow-y: auto;">
            <div class="row">
              <table class="table table-hover table-nowrap stock-new-table transactional-book-table mt-n5">
                ...
                <tbody>
                  ...
                  $sqlList = "SELECT bin.* , erpBin.layer_name FROM `erp_storage_bin` as bin  LEFT JOIN erp_layer as erpBin ON erpBin.layer_id =bin.layer_id WHERE 1 AND  bin.`company_id`=$company_id AND bin.`branch_id`=$branch_id AND bin.`location_id`=$location_id " . $cond . " " . $sts . "  ORDER BY bin.layer_id desc";
                  $sqlBin =  $dbObject->queryGet($sqlList,true);
                  $numRows=$sqlBin['numRows'];
  ...
  <section class="content">
    <div class="container-fluid">
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" id="Edit_bin" name="Edit_bin">
        ...
        <input type="hidden" name="bincode" id="bincode" value="<?= $row['bin_code'] ?>">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="input-group">
                          <select id="" name="storage_location" class="form-control form-control-border borderColor">
                            ...
                            <option value="<?= $list['bin_id'] ?>" data-goodType="">
                              <?= $list['storage_location_name'] ?>[WAREHOUSE - <?= $list['warehouse_name'] ?>]</option>
          ...
          <div class="p-0 pt-1 my-2">
            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
              <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                ...
                <a href="<?php echo basename($_SERVER['PHP_SELF']) ?>?create" class="btn btn-sm btn-primary"><i
            ...
            <div class="tab-content" id="custom-tabs-two-tabContent">
              <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                <?php
                  ...
                  $sql_list = "SELECT * FROM `erp_storage_bin` as bin LEFT JOIN `erp_layer` as layer ON layer.layer_id=bin.layer_id WHERE 1 " . $cond . " AND bin.company_id=$company_id ";
                ...
                <table class="table defaultDataTable table-hover text-nowrap p-0 m-0">
                  ...
                  <tbody>
                    ...
                    <tr style="cursor:pointer" data-toggle="modal"
                      data-target="#fluidModalRightSuccessDemo_<?= $row['bin_id'] ?>">
                      <td><?= $cnt++ ?></td>
                      <?php if (in_array(1, $settingsCheckbox)) { ?>
                      <td><?= $bin_name ?></td>
                      <?php }
                      ...
                      <td>
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                          ...
                          <button <?php if ($row['status'] == "draft") { ?> type="button" <?php } else { ?>type="submit"
                    ...
                    <div class="modal fade right customer-modal" id="fluidModalRightSuccessDemo_<?= $row['bin_id'] ?>"
                      tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true"
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            ...
                            <div class="display-flex-space-between mt-4 mb-3">
                              ...
                              <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link active" id="home-tab<?= str_replace('/', '-', $bin_code) ?>"
                                    data-toggle="tab" href="#home<?= str_replace('/', '-', $bin_code) ?>" role="tab"
                                    aria-controls="home" aria-selected="true">Info</a>
                                </li>
                                <!-- -------------------Audit History Button Start------------------------- -->
                                <li class="nav-item">
                                  <a class="nav-link auditTrail" id="history-tab<?= str_replace('/', '-', $bin_code) ?>"
                                    data-toggle="tab" data-ccode="<?= str_replace('/', '-', $bin_code) ?>"
                                    href="#history<?= str_replace('/', '-', $bin_code) ?>" role="tab"
                                    aria-controls="history<?= str_replace('/', '-', $bin_code) ?>"
                                    aria-selected="false">Trail</a>
                                </li>
                                <!-- -------------------Audit History Button End------------------------- -->
                              </ul>
                              <div class="action-btns display-flex-gap" id="action-navbar">
                                <?php
                                      $binId = base64_encode($row['bin_id']);
                                      ?>
                                <form action="" method="POST">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                              ...
                              <div class="tab-pane fade show active" id="home<?= str_replace('/', '-', $bin_code) ?>"
                                ...
                                <div class="row px-3 p-0 m-0" style="place-items: self-start;">
                                  ...
                                  <div class="col-md-6">
                                    <div class="row m-2 py-2 shadow-sm bg-light">
                                      <div class="col-md-6">
                                        <span class="font-weight-bold text-secondary"> Layer: </span>
                                      </div>
                                      <div class="col-md-6">
                                        <span><?= $layer ?></span>
                                      </div>
...
>>>>>>> 7ebec9d39507a64681e57351494342477060e8cd
                                </div>
                              </div>

                              <!-- -------------------Audit History Tab Body Start------------------------- -->
                              <div class="tab-pane fade" id="history<?= str_replace('/', '-', $bin_code) ?>"
                                ...
                                <div class="audit-head-section mb-3 mt-3 ">
                                  <p class="text-xs font-italic"><span class="font-bold text-normal">Created by </span>
                                    <?= getCreatedByUser($row['created_by']) ?> <span class="font-bold text-normal"> on
                                    </span> <?= formatDateORDateTime($row['created_at']) ?></p>
                                  <p class="text-xs font-italic"> <span class="font-bold text-normal">Last Updated
                                      by</span> <?= getCreatedByUser($row['updated_by']) ?> <span
                                      class="font-bold text-normal"> on </span>
                                    <?= formatDateORDateTime($row['updated_at']) ?></p>
                                </div>
                                <hr>
                                <div
                                  class="audit-body-section mt-2 mb-3 auditTrailBodyContent<?= str_replace('/', '-',$bin_code) ?>">
                    ...
                    <div class="modal-body">
                      ...
                      <div id="main2">
                        <table>
                          ...
                          <tr>
                            <td valign="top" style="width: 165px"><input type="checkbox"
                                <?php echo (in_array(5, $settingsCheckbox) ? 'checked="checked"' : ''); ?>
                                name="settingsCheckbox[]" id="settingsCheckbox3" value="5" />
                              Temp Control</td>
                          </tr>

        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Storage Location</a></li>
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Storage Location</a></li>
            </ol>
          </div>
                  ...
                  <div id="collapseThree">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="input-group">
                            <input type="text" name="storage_control" class="m-input" value="<?= $row['storage_control'] ?>">
                            <label>Storage Control</label>
                          </div>
                        </div>
            ...
            <div class="p-0 pt-1 my-2">
              <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                  <h3 class="card-title">Manage Storage Location</h3>
            ...
            <div class="card card-tabs" style="border-radius: 20px;">
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                  ...
                  $sql_list = "SELECT * FROM " . ERP_STORAGE_LOCATION . " as sl ," . ERP_WAREHOUSE . " as warehouse WHERE 1 AND sl.warehouse_id=warehouse.warehouse_id AND sl.`visibility`='show' AND sl.`company_id`=$company_id AND sl.`branch_id`=$branch_id AND sl.`location_id`=$location_id  ORDER BY sl.warehouse_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                  $qry_list = mysqli_query($dbCon, $sql_list);
                  $num_list = mysqli_num_rows($qry_list);

                  //AND  sl.'warehouse_id'=warehouse.'warehouse_id' 
                  //as sl ,".ERP_WAREHOUSE." as warehouse
                  $countShow = "SELECT count(*) FROM " . ERP_STORAGE_LOCATION . " as sl ," . ERP_WAREHOUSE . " as warehouse WHERE 1 AND sl.warehouse_id=warehouse.warehouse_id AND sl.`visibility`='show' AND sl.`company_id`=$company_id AND sl.`branch_id`=$branch_id AND sl.`location_id`=$location_id";
                  $countQry = mysqli_query($dbCon, $countShow);
                  $rowCount = mysqli_fetch_array($countQry);
                  $count = $rowCount[0];
                  $cnt = $GLOBALS['start'] + 1;
                  $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_STORAGE_LOCATION", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                    ...
                    <table class="table defaultDataTable table-hover text-nowrap p-0 m-0">
                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($qry_list)) {
                          ...
                          $storage_control = $row['storage_control'];
                        ...
                        ?>
                          <tr>
                            <td><?= $cnt++ ?></td>
                            <?php if (in_array(1, $settingsCheckbox)) { ?>
                              <td><?= $storage_location_name ?></td>
                            <?php }
                            if (in_array(2, $settingsCheckbox)) { ?>
                              <td><?= $storage_location_code ?></td>
                            <?php }
                            if (in_array(3, $settingsCheckbox)) { ?>
                            ...
                            <td>
                              <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                <input type="hidden" name="id" value="<?php echo $row['storage_location_id'] ?>">
                            ...
                            <td>
                              <a style="cursor: pointer;" class="btn btn-sm" data-toggle="modal" data-target="#fluidModalRightSuccessDemo_<?= $row['storage_location_id'] ?>"><i class="fa fa-eye po-list-icon"></i></a>
                            </td>
                          </tr>
                          <!-- right modal start here  -->
                          <div class="modal fade right storage-location-modal customer-modal" id="fluidModalRightSuccessDemo_<?= $row['storage_location_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-header">
                                  ...
                                  <div class="display-flex-space-between mt-4 mb-3">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                      <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home<?= str_replace('/', '-', $storage_location_code) ?>" role="tab" aria-controls="home" aria-selected="true">Info</a>
                                      </li>
                                      <!-- -------------------Audit History Button Start------------------------- -->
                                      <li class="nav-item">
                                        <a class="nav-link auditTrail" id="history-tab<?= str_replace('/', '-', $storage_location_code) ?>" data-toggle="tab" data-ccode="<?= str_replace('/', '-', $storage_location_code) ?>" href="#history<?= str_replace('/', '-', $storage_location_code) ?>" role="tab" aria-controls="history<?= str_replace('/', '-', $storage_location_code) ?>" aria-selected="false"><i class="fa fa-history mr-2"></i> Trail</a>
                                      </li>
                                ...
                                <div class="modal-body" style="padding: 0;">
                                  ...
                                  <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home<?= str_replace('/', '-', $storage_location_code) ?>" role="tabpanel" aria-labelledby="home-tab">
                                      <div class="col-md-12">
                                      ...
                                      <div class="row px-3 p-0 m-0" style="place-items: self-start;">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">storage location Name: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $storage_location_name ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">storage location Code: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $storage_location_code ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <!-- <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Longitude: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $warehouse_lng ?></span>
                                            </div>
                                          </div>
                                        </div> -->
                                    ...
                                    <div class="tab-pane fade" id="history<?= str_replace('/', '-', $storage_location_code) ?>" role="tabpanel" aria-labelledby="history-tab">

                                      <div class="audit-head-section mb-3 mt-3 ">
                                        <p class="text-xs font-italic"><span class="font-bold text-normal">Created by </span> <?= getCreatedByUser($storage_location_code['createdBy']) ?> <span class="font-bold text-normal"> on </span> <?= formatDateORDateTime($storage_location_code['createdAt']) ?></p>
                                        <p class="text-xs font-italic"> <span class="font-bold text-normal">Last Updated by</span> <?= getCreatedByUser($storage_location_code['updatedBy']) ?> <span class="font-bold text-normal"> on </span> <?= formatDateORDateTime($storage_location_code['updatedAt']) ?></p>
                                      </div>
                                      <hr>
                                      <div class="audit-body-section mt-2 mb-3 auditTrailBodyContent<?= str_replace('/', '-', $storage_location_code) ?>">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                      ...
                      <input type="hidden" name="pageTableName" value="ERP_STORAGE_LOCATION" />

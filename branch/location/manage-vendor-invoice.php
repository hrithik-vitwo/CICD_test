                                                        ...
                                                        <div class="filter-action filter-mobile-search mobile-page">
                                                            ...
                                                            <div class="exportgroup mobile-page mobile-export">
                                                                ...
                                                                <ul class="export-options">
                                                                    <li>
                                                                        <button>
                                                                            <ion-icon name="list-outline" class="ion-fulllistVendorInvoice md hydrated" id="exportAllBtn" role="img" aria-label="list outline"></ion-icon>Export
                                                                        </button>
                                                                    </li>
                                                                    <li>
                                                                        <button>
                                                                            <ion-icon name="list-outline" class="ion-paginationlistVendorInvoice md hydrated" role="img" aria-label="list outline"></ion-icon>Download
                                                                        </button>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <div class="exportgroup">
                                                ...
                                                <ul class="export-options">
                                                    <li>
                                                        <button class="ion-paginationlistVendorInvoice">
                                                            <ion-icon name="list-outline" class="ion-paginationlistVendorInvoice md hydrated" role="img" aria-label="list outline"></ion-icon>Export
                                                        </button>
                                                    </li>
                                                    <li>

                                                        <button class="ion-fulllistVendorInvoice">
                                                            <ion-icon name="list-outline" class="ion-fulllistVendorInvoice md hydrated" role="img" aria-label="list outline"></ion-icon>Download
                                                        </button>
                                                    </li>
                                                </ul>
                                            </div>
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($columnMapping as $columnIndex  => $column) {
                                                                            if ($columnIndex === 0 || $columnIndex === 1 || $columnIndex === 14  || $columnIndex === 19) {
                                                                                continue;
                                                                            } ?>
                                                                            <tr>
                                                                                <td>
                                                                                ...
                                                                                <div class="customer-details">
                                                                                    ...
                                                                                    <div class="address-contact">
                                                                                        <div class="address-customer">
                                                                                            <div class="details">
                                                                                                <label for="">location Gstin</label>
                                                                            ...
                                                                            <div class="items-table">
                                                                                ...
                                                                                <div class="multiple-item-table">
                                                                                    <div class="row head-state-table">
                                                                                        ...
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td text-right">TDS</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".ion-paginationlistVendorInvoice", function(e) {
            $.ajax({
                type: "POST",
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookieVendorInvoice')
                },
                beforeSend: function() {
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-paginationlistVendorInvoice').prop('disabled', true)
                },
                ...
                complete: function() {
                    ...
                    $('#loaderModal').hide();
                    $('.ion-paginationlistVendorInvoice').prop('disabled', false)
                }
            })

        });
        $(document).on("click", ".ion-fulllistVendorInvoice", function(e) {
            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-vendor-invoice.php",
                dataType: "json",
                ...
                beforeSend: function() {
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-fulllistVendorInvoice').prop('disabled', true)
                },
                success: function(response) {
                ...
                complete: function() {
                    // Hide loader modal after request completes
                    $('#loaderModal').hide();
                    $('.ion-fulllistVendorInvoice').prop('disabled', false);
                }
            })
...
<script>
    $(document).on("click", ".soModal", function() {
        ...
        let grncode = $(this).data('grncode'); 
        // let grnType =$(this).data('code');

        $('.auditTrail').attr("data-ccode", grncode);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status) {
                    ...
                    // nav head 
                    $(".left #amount").html(`${responseObj.companyCurrency}` + " " + decimalAmount(dataObj.grnTotalAmount));

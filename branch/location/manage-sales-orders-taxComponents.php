...
if (!isset($_COOKIE["cookieManageSo"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieManageSo", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Manage Sales Order</h3>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <a href="sales_order_creation.php?sales_order_creation" class="btn btn-create" type="button">
                                                <ion-icon name="add-outline"></ion-icon>
                                                Create
                                            </a>
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                                                                            ...
                                                                            <div class="items-table">
                                                                                ...
                                                                                <div class="other-info">
                                                                                    <div class="details">
                                                                                        <label for="">Customer Order No</label>
                                                                                        <p id="custOrderNo"></p>
                                                                                    </div>
                                                                                    <div class="details">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookieManageSo');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-so.php",
                dataType: 'json',
                data: {
                    act: 'tdata',
                    comid: comid,
                            ...
                            dataTable.row.add([
                                ...
                                ` <div class="dropout">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <button class="soModal" data-toggle="modal" data-id=${value.so_id} data-code="${value.so_number}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>
                                    ${actions}                                    
                                    </ul>
                                </div>`
        ...
        $(document).on("click", ".ion-paginationliststock", function(e) {
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookieManageSo')
                },
                beforeSend: function() {
                    $('#loaderModal').show();
        ...
        $(document).ready(function() {
            ...
            if (type) {
                ...
                $('.filter-link[data-name="' + type + '"]').addClass('active');
...
<script>
    $(document).on("click", ".soModal", function() {
        ...
        $.ajax({
            type: "GET",
            url: "ajaxs/modals/so/ajax-manage-so-modal-taxComponents.php",
            dataType: 'json',
            data: {
                act: "modalData",
                so_id
            ...
            success: function(value) {
                ...
                if (value.status) {
                    ...
                    let taxComponents;
                    if (responseObj.dataObj.taxComponents) {
                        taxComponents = JSON.parse(responseObj.dataObj.taxComponents);
                    }
                    ...
                    $("#classicViewPrint").attr('href', `classic-view/invoice-preview-print-taxcomponents.php?so_id=${responseObj.so_IdBase}`);
                    ...
                    $("#custCode").html("Customer Code : " + responseObj.dataObj.customer_code);
                    // if (countrycode != 103) {
                    //     $(".gstin").hide();
                    // } else {
                    ...
                    $.each(itemsObj, function(index, val) {
                        if (countrycode != 103) {
                            ...
                            $("#GstName2").html(responseObj.gstName + " Amount (" + responseObj.companyCurrency + ")");
...
<script>
    ...
    $(document).on('click', '.editSobtn', function() {
        ...
        let url = `sales_order_creation.php?edit_so=${btoa(so_id)}`;
        Swal.fire({
            icon: 'warning',
            title: 'Are you sure?',

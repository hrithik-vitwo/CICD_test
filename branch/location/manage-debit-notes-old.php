...
if (isset($_POST["createdata"])) {
  // console($_POST);
    $addNewObj = createDebitNote($_POST + $_FILES);
  // console($addNewObj);
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="sub-content">
                          <span>
                            <input type="radio" name="debitNoteReference" class="reff-type-radio select_payment_entry" value="Payment/Expenses" data-target="div-option-pay" checked="">
                            <label> Payment/Expenses</label>
                          </span>
                          <span>
                            <input type="radio" name="debitNoteReference" class="reff-type-radio select_payment_entry" value="Collection" data-target="div-option-collect" checked="">
                            <label> Collection</label>
                          </span>
                          <span>
                            <input type="radio" name="debitNoteReference" class="reff-type-radio select_payment_entry" value="Purchase" data-target="div-option-purchase">
                            <label> Purchase</label>
                          </span>
                          <span>
                            <input type="radio" name="debitNoteReference" class="reff-type-radio select_payment_entry" value="Production" data-target="div-option-production">
                            <label> Production</label>
                          </span>
                          <span>
                            <input type="radio" name="debitNoteReference" class="reff-type-radio select_payment_entry" value="Sales" data-target="div-option-sales">
                            <label>Sales</label>
                          </span>
                          <span>
                            <input type="radio" name="debitNoteReference" class="reff-type-radio select_payment_entry" value="Other" data-target="div-option-other">
                            <label>Other</label>
                          </span>
                        </div>
                      </div>

...
if ($quotation_createion) {
  ...
  if (isset($_POST['addNewInvoiceFormSubmitBtn'])) {
    ...
    if ($editBranchSo['status'] == 'success') {
      swalAlert($editBranchSo["status"], $editBranchSo["message"], 'manage-sales-orders.php');
    } else {
      swalAlert($editBranchSo["status"], 'Warning', $editBranchSo["message"]);
    }
  }
                  ...
                  <div class="row customer-info-form-view">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="input-box customer-select">
                        ...
                        <?php if (isset($_GET['quotation']) || isset($_GET['quotation_to_so']) || isset($_GET['so_to_invoice']) || isset($_GET['party_order_to_so']) || isset($_GET['party_order_to_quotation']) || isset($_GET['pgi_to_invoice']) ||  isset($_GET['edit_invoice']) || $_GET['edit_so']) { ?>
                          <?php
                  ...
                  <?php } else { ?>
                    <div class="row others-info-form-view" style="row-gap: 5px; justify-content: center;">
                      ...
                      <div class="row dotted-border-area">
                        ...
                        <?php if (!isset($_GET['quotation_to_so']) && !isset($_GET['sales_order_creation']) && !isset($_GET['quotation_createion']) && !isset($_GET['party_order_to_so']) && !isset($_GET['party_order_to_quotation']) && !isset($_GET['proforma_invoice']) && !isset($_GET['edit_so'])) { ?>
                          <!-- invoice formate -->
                          <div class="col-lg-4 col-md-4 col-sm-4 <?php if ($edit_invoice) {
                                                                    echo "displayOverLay";
                                                                  } ?>">
                      ...
                      <div class="row dotted-border-area">
                        ...
                        <?php if (!$sales_order_creation && !$edit_so) { ?>
                    ...
                    <div class="row">
                      <?php if (!isset($_GET['quotation_to_so']) && !isset($_GET['sales_order_creation']) && !isset($_GET['quotation_createion']) && !isset($_GET['party_order_to_so']) && !isset($_GET['party_order_to_quotation']) && !isset($_GET['edit_so'])) { ?>

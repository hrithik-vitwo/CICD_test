...
$cond='';
    ...
    $custsql="SELECT customer_id as id, CONCAT(customer_code,' | ',trade_name) as text FROM `" . ERP_CUSTOMER . "` WHERE 1 ".$cond." AND company_id='" . $company_id . "' AND `customer_status`='active' LIMIT $start,$limit";

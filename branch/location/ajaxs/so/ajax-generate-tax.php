...
if ($_GET['act'] === "getTaxComponent") {
  ...
  $branchGstinCode = $_GET['branchGstinCode'];
  $customerGstinCode = $_GET['customerGstinCode'];


  $getItemTaxRule = getItemTaxRule($companyCountry, $branchGstinCode, $customerGstinCode);
   ...
   <td colspan="12" class="text-right p-2" style="border: none; background: none;"> </td>
                      ...
                      <td class="text-right pr-2" style="border: none; background: none;">
                        <small class="text-large font-weight-bold text-success">
                          <span class="rupee-symbol_dynamic"></span><span  id="grandTaxAmt_' . $tax['taxComponentName'] . '">0.00</span>
                        ...
                        <small class="text-small font-weight-bold text-primary convertedDiv">
                          (<span class="rupee-symbol currency-symbol-dynamic"></span><span id="convertedGrandTaxAmount">0.00</span>)

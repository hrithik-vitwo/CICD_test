...
if (isset($_GET['vr']) && $_GET['vr'] != '') {
    ...
    $sql = queryGet("SELECT t1.postingDate AS prev_date FROM erp_debit_note t1 WHERE t1.company_id = $company_id AND t1.variant_id = $variant_id ORDER BY t1.postingDate DESC LIMIT 1;");

...
?>
    ...
    <tbody class="add-row inv_items">
      ...
      ?>
        ...
        <tr class="items_row" id="<?= $rand ?>">
            ...
            <div class="d-flex gap-2">
              ...
              <span class="custom_batch_<?= $rand ?> <?php if ($goodsType == 5 || $goodsType == 7) {
                ...
                <div class="qty-modal py-2">
                  <p class="font-bold text-center checkQtySpan" id="checkQtySpan_<?= $rand ?>"><?= decimalQuantityPreview($sumOfBatches); ?></p>
              ...
              <?php if ($goodsType == 5 || $goodsType == 7) { ?>
                ...
                <input type="number" step="any" name="item[<?= $rand ?>][qty]" class="form-control itemQty" id="itemQty_<?= $rand ?>" value="<?= inputQuantity($data['goodQty']) ?>">
              <?php } else { ?>
                <input type="number" step="any" name="item[<?= $rand ?>][qty]" class="form-control itemQty" id="itemQty_<?= $rand ?>" value="" <?php if (count($batchesDetails) > 0) {
                                                                                                                                                  echo 'readonly';
                                                                                                                                                } ?>>
              <?php } ?>
            </div>
          ...
          <input type="hidden" name="item[<?= $rand ?>][dis]" class="form-control itemDis" id="itemDis_<?= $rand ?>" value="<?= $data['cashDiscount'] ?>">
          <input type="hidden" name="item[<?= $rand ?>][disval]" class="form-control itemDisVal" id="itemDisVal_<?= $rand ?>" value="<?= $data['cashDiscountAmount'] ?>">

          <td class="text-right"><input type="number" step="any" name="item[<?= $rand ?>][rate]" class="form-control price" id="price_<?= $rand ?>" value="<?= inputValue($data['unitPrice']) ?>"></td>
          <td>
            <div class="d-flex gap-2">
              <input type="number" step="any" class="form-control tax" name="item[<?= $rand ?>][tax]" id="tax_<?= $rand ?>" value="<?= decimalQuantityPreview($data['tax']) ?>">
    ...
    <tr id="subtotalTr">
      ...
      <td colspan="2" class="text-right" id="total_discount_c"><?= ($cuinv['data']['totalCashDiscount']) ?>
      </td>
      <input type="hidden" step="any" id="total_discount" style="float: right;" class="form-control text-right" name="total_discount" value="<?= inputValue($cuinv['data']['totalCashDiscount']) ?>">
    ...
    <tr id="subtotalTr">
      ...
      <td colspan="2" class="text-right" id="total_tcs_c">
        <input type="number" step="any" id="total_tcs" style="float: right;" class="form-control text-right" name="total_tcs" value="<?= inputValue($cuinv['data']['tcs_amount']) ?>">
    ...
    <tr id="subtotalTr">
      ...
      <td colspan="2" class="text-right" id="total_round_off_c">
        <div class="adjust-currency d-flex gap-2 " style="float: right;">
          ...
          <input type="number" step="any" name="round_value" step="any" id="round_value" value="<?= $rounva ?>" class="form-control text-right">
        </div>
    ...
    <tr>
      <td><input type="hidden" id="grandTotalHidden" name="grandTotal" value="<?= $total ?>"></td>
      <td> <input type="hidden" name="discountAmount" id="discountAmountHidden" class="form-control" value="0"></td>
      <td><input type="hidden" class="form-control" name="subTotal" id="subTotalHidden" value="<?= $total ?>"></td>
    </tr>
  ...
  <?php
    ...
    // console($grninv);
    $inv = queryGet("SELECT * FROM `erp_grninvoice_goods` as goods, `erp_hsn_code` as hsn WHERE hsn.`hsnCode` = goods.`goodHsn` AND goods.`grnIvId` = $bill_id AND hsn.country_id=$companyCountry", true);
    //console($inv);
    $total = 0;
  ?>
    ...
    <tbody class="add-row inv_items">
      ...
      ?>
        ...
        <tr class="items_row" id="<?= $rand ?>">
          ...
          <td class="text-right"><?= $data['receivedQty'] ?></td>
          ...
          <input type="hidden" step="any" name="item[<?= $rand ?>][total_tds_per]" id="total_tds_per_<?= $rand ?>" value="<?= $data['tds'] ?>">

          <td class="text-right"><input type="number" step="any" name="item[<?= $rand ?>][rate]" class="form-control price" id="price_<?= $rand ?>" value="<?= inputValue($data['unitPrice']) ?>"></td>
          <td>
            <div class="d-flex gap-2">
              <input type="number" step="any" class="form-control tax" name="item[<?= $rand ?>][tax]" id="tax_<?= $rand ?>" value="<?= decimalQuantityPreview($data['taxPercentage']) ?>">
    ...
    <tr id="subtotalTr">
      ...
      <td colspan="2" class="text-right" id="total_tds_c">
        <input type="number" step="any" style="float: right;" id="total_tds" readonly class="form-control text-right" name="total_tds" value="<?= ($grninv['data']['grnTotalTds']) ?>">
    ...
    <tr id="subtotalTr">
      <td colspan="5" class="text-right">Total <?= $tcslable ?></td>
      <td colspan="2" class="text-right" id="total_tcs_c">
        <input t type="number" step="any" id="total_tcs" style="float: right;" class="form-control text-right" name="total_tcs" value="<?= ($grninv['data']['grnTotalTcs']) ?>">
    ...
    <tr id="subtotalTr">
      ...
      <td colspan="2" class="text-right" id="total_round_off_c">
        <div class="adjust-currency d-flex gap-2 " style="float: right;">
          ...
          <input type="number" step="step" name="round_value" step="any" id="round_value" value="<?= $rounva ?>" class="form-control text-right">
        </div>

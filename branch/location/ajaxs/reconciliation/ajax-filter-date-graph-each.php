...
if(isset($_GET['startdate']) && $_GET['startdate'] != "" && isset($_GET['enddate']) && $_GET['enddate'] != "" && isset($_GET['bankid']) && $_GET['bankid'] != "" && isset($_GET['pgl']) && $_GET['pgl'] != "" && isset($_GET['subgl']) && $_GET['subgl'] != ""){
    ...
    foreach ($monthsAndDatesInRange as $item) {
        ...
        $bank_amount = $brsObj->getBankAmountgraphEach($bank_id,$start_date,$end_date)["data"]["amount"] ?? 0;
        $book_amount = $brsObj->getBooksAmountgraphEach($pgl,$subgl,$start_date,$end_date);

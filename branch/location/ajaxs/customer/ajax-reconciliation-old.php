...
<div class="amount-section d-flex justify-content-between mt-3">
  ...
  <a class="btn btn-primary float-right my-2" href="recon.php?type=customer&party_id=<?= $party_id ?>&from_date=<?= $from_date ?>&to_date=<?= $to_date ?>">Proceed For Reconcilation</a>

...
ORDER BY 
  ...
  <div class="col-12 col-md-6">
   <div class="amount-block">
      <h6><ion-icon name="card-outline"></ion-icon>Acount Summary</h6>
           ...
           <div class="info">
              <label for=""><ion-icon name="wallet-outline"></ion-icon>Debit</label>
              <p class="text-xs">Rs ' . round($sum_sql['data'][0]['amount'], 2) . '</p>
            </div>
            <div class="info">
            <label for=""><ion-icon name="wallet-outline"></ion-icon>Credit</label>
  ...
  <tfoot>
      <tr class="balnce-due">
         ...
         <td class="text-right font-bold">' . round($opening_balance + $total, 2) . '</td>
      </tr>
    </tfoot>

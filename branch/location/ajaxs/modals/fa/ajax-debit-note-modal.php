...
$tempObj = new TemplateDebitNoteController();
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && $_GET['act'] == 'modaldata') {
    ...
    foreach ($itemDetails as  $item) {
        ...
        $items[] = [
            ...
            "item_qty" => decimalQuantityPreview($item['item_qty']),
            "uomName" => $uomName,
            "item_rate" => decimalValuePreview($item['item_rate']),
            "taxbleAmount" => decimalValuePreview($taxbleAmount),
            "item_tax" => decimalQuantityPreview($item['item_tax']),
            "item_amount" => decimalValuePreview($item['item_amount']),
            "gstamt" => decimalValuePreview($gstamt)
    ...
    $dynamic_data = [
        ...
        "subTotalAmt" => decimalValuePreview($subTotalAmt),

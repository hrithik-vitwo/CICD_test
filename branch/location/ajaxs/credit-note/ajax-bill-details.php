...
?>
    ...
    <tbody class="add-row inv_items">
      ...
      <tr class="items_row"  id="<?=$rand?>" >
          <td><p class="pre-normal"><?= $data['itemCode'] . '[' . $data['itemName'] . ']' ?></p>
          ...
          <td class="text-right">
            <div class="d-flex gap-2">
              ...
              <span class="custom_batch_<?= $rand ?> <?php if ($goodsType == 5 || $goodsType == 7) {
                ...
                $partyCreditDate = $_GET['partyCreditDate'] ?? date('Y-m-d');
                $randCode = $rand;
                                                ...
                                                <div class="card-body bg-light mx-3">
                                                  ...
                                                  ?>
                                                    <div class="storage-location mb-2">
                                                      ...
                                                      <div class="input">
                                                        <?php if ($batch['itemQty'] > 0) { ?>
                                                          <input type="number" name="item[<?= $randCode ?>][batchselection][<?= $batch['logRef'] . '_' . $locationKey . '_' . $whKey . $batchKey; ?>]" data-maxval="<?= $batch['itemQty'] ?>" data-rdcode="<?= $randCode . '|' . $batch['logRef']; ?>" class="form-control inputQuantityClass ml-auto enterQty batchqty<?= $batch['logRef']; ?> qty<?= $randCode; ?>" id="enterQty_<?= $batch['logRef']; ?>">
                                                        <?php } else { ?>
                                                          <input type="number" name="item[<?= $randCode ?>][batchselection][<?= $batch['logRef'] . '_' . $locationKey . '_' . $whKey . $batchKey; ?>]" data-maxval="<?= $batch['itemQty'] ?>" data-rdcode="<?= $randCode . '|' . $batch['logRef']; ?>" class=" form-control inputQuantityClass ml-auto enterQty batchqty<?= $batch['logRef']; ?> qty<?= $randCode; ?>" id="enterQty_<?= $batch['logRef']; ?>">
                                                        <?php } ?>
                                                      </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-6">
                                      <div class="form-input">
                                        ...
                                        <input type="number" class="form-control inputQuantityClass enterQtyManual qty<?= $randCode; ?>" data-rdcode="<?= $randCode . '|Manual'; ?>" name="item[<?= $randCode ?>][manualbatchselection][qty]">
                                      </div>
                                    </div>
                                    <div class="col-6">
                                      <div class="form-input">
              ...
              <?php if ($goodsType == 5 || $goodsType == 7) { ?>
                ...
                <input type="number" name="item[<?= $rand ?>][qty]" class="form-control inputQuantityClass itemQty" id="itemQty_<?= $rand ?>" value="<?= inputQuantity($data['goodQty']) ?>">
              <?php } else { ?>
                <input type="number" name="item[<?= $rand ?>][qty]" class="form-control inputQuantityClass itemQty" id="itemQty_<?= $rand ?>" value="" <?php if (count($batchesDetails) > 0) {
                                                                                                                                      echo 'readonly';
                                                                                                                                    } ?>>
              <?php } ?>
            </div>
          ...
          <td class="text-right"><input type="number" name="item[<?= $rand ?>][rate]" class="form-control price inputAmountClass" id="price_<?= $rand ?>" value="<?= inputValue($data['itemTargetPrice']) ?>"></td>
          <td>
            <div class="d-flex gap-2">
              <input type="number" class="form-control inputQuantityClass tax" name="item[<?= $rand ?>][tax]" id="tax_<?= $rand ?>" value="<?= inputQuantity($data['tax']) ?>">
                ...
                <div class="row round-off calculte-input px-0">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="adjust-currency d-flex gap-2">
                      ...
                      <input type="number" name="round_value" step="any" id="round_value" value="0" class="form-control text-center inputAmountClass">
                    </div>
                  </div>
                </div>
    ...
    <tr>
      ...
      <td class="text-right font-bold" id="grandTotal"> <?= decimalValuePreview($total) ?>
  ...
  ?>
    ...
    <tbody class="add-row inv_items">
      ...
      foreach ($inv['data'] as $keyss => $data) {
        ...
        $itemgl = queryGet("SELECT parentGlId,goodsType FROM `" . ERP_INVENTORY_ITEMS . "` WHERE itemId='" . $data['goodId'] . "' AND company_id = '" . $company_id . "' ");
      ...
      ?>
        ...
        <tr class="items_row"  id="<?=$rand?>" >
          ...
          <td class="text-right">
            <div class="d-flex">
              <span class="custom_batch_<?= $rand ?> <?php if ($goodsType == 5 || $goodsType == 7) {
                ...
                // $qtyObj = $BranchSoObj->deliveryCreateItemQty($getItemObj['data']['itemId']);
                $qtyObj = itemQtyStockChecking($itemId, "'rmWhOpen', 'fgWhOpen'", "DESC", "'" . $grninv['data']['grnCode'] . $data['itemStorageLocation'] . "'", $partyCreditDate);
                                                    ...
                                                    <div class="storage-location mb-2">
                                                      ...
                                                      <div class="input">
                                                        <?php if ($batch['itemQty'] > 0) { ?>
                                                          <input type="number" name="item[<?= $randCode ?>][batchselection][<?= $batch['logRef'] . '_' . $locationKey . '_' . $whKey . $batchKey; ?>]" data-maxval="<?= $batch['itemQty'] ?>" data-rdcode="<?= $randCode . '|' . $batch['logRef']; ?>" class="form-control inputQuantityClass ml-auto enterQty batchqty<?= $batch['logRef']; ?> qty<?= $randCode; ?>" id="enterQty_<?= $batch['logRef']; ?>">
                                                        <?php } else { ?>
                                                          <input type="number" name="item[<?= $randCode ?>][batchselection][<?= $batch['logRef'] . '_' . $locationKey . '_' . $whKey . $batchKey; ?>]" data-maxval="<?= $batch['itemQty'] ?>" data-rdcode="<?= $randCode . '|' . $batch['logRef']; ?>" class=" form-control inputQuantityClass ml-auto enterQty batchqty<?= $batch['logRef']; ?> qty<?= $randCode; ?>" id="enterQty_<?= $batch['logRef']; ?>" disabled>
                                                        <?php } ?>
                                                      </div>
                                                    </div>
                                                    <hr>
                                ...
                                <div class="accordion-body p-3">
                                  <div class="row">
                                    ...
                                    <div class="col-6">
                                      <div class="form-input">
                                        <label for="">Quantity<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control enterQtyManual qty<?= $randCode; ?>" data-rdcode="<?= $randCode . '|Manual'; ?>" name="item[<?= $randCode ?>][manualbatchselection][qty]">
                                      </div>
                                    </div>
                                    <div class="col-6">
                                      <div class="form-input">
          ...
          <td>
            <div class="d-flex gap-2">
              <input type="number" class="form-control tax" name="item[<?= $rand ?>][tax]" id="tax_<?= $rand ?>" value="<?= inputQuantity($data['taxPercentage']) ?>">

...
?>
    ...
    <tbody class="add-row inv_items">
      ...
      ?>
        ...
        <tr class="items_row" id="<?= $rand ?>">
          ...
          <td class="text-right"><input type="number" name="item[<?= $rand ?>][rate]" class="form-control price" id="price_<?= $rand ?>" value="<?= $data['itemTargetPrice'] ?>"></td>
          <td>
            <div class="d-flex gap-2">
    ...
    <tr id="subtotalTr">
      ...
      <td colspan="2" class="text-right" id="subTotal"><?= $total ?>
                ...
                <div class="row round-off calculte-input px-0">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="adjust-currency d-flex gap-2">
                      ...
                      <input type="number" name="round_value" step="any" id="round_value" value="0" class="form-control text-center">
                    </div>
                  </div>
                </div>
    ...
    <tr>
      ...
      <td colspan="2" class="text-right font-bold" id="grandTotal"> <?= $total ?>
      </td>
    </tr>
    <tr>
    ...
    <tbody class="add-row inv_items">
      ...
      ?>
        ...
        <tr class="items_row" id="<?= $rand ?>">
                                                    ...
                                                    <div class="storage-location mb-2">
                                                      ...
                                                      <div class="input">
                                                        <?php if ($batch['itemQty'] > 0) { ?>
                                                          <input step="0.01" type="number" name="item[<?= $randCode ?>][batchselection][<?= $batch['logRef'] . '_' . $locationKey . '_' . $whKey . $batchKey; ?>]" data-maxval="<?= $batch['itemQty'] ?>" data-rdcode="<?= $randCode . '|' . $batch['logRef']; ?>" class="form-control ml-auto enterQty batchqty<?= $batch['logRef']; ?> qty<?= $randCode; ?>" id="enterQty_<?= $batch['logRef']; ?>">
                                                        <?php } else { ?>
                                                          <input step="0.01" type="number" name="item[<?= $randCode ?>][batchselection][<?= $batch['logRef'] . '_' . $locationKey . '_' . $whKey . $batchKey; ?>]" data-maxval="<?= $batch['itemQty'] ?>" data-rdcode="<?= $randCode . '|' . $batch['logRef']; ?>" class=" form-control ml-auto enterQty batchqty<?= $batch['logRef']; ?> qty<?= $randCode; ?>" id="enterQty_<?= $batch['logRef']; ?>" disabled>
                                                        <?php } ?>
                                                      </div>
                                                    </div>
                                                    <hr>
          ...
          <td>
            <div class="d-flex gap-2">
              <input type="number" class="form-control tax" name="item[<?= $rand ?>][tax]" id="tax_<?= $rand ?>" value="<?= $data['taxPercentage'] ?>">

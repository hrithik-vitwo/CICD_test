...
if ($_POST['act'] == 'detailedTransactionalConcised') {
                    ...
                    FROM
                        ...
                        (SELECT
                            ...
                            WHERE
                                ...
                                journal.postingDate BETWEEN '" . $start_date . "' AND '" . $end_date . "') AS main_report)
                            UNION 
                            (SELECT *,
                                CASE
                            ...
                            WHERE
                                ...
                                journal.branch_id=$branch_id AND
                                journal.location_id=$location_id AND
                                journal.postingDate BETWEEN '" . $start_date . "' AND '" . $end_date . "') as mainReport)) as table1

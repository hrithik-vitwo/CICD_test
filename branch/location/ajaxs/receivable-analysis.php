                                    ...
                                    <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                        <div class="label-select">
                                            ...
                                            <select name="fydropdown" id="fYDropdown" class="form-control fy-dropdown" >
                                                <?php 
                                                foreach($variant_sql['data'] as $data){
                                                ...
                                                ?>
                                                <option value="<?= $data['year_variant_id'] ?>" data-start="<?= $startDate ?>" data-end="<?= $endDate ?>" <?php if($_POST['drop_id'] == $data['year_variant_id'] ) { echo "selected"; } ?>><?= $data['year_variant_name'] ?></option>
                                                <?php
                                                }
                                                ?>
                                              
                                                <option value="customrange" <?php if($_POST['drop_id'] == 'customrange' ) { echo "selected"; } ?>>
                                        ...
                                        <form method="POST" action ="" id="date_form" name="date_form">   
                                        <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" name="drop_id" id="drop_id" class="form-control" value="customrange" />

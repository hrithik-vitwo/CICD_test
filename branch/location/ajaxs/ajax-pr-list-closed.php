...
if ($_POST['act'] == 'managePrClosed') {
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_list = "SELECT * FROM `" . ERP_BRANCH_PURCHASE_REQUEST . "` WHERE 1 " . $cond . "  AND pr_status=10 AND company_id='" . $company_id . "' " . $sts . "  ORDER BY purchaseRequestId desc";

...
if ($_POST['act'] == 'tdata') {
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $implodeFrom = implode('', array_map(function ($slag, $data) {
      ...
      } elseif ($slag === "totalAmount" || $slag === 'vend.vendor_opening_balance' ) {
    ...
    }else if($slag ==='vend.vendor_opening_balance'){
      $data['value']=decimalValue($data['value']);
      $conds .= $slag . " " . $data['operatorName'] . " '%" . $data['value'] . "%'";
      } else if ($slag === 'vend.vendor_credit_period') {
        $conds .= $slag . " " . $data['operatorName'] . "" . $data['value'] . "";
      }
    ...
    if ($num_list > 0) {
      foreach ($sql_data as $data) {
        ...
        $dynamic_data[] = [
          ...
          "vend.vendor_code" => $data['vendor_code'],
          "vend.trade_name" => $data['trade_name'],
          "vend.legal_name" => $data['legal_name'],
          "vend.vendor_pan" => $data['vendor_pan'],
          "vend.vendor_gstin" => $data['vendor_gstin'],
          "vend.constitution_of_business" => $data['constitution_of_business'],
          "vend.vendor_opening_balance" => $data['vendor_opening_balance'] ?? decimalValuePreview(0),
          "currType.currency_name" => $data['currency_name'] ?? "-",
          "vend.vendor_visible_to_all" => $data['vendor_visible_to_all'],
          "vend.vendor_website" => $data['vendor_website'],
          "vend.vendor_credit_period" => $data['vendor_credit_period'],
          "vend.vendor_authorised_person_name" => $data['vendor_authorised_person_name'],
          "vend.vendor_authorised_person_email" => $data['vendor_authorised_person_email'],
          "vend.vendor_authorised_person_phone" => $data['vendor_authorised_person_phone'],
          "vend.vendor_authorised_alt_phone" => $data['vendor_authorised_alt_phone'],
          "vend.vendor_authorised_person_designation" => $data['vendor_authorised_person_designation'],
          "address.vendor_business_primary_flag" => $data['vendor_business_primary_flag'],
          "address.vendor_business_building_no" => $data['vendor_business_building_no'],
          "address.vendor_business_flat_no" => $data['vendor_business_flat_no'],
          "address.vendor_business_street_name" => $data['vendor_business_street_name'],
          "address.vendor_business_pin_code" => $data['vendor_business_pin_code'],
          "address.vendor_business_location" => $data['vendor_business_location'],
          "address.vendor_business_city" => $data['vendor_business_city'],

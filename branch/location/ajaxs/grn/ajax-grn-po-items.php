    ...
    if ($poDetailsObj["numRows"] == 0) {
        ...
        foreach ($po_item_data as $oneItemObj) {
            ...
            ?>
                ...
                <input type="hidden" class="ItemInvoiceTotalPrice" id="ItemInvoiceTotalPrice_<?= $sl ?>" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemTotalPrice]" value="<?= inputValue($itemUnitPrice * $itemQty) ?>" />
                ...
                <td>
                    <div class="input-group input-group-sm m-0" style="flex-wrap: nowrap;">
                        ...
                        <input type="number" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemUnitPriceOtherCurrency]" value="<?= inputValue($itemUnitPrice) ?>" id="grnItemUnitPriceTdInput_<?= $sl ?>" class="form-control border py-3 text-right itemUnitPrice" required readonly>
                ...
                <td>
                    <div class="form-input d-flex" style="align-items: center; gap: 7px;">
                        <input type="number" name="grnItemList[<?= $vendor_id ?>][<?= $sl ?>][itemTds]" value="<?= inputValue($tds) ?>" id="grnItemTdsTdInput_<?= $sl ?>" class="form-control text-xs itemTds" required>
                        <p class="text-xs">%</p>
                    </div>
                </td>

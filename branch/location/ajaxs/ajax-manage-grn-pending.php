...
if ($_POST['act'] == 'grnPending') {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql_list = "SELECT * FROM erp_grn WHERE 1 " . $cond . " AND companyId =" . $company_id . " AND branchId=" . $branch_id . " AND locationId=" . $location_id . " AND iv_status = 0 " . $sts . " ORDER BY grnId DESC";

...
if ($_POST['act'] == 'managePrOpen') {
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_list = "SELECT pr.*, admin.fldAdminName FROM erp_branch_purchase_request as pr LEFT JOIN tbl_branch_admin_details as admin ON pr.created_by=admin.fldAdminKey WHERE 1 " . $cond . "  AND pr_status=9 AND company_id='" . $company_id . "' " . $sts . "  ORDER BY purchaseRequestId desc";

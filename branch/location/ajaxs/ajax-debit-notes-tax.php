...
if ($_POST['act'] == 'debitnotes') {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $implodeFrom = implode('', array_map(function ($slag, $data) {
            ...
            } else if ($slag == 'total' || $slag == 'igst' || $slag == 'sgst' || $slag == 'cgst') {
        ...
        $sql_list = "SELECT * FROM `erp_debit_note` WHERE 1 " . $cond . "  AND`branch_id`=$branch_id AND `location_id`=$location_id AND `company_id`=" . $company_id . " ORDER BY dr_note_id desc";

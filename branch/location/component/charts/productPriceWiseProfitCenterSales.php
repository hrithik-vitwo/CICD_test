...
$searchValue = "productPriceWiseSalesProfitCenter"; // Add this from ajax "?chart=" value
...
<div class="col-md-6 col-sm-6 d-flex">
    <div class="card flex-fill productPriceWiseSalesProfitCenter">
        <div class="card-header">
            <div class="head-title">
                <button class="btn btn-primary pin-btn border" id="productPriceWiseProfitCenterSales"><?= chartExistorNot('productPriceWiseProfitCenterSales.php') ? 'Pinned' : 'Pin'; ?></button>
...
<script>
    ...
    // ===============================================================================================
    var quickDrop = $(".productPriceWiseSalesProfitCenter").find("select.quickDrop").val();

    function get_productPriceWiseProfitCenterSales(quickDrop, search) {
        // AJAX CALL 
        $.ajax({
            url: `<?= BASE_URL ?>branch/location/ajaxs/reports/ajax-charts.php?chart=productPriceWiseSalesProfitCenter&search=${search}&quickDrop=${quickDrop}`,
            async: false,
            beforeSend: function() {
                $(".load-wrapp").show();
    ...
    get_productPriceWiseProfitCenterSales(quickDrop, null);

    $('.applyFilter<?= $searchValue; ?>').click(function() {
        var quickDrop = $(".productPriceWiseSalesProfitCenter").find("select.quickDrop").val();

        get_productPriceWiseProfitCenterSales(quickDrop, 'searching');
    });
</script>
...
$searchValue = "kamWiseQuantityProductGroupSales"; // Add this from ajax "?chart=" value
...
<div class="col-md-6 col-sm-6 d-flex">
    <div class="card flex-fill kamWiseQuantityProductGroupSales">
        <div class="card-header">
            <div class="head-title">
                <button class="btn btn-primary pin-btn border" id="kamWiseQuantityProductGroupSales"><?= chartExistorNot('kamWiseQuantityProductGroupSales.php') ? 'Pinned' : 'Pin'; ?></button>
...
<script>
    ...
    // ===============================================================================================
    var quickDrop = $(".kamWiseQuantityProductGroupSales").find("select.quickDrop").val();

    function get_kamWiseQuantityProductGroupSales(quickDrop, search) {
        // AJAX CALL 
        $.ajax({
            url: `<?= BASE_URL ?>branch/location/ajaxs/reports/ajax-charts.php?chart=kamWiseQuantityProductGroupSales&search=${search}&quickDrop=${quickDrop}`,
            async: false,
            beforeSend: function() {
                $(".load-wrapp").show();
    ...
    get_kamWiseQuantityProductGroupSales(quickDrop, null);

    $('.applyFilter<?= $searchValue; ?>').click(function() {
        var quickDrop = $(".kamWiseQuantityProductGroupSales").find("select.quickDrop").val();

        get_kamWiseQuantityProductGroupSales(quickDrop, 'searching');
    });
</script>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="image-input">
                                            ...
                                            <span class="change-image"><button class=" btn btn-danger btn-remove"><i class="fa fa-times"></i></button></span>
                                            <div id="iframePreview" style="display: none;">
                                                <iframe class="iframe-preview" src="" frameborder="0"></iframe>
                                                <div id="iframeClickOverlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; cursor: pointer;"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-input totaldueamount">
                                            ...
                                            <input type="date" name="paymentDetails[postingDate]" class="form-control" value="<?= $min ?>" min="<?= $min ?>" max="<?= $max ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <table class="table">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= formatDateWeb($invoiceData['dueDate']) ?>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm m-0">
                                                    ...
                                                    <input type="number" class="form-control border py-3 text-right inputInvoiceAmt" id="inputInvoiceAmt_<?= $invRowNo ?>" value="<?= inputValue($invoiceData['grnTotalAmount'] * $currentConverstionRate) ?>" placeholder="0.00" readonly>
                                                </div>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm m-0">
                                                    ...
                                                    <input type="number" class="form-control border py-3 text-right inputInvoicePayableAmt" id="inputInvoicePayableAmt_<?= $invRowNo ?>" value="<?= inputValue($invoiceData['dueAmt'] * $currentConverstionRate) ?>" placeholder="0.00" readonly>
                                                </div>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm m-0">
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <input type="number" step="any" name="paymentInvoiceDetails[<?= $vendor_id ?>][<?= $invRowNo ?>][recAmt]" class="form-control border py-3 text-right inputInvoicePayAmt" id="inputInvoicePayAmt_<?= $invRowNo ?>" value="<?= inputValue($invoiceData['dueAmt'] * $currentConverstionRate) ?>" placeholder="Enter amount">
                                                    <?php } ?>
                                                </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <div class="text-light text-nowrap">
                                                            ...
                                                            <p class="text-xs my-2"><span class="text-muted">GRN Total:</span> <?= $invoiceData['currency_name'] . " " . decimalValuePreview($invoiceData['grnTotalAmount'] * $currentConverstionRate) ?> </p>
                                                            ...
                                                            <p class="text-xs my-2"><span class="text-muted">Total Payable:</span> <?= $invoiceData['currency_name'] . " " . decimalValuePreview($invoiceData['dueAmt'] * $currentConverstionRate) ?></p>
                                                    ...
                                                    <div class="modal-body p-3">
                                                        <div class="card mb-3">
                                                            <div class="card-header py-1 text-light">
                                                                <p>Round Off</p>
                                                                <div class="help-tip ex-work-tooltip">
                                                                    <p>Refers to adjusting the total amount of the bill to the nearest specified currency unit
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="card-body py-1">
                                                                <div class="d-flex gap-2 m-0 p-0">
                                                                    ...
                                                                    <div class="input-group input-group-sm">
                                                                        <input type="number" step="any" id="inputRoundOffInr_<?= $invRowNo ?>" class="form-control border py-3 text-right inputRoundOffInr adjustmentInputValue inputAmountClass" placeholder="<?= inputValue(0) ?>">
                                                        ...
                                                        <div class="card mb-3">
                                                            <div class="card-header py-1 text-light">
                                                                <p>Write Back</p>
                                                                <div class="help-tip ex-work-tooltip">
                                                                    <p>Refers to reducing the amount of bill/liability
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="card-body py-1">
                                                                <div class="d-flex gap-2 m-0 p-0">
                                                                    ...
                                                                    <div class="input-group input-group-sm">
                                                                        <input type="number" step="any" id="inputWriteBackInr_<?= $invRowNo ?>" class="form-control border py-3 text-right inputWriteBackInr adjustmentInputValue inputAmountClass" placeholder="<?= inputValue(0) ?>">
                                                        ...
                                                        <div class="card mb-3">
                                                            <div class="card-header py-1 text-light">
                                                                ...
                                                                <div class="help-tip ex-work-tooltip">
                                                                    <p>Refers to charges being levied by banking partners.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="card-body py-1">
                                                                <div class="d-flex gap-2 m-0 p-0">
                                                                    ...
                                                                    <div class="input-group input-group-sm">
                                                                        <input type="number" step="any" id="inputFinancialChargesInr_<?= $invRowNo ?>" class="form-control border py-3 text-right inputFinancialChargesInr adjustmentInputValue inputAmountClass" placeholder="<?= inputValue(0) ?>">
                                                        ...
                                                        <div class="card mb-3">
                                                            <div class="card-header py-1 text-light">
                                                                <p>Forex Loss/Gain</p>
                                                                <div class="help-tip ex-work-tooltip">
                                                                    <p>Refers to the profit or loss resulting due to conversion of a foreign currency into domestic currency
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="card-body py-1">
                                                                <div class="d-flex gap-2 m-0 p-0">
                                                                    ...
                                                                    <div class="input-group input-group-sm">
                                                                        <input type="number" step="any" id="inputForexLossGainInr_<?= $invRowNo ?>" class="form-control border py-3 text-right inputForexLossGainInr inputAmountClass" placeholder="<?= inputValue(0) ?>">
                                                        ...
                                                        <div class="card mb-3">
                                                            <div class="card-header py-1 text-light">
                                                                <p>Total TDS</p>
                                                                <div class="help-tip ex-work-tooltip">
                                                                    <p>Refers to the total TDS amount withheld against a bill
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="card-body py-1">
...
<script>
    $(document).ready(function() {
        ...
        function updateAdjustmentAmount(rowNo) {
            ...
            $(`#inputInvoiceAdjustAmt_${rowNo}`).val(decimalAmount(totalAdjustedAmount));

            // console.log()
            $(`#inputInvoiceRemainAmt_${rowNo}`).val(decimalAmount(inputInvoiceRemainAmt + totalAdjustedAmount));
            $(`#modalRemainAmt_${rowNo}`).html(decimalAmount(inputInvoiceRemainAmt + totalAdjustedAmount));
        ...
        function calculateVendorPaymentForm() {
            ...
            $(".inputInvoicePayAmt").each(function() {
                ...
                if (invPayAmt > invPayableAmt) {
                    ...
                    $(`#modalRemainAmt_${invRowNo}`).html(decimalAmount(invPayableAmt));
                    invPayAmt = 0;
                    invINRPayAmt = 0;
                    ...
                    $(`#modalRemainAmt_${invRowNo}`).html(decimalAmount(invRemainAmt));
                }
            ...
            $(`#inputTotalPaymentAmount`).val(decimalAmount(grandTotalPayAmt));
            $(`#inputTotalRemainAmount`).val(decimalAmount(grandTotalRemainAmt));
        }
            ...
            $('#imageInput').on('change', function(event) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        // console.log("Setting iframe src to:", e.target.result);
                        $('#imageFrame').attr('src', e.target.result).show();
                        $('.image-button').hide();
                        $('#iframePreview').show();
                        $('.change-image').show();
                    }
        ...
        $(document).ready(function() {
            $('#imageInput').on('change', function(event) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        // console.log("Setting iframe src to:", e.target.result);
                        $('#iframePreview  iframe').attr('src', e.target.result).show();
                        $('.image-button').hide();
                        $('#iframePreview ').show();
                        $('.change-image').show();
                    }
            ...
            $('#iframeClickOverlay').on('click', function() {
                var src = $('#iframePreview iframe').attr('src');
                if (src) {
                    // Split out the base64 data part
                    var parts = src.split(',');

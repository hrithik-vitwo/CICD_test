                                ...
                                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        ...
                                        <div class="right-block">
                                            <?php require_once("components/pp/production-declaration-tab.php"); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fill_datatable(formDatas = '', pageNo = '', limit = '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-manage-prod-declaration-sfg.php",
                    dataType: 'json',
                    data: {
                        act: 'prodDeclareSfg',
                        comid: comid,
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            var checkboxSettings = Cookies.get('cookiesprodDeclareSfg');

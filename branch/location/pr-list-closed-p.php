...
// if (!isset($_COOKIE["cookiesPrlist"])) {
...
//         setcookie("cookiesPrlist", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
//     }
// }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <a href="manage-pr.php?pr-creation" class="btn btn-create waves-effect waves-light" type="button">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fill_datatable(formDatas = '', pageNo = '', limit = '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-pr-list-closed.php",
                    dataType: 'json',
                    data: {
                        act: 'managePrClosed',
                        comid: comid,
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            var checkboxSettings = Cookies.get('cookiesPrClosed');
            ...
            $(document).ready(function() {
                $(document).on("click", "#serach_submit", function(event) {
                    ...
                    $(".selectOperator").each(function() {
                        ...
                        if ((columnSlag === 'pr_date') && operatorName == "BETWEEN") {

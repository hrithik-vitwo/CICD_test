...
<?php
if (isset($_GET['sfg'])) {
    require_once("components/mm/goods-type-items-sfg.php");
                                        ...
                                        <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                            <div class="left-block">
                                                <div class="label-select">
                                                    <h3 class="card-title mb-0">SFG Inventory</h3>
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookiesSfgStock');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-sfg-stock.php",
                dataType: 'json',
                data: {
                    act: 'sfg',
                    comid: comid,

                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space"
                                        ...
                                        <div class="right-block">
                                            ...
                                            <div class="page-list-filer filter-list">
                                                <?php include("common/QLCommonList.php"); ?>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active"
                                            ...
                                            <a href="<?= LOCATION_URL ?>quotationCreation.php?quotation_creation"
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                                    ...
                                    <div class="items-table">
                                        ...
                                        <div class="other-info">
                                            ...
                                            <div id="complianceInvoiceType" class="details">
                                    ...
                                    <div class="items-table">
                                        ...
                                        <div class="multiple-item-table">
                                            <div class="row head-state-table">
                                                ...
                                                <div
                                                    class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td text-right">
                                                    <span id="gstAmtlabel"></span> Amount (<span
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            // if (formattedDate > givenDate && value.approvalStatus != 16 || value.approvalStatus == 11) {
                            ...
                            if (value.approvalStatus == 14) {
                                ...
                                delAction = `
                                        <li>
                                            <button class="deleteQuotationBtn" data-id=${value.quotation_id} data-quotationno="${value.quotation_no}" data-toggle="modal"  data-target="#viewModal"><ion-icon name="trash-outline" class="ion-delete"></ion-icon>Delete</button>
                                        </li>
                                `;
...
<script>
    $(document).on("click", ".soModal", function() {
        ...
        $("#classicViewPrint").attr('href', `classic-view/invoice-preview-print-taxcomponents.php?quotationId=${btoa(quotation_id)}`);

        // overview data
        $.ajax({
            type: "GET",
            url: "ajaxs/modals/so/ajax-manage-quotations-modal-tax.php",
            dataType: 'json',
            data: {
                act: "modalData",
                quotation_id,
            ...
            success: function(value) {
                ...
                if (value.status) {
                    ...
                    var complianceInvoiceType = country_labels.compliance_invoice;
                    ...
                    // alert(country_fields.businessTaxID);
                    ...
                    if (place_of_supply == false) {
                        $("#place_of_supply").hide();
                    } else {
                        $("#place_of_supply").show();
                    }

                    if (complianceInvoiceType == 'false') {
                        $("#complianceInvoiceType").hide();
                    } else {
                        $("#complianceInvoiceType").show();
                    }
                    ...
                    $("#qtype").html(" : " + responseObj.dataObj.quotation_type);
                    $("#inco_term").html(" : " + responseObj.dataObj.inco_term);
                    ...
                    if (responseObj.countryCode === '103') {
                        // For India
                        if (responseObj.dataObj.igst == 0) {
                            $("#csgst").css("display", "block"); // Show CGST and SGST block
                            $("#igstP").hide(); // Hide IGST label
                            $("#igst").hide(); // Hide IGST value
                            $("#cgstVal").html(responseObj.companyCurrency + " " + decimalAmount(responseObj.dataObj.cgst)); // Populate CGST value
                            $("#sgstVal").html(responseObj.companyCurrency + " " + decimalAmount(responseObj.dataObj.sgst)); // Populate SGST value
                        } else {
                            $("#cgstVal").empty()
                            $("#sgstVal").empty()
                            ...
                            $("#igstP").show();
                            $("#igst").show();
                            $("#igst").html(responseObj.companyCurrency + " " + decimalAmount(responseObj.dataObj.igst)); // Populate IGST value
                        }
                    } else {
                ...
                <p class="gstValues">
                    ...
                    $("#gstlabel").html(decimalQuantity(taxName) + '(%)')

...
if ($componentsjsn['fields']['taxNumber']) {
    $columnMapping[] = [
        'name' => $componentsjsn['fields']['taxNumber'],
        'slag' => 'vendor_pan',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => ''
    ];
...
<style>
    ...
    #nav-tabContent #nav-transaction .inner-content .tab-content {
        overflow: auto;
    }

    .accordion .accordion-item #collapseOtherAddress .accordion-body .otherBuinessDetails_container table th {
        color: #000;
        background: #ccc;
        font-weight: 600;
    ...
    .accordion .accordion-item #collapseOtherAddress .accordion-body .otherBuinessDetails_container table td {
        padding: 20px 12px;
        background: #fbfbfb;
...
<!-- css for loader in the mail tab for verificatrion -->


<style>
    .loader.ai-style-change-1 {
        display: block;
        position: static;
        width: 20px;
        height: 20px;
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active"
                                            ...
                                            <a href="vendorAction.php?create" class="btn btn-create" type="button">
                                                <ion-icon name="add-outline"></ion-icon>
                                                Create
                                            </a>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="tab-content global-tab-content"
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        <h4>Purchase
                                                                                            Orders</h4>
                                                                                        <a href="manage-purchases-orders-tax.php"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Manage
                                                                                            PO </a>
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    ...
                                                                                    <div id="innerBillsTableBody"
                                                                                        class="innerBillsTable innerVendTransDiv">
                                                                                        <table id="billsTable"
                                                                                            class="exportTable vendTransDatatable">
                                                                                            <thead
                                                                                                class="innerTableHeadPos">
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        ...
                                                                                        <!-- <button
                                                                                            ...
                                                                                            invoice</button> -->
                                                                                        <a href="debit-note-creation-taxrule.php?create"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Create
                                                                                            Debit Note</a>
                                                                                    ...
                                                                                    <div class="head">
                                                                                        ...
                                                                                        <!-- <button
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Create
                                                                                            invoice</button> -->
                                                                                        <a href="credit-notes-creation-rule-book.php?create"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Create
                                                                                            Credit Note</a>
                                                                ...
                                                                <div class="tab-pane mail-tab-pane fade" id="nav-mail"
                                                                    ...
                                                                    <div class="alert alert-light d-flex justify-content-between align-items-center p-3 border rounded shadow-sm">
                                                                        <span class="text-dark font-weight-bold" id="mailmsg">
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            let status = ``;
                            let mailStatus = '';
                            if (value['vend.isMailValid'] == 'Verified') {
                                mailStatus = '<p class="status-bg status-open">Verified</p>';
                            } else {
                                mailStatus = '<p class="status-bg status-closed">Not Verified</p>';
                            }
                            if (value.vendor_status == "inactive") {
                                status = ` <form action="" method="POST">
                                <input type="hidden" name="id" value="${value.vendorId}">
                                <input type="hidden" name="changeStatus" value="active_inactive">
                                <button type="submit" onclick="return confirm('Are you sure change vendor_status?')" style="cursor: pointer; border:none" class="p-0 m-0 ml-2 " data-toggle="tooltip" data-placement="top" title="Inactive">
                                                                      <p class="status-bg status-closed">Inactive</p>
                                  
                                </button>
                              </form>`;
                            } else if (value.vendor_status == "active") {
                                status = ` <form action="" method="POST">
                                <input type="hidden" name="id" value="${value.vendorId}">
                                <input type="hidden" name="changeStatus" value="active_inactive">
                                <button type="submit" onclick="return confirm('Are you sure change vendor_status?')" style="cursor: pointer; border:none" class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="active">
                                                                      <p class="status text-xs">Active</p>
                                  
                                </button>
                              </form>`;
                            } else if (value.vendor_status == "draft") {
                                status = ` <form action="" method="POST">
                                <input type="hidden" name="id" value="${value.vendorId}">
                                <input type="hidden" name="changeStatus" value="draft_to_active">
                                <button type="submit" onclick="return confirm('Are you sure change vendor_status?')" style="cursor: pointer; border:none" class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="guest">
                                                                      <p class='status-bg status-pending'>Draft</p>
                                                                         </button>
                              </form>`;
                            } else if (value.vendor_status == "guest") {
                                status = ` <form action="" method="POST">
                                <input type="hidden" name="id" value="${value.vendorId}">
                                <input type="hidden" name="changeStatus" value="guest_to_active">
                                <button type="submit" onclick="return confirm('Are you sure change vendor_status?')" style="cursor: pointer; border:none" class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="guest">
                                                                      <p class="status-bg status-pending">Guest</p>
                                                                         </button>
                              </form>`;
                            }
                            ...
                            dataTable.row.add([
                                value.sl_no,
                                `<a href="#" class="soModal" data-id="${value.vendorId}" data-code="${value.vendor_code}" data-vendor_gstin="${value.vendor_gstin}"  data-toggle="modal" data-target="#viewGlobalModal">${value.vendor_code}</a>`,
                                value.trade_name,
                                value.vendor_pan,
                                value.constitution_of_business,
                                value.vendor_gstin,
                                value.vendor_authorised_person_email,
                                value.vendor_authorised_person_phone,
                                mailStatus,
                                status,
                                ` <div class="dropout">
                                    <button class="more">
                                    ...
                                    <ul>
                                        <li>
                                            <button data-toggle="modal" class="editbtn" data-id="${value.vendorId}" data-vendor_gstin="${value.vendor_gstin}" data-code="${value.vendor_code}"><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                        </li>
                                        <li>
                                            <button class="soModal" data-toggle="modal" data-id="${value.vendorId}" data-vendor_gstin="${value.vendor_gstin}" data-code="${value.vendor_code}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>                             
                                    </ul>
                                </div>`
                            ]).draw(false);
        ...
        $(document).on("click", ".ion-paginationliststock", function(e) {
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiemanagevendors')
                },
                beforeSend: function() {
                    $('#loaderModal').show();
...
<script>
    let components = <?php echo json_encode($componentsjsn); ?>;
    $(document).ready(function() {
        ...
        $(document).on("click", ".soModal", function() {
            ...
            vendor_gstin = $(this).data('vendor_gstin');
            ...
            $("#nav-transaction-tab").click(function() {
                $(".innerQuotations_wrapper").scrollTop(0);
                $(".innerPurchaseOrder_wrapper").scrollTop(0);
                $(".innerBillsTable_wrapper").scrollTop(0);
                $(".innerPayments_wrapper").scrollTop(0);
                $(".innerJournals_wrapper").scrollTop(0);
                $(".innerDebitNote_wrapper").scrollTop(0);
                $(".innerCreditNote_wrapper").scrollTop(0);
...
`);
            ...
            $.ajax({
                ...
                success: function(value) {
                    ...
                    if (value.status) {
                        ...
                        // let navBar = value.navbar;
                        // let dataObj = value.data.responseObj;
                        // nav head

                        let navContent = ''; // Default value
                        if (value.navbar) {
                            navContent = value.navbar; // Use the value if it exists
                        }

                        $("#mailmsg").html(value.mailmsg);
                        $(".nav-overview-tabs").html(navContent);
                        ...
                        // vendor_gstin = dataObj.vendor_gstin;
                    }
                },
                complete: function() {
                    // $("#globalModalLoader").remove();
                    ...
                    if (value.status === 'success') {
                        ...
                        let output = `
                                    <div class="accordion-body">
                                        ...
                                        <div class="details">
                                            <label><ion-icon name="arrow-forward-outline"></ion-icon> ${components.fields.businessTaxID}</label>
                                            <p>: ${details.vendor_gstin || " --"}</p>
                                        </div>
                                        <div class="details">
                                            <label><ion-icon name="arrow-forward-outline"></ion-icon> ${components.fields.taxNumber}</label>
                    ...
                    if (value.status == 'success') {
                        ...
                        output = `
                                    <div class="accordion-body">
                                        ...
                                        <div class="details">
                                            <label for=""><ion-icon name="arrow-forward-outline"></ion-icon>${components.fields.BankIdCode}</label>
            ...
            $.ajax({
                ...
                success: function(value) {
                    if (value.status == 'success') {
                        ...
                        // Generate table rows dynamically for all businessPlace entries
                        let i = 1;
                        value.data.forEach(function(businessPlace) {
                            ...
                            tableRows += `
                                            <tr>
                                                <td>${i}</td>
                                                <td>${businessPlace.vendor_business_state && businessPlace.vendor_business_state.trim() !== "" ? businessPlace.vendor_business_state : "-"}</td>
                                                <td>${businessPlace.vendor_business_city && businessPlace.vendor_business_city.trim() !== "" ? businessPlace.vendor_business_city : "-"}</td>
                                                <td>${businessPlace.vendor_business_district && businessPlace.vendor_business_district.trim() !== "" ? businessPlace.vendor_business_district : "-"}</td>
                                                <td>${businessPlace.vendor_business_location && businessPlace.vendor_business_location.trim() !== "" ? businessPlace.vendor_business_location : "-"}</td>
                                                <td>${businessPlace.vendor_business_building_no && businessPlace.vendor_business_building_no.trim() !== "" ? businessPlace.vendor_business_building_no : "-"}</td>
                                                <td>${businessPlace.vendor_business_flat_no && businessPlace.vendor_business_flat_no.trim() !== "" ? businessPlace.vendor_business_flat_no : "-"}</td>
                                                <td>${businessPlace.vendor_business_street_name && businessPlace.vendor_business_street_name.trim() !== "" ? businessPlace.vendor_business_street_name : "-"}</td>
                                            </tr>`;
                            i++;
                        });

                        // Wrap the rows inside the table and accordion-body
                        const output = `
                                        <div class="accordion-body">
                                        <div class="otherBuinessDetails_container">
                                            <table class="">
                        ...
                        // Update the content of collapseOtherAddress
                                ...
                                if (value.status == 'success') {
                                    ...
                                    $.each(responseObj, function(index, val) {
                                        tableBills.row.add([
                                            ...
                                            `${(val.dueDate) ?? "-"}`,
                                            `${(val.grnSubTotal) ?? "-"}`,
                                            `${(val.taxTotal) ?? "-"}`, // Sum of CGST, SGST, IGST
                                            `${val.grnTotalTds ?? "-"}`,
                                            `${(val.grnTotalAmount) ?? "-"}`,
                                            `${(val.paidAmount) ?? "-"}`,
                                            `${(val.dueAmt) ?? "-"}`,
                            ...
                            try {
                                if (value.status == 'success') {
                                    ...
                                    $.each(responseObj, function(index, payment) {
                                        ...
                                        // let paymentType = payment.paymentCollectType ;
                        ...
                        success: function(value) {
                            try {
                                if (value.status == 'success') {
                                    ...
                                    // alert('caught here')
                                    $('#vendorJournal').empty();
                                    let obj = `<tr><td colspan="6"><p class="text-center">No Journals Found</p> </td></tr>  `;
                                    debounceFlagInnerJournals = false;
            ...
            $.ajax({
                ...
                success: function(value) {
                    ...
                    if (value.status == 'success') {
                        ...
                        let obj = `<div class="subject-detail text-center p-2">
            ...
            function statementCheck() {
                const currentDate = new Date();
                const to_date = currentDate.toISOString().split('T')[0]; // Format today's date as YYYY-MM-DD
                const from_date = new Date(currentDate.setMonth(currentDate.getMonth() - 1)).toISOString().split('T')[0]; // 1 month before today
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $(".statement-details").html(` <div class="spinner-border text-dark" role="status">
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            $('#statementSection').html(obj.html);
            ...
            // initial statement call

            //statementCheck();



            $("#nav-statement-tab").click(function() {
                const currentDate = new Date();
                const to_date = currentDate.toISOString().split('T')[0]; // Format today's date as YYYY-MM-DD
                const from_date = new Date(currentDate.setMonth(currentDate.getMonth() - 1)).toISOString().split('T')[0];
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $('#nav-compliance').children().not('.dropdown').remove();


                    $('#nav-compliance').append(`
                                                <div class="load-wrapp" id="globalModalLoader">
                                                    <div class="load-1">
                                                        <div class="line"></div>
                                                        <div class="line"></div>
                                                        <div class="line"></div>
                ...
                success: function(response) {
                                                    ...
                                                    <div class="gst-list gst-one-tab">
                                                        <div class="head">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tbody>`;
                    responseData["EFiledlist"].sort((a, b) => {
                        const dateA = new Date(a.dof.split('-').reverse().join('-'));
                        const dateB = new Date(b.dof.split('-').reverse().join('-'));
                        return dateA - dateB;
                    });
                    ...
                    $("#nav-compliance").append(complianceContentHtml);
...
<script>
    ...
    $(document).on("click", "#sendVerificationMail", function(e) {
        e.preventDefault();

        let id = atob($(this).data('id')); // Decode base64 ID
        let $this = $(this); // Cache the button element

        Swal.fire({
            title: "Confirm Email Sending",
            text: "Are you sure you want to send the verification email?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'GET',
                    data: {
                        act: 'sendVerificationMail',
                        id
                    },
                    url: "ajaxs/modals/vendor/ajax-manage-vendor-modal.php",
                    beforeSend: function() {
                        // Replace button content with loader and "Sending..."
                        $this.html(
                            '<ion-icon name="send-outline"></ion-icon> waiting...'
                        );
                    },
                    success: function(res) {
                        try {
                            ...
                            $this.html(
                                '<ion-icon name="send-outline"></ion-icon> Send Verification Mail'
                            );
                            ...
                            Toast.fire({
                                icon: response.status, // e.g., "success" or "error"
                                title: ' ' + response.message
                            }).then(function() {
                                // $("#serach_submit").click(); // Trigger search refresh
                            });
                        } catch (error) {
                            console.log(error);
                            console.log(res);
                            // Revert even on error to avoid stuck state
                            $this.html(
                                '<ion-icon name="send-outline"></ion-icon> Send Verification Mail'
                            );
                        }

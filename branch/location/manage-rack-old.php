...
if (isset($_POST["createRack"])) {
  ...
  $addNewObj = $warehouseController->createRack($_POST);
  swalToast($addNewObj["status"], $addNewObj["message"]);
}
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-input">
                        ...
                        <textarea type="text" name="rack_desc" class="form-control"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card card-success">
                ...
                <div class="card-header cardHeader">
                  <h4 class="card-title w-100"> <a class="d-block w-100 text-dark" data-toggle="collapse"
                      href="#collapseThree"> Rack Details </a> </h4>
                </div>
                <div id="collapseThree">
                  <div class="card-body">
                    <div class="row">
          ...
          <div class="p-0 pt-1 my-2">
            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
              <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                <h3 class="card-title">Manage Rack</h3>
            ...
            <div class="tab-content" id="custom-tabs-two-tabContent">
              <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                <?php
                  ...
                  $sql_list = queryGet("SELECT * FROM `erp_rack` as rack ," . ERP_STORAGE_LOCATION  . " as sl WHERE 1 AND sl.storage_location_id=rack.storage_location_id AND rack.`company_id`=$company_id AND rack.`branch_id`=$branch_id AND rack.`location_id`=$location_id  ORDER BY rack.rack_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ",true);
                  
                

                  //AND  rack.'warehouse_id'=warehouse.'warehouse_id' 
                  //as sl ,".ERP_WAREHOUSE." as warehouse
                  $countShow = "SELECT COUNT(*) FROM `erp_rack` as rack ," . ERP_STORAGE_LOCATION  . " as sl WHERE 1 AND sl.storage_location_id=rack.storage_location_id AND rack.`company_id`=$company_id AND rack.`branch_id`=$branch_id AND rack.`location_id`=$location_id  ";
                  $countQry = mysqli_query($dbCon, $countShow);
                  $rowCount = mysqli_fetch_array($countQry);
                  $count = $rowCount[0];
                  $cnt = $GLOBALS['start'] + 1;
                  $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_RACK", $_SESSION["logedBranchAdminInfo"]["adminId"]);
                  ...
                  <tbody>
                    <?php
                     ...
                     foreach($sql_list['data'] as $row){
                          ...
                          $sl = $row['storage_location_name'];
                          $desc = $row['rack_description'];
                    ...
                    <tr>
                      ...
                      <td>
                        <a style="cursor: pointer;" class="btn btn-sm" data-toggle="modal"
                          data-target="#fluidModalRightSuccessDemo_<?= $row['rack_id'] ?>"><i
                            class="fa fa-eye po-list-icon"></i></a>
                      </td>
                    </tr>
                    <!-- right modal start here  -->
                    <div class="modal fade right storage-location-modal customer-modal"
                      id="fluidModalRightSuccessDemo_<?= $row['rack_id'] ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                              ...
                              <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link active" id="home-tab" data-toggle="tab"
                                    href="#home_<?= $rack_id ?>" role="tab" aria-controls="home"
                          ...
                          <div class="modal-body" style="padding: 0;">
                            ...
                            <div class="tab-content" id="myTabContent">
                              ...
                              <div class="tab-pane fade show active" id="home_<?= $rack_id ?>" role="tabpanel"
                                ...
                                <div class="row px-3 p-0 m-0" style="place-items: self-start;">
                                  ...
                                  <div class="col-md-6">
                                    <div class="row m-2 py-2 shadow-sm bg-light">
                                      <div class="col-md-6">
                                        <span class="font-weight-bold text-secondary">Rack Name: </span>
                                      </div>
                                      <div class="col-md-6">
                                        <span><?= $rack_name ?></span>
                                      </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="row m-2 py-2 shadow-sm bg-light">
                                      <div class="col-md-6">
                                        <span class="font-weight-bold text-secondary">Rack Code: </span>
                                      </div>
                                      <div class="col-md-6">
                                        <span></span>
                                      </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
                    ...
                    <input type="hidden" name="pageTableName" value="ERP_RACK" />

                        ...
                        <div class="p-0 pt-1 my-2">
                            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                    <h3 class="card-title">Manage Credit Notes</h3>
                                        ...
                                        <div class="row filter-serach-row">
                                            ...
                                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                                    <?php
                                                    $sql_list = "SELECT * FROM `erp_credit_note` WHERE 1 " . $cond . "  AND `branch_id`=$branch_id AND `location_id`=$location_id AND `company_id`=$company_id " . $sts . "  ORDER BY cr_note_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                                    $qry_list = queryGet($sql_list, true);
                                                    $num_list = $qry_list['numRows'];

                                                    //console($qry_list);

                                                    $countShow = "SELECT count(*) FROM `erp_credit_note` WHERE 1 " . $cond . " AND `branch_id`=$branch_id AND `location_id`=$location_id AND `company_id`=$company_id " . $sts . " ";
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        if (in_array(3, $settingsCheckbox)) { ?>
                                                                            ...
                                                                            <td><?= $party_name['data']['trade_name'] . '(' . $data['party_code'] . ')' ?></td>
                                                                        <?php }
                                                                        if (in_array(4, $settingsCheckbox)) { ?>
                                                                        ...
                                                                        <td>
                                                                            <a style="cursor:pointer" data-toggle="modal" data-target="#fluidModalRightSuccessDemo_<?= $data['cr_note_id'] ?>" class="btn btn-sm waves-effect waves-light"><i class="fa fa-eye po-list-icon"></i></a>
                                                                            <!-- <a href="branch-so-invoice.php?pgi-invoice=MTE=" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-download"></i></a> -->

                                                                            <!-- right modal start here  -->
                                                                            <div class="modal fade right pgi-modal customer-modal classic-view-modal" id="fluidModalRightSuccessDemo_<?= $data['cr_note_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-header">
                                                                                            <div class="d-flex justify-content-between">
                                                                                                <!-- <h2 class="text-white mt-2 mb-2 d-flex gap-2"><span class="rupee-symbol">₹</span><?= $data['total'] ?></h2> -->
                                                                                            ...
                                                                                            <div class="display-flex-space-between mt-2 mb-3">
                                                                                                ...
                                                                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                                                                    <li class="nav-item waves-effect waves-light">
                                                                                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home<?= $data['cr_note_id'] ?>" role="tab" aria-controls="home" aria-selected="true">Info</a>
                                                                                                    </li>
                                                                                                    <li class="nav-item">
                                                                                                        <a class="nav-link" id="classic-view-tab" data-toggle="tab" href="#classicViewTab<?= $data['cr_note_id'] ?>" role="tab" aria-controls="classic-view" aria-selected="false">Classic View</a>
                                                                                                    </li>
                                                                                                    <!----------------Audit History Button Start------------------------- -->
                                                                                                    <li class="nav-item waves-effect waves-light">
                                                                                                        <a class="nav-link auditTrail" id="history-tab<?= $data['cr_note_id'] ?>" data-toggle="tab" data-ccode="<?= $data['cr_note_id'] ?>" href="#history<?= $data['cr_note_id'] ?>" role="tab" aria-controls="history" aria-selected="false"><i class="fa fa-history mr-2"></i>Trail</a>
                                                                                                    </li>
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="tab-content pt-0" id="myTabContent">
                                                                                                <div class="tab-pane fade show active" id="home<?= $data['cr_note_id'] ?>" role="tabpanel" aria-labelledby="home-tab">
                                                                                                    <!--------Customer Details--------->
                                                                                                    ...
                                                                                                    <div class="accordion accordion-flush matrix-accordion p-0" id="accordionFlushExample">
                                                                                                        <div class="accordion-item">
                                                                                                            ...
                                                                                                            <div id="itemDetails" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                                                                                                <?php
                                                                                                                $iv_item = queryGet("SELECT * FROM `credit_note_item` AS cr_item, `erp_inventory_items` AS item  WHERE item.itemId=cr_item.item_id AND `credit_note_id` = '" . $data['cr_note_id'] . "'", true);
                                                                                                                // console($iv_item);
                                                                                                ...
                                                                                                <div class="tab-pane fade" id="classicViewTab<?= $data['cr_note_id'] ?>" role="tabpanel" aria-labelledby="profile-tab">
                                                                                                    <a href="classic-view/invoice-preview-print.php?cr_note_id=<?= base64_encode($data['cr_note_id']) ?>" class="btn btn-primary classic-view-btn float-right" target="_blank">Print</a>
                                                                                                    <div class="card classic-view bg-transparent">
                                                                                                        <?php $templateCreditNoteControllerObj->printCreditNotes($data['cr_note_id']) ?>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="tab-pane fade" id="history<?= $data['cr_note_id'] ?>" role="tabpanel" aria-labelledby="history-tab">
                                                                                                    ...
                                                                                                    <hr>
                                                                                                    <div class="audit-body-section mt-2 mb-3 auditTrailBodyContent<?= $data['cr_note_id'] ?>">
...
<script>
    ...
    $(document).on('change', '.item_select', function() {
        ...
        //     $.ajax({
        //         type: "POST",
        //         url: `ajaxs/credit-note/ajax-items-stock-check.php`,
        //         data: {
        //             act: "itemStockCheck",
        //             invoicedate: invoicedate,

...
?>
    <div class="content-wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <input type="text" name="paymentDetails[collectPayment]" class="form-control collectTotalAmt px-3 mr-1 inputAmountClass" placeholder="Enter amount" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <label for="" class="label-hidden"></label>
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="totaldueamount">
                                                <button class="btn btn-success" type="button" id="paytoCustomerBtn">Pay to Customer</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog modal-full-height modal-right modal-notify modal-success" style="max-width: 30%;" role="document">
                        <div class="modal-content">
                            <form id="customerPaymentForm" action="" method="POST">
                                <!-- Modal Header -->
                                <div class="modal-header">
                                    <h5 class="modalHeader"><strong>Payment to Customer</strong></h5>
                                    <div class="row mt-3">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-input totalamount">
                                                <label for="">Transaction Date</label>
                                                <input type="date" name="customer_modal_documentDate" class="form-control" aria-label="Username" aria-describedby="basic-addon1" require>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-input totaldueamount">
                                                <label for="">Posting Date</label>
                                                <input type="date" name="customer_modal_postingDate" class="form-control" min="<?= $min ?>" max="<?= $max ?>" aria-label="Username" aria-describedby="basic-addon1" require>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-input totaloverdue">
                                                <label for="">Transaction Id / Doc. No.</label>
                                                <input type="text" placeholder="Tnx. Id / Doc. No." name="customer_modal_tnxDocNo" class="form-control" aria-label="Username" aria-describedby="basic-addon1" require>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <select name="customer_modal_vendorId" class="select2 form-control" id="selectcustomer2">
                                                    <option value="">Select Customers</option>
                                                    <?php foreach ($getAllCustomersObj['data'] as $customer) { ?>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <label for="" class="label-hidden"></label>
                                                <input type="text" name="customer_modal_collectPayment" class="form-control collectTotalAmt px-3 mr-1 inputAmountClass" placeholder="Enter amount" aria-label="Username" aria-describedby="basic-addon1" require>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <label for="" class="label-hidden"></label>
                                                <?php $fetchCOADetails = get_acc_bank_cash_accounts()['data']; ?>
                                                <select name="customer_modal_bankId" class="form-control mx-1">
                                                    <option value="0">Select Bank</option>
                                                    <?php
                                                    foreach ($fetchCOADetails as $one) {
                                                        $account_no = "";
                                        ...
                                        <div class="row  mt-3">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <button class="btn btn-success customerBtn" type="button" id="submitCollectPaymentCustomerBtn">Pay</button>
                                            </div>
                                        </div>

                                        <div class="row  mt-3">
                                            <p><span class="text-danger">*</span> Confirming the pay button - the user is confirming the processing of the transaction in the nature of payment to a customer.</p>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                        <div class="totalamount">
                                                            <p class="text-xs"> Total Invoice Amount</p>
                                                            <p class="text-xs font-bold rupee-symbol"><?= $companyCurrencyData["currency_name"] ?> <span class="totalInvAmt"><?=decimalValuePreview(0)?></span></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                        <div class="totaldueamount">
                                                            <p class="text-xs">Current Due Amount</p>
                                                            <p class="text-xs font-bold rupee-symbol"><?= $companyCurrencyData["currency_name"] ?> <span class="totalDueAmt"><?=decimalValuePreview(0)?></span></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                        <div class="totaloverdue">
                                                            <p class="text-xs">Overdue Amount</p>
                                                            <p class="text-xs font-bold rupee-symbol"><?= $currency_name ?> <span class="totalOverDueAmt"><?=decimalValuePreview(0)?></span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        require_once("../common/footer.php");
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    $(document).on("keyup", ".collectTotalAmt", function() {
                        ...
                        let collectTotalAmt = ($(".collectTotalAmt").val()) ? ($(".collectTotalAmt").val()) : 0;
                        staticRemain = rem;
                        $(".remaningAmt").text(decimalAmount(rem));
            ...
            <script>
                $(document).on("click", '#paytoCustomerBtn', function() {
                    $('#collectActionModal').modal('show');
                })


                //customer payment btn start

                $(document).on("click", '#submitCollectPaymentCustomerBtn', function() {
                    // Define the fields and their respective error messages
                    const fields = {
                        vendorId: 'Please select a vendor.',
                        collectPayment: 'Please enter a collect payment amount.',
                        bankId: 'Please select a bank.',
                        documentDate: 'Please enter a document date.',
                        postingDate: 'Please enter a posting date.',
                        tnxDocNo: 'Please enter a transaction document number.'
                    };

                    // Reset previous red border (if any)
                    $('input, select').removeClass('error-field');

                    let isValid = true; // Flag to check if all fields are valid

                    // Loop through the fields to validate them
                    for (let field in fields) {
                        let value;
                        let inputElement;

                        // Check for the correct element type (select or input)
                        if (field === 'vendorId' || field === 'bankId') {
                            inputElement = $('select[name="customer_modal_' + field + '"]');
                            value = inputElement.val();
                        } else {
                            inputElement = $('input[name="customer_modal_' + field + '"]');
                            value = inputElement.val();
                        }

                        // If the field is empty, show the specific error and mark the field
                        if (!value) {
                            // Add red border to the field
                            inputElement.addClass('error-field');

                            // Set isValid to false as one or more fields are empty
                            isValid = false;
                        }
                    }

                    // If any field is invalid, show the alert and stop the submission
                    if (!isValid) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Required: All fields must be filled',
                            text: 'Please fill in all the required fields.', // General message for all fields
                        });
                        return; // Stop the execution if validation fails
                    }

                    // If all fields are valid, send the AJAX request
                    let finalData = {
                        paymentDetails: {
                            paymentCollectType: "collect",
                            vendorId: $('select[name="customer_modal_vendorId"]').val(),
                            collectPayment: $('input[name="customer_modal_collectPayment"]').val(),
                            bankId: $('select[name="customer_modal_bankId"]').val(),
                            paymentAdviceImg: "",
                            documentDate: $('input[name="customer_modal_documentDate"]').val(),
                            postingDate: $('input[name="customer_modal_postingDate"]').val(),
                            tnxDocNo: $('input[name="customer_modal_tnxDocNo"]').val(),
                            advancedPayAmt: ""
                        },
                        type: "customer"
                    };
                    ...
                    $.ajax({
                        type: "POST",
                        url: `ajaxs/modals/so/ajax-payment-to-customer.php`,
                        data: finalData,
                        beforeSend: function() {
                            // Optional: Show loading indicator or disable button while processing
                        },
                        success: function(response) {
                ...
                $("#submitCollectPaymentCustomerBtn").prop("disabled", true);

                $(document).on("keyup", ".collectTotalAmt", function() {
                    let recAmt = (parseFloat($(this).val()) > 0) ? parseFloat($(this).val()) : 0;
                    if (recAmt > 0) {
                        $("#submitCollectPaymentCustomerBtn").prop("disabled", false);
                    } else {
                        $("#submitCollectPaymentCustomerBtn").prop("disabled", true);

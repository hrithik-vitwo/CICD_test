                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                value.sl_no,
                                `<a href="#" class="soModal"  data-id="${value.vendorId}" data-code="${value.vendor_code}" data-toggle="modal" data-target="#viewGlobalModal">${value.vendor_code}</a>`,
                                value.trade_name,
                                value.vendor_pan,
                                ...
                                ` <div class="dropout">
                                    ...
                                    <ul>
                                        <li>
                                            <button data-toggle="modal" class="editSobtn" data-id=${value.vendorId} data-code="${value.vendor_code}"><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                        </li>
                                        <li>
                                            <button class="soModal" data-toggle="modal" data-id=${value.vendorId} data-code="${value.vendor_code}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>                             
                                    </ul>
                                </div>`
                            ]).draw(false);

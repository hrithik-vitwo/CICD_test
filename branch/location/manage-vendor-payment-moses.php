...
if (!isset($_COOKIE["cookieVendorPayment"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieVendorPayment", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    } else {
        for ($i = 0; $i < 5; $i++) {
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div id="main2">
                                                                        ...
                                                                        <table class="colomnTable">
                                                                            <?php
                                                                            $cookieTableStockReport = json_decode($_COOKIE["cookieVendorPayment"], true) ?? [];
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == "success") {
                        ...
                        if (!gstr1found) {
                            gstinReturnsDataDivHtml += `<tr><td colspan="4" class="text-center">GSTR1 Status Unavailable</td></tr>`;
                        }
                        ...
                        if (!gstr3bfound) {
                            gstinReturnsDataDivHtml3b += `<tr><td colspan="4" class="text-center">GSTR3B Status Unavailable</td></tr>`
                        }
                        ...
                        let gstinReturnsDataDivHtml = `
                                                    ...
                                                    <tbody><tr><td colspan="4" class="text-center">No Compliance Status Found</td></tr></tbody></table>`;

                        let gstinReturnsDataDivHtml3b = `<table class="table table-striped table-bordered w-100">
                                                    <thead>
                                                    <tr>
                                                        <th>Financial Year</th>
                                                        <th>Tax Period</th>
                        ...
                        $("#gstinReturnsDatacomp_Div").html(gstinReturnsDataDivHtml);
                        $("#gstinReturnsDatacomp3b_Div").html(gstinReturnsDataDivHtml3b);
                        $("#mdl_gstin_span").html(gstin = "XXXXXXXXXX");
...
<script>
    ...
    $(document).ready(function () {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookieVendorPayment');
                ...
                success: function (response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function (index, value) {
                            ...
                            dueAmountOriginal = value['grniv.dueAmt'];
                            ...
                            dataTable.row.add([
                                ...
                                `<p class="text-right"><span class="text-right">${decimalAmount(value['grniv.dueAmt']) || '-'}</span></p>`,
        ...
        $(document).on("click", ".ion-paginationlistnew", function (e) {
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookieVendorPayment')
                },
                // beforeSend:function(){

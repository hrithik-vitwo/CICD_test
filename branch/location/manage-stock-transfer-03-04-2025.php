    ...
    <section class="content">
        ...
        <form action="" method="POST" id="addNewSOForm">
            ...
            <div class="row">
                                    ...
                                    <div class="row info-form-view">
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            ...
                                            <select name="movemenrtypesDropdown" id="movemenrtypesDropdown" class="form-control" required>
                                                ...
                                                <option value="book_to_physical">Direct Consumption Posting (Book to Physical)</option>
                                            </select>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <button type="submit" name="addNewInvoiceFormSubmitBtn" onclick="return confirm('Are you sure to submit?')" id="directInvoiceCreationBtn" class="btn btn-primary items-search-btn float-right">Submit</button>
                    </div>
                </div>
        </form>
    </section>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("change", ".destination_item_class", function() {
            ...
            var uom = $(".destination_item_class").find(':selected').data("uom");
            var uomId = $(".destination_item_class").find(':selected').data("uomid");

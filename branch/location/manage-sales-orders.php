                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            if (value.soStatus == 14) {
                                actions = ` <li>
                                            ...
                                            <li>
                                                <button class="deleteSoBtn" data-toggle="modal"  data-id="${value.so_number}" data-target="#viewModal"><ion-icon name="trash-outline" class="ion-delete"></ion-icon>Delete</button>
                                            </li>`;
                            }
                            dataTable.row.add([
                                value.sl_no,
            ...
            success: function(value) {
                ...
                if (value.status) {
                    ...
                    if (responseObj.dataObj.igst == 0) {
                        ...
                        $("#cgstVal").css("display", "block");
                        $("#sgstVal").css("display", "block");
                        // $("#igstP").hide();
                        // $("#igst").hide();

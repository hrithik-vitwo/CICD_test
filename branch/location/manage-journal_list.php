                ...
                <div class="card-body">
                  <div class="tab-content" id="custom-tabs-two-tabContent">
                    <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                      ...
                      <a href="manage-journal-actions_arpan.php?show=create" class="btn btn-create" type="button">
                        <ion-icon name="add-outline"></ion-icon>
                        Create
                      </a>
        ...
        success: function(response) {
          ...
          if (response.status) {
            ...
            $.each(responseObj, function(index, value) {
              let revBtn = '';
              if (value.reverse_jid == '0' && value.journalEntryReference != "reverseJournal") {
                // console.log(value.del_status);
                revBtn = `
                                    <li>
                                        <button class="reverseJournal" data-id="${value.id}" data-code="${value.jv_no}" ><ion-icon name="repeat-outline"></ion-icon>Reverse</button>
                                    </li>`;
              }
    ...
    $(document).ready(function() {
      $(document).on("click", "#serach_submit", function(event) {
        ...
        $(".selectOperator").each(function() {
          ...
          if ((columnSlag === 'delivery_date' || columnSlag === 'so_date' || columnSlag === 'created_at' || columnSlag === 'postingDate') && operatorName == "BETWEEN") {

              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT items.itemCode,items.itemName,bom.preparedDate,bom.cogm,bom.cogs,bom.msp,bom.createdAt,bom.createdBy,bom.updatedAt,bom.updatedBy FROM erp_bom AS bom INNER JOIN erp_inventory_items AS items ON bom.itemId=items.itemId WHERE bom.companyId=$company_id AND bom.branchId=$branch_id AND bom.locationId=$location_id ORDER BY bom.preparedDate desc;";

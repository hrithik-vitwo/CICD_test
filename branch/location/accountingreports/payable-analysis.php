...
< <link rel="stylesheet" href="../../../public/assets/new_listing.css">
                            ...
                            <div class="card card-tabs reports-card">
                                <div class="p-0 pt-1 my-2 pb-2" style="border-bottom: 1px solid #dbe5ee;">
                                    ...
                                    <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                        ...
                                        <li class="pt-0 pt-md-0 px-md-3 d-flex justify-content-between align-items-center" style="width:100%">
                                                            ...
                                                            <div class="fy-custom-section">
                                                                <div class="fy-dropdown-section">
                                                                    ...
                                                                    if (isset($_POST['from_date'])) {
                                                                        ...
                                                                        $f_date =  $f_date = date('Y-m-d', strtotime('-7 day'));
                                                                        $to_date = date('Y-m-d');
                                ...
                                <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            // $sql_list = "SELECT vendorId,vendorName,DATEDIFF(dueDate,CURDATE())AS due_days,COUNT(*) AS count_,SUM(dueAmt) AS total_due_amount FROM erp_grninvoice AS iv WHERE companyId=$company_id AND branchId=$branch_id AND locationId=$location_id AND postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND dueAmt!=0 AND dueDate>CURDATE() GROUP BY vendorId,vendorName,due_days ORDER BY due_days,vendorName,total_due_amount desc;";
                                            ...
                                            if (isset($_GET['toDate'])) {
                                                ...
                                                vendorId,
                                                vendorName,
                                                GREATEST(DATEDIFF(CURDATE(), dueDate), 0) AS due_days,
                                                COUNT(*) AS count_,
                                                SUM(dueAmt) AS total_due_amount
                                            FROM
                                                erp_grninvoice AS iv
                                            WHERE
                                                companyId = $company_id
                                                AND branchId = $branch_id
                                                AND locationId = $location_id
                                                AND postingDate <= '" . $to_date . "'
                                                AND dueAmt != 0
                                            GROUP BY
                                                vendorId, vendorName, due_days
                                            ORDER BY
                                                due_days, vendorName, total_due_amount DESC;
                                            ";
                                            } else {
                                                $sql_list = "SELECT vendorId,vendorName,GREATEST(DATEDIFF(CURDATE(), dueDate), 0) AS due_days,COUNT(*) AS count_,SUM(dueAmt) AS total_due_amount FROM erp_grninvoice AS iv WHERE companyId=$company_id AND branchId=$branch_id AND locationId=$location_id AND postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND dueAmt!=0 GROUP BY vendorId,vendorName,due_days ORDER BY due_days,vendorName,total_due_amount desc;";
                                            }
                                                ...
                                                <table id="dataTable" class="table table-hover transactional-book-table" style="width: 100%; position: relative;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($array['making'] as $key => $data) {
                                                            ...
                                                            $overdue_sql = queryGet("SELECT SUM(dueAmt) AS total_due_amount FROM erp_grninvoice WHERE companyId = $company_id AND branchId=$branch_id AND locationId=$location_id AND vendorId=$vendor_id AND postingDate BETWEEN '2022-04-01' AND '2023-03-31' AND dueAmt!=0 AND dueDate < CURRENT_DATE;");
                                                            //console($overdue_sql);
                                                            ...
                                                            <tr>
                                                                ...
                                                                if (in_array($i, $settingsCheckbox)) {
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <td class="text-right"> <a href="<?= $_SERVER['PHP_SELF']; ?>?detailed-view-single&id=<?= $vendor_id ?>&toDate=<?= $to_date ?>" target="_blank"> <?php echo $total_sum; ?></a></td>

                                                                    <?php
                                                                    } else { ?>
                                                                        <td class="text-right"> <a href="<?= $_SERVER['PHP_SELF']; ?>?detailed-view-single&id=<?= $vendor_id ?>" target="_blank"> <?php echo $total_sum; ?></a></td>
                                                                <?php }
                                                                }
                                                                ?>
                                                            </tr>
                            ...
                            <div class="card card-tabs reports-card">
                                                            ...
                                                            <div class="fy-custom-section">
                                                                <div class="fy-dropdown-section">
                                                                    ...
                                                                    if (isset($_POST['from_date'])) {
                                                                        ...
                                                                        $start = explode('-', $variant_sql['data'][0]['year_start']);
                                                                        $end = explode('-', $variant_sql['data'][0]['year_end']);
                                                                        $f_date = date('Y-m-d', strtotime('-7 day'));
                                                                        $to_date = date('Y-m-d');
                                                                        $_POST['from_date'] = $f_date;
                                                                        $_POST['to_date'] = $to_date;
                                                                        $_POST['drop_val'] = 'fYDropdown';
                                ...
                                <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            if (isset($_GET['toDate'])) {
                                                $to_date = $_GET['toDate'];
                                                $cond = " AND vg.vendorDocumentDate <= '" . $to_date . "'";
                                            } else {
                                                $cond = " AND vg.vendorDocumentDate BETWEEN  '" . $f_date . "' AND '" . $to_date . "'";
                                            }

                                            $sql_list = "SELECT
                                            vg.vendorCode,
                                            vg.vendorName,
                                            vg.vendorDocumentDate AS invoice_date,
                                            vg.vendorDocumentNo AS invoice_num,
                                            vg.ivPostingJournalId,
                                            aj.jv_no,
                                            vg.postingDate AS posting_date,
                                            vg.grnIvCode AS posting_doc_num,
                                            vg.grnSubTotal AS base_amount,
                                            vg.grnTotalCgst AS cgst,
                                            vg.grnTotalSgst AS sgst,
                                            vg.grnTotalIgst AS igst,
                                            vg.taxComponents AS tax,
                                            vg.grnTotalAmount AS invoice_amount,
                                            vg.dueAmt,
                                            vg.dueDate,
                                            vg.grnCreatedAt AS created_at,
                                            vg.grnCreatedBy AS created_by,
                                            vg.grnUpdatedAt AS updated_at,
                                            vg.grnUpdatedBy AS updated_by
                                        FROM
                                            erp_grninvoice vg
                                        LEFT JOIN
                                            erp_acc_journal aj ON vg.ivPostingJournalId = aj.id
                                        WHERE
                                            vg.companyId = $company_id
                                            AND vg.branchId = $branch_id
                                            AND vg.locationId = $location_id
                                            AND vg.dueAmt != 0
                                           " . $cond . "
                                        ORDER BY
                                            vg.vendorDocumentDate DESC;";
                                                    ...
                                                    <tbody class="">
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                $i++;
                                                                if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                                                    <td class="text-right"><?php echo ($data['dueAmt']);  ?></td>
                                                                <?php }
                                                                $i++;
                                                                if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                              ...
                              foreach ($taxName as $row) {
                                ...
                                foreach ($taxSplit['tax'] as $tax) {?>
                                  <tr>
                                  <td valign="top" style="width: 165px"><input type="checkbox" <?php $p++;
                                                                                                echo (in_array($p, $settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox_concised_view1" value="<?php echo $p; ?>" />
                                ...
                                <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        ...
                                        WHERE
                                            ...
                                            AND vg.dueAmt != 0
                                            AND vg.vendorId = $id
                                            AND vg.vendorDocumentDate <= '" . $to_date . "'
                                        ORDER BY
                                            vg.vendorDocumentDate DESC;
                                        ";
                                                    ...
                                                    <tbody class="">
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                $i++;
                                                                if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                                                    <td> <?php if ($iv_type == 'grn') { ?> <a href="../manage-grn.php?type=grn&view=<?= $grnId ?>" target="_blank"><?= $data['posting_doc_num'] ?></a> <?php  } else { ?> <a href="../manage-grn.php?type=srn&view=<?= $grnId ?>" target="_blank"> <?= $data['posting_doc_num'] ?></a> <?php  } ?> </td>
                                                                <?php }
                                                                $i++;
                                                                if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                                                    <td><?php echo $data['vendorCode']; ?></td>
    ...
    <script>
        ...
        am4core.ready(function() {
            ...
            // Process data
            let finalData = processData(chartData.data);

            // Create Column Chart
            createColumnChart(finalData);
        ...
        function createColumnChart(data) {
            // Create chart instance for Column Chart
            var columnChart = am4core.create("chartDivColumn", am4charts.XYChart);
            columnChart.logo.disabled = true;

            // Configure Column Chart
            columnChart.data = data;
            var categoryAxisColumn = columnChart.yAxes.push(new am4charts.CategoryAxis());
            categoryAxisColumn.dataFields.category = "category";
            categoryAxisColumn.renderer.grid.template.location = 0;
            categoryAxisColumn.renderer.inversed = true;
            ...
            columnSeriesColumn.dataFields.valueX = "value";
            columnSeriesColumn.dataFields.categoryY = "category";
        ...
        function createPieChart(data) {
            ...
            var pieChart = am4core.create("chartDivPie", am4charts.PieChart3D);

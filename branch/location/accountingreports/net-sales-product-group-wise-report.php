...
if (!isset($_COOKIE["cookieManageNetSalesProductGroupWise"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieManageNetSalesProductGroupWise", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
...
$columnMapping = [
    ...
    [
        'name' => 'Item Group',
        'slag' => 'subquery.itemGroup',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Item Quantity',
        'slag' => 'subquery.quantity',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Base Amount',
        'slag' => 'subquery.base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
    ...
    [
        'name' => 'Total Amount',
        'slag' => 'subquery.total_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note Base Amount',
        'slag' => 'subquery.cn_base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note CGST',
        'slag' => 'subquery.cn_cgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note SGST',
        'slag' => 'subquery.cn_sgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note IGST',
        'slag' => 'subquery.cn_igst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note Amount',
        'slag' => 'subquery.credit_note_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note Base Amount',
        'slag' => 'subquery.dn_base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note CGST',
        'slag' => 'subquery.dn_cgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note SGST',
        'slag' => 'subquery.dn_sgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note IGST',
        'slag' => 'subquery.dn_igst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note Amount',
        'slag' => 'subquery.debit_note_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Net Sales Amount',
        'slag' => 'subquery.net_sales_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ]
];
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Net Sales Product Group Wise Report </h3>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookieManageNetSalesProductGroupWise');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "../ajaxs/newreportlist/ajax-net-sales-product-group-wise-report.php",
                dataType: 'json',
                data: {
                    act: 'pgdata',
                    comid: comid,
        ...
        $(document).on("click", "#check-box-submt", function(event) {
            ...
            if (settingsCheckbox.length < 5) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        act: 'manageNetSalesReportProductGroupWise',
                        fromData: fromData
                    },
                    success: function(response) {
                        // console.log(response);

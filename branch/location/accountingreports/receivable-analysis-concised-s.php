...
if (!isset($_COOKIE["cookieReceivableAnalysisConcised"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieReceivableAnalysisConcised", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}

$asOnDate = isset($_POST['asOnDate']) ? $_POST['asOnDate'] : date('Y-m-d');
...
$columnMapping = [
    ...
    [
        'name' => '0-30 Days Due',
        'slag' => 'zero_thirty_days_due',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '31-60 Days Due',
        'slag' => 'thirtyone_sixty_days_due',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '61-90 Days Due',
        'slag' => 'sixtyone_ninety_days_due',
        'icon' => '<ion-icon name="code-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '91-180 Days Due',
        'slag' => 'ninetyone_oneeighty_days_due',
        'icon' => '<ion-icon name="cloud-circle-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'More Than 180 Days Due',
        'slag' => 'more_than_oneeighty_days_due',
        'icon' => '<ion-icon name="albums-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Total Onaccount',
        'slag' => 'total_onaccount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '0-30 Days Onaccount',
        'slag' => 'zero_thirty_days_onaccount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '31-60 Days Onaccount',
        'slag' => 'thirtyone_sixty_days_onaccount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '61-90 Days Onaccount',
        'slag' => 'sixtyone_ninety_days_onaccount',
        'icon' => '<ion-icon name="code-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => '91-180 Days Onaccount',
        'slag' => 'ninetyone_oneeighty_days_onaccount',
        'icon' => '<ion-icon name="cloud-circle-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'More Than 180 Days Onaccount',
        'slag' => 'more_than_oneeighty_days_onaccount',
        'icon' => '<ion-icon name="albums-outline"></ion-icon>',
        'dataType' => 'number'
    ],
];
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Receivable Analysis - Concised View </h3>
                                            </div>
                                        </div>
                                                ...
                                                <form name="asondate" method="post">
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="form-inline gap-2">
                                                            ...
                                                            <input class="form-control" type="date" name="asOnDate" id="asOnDate" value="<?=$asOnDate?>">
                                                        </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title text-sm">Deialed View Column Settings</h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        <form name="table_settings_detailed_view" method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                                                            <div class="modal-body" style="max-height: 450px;">
                                                                <!-- <h4 class="modal-title">Deialed View Column Settings</h4> -->
                                                                                ...
                                                                                <td>
                                                                                    <select class="form-control selectOperator" id="selectOperator_<?= $columnIndex ?>" name="operator[]" val="">
                                                                                        ...
                                                                                        ?>
                                                                                            ...
                                                                                            $operator = array_slice($operators, 3, 15);
                                                                                            foreach ($operator as $oper) {
                                                                                            ?>
                                                                                                <option value="<?= $oper ?>"><?= $oper ?></option>
                                                                                                <?php
...
let data;
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookieReceivableAnalysisConcised');
            ...
            $.ajax({
                type: "POST",
                url: "../ajaxs/newreportlist/ajax-receivable-analysis-concised.php",
                dataType: 'json',
                data: {
                    act: 'cdata',
                    comid: comid,
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                value.net_due,
                                value.total_due,
                                value.zero_thirty_days_due,
                                value.thirtyone_sixty_days_due,
                                value.sixtyone_ninety_days_due,
                                value.ninetyone_oneeighty_days_due,
                                value.more_than_oneeighty_days_due,
                                value.total_onaccount,
                                value.zero_thirty_days_onaccount,
                                value.thirtyone_sixty_days_onaccount,
                                value.sixtyone_ninety_days_onaccount,
                                value.ninetyone_oneeighty_days_onaccount,
                                value.more_than_oneeighty_days_onaccount,
        ...
        $(document).on("click", ".ion-paginationliststock", function(e) {
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookieReceivableAnalysisConcised')
                },
                beforeSend: function() {
                    $('#loaderModal').show();
        ...
        $(document).ready(function() {
            $(document).on("click", "#serach_submit", function(event) {
                ...
                $(".selectOperator").each(function() {
                    ...
                    let value1 = $(`#value1_${columnIndex}`).val() ?? "";
...
<script>
    $(document).ready(function() {
        $(document).on("change", ".selectOperator", function() {
            ...
            if ((columnName === 'Document Date' || columnName === 'SO Date' || columnName === 'Created Date') && operatorName === 'BETWEEN') {

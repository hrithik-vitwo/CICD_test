...
$columnMapping = [
    ...
    [
        'name' => 'Base Amount',
        'slag' => 'grn.grnSubTotal',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'CGST',
        'slag' => 'grn.grnTotalCgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'SGST',
        'slag' => 'grn.grnTotalSgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'IGST',
        'slag' => 'grn.grnTotalIgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Total Amount',
        'slag' => 'grn.grnTotalAmount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
];
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Payble Analysis Detailed View</h3>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            $.ajax({
                type: "POST",
                url: "../ajaxs/newreportlist/ajax-payble-analysis-detailed.php",
                dataType: 'json',
                data: {
                    act: 'tdata',
                    comid: comid,

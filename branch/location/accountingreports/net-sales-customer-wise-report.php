...
if (!isset($_COOKIE["cookieManageNetSalesCustomerWise"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieManageNetSalesCustomerWise", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
...
$columnMapping = [
    ...
    [
        'name' => 'Customer Name',
        'slag' => 'customer.trade_name',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Base Amount',
        'slag' => 'invoice.base_amt',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
    ...
    [
        'name' => 'Total Amount',
        'slag' => 'invoice.total_amt',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note Base Amount',
        'slag' => 'cn_base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note CGST',
        'slag' => 'credit_notes.cgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note SGST',
        'slag' => 'credit_notes.sgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note IGST',
        'slag' => 'credit_notes.igst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Credit Note Amount',
        'slag' => 'credit_notes.amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note Base Amount',
        'slag' => 'dn_base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note CGST',
        'slag' => 'debit_notes.cgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note SGST',
        'slag' => 'debit_notes.sgst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note IGST',
        'slag' => 'debit_notes.igst',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Debit Note Amount',
        'slag' => 'debit_notes.dn_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Net Sales Amount',
        'slag' => 'net_sales_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Created By',
        'slag' => 'customer.customer_created_by',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Created At',
        'slag' => 'customer.customer_created_at',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'date'
    ],
    [
        'name' => 'Updated By',
        'slag' => 'customer.customer_updated_by',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Updated At',
        'slag' => 'customer.customer_updated_at',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'date'
    ]
];
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Net Sales Customer Wise Report </h3>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookieManageNetSalesCustomerWise');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "../ajaxs/newreportlist/ajax-net-sales-customer-wise-report.php",
                dataType: 'json',
                data: {
                    act: 'cdata',
                    comid: comid,
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                `<p class="text-right">${decimalAmount(value.total_amount)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cn_base_amount)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cn_cgst)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cn_sgst)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cn_igst)}</p>`,
                                `<p class="text-right">${decimalAmount(value.credit_note_amount)}</p>`,
                                `<p class="text-right">${decimalAmount(value.dn_base_amount)}</p>`,
                                `<p class="text-right">${decimalAmount(value.dn_cgst)}</p>`,
                                `<p class="text-right">${decimalAmount(value.dn_sgst)}</p>`,
                                `<p class="text-right">${decimalAmount(value.dn_igst)}</p>`,
                                `<p class="text-right">${decimalAmount(value.debit_note_amount)}</p>`,
                                `<p class="text-right">${decimalAmount(value.net_sales_amount)}</p>`,
                                value.created_by,
        ...
        $(document).on("click", "#check-box-submt", function(event) {
            ...
            if (settingsCheckbox.length < 5) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        act: 'manageNetSalesReportCustomerWise',
                        fromData: fromData
                    },
                    success: function(response) {
                        // console.log(response);

              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                    ...
                    $sql_list = "SELECT func.functionalities_name,invoices.grnIvCode,invoices.vendorCode,invoices.vendorName,invoices.postingDate,invoices.grnSubTotal,invoices.grnTotalCgst,invoices.grnTotalSgst,invoices.grnTotalIgst,invoices.grnTotalTds,invoices.grnTotalAmount AS total_amount FROM erp_grninvoice AS invoices LEFT JOIN erp_company_functionalities AS func ON invoices.functionalAreaId=func.functionalities_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.locationId=$location_id AND invoices.grnStatus='active' AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' ORDER BY invoices.postingDate DESC;";
              ...
              <div class="card card-tabs reports-card">
                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab"
                    ...
                    $sql_list = "SELECT func.functionalities_name,SUM(invoices.grnTotalAmount) AS total_amount FROM erp_grninvoice AS invoices LEFT JOIN erp_company_functionalities AS func ON invoices.functionalAreaId=func.functionalities_id WHERE invoices.companyId=$company_id AND invoices.branchId=$branch_id AND invoices.locationId=$location_id AND invoices.grnStatus='active' AND invoices.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' GROUP BY func.functionalities_name;";

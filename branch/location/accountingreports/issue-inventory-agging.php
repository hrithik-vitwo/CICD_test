                                ...
                                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                    <li class="pt-2 pt-md-0 px-md-3 d-flex justify-content-between align-items-center" style="width:100%">
                                        <div class="label-select">
                                            <h3 class="card-title">Inventory Aging by Issue Date</h3>
                                        </div>
                                                                ...
                                                                <form method="POST" action="" class="custom-Range" id="date_form" name="date_form">
                                                                    ...
                                                                    <div class="date-range-input d-flex">
                                                                        <div class="form-input" style="width: 100% !important">
                                                                            <input type="date" class="form-control" style="width: 100% !important" name="ason_date" id="ason_date" value="<?= $_POST['ason_date']; ?>" required>
                                                                        </div>
                                                                    </div>
...
<script>
    ...
    am4core.ready(function() {
        ...
        // Add data
        // chart.data = masterColumnChartData['0 to 30 Days'];
        ...
        categoryAxis.renderer.minGridDistance = 20; // Increase the grid distance for better readability

                        ...
                        <div class="card card-tabs reports-card">
                            <div class="p-0 pb-2" style="border-bottom: 1px solid #dbe5ee;">
                                ...
                                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                    <li class="pt-2 pt-md-0 px-md-3 d-flex justify-content-between align-items-center" style="width:100%">
                                        <div class="label-select">
                                            <h3 class="card-title ">Inventory Aging by Received Date</h3>
                                        </div>
                                                            ...
                                                            <div class="customrange-section">
                                                                ...
                                                                <form method="POST" action="" class="custom-Range" id="date_form" name="date_form">
                                                                    ...
                                                                    <div class="date-range-input d-flex">
                                                                        <div class="form-input" style="width: 100% !important">
                            ...
                            <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                ...
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                        ...
                                        //     SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END) AS `0-30_days_total_qty`,
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) THEN LOG.itemQty ELSE 0 END) AS `31-60_days_total_qty`,
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) THEN LOG.itemQty ELSE 0 END) AS `61-90_days_total_qty`,
                                        //     SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) THEN LOG.itemQty ELSE 0 END) AS `91-180_days_total_qty`,
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END) AS `more_than_180_days_total_qty`,

                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END) +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) THEN LOG.itemQty ELSE 0 END) +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) THEN LOG.itemQty ELSE 0 END) +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) THEN LOG.itemQty ELSE 0 END) +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END) AS `total_qty`,

                                        //     SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice AS `0-30_days_total_value`,
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice AS `31-60_days_total_value`,
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice AS `61-90_days_total_value`,
                                        //     SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice AS `91-180_days_total_value`,
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice AS `more_than_180_days_total_value`,

                                        //     SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice +
                                        //     SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice +
                                        //         SUM(CASE WHEN LOG.refActivityName IN ('GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN') AND DATE(LOG.postingDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END) * summary.movingWeightedPrice AS `total_value`
                                        ...
                                        // Query Updated At 26-04-2024

                                        // $sql_list = "SELECT item.itemCode AS item_code, item.itemName AS item_name, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) AS `0-30_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) AS `31-60_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) AS `61-90_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) AS `91-180_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) AS `more_than_180_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) AS `total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `0-30_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `31-60_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `61-90_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `91-180_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `more_than_180_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `total_value` FROM erp_inventory_stocks_log AS LOG LEFT JOIN erp_inventory_items AS item ON LOG.itemId = item.itemId LEFT JOIN erp_inventory_stocks_summary AS summary ON item.itemId = summary.itemId WHERE summary.company_id = $company_id AND summary.branch_id = $branch_id AND summary.location_id = $location_id GROUP BY LOG.itemId, item.itemCode, item.itemName, summary.movingWeightedPrice";
                                        $sql_list="SELECT item.itemCode AS item_code, item.itemName AS item_name, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) AS `0-30_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) AS `31-60_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) AS `61-90_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) AS `91-180_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) AS `more_than_180_days_total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) AS `total_qty`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `0-30_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `31-60_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `61-90_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `91-180_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `more_than_180_days_total_value`, SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 30 DAY) AND '" . $ason_date . "' THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 60 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 31 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 90 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 61 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) BETWEEN DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) AND DATE_SUB('" . $ason_date . "', INTERVAL 91 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice + SUM( CASE WHEN LOG.refActivityName IN( 'GRN', 'REV-GRN', 'MIGRATION', 'MAT-MAT-IN', 'PROD-IN', 'PROD', 'BOOK-PHYSICAL', 'CONSUMPTION(BOOK-PHYSICAL)' ) AND LOG.itemQty > 0 AND DATE(LOG.bornDate) < DATE_SUB('" . $ason_date . "', INTERVAL 180 DAY) THEN LOG.itemQty ELSE 0 END ) * summary.movingWeightedPrice AS `total_value` FROM erp_inventory_stocks_log AS LOG LEFT JOIN erp_inventory_items AS item ON LOG.itemId = item.itemId LEFT JOIN erp_inventory_stocks_summary AS summary ON item.itemId = summary.itemId WHERE summary.company_id = $company_id AND summary.branch_id = $branch_id AND summary.location_id = $location_id GROUP BY LOG.itemId, item.itemCode, item.itemName, summary.movingWeightedPrice";
                                        // echo $ason_date;
                                        $queryset = queryGet($sql_list, true);
                                        // console($queryset['sql']);
                                            ...
                                            <table id="dataTable" class="table table-hover transactional-book-table" style="width: 100%; position: relative;">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Quantity <br /> 0-30 days</th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Quantity <br /> 31-60 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Quantity <br /> 61-90 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Quantity <br /> 91-180 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Quantity <br /> above 180 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Value <br />0-30 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Value <br />31-60 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Value <br />61-90 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Value <br />91-180 days </th>
                                                        <?php }
                                                        $i++;
                                                        if (in_array($i, $settingsCheckbox)) { ?>
                                                            <th>Value <br />above 180 days </th>
                                                        <?php }
                                                        ?>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td><?php echo round($data['total_qty']);  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                            ...
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td><?php echo round($data['0-30_days_total_qty']);  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td><?php echo round($data['31-60_days_total_qty']);  ?></td>
                                                            <?php }

                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td><?php echo round($data['61-90_days_total_qty']);  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td><?php echo round($data['91-180_days_total_qty']);  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td><?php echo round($data['more_than_180_days_total_qty']);  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                            ...
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td class="text-right"><?php echo  number_format($data['91-180_days_total_value'], 2, '.', '');  ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
...
<!-- CHART FUNCTION -->
<script>
    var masterColumnChartData = <?php echo $chartData; ?>;
    let masterPieChartData = <?php echo $pieData ?>;
    // console.log(masterColumnChartData);
    // console.log(masterPieChartData);

    //  console.log(masterColumnChartData);
    function sortChartDataByItemValue(chartData) {
        // Iterate through each time period (e.g., "0 to 30 Days", "31 to 60 Days", etc.)
        for (const period in chartData) {
            if (chartData.hasOwnProperty(period)) {
                // Sort the array of items for each time period based on itemValue in descending order
                chartData[period].sort((a, b) => parseFloat(b.itemValue) - parseFloat(a.itemValue));
            }
        }
    }

    // Call the function with your chart data
    sortChartDataByItemValue(masterColumnChartData);
    am4core.ready(function() {
        ...
        let selectedData;
        for (let i = 0; i < masterPieChartData.length; i++) {
            if (masterPieChartData[i].totalValue > 0) {
                selectedData = masterPieChartData[i].period;
                break;
            }
        }


        chart.data = masterColumnChartData[selectedData];
        // console.log("cartData: ", chart.data);
        // Create axes
        var categoryAxis = chart.yAxes.push(new am4charts.CategoryAxis());
        categoryAxis.dataFields.category = 'itemName';
        categoryAxis.renderer.grid.template.location = 0;
        categoryAxis.renderer.inversed = true; // Invert the axis to make it horizontal
        categoryAxis.renderer.minGridDistance = 20;
        categoryAxis.renderer.labels.template.wrap = true; // Enable word wrapping
        // Create scrollbarY with proper syntax
        ...
        series.dataFields.valueX = 'itemValue'; // Use valueX instead of valueY
        series.dataFields.categoryY = 'itemName'; // Use categoryY instead of categoryX
        ...
        pieChart.data = masterPieChartData;
        ...
        series.events.on("datavalidated", function() {
            series.dataItems.each(function(dataItem) {
                // console.log("Item Name: :", dataItem.dataContext.itemName, "Value:", dataItem.dataContext.itemValue);
            });
        });

        pieSeries.slices.template.events.on("toggled", function(ev) {
            if (ev && ev.target && ev.target.dataItem) {
                var categoryName = ev.target.dataItem.category;
                // console.log("Toggled category:", categoryName);
                chart.data = masterColumnChartData[categoryName];
            }
        });

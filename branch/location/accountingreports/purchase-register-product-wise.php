                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-3 pt-md-0 px-md-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <div class="label-select">
                      <h3 class="card-title mb-0">Purchase Register Product Wise</h3>
                    </div>
                      ...
                      <table id="dataTable" class="table table-hover transactional-book-table" style="width: 100%; position: relative;">
                        ...
                        <tbody>
                          ...
                          foreach ($datas as $data) {
                            ...
                            // console($data);
                            $sl++;
                            $qty = ($data['total_received_qty'] != 0) ? ($data['total_received_qty']) : 1;
                            $unitPrice = $data['unitPrice'];
                            $basicAmout = $qty * $data['unitPrice'];
                            $totalGst = $data['cgst'] + $data['sgst'] + $data['igst'];
                            $subtotal = $basicAmout;
                            $tds = $data['tds'] ?? 0;
                            $totalTDS = $subtotal * $tds / 100;
                          ?>
                            <tr>
                              <?php if (in_array($i, $settingsCheckbox)) { ?>
                                <td> <?php echo  $sl; ?></td>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td> <?php echo $data['total_ordered_qty']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td> <?php echo $data['total_received_qty']; ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td class="text-right"><?php echo ($basicAmout);  ?> </td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td class="text-right"><?php echo ($totalGst);  ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td class="text-right"><?php echo ($totalTDS);  ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
                        ...
                        <tbody class="">
                          ...
                          ?>
                            <tr>
                              ...
                              $i++;
                              if (in_array($i, $settingsCheckbox_concised_view)) { ?>
                                <td class="text-right"><?php echo round($data['total_amount'], 2);  ?></td>
                              <?php } ?>
                            </tr>
                          <?php
                          }
                ...
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                  ...
                  ?>
                    ...
                    <div class="container-fluid mt-10">
                      <div class="row">
                        <div class="col-md-12 col-sm-12 d-flex p-0 p-md-3">
...
<script>
  ...
  am4core.ready(function() {
    ...
    for (elem of chartData.data) {
      finalData.push({
        "label": elem.item_group,
        "uom": elem.uom,
        "total_received_qty": Number(elem.total_received_qty),

...
$columnMapping = [
    ...
    [
        'name' => 'Customer Authorised Person Name',
        'slag' => 'base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Customer Authorised Person Email',
        'slag' => 'base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Customer Authorised Person alternative Email',
        'slag' => 'base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Customer Authorised Person Phone',
        'slag' => 'base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Customer Authorised Person Alternative Phone',
        'slag' => 'base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
    [
        'name' => 'Customer Authorised Person Designation',
        'slag' => 'base_amount',
        'icon' => '<ion-icon name="document-outline"></ion-icon>',
        'dataType' => 'string'
    ],
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Net Sales Report</h3>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            $.ajax({
                type: "POST",
                url: "../ajaxs/newreportlist/ajax-net-sales-concised-report.php",
                dataType: 'json',
                data: {
                    act: 'tdata',
                    comid: comid,
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                value.customer_authorised_person_designation,
                                value.customer_discount_group,
                                value.customer_mrp_group,
                                ...
                                value.updated_by,
                                value.customer_active_flag,
                                value.invoice_count,
                                value.mail_send_status,
                                value.credit_note_count,
                                value.totalPrice,          
                                // `<p>hs</p>`,
                            ]).draw(false);

                    ...
                    <div class="card card-tabs reports-card">
                        <div class="p-0 pt-1 my-2 pb-2" style="border-bottom: 1px solid #dbe5ee;">
                            ...
                            <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                ...
                                <li class="pt-2 px-3 d-flex flex-wrap justify-content-between align-items-center" style="width:100%">

                                    <div class="label-select">
                                        <h3 class="card-title mb-0">Inventory Ageing (Received Date Wise)</h3>
                                    </div>
                        ...
                        <div class="card card-tabs mb-0" style="border-radius: 20px;">
                            ...
                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                    ...
                                    $settingsTable = getTableSettings(TBL_BRANCH_ADMIN_TABLESETTINGS, "ERP_REPORT_INVENTORY_BORN_DATE_VIEW" . $pageName, $_SESSION["logedBranchAdminInfo"]["adminId"]);
                                            ...
                                            <tbody>
                                               ...
                                               // console($datas[0]);
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?= $sl ?></td>
                                                    <?php if (in_array($a, $settingsCheckbox)) { ?>
                                                        <td> <?php echo  $data['itemName'] . '(' . $data['itemCode']  . ')'; ?></td>
                                                        <?php }
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['logRef']; ?></td>
                                                        <?php }
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['opening_quantity']; ?></td>
                                                        ...
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['in_quantity']; ?></td>


                                                        <?php }
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['in_balance']; ?></td>

                                                        <?php }
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['out_quantity']; ?></td>

                                                        <?php }
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['out_balance']; ?></td>

                                                        <?php }
                                                        $a++;
                                                        if (in_array($a, $settingsCheckbox)) { ?>
                                                            <td><?php echo $data['closing_quantity']; ?></td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="table-settings" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onsubmit="return table_settings();">
                                            <div class="modal-body" style="max-height: 450px;">
                                                ...
                                                <input type="hidden" name="pageTableName" value="ERP_REPORT_INVENTORY_BORN_DATE_VIEW<?= $pageName ?>" />

                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-3 pt-md-0 px-md-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <div class="label-select">
                      <h3 class="card-title mb-0">Purchase Register Vendor Wise</h3>
                    </div>
                            ...
                            <div class="fy-custom-section">
                              <div class="fy-dropdown-section">
                                ...
                                if (isset($_POST['from_date'])) {
                                  ...
                                  $f_date = date('Y-m-d', strtotime('-7 day')); // Today's date
                                  $to_date = date('Y-m-d', strtotime('+1 day')); // Tomorrow's date
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              if (in_array($i, $settingsCheckbox)) { ?>
                                <td><?php echo formatDateORDateTime($data['updated_by']);  ?></td>
                              <?php }
                              $i++;
                              if (in_array($i, $settingsCheckbox)) { ?>
              ...
              <div class="card card-tabs mb-0" style="border-radius: 20px;">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                    ...
                    $sql_list = "SELECT grn.vendorCode AS vendor_code,grn.vendorName AS vendor_name,SUM(grn.grnSubTotal) AS total_base_amount,SUM(grn.grnTotalCgst) AS total_cgst,SUM(grn.grnTotalSgst) AS total_sgst,SUM(grn.grnTotalIgst) AS total_igst,SUM(grn.grnTotalTds) AS total_tds,SUM(grn.grnTotalAmount) AS total_amount,SUM(grn.dueAmt) AS total_due_amount FROM erp_grninvoice AS grn WHERE grn.companyId=$company_id AND grn.branchId=$branch_id AND grn.locationId=$location_id AND grn.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND grn.grnStatus='active' GROUP BY vendor_code,vendor_name;";
            ...
            <div class="card card-tabs reports-card">
              <div class="p-0 pb-2" style="border-bottom: 1px solid #dbe5ee;">
                ...
                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-3 pt-md-0 px-md-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <div class="label-select">
                      <h3 class="card-title mb-0">Purchase Register Vendor Wise-2</h3>
                    </div>
                    <div class="d-flex align-items-center">
                      <div class="daybook-filter-list filter-list">
                            ...
                            <div class="fy-custom-section">
                              <div class="fy-dropdown-section">
                                ...
                                if (isset($_POST['from_date'])) {
                                  ...
                                  $start = explode('-', $variant_sql['data'][0]['year_start']);
                                  $end = explode('-', $variant_sql['data'][0]['year_end']);
                                  $f_date = date('Y-m-d'); // Today's date
                                  $to_date = date('Y-m-d', strtotime('+1 day')); // Tomorrow's date
                                  $_POST['from_date'] = $f_date;
                                  $_POST['to_date'] = $to_date;
                                  $_POST['drop_val'] = 'fYDropdown';
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                  ...
                  $sql_list = "SELECT grn.vendorCode AS vendor_code,grn.vendorName AS vendor_name,SUM(grn.grnSubTotal) AS total_base_amount,SUM(grn.grnTotalCgst) AS total_cgst,SUM(grn.grnTotalSgst) AS total_sgst,SUM(grn.grnTotalIgst) AS total_igst,SUM(grn.grnTotalTds) AS total_tds,SUM(grn.grnTotalAmount) AS total_amount,SUM(grn.dueAmt) AS total_due_amount FROM erp_grninvoice AS grn WHERE grn.companyId=$company_id AND grn.branchId=$branch_id AND grn.locationId=$location_id AND grn.postingDate BETWEEN '" . $f_date . "' AND '" . $to_date . "' AND grn.grnStatus='active' GROUP BY vendor_code,vendor_name ORDER BY SUM(grn.dueAmt) DESC LIMIT 20;";
                      ...
                      <div class="row">
                        <!-- <div class="col-md-6 col-sm-6 d-flex">
                          <div class="card flex-fill reports-card">
                            ...
                            <div class="card-body">
                              <div id="chartDivPurchaseRegisterVendorWise" class="chartContainer"></div>
                            </div>
                          </div>
                        </div> -->
                        <div class="col-md-6 col-sm-6 d-flex">
...
<!-- <script>
  ...
  am4core.ready(function() {
    ...
    var chart = am4core.create("chartDivPurchaseRegisterVendorWise", am4charts.XYChart);
    ...
    for (elem of chartData.data) {
      finalData.push({
        ...
        "total_receivable_amount": Number(elem.total_due_amount),
    ...
    series.tooltipText = "Payable Amount: [bold]{valueY}[/]";

    var series2 = chart.series.push(new am4charts.ColumnSeries());
    series2.dataFields.valueY = "total_amount";
    series2.dataFields.categoryX = "vendor";
    series2.clustered = false;
    series2.columns.template.width = am4core.percent(50);
    series2.tooltipText = "Total Amount: [bold]{valueY}[/]";
...
<script>
  ...
  am4core.ready(function() {
    ...
    // Create series
    var series = chart.series.push(new am4charts.ColumnSeries());
    series.dataFields.valueX = "total_receivable_amount";
    series.dataFields.categoryY = "vendor";
    series.clustered = false;
    series.tooltipText = "Payable Amount: [bold]{valueX}[/]";

    var series2 = chart.series.push(new am4charts.ColumnSeries());
    series2.dataFields.valueX = "total_amount";
    series2.dataFields.categoryY = "vendor";
    series2.clustered = false;
    series2.columns.template.height = am4core.percent(50);
    series2.tooltipText = "Total Amount: [bold]{valueX}[/]";
    ...
    // categoryAxis.renderer.labels.template.truncate = true;
    // categoryAxis.renderer.labels.template.maxHeight = 120; // Adjust the maximum height as needed
    // categoryAxis.renderer.labels.template.tooltipText = "{category}"; // Display full category name in tooltip

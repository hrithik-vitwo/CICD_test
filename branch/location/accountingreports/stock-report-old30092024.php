<?php
// --------------- prev this page name was stock register 11/09/2024 
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <div class="modal advanced-search-modal" id="btnSearchCollpase_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            // let movement_type = (value.movement_type == null)?'-':value.movement_type.toLowerCase();
                            ...
                            //     movement_type = '-';
                            // }else{
                            //     movement_type = value.movement_type.toLowerCase();
                            // }
                            dataTable.row.add([
                                value.sl_no,
                                value.loc,

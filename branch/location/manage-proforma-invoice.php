                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <a href="direct-create-invoice.php?proforma_invoice" class="btn btn-create waves-effect waves-light" type="button">
...
<script>
    ...
    $(document).on("click", ".soModal", function() {
        ...
        $("#classicViewPrint").attr('href', `classic-view/invoice-preview-print.php?proformaInv=${btoa(proforma_invoice_id)}`);


        $.ajax({
            type: "GET",
            url: "ajaxs/modals/so/ajax-manage-proforma-invoice-modal.php",
            dataType: 'json',
            data: {
                act: "modalData",
                proforma_invoice_id
            ...
            success: function(value) {
                ...
                if (dataObj.status == "active") {
                    $("#inVoiceLink").show();
                    $("#soLink").show();
                    $("#inVoiceLink").attr('href', `direct-create-invoice.php?proforma_to_invoice=${responseObj.bashProformaId}`);
                    $("#soLink").attr('href', `direct-create-invoice.php?proforma_to_so=${responseObj.bashProformaId}`);
                ...
                if (responseObj.dataObj.igst == 0) {
                    if (responseObj.dataObj.cgst != 0 || responseObj.dataObj.sgst != 0) {
                        cgst = totalTax / 2;
                        sgst = totalTax / 2;
                        ...
                        // $("#igstP").hide();
                        // $("#igst").hide();
                        $("#cgstVal").show().html(responseObj.companyCurrencyName + " " + decimalAmount(cgst));
                        $("#sgstVal").show().html(responseObj.companyCurrencyName + " " + decimalAmount(sgst));
                    }
                } else {

...
if (isset($_POST["editNewPOFormSubmitBtn"])) {
    ...
    swalToast($editBranchPo["status"], $editBranchPo["message"], "manage-purchases-orders.php ");
}
                                        ...
                                        <tbody id="itemsTable">
                                            ...
                                            ?>
                                                    ...
                                                    <tr class="rowDel itemRow" id="delItemRowBtn_<?= $key ?>">
                                                        ...
                                                        <td>
                                                            <input type="number" step="any" name="listItem[<?= $randCode ?>][basePrice]" value="<?= inputValue($basePrice) ?>" class="form-control full-width-center itemBasePrice" id="itemBasePrice_<?= $randCode ?>" readonly>
                                                        ...
                                                        <td>
                                                            <input type="number" step="any" name="listItem[<?= $randCode ?>][gst]" value="<?= inputValue($gstPercentage['data']['taxPercentage']) ?>" class="form-control full-width-center gst" id="gst_<?= $randCode ?>" readonly>
                                                        </td>
                                                        <td>
                                                            <input type="number" step="any" name="listItem[<?= $randCode ?>][gstAmount]" value="<?= $gstAmount ?>" class="form-control full-width-center gstAmount" id="gstAmount_<?= $randCode ?>" readonly>
                                                        </td>
                                                        <td>
    ...
    <div class="content-wrapper is-purchase-order">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= BRANCH_URL ?>" class="text-dark"><i class="fas fa-home po-list-icon"></i> Home</a></li>
                    <li class="breadcrumb-item active"><a href="manage-purchases-orders.php" class="text-dark"><i class="fa fa-list po-list-icon"></i>Purchase Order List</a></li>
                    <li class="breadcrumb-item active"><a href="" class="text-dark"><i class="fa fa-plus po-list-icon"></i> Create Purchase Order</a></li>
                    <li class="back-button">
                        <a href="<?= basename($_SERVER['PHP_SELF']); ?>">
                            <i class="fa fa-reply po-list-icon"></i>
                                ...
                                <table class="table tabel-hover table-nowrap">
                                    ...
                                    <tbody class="total-calculate purchase-order-item-list">
                                        ...
                                        <tr class="p-2">
                                            ...
                                            <td class="font-weight-bold text-right pr-2" style="border-top: 3px double !important; background: none;">
                                                <small class="text-large font-weight-bold text-success">
                                                    <span class="rupee-symbol">INR </span><span id="grandTotalAdjustAmount">0.00</span>
                                                </small>
                                                <small class="text-small font-weight-bold text-primary convertedDiv" style="display: none;">
                                                    (<span class="rupee-symbol currency-symbol-dynamic">INR</span><span id="">0.00</span>)
                                                </small>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="pr_form">
                            <div class="modal-body">
                                ...
                                <button id="" class="btn btn-primary float-right mt-3">Select PR</button>
                            </div>
                        </form>
                    </div>
                </div>
                                    ...
                                    <tbody id="itemsTable">
                                        ...
                                        ?>
                                            <tr class="rowDel itemRow" id="delItemRowBtn_<?= $getItemObj['data']['itemId'] ?>">
                                                ...
                                                <td>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][unitPrice]" id="itemUnitPrice_<?= $randCode ?>" value="<?= inputValue($lastPrice) ?>" class="form-control full-width-center itemUnitPrice inputAmountClass" data-attr="<?= $randCode ?>">
                                                    <div class="d-flex gap-2 my-1">
                                                ...
                                                <td>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][basePrice]" value="<?= inputValue($basePrice) ?>" class="gstTD form-control full-width-center itemBasePrice" id="itemBasePrice_<?= $randCode ?>" data-attr="<?= $randCode ?>" readonly>
                                                    <div class="d-flex gap-2 my-1">
                                                        <?= $comp_currency ?> <p id="local_base_price_<?= $randCode ?>">0.00</p>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][gst]" value="<?= inputValue($gstPercentage['data']['taxPercentage']) ?>" class="gstTD form-control full-width-center gst" id="gst_<?= $randCode ?>" data-attr="<?= $randCode ?>" readonly>


                                                    <input type="number" step="any" style="display:none" name="listItem[<?= $randCode ?>][gstbackup]" value="<?= $gstPercentage['data']['taxPercentage'] ?>" class="form-control full-width-center gst" id="gstbackup_<?= $randCode ?>" readonly>

                                                </td>
                                                <td>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][gstAmount]" value="<?= $gstAmount ?>" class="gstTD form-control full-width-center gstAmount" id="gstAmount_<?= $randCode ?>" data-attr="<?= $randCode ?>" readonly>
                                                    <div class="d-flex gap-2 my-1">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12  modal-add-row modal-add-row-delivery_<?= $randCode ?>">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class=" col-lg-5 col-md-5 col-sm-5 col-12">
                                                                                <div class="form-input">
                                                                                    <label>Delivery date</label>
                                                                                    <input type="date" name="listItem[<?= $randCode ?>][deliverySchedule][<?= $randCode ?>][multiDeliveryDate]" class="form-control delDate delDate_<?= $randCode ?>" data-attr="<?= $randCode ?>" id="delivery-date" placeholder="delivery date" value="<?= $data['dsdelivery_date'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-12">
                                                                                <div class="form-input">
                                                                                    <label>Quantity</label>
                                                                                    <input type="text" step="any" name="listItem[<?= $randCode ?>][deliverySchedule][<?= $randCode ?>][quantity]" class="form-control multiQuantity multiQty_<?= $randCode ?>" data-attr="<?= $randCode ?>" id="multiQuantity_<?= $randCode ?>" placeholder="quantity" value=<?= $data['deliveryremaining_qty'] ?>>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-2 col-md-2 col-sm-2 col-12">
                                                                                <div class="add-btn-plus">
    ...
    <div class="content-wrapper is-purchase-order is-purchase-edit">
        <section class="content">
                                        ...
                                        ?>
                                            ...
                                            <tr class="rowDel itemRow" id="delItemRowBtn_<?= $getItemObj['data']['itemId'] ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex gap-2 my-1">
                                                        <?= $comp_currency ?> <p id="local_unit_price_<?= $randCode ?>"></p><?= inputValue($data['unitPrice']) ?>
                                                    </div>
            ...
            <input type="number" name="listItem[<?= $randCode ?>][totalDiscount]" value="0.00" class="form-control full-width-center itemDiscount">%
                                                ...
                                                <td>
                                                    <?= $vendor_curr ?>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][update_basePrice]" value="<?= $basePrice * $sqlData['conversion_rate'] ?>" class="form-control full-width-center updateitemBasePrice" id="updateitemBasePrice_<?= $randCode ?>" data-attr="<?= $randCode ?>" readonly>
                                                    <div class="d-flex gap-2 my-1">
                                                ...
                                                <td>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][update_gst]" value="<?= $data['gst'] ?>" class="form-control full-width-center updategst" id="updategst_<?= $randCode ?>" data-attr="<?= $randCode ?>" readonly>

                                                </td>
                                                <td>
                                                    <?= $vendor_curr ?>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][update_gstAmount]" value="<?= $data['gstAmount'] * $sqlData['conversion_rate'] ?>" class="form-control full-width-center updategstAmount" id="updategstAmount_<?= $randCode ?>" data-attr="<?= $randCode ?>" readonly>
                                                    <div class="d-flex gap-2 my-1">
                                                ...
                                                <td>
                                                    <?= $vendor_curr ?>
                                                    <input type="number" step="any" name="listItem[<?= $randCode ?>][update_totalPrice]" id="updateitemTotalPrice_<?= $randCode ?>" value="<?= $data['total_price'] * $sqlData['conversion_rate'] ?>" class="form-control full-width-center updateitemTotalPrice" data-attr="<?= $randCode ?>" step="any" readonly>
                                                    <div class="d-flex gap-2 my-1">
                                    ...
                                    <tbody id="itemsTable">
                                        ...
                                        ?>
                                                ...
                                                <tr class="rowDel itemRow" id="delItemRowBtn_<?= $getItemObj['data']['itemId'] ?>">
                                                    ...
                                                    <td>
                                                        <input type="number" step="any" name="listItem[<?= $randCode ?>][gst]" value="<?= inputValue($gstPercentage['data']['taxPercentage']) ?? 0 ?>" class="form-control full-width-center gst" id="gst_<?= $randCode ?>" readonly>
                                                    </td>
                                                    <td>
                                                        <input type="number" step="any" name="listItem[<?= $randCode ?>][gstAmount]" value="<?= $gstAmount  ?>" class="form-control full-width-center gstAmount" id="gstAmount_<?= $randCode ?>" readonly>
                                                    </td>
...
<?php
    ...
    $url = BRANCH_URL . 'location/manage-purchases-orders.php';
?>
    <script>
                                 ...
                                 <?php
                                    ...
                                    ?>
                                                                ...
                                                                <div class="col-lg-3 col-md-12 col-sm-12">
                                                                    <div class="form-input">
                                                                        <label for="">Amount</label>
                                                                        <input type="number" step="any" class="form-control amount" placeholder="amount" name="FreightCost[${addressRandNo}][service_amount]">
                                                                    </div>
                                                                </div>
                                 ...
                                 <?php
                                    ...
                                    ?>
                                                                ...
                                                                <div class="col-lg-3 col-md-12 col-sm-12">
                                                                    <div class="form-input">
                                                                        <label for="">Amount</label>
                                                                        <input type="number" step="any" class="form-control other_amount" placeholder="amount" name="OthersCost[${addressRandNo}][service_amount]">
                                                                    </div>
                                                                </div>
...
<script>
    ...
    function calculateAllItemsGrandAmount() {
        ...
        $(".itemUnitPrice").each(function() {
            ...
            var currency_conversion_rate = $("#currency_conversion_rate").val();
            // alert(currency_conversion_rate);
            var local_unit_price = inputValue(unit_price / currency_conversion_rate);
        ...
        if (loc_state == vendor_state) {
            ...
            $("#sgst").val(inputValue(sgst));
            $(".sgstTr").show();
            $("#cgst_span").html(cgst.toFixed(2));
            $(".cgstTr").show();
            $("#cgst").val(inputValue(cgst));
            ...
            $(".sgstTr").hide();
            $(".cgstTr").hide();
            $("#igst_span").html(inputValue(igst));
            $("#igst").val(inputValue(igst));
            let ptype = $("#potypes").val();
            if (ptype != 'international') {
                $(".igstTr").show();
            }

...
if (!isset($_COOKIE["cookiesPf"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiesPf", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        var checkboxSettings = Cookies.get('cookiesPf');
        ...
        $(document).on("click", ".ion-paginationlistnew", function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiesPf')
                },
                beforeSend: function() {

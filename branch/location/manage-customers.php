                                        ...
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active"
                                            ...
                                            <div class="row custom-table-footer">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div id="limitTextShow" class="limit-text">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-12">
                                                            ...
                                                            <div class="tab-content global-tab-content"
                                                                        ...
                                                                        <div class="tab-content" id="pills-tabContent">
                                                                            <div class="tab-pane fade show active"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        <h4>Invoices</h4>
                                                                                        <a href="manage-invoices-taxComponents.php"
                                                                                            target="_blank"
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        <h4>Estimates</h4>
                                                                                        <a href="manage-quotations-tax.php"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Manage
                                                                                            Quotations</a>
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        <h4>Sales Order</h4>
                                                                                        <a href="manage-sales-orders-taxComponents.php"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Manage
                                                                                            SO</a>
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        <h4>Debit Notes</h4>
                                                                                        <a href="manage-debit-notes-tax.php"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Manage
                                                                                            DN</a>
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="list-block">
                                                                                    <div class="head">
                                                                                        <h4>Credit Notes</h4>
                                                                                        <a href="manage-credit-notes-taxComponents.php"
                                                                                            target="_blank"
                                                                                            class="btn btn-primary"><ion-icon
                                                                                                name="add-outline"></ion-icon>Manage
                                                                                            CN</a>
                                                                ...
                                                                <div class="tab-pane mail-tab-pane fade" id="nav-mail"
                                                                    ...
                                                                    <div class="alert alert-light d-flex justify-content-between align-items-center p-3 border rounded shadow-sm">
                                                                        ...
                                                                        <div id="approvedQuot" style="display: none;">
                                                                            <a class="btn text-dark d-flex align-items-center px-3 py-2 shadow-sm" style="background-color: #FFC107; margin-left: 10px;  text-decoration: none;">
                                                                                <ion-icon name="send-outline" class="mr-2"></ion-icon> Send Verification Mail
                                                                            </a>
                                                                        </div>
                                                                    </div>
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            if (value.customer_status == "active") {
                                ...
                                <input type="hidden" name="id" value="${value.customerId}">
                                <input type="hidden" name="changeStatus" value="active_inactive">
                                <button type="submit" onclick="return confirm('Are you sure change customer_status?')" style="cursor: pointer; border:none" class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="active">
                                ...
                                <input type="hidden" name="id" value="${value.customerId}">
                                <input type="hidden" name="changeStatus" value="active_inactive">
                                <button type="submit" onclick="return confirm('Are you sure change customer_status?')" style="cursor: pointer; border:none" class="p-0 m-0 ml-2 " data-toggle="tooltip" data-placement="top" title="Inactive">
                        ...
                        $('#limitTextShow').html(response.limitTxt);
        ...
        $(document).on("click", ".ion-paginationliststock", function(e) {
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookieManageCustomerList')
                },
                beforeSend: function() {
                    $('#loaderModal').show();
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".soModal", function() {
            ...
            $("#nav-transaction-tab").click(function() {
                ...
                $(".innerEstimates_wrapper").scrollTop(0);
                $(".innerSalesOrder_wrapper").scrollTop(0);
                $(".innerJournals_wrapper").scrollTop(0);
                $(".innerDebitNote_wrapper").scrollTop(0);
                $(".innerCreditNote_wrapper").scrollTop(0);
            })

            // console.log($(".innerCollections_wrapper")[0].scrollTop());
            ...
            $.ajax({
                ...
                success: function(value) {
                    ...
                    if (value.status) {
                        ...
                        mailstatus = dataObj.isMailValid;
            ...
            function innerCollectionsTable() {
                ...
                if (debounceFlagInnerCollection) {
                    ...
                    $.ajax({
                        ...
                        complete: function() {
                            // $(".innerCollections_wrapper").scrollTop(lastScrollTop);
                        }
                    });
                }
            }
            ...
            //Mail Start
            $(document).on("click", "#nav-mail-tab", function(e) {

                if (mailstatus === "no") {
                    $("#mailmsg").html('Customer mail is not verified. Click the button to send verification mail:')
                    $("#approvedQuot").css('display', 'block');
                } else {
                    $("#mailmsg").html('Customer mail is verified.')
                    $("#approvedQuot").css('display', 'none');
                }
            })
            ...
            $(document).on("click", "#approvedQuot", function(e) {
                e.preventDefault();
                let $btn = $(this);
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                act: "Mailsent",
                                id: custId, // Ensure this variable is properly defined
                            },
                            success: function(response) {
                                try {
            ...
            $("#nav-statement-tab").click(function() {
                ...
                $.ajax({
                    url: `ajaxs/customer/ajax-dateRange-statement-customer.php`,
                    type: 'POST',
                    data: {
                        from_date: from_date,
                        to_date: to_date,
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (responseObj.status == "success") {
                        ...
                        $("#nav-compliance").append("<p>No Data Found</p>");
                    }
                }
            });

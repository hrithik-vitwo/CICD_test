...
require_once("../../app/v1/functions/branch/func-kam-controller.php");
...
if (isset($_POST["createKam"])) {
  ...
  $addNewObj = $kamController->createKam($_POST,$branch_id,$company_id,$location_id,$created_by);
  swalToast($addNewObj["status"], $addNewObj["message"]);
}
if (isset($_POST["editKam"])) {


  $addNewObj = $kamController->editKam($_POST,$branch_id,$company_id,$location_id,$created_by);
  swalToast($addNewObj["status"], $addNewObj["message"]);
}
                  ...
                  <div id="collapseThree" >
                    <div class="card-body">
                      <div class="row">
                        ...
                        <?php
                         $kam = queryGet("SELECT * FROM `".ERP_KAM."` WHERE `company_id`=$company_id AND `branch_id`=$branch_id AND `location_id`=$location_id",TRUE);
                       // console($kam);
                         $row = $kam["data"];
                       // console($row);
...
?>
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
    <?php
    $kamId = base64_decode($_GET['edit']);
 $sql = "SELECT * FROM `" . ERP_KAM . "` WHERE `kamId` = $kamId";
            ...
            <div class="card card-tabs" style="border-radius: 20px;">
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                  ...
                  $sql_list = "SELECT * FROM " . ERP_KAM . " WHERE 1 " . $cond . " " . $sts . " AND `location_id`=$location_id  ORDER BY kamId desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                  $qry_list = mysqli_query($dbCon, $sql_list);
                  $num_list = mysqli_num_rows($qry_list);


                  $countShow = "SELECT count(*) FROM " . ERP_KAM . " WHERE 1 " . $cond . " AND `location_id`=$location_id ";
                    ...
                    <table class="table table-hover text-nowrap p-0 m-0">
                      <thead>
                        <tr class="alert-light">
                          ...
                          <?php if (in_array(1, $settingsCheckbox)) { ?>
                            <th class="borderNone">KAM Name</th>
                          <?php }
                          if (in_array(2, $settingsCheckbox)) { ?>
                            <th class="borderNone">KAM Code</th>
                          <?php }
                          if (in_array(3, $settingsCheckbox)) { ?>
                            <th class="borderNone">KAM Parent</th>
                          <?php  }
                          if (in_array(4, $settingsCheckbox)) { ?>
                            <th class="borderNone">KAM Description</th>
                          <?php }
                      ...
                      <tbody>
                        ...
                        ?>
                          ...
                          <div class="modal fade right" id="fluidModalRightSuccessDemo_<?= $row['kamId'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      <div class="col-md-12">
                                        <div class="shadow-sm bg-light py-2 mx-2 my-2" id="action-navbar" style="text-align:right">
                                          <?php 
                                            $kam_id = base64_encode($row['kamId']);
                                          ?>
                                          <form action="" method="POST">
                                           
                                            <a href="manage-kam.php?edit=<?= $kam_id ?>" name="customerEditBtn">

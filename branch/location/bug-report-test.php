                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $data['status'] ?></td>
                                                            <td>
                                                                <a style="cursor:pointer" data-toggle="modal" data-target="#fluidModalRightSuccessDemo<?= $data['id'] ?>" data-image-url="<?= $data['image_url'] ?>" class="btn btn-sm waves-effect waves-light" onclick="getChatHistory(<?= $data['id'] ?>)"><i class="fa fa-eye po-list-icon"></i></a>
                                                                                                        ...
                                                                                                        <div class="chat">
                                                                                                            <div class="chat-container" id="chat-con<?= $data['id'] ?>">
                                                                                                                ...
                                                                                                                <div class="conversation">
                                                                                                                    ...
                                                                                                                    <div class="assignedMsg">
                                                                                                                        Hi <?= $adminName?> has been assigned for this task. Feel free to connect here for any assistance or if you encounter any challenges in the future.
                                                                                                                    </div>
                                ...
                                <script>
                                    $(document).ready(function() {
                                        $('a[data-toggle="modal"][data-target^="#fluidModalRightSuccessDemo"]').on('click', function() {
                                            ...
                                            $.ajax({
                                                url: '../../uploads/bugimages/' + $(this).data('image-url'),
                                                method: 'GET',
                                                dataType: 'html',
                                                success: function(data) {
                                                    $('.img-bug-screenshot').attr('src', this.url);
...
<script>
    ...
    function sendMessage(e, $bug_Id) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo BASE_URL ?>api/v2/bugs/chat-api-test.php',
            data: formData,
            contentType: false,
            cache: false,
            processData: false,

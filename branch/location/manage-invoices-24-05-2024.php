                                            ...
                                            <div style="display: flex; justify-content: space-between">
                                                ...
                                                <div>
                                                    <select title="Select Template" class="form-control handleTemplates" id="handleTemplates_<?= $oneSoList['so_invoice_id'] ?>">
                                                        <option <?php if($invoice_template_id == 0) { echo "selected"; } ?> value="0">Default</option>
                                                        <option <?php if($invoice_template_id == 1) { echo "selected"; } ?> value="1">Standard</option>
                                                    </select>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".handleCompanyCopyTemplate", function() {
            ...
            $(`#handleCompanyPrintBtn_${invoiceId}`).html(`<a href="classic-view/invoice-preview-print.php?invoice_id=<?= base64_encode($oneSoList['so_invoice_id']) ?>&type=company&template_id=${templateId}" class="btn btn-primary classic-view-btn float-right" target="_blank">Print</a>`)
        ...
        $(document).on("click", ".handleCustomerCopyTemplate", function() {
            ...
            $(`#handleCustomerPrintBtn_${invoiceId}`).html(`<a href="classic-view/invoice-preview-print.php?invoice_id=<?= base64_encode($oneSoList['so_invoice_id']) ?>&type=customer&template_id=${templateId}" class="btn btn-primary classic-view-btn float-right" target="_blank">Print</a>`)

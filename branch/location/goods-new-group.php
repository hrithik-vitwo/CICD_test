...
?>
  ...
  <div class="content-wrapper">
    ...
    {
      global $company_id;
      $sql = queryGet("SELECT * FROM `erp_inventory_mstr_good_groups` WHERE `companyId` = $company_id AND groupParentId " . ($parent_id === null ? "= 0" : "= $parent_id"), true);
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                              ...
                              <div class="boq-checkbox" id="boqCheckBoxDiv" style="display:none;">
                                ...
                                <div class="d-flex mb-3">
                                  ...
                                  <input type="checkbox" name="boqRequired" style="width: auto; margin-bottom: 0;">
                                      ...
                                      <div class="col-lg-6 col-md-6 col-sm-6 col pr-0 base-measure">
                                        ...
                                        <div class="form-input">
                                          ...
                                          <select id="buomDrop" name="baseUnitMeasure" class="form-control">
                                            ...
                                            $uomList_sql = queryGet("SELECT * FROM `erp_inventory_mstr_uom` WHERE `companyId`=$company_id AND `uomType`='material'", true);
                              ...
                              <div class="row othe-cost-infor">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5">
                                  ...
                                  <div class="form-input py-0">
                                    ...
                                    <input type="text" name="spec[1][spec_name]" data-attr="1" class="form-control specification_1" id="">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <div class="row goods-info-form-view customer-info-form-view">
                            ...
                            <?php
                            $uomList = queryGet("SELECT * FROM `erp_inventory_mstr_uom` WHERE `companyId`=$company_id AND `uomType`='service'", true);
                            ?>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                              ...
                              <div class="form-input">
                                ...
                                <select id="serviceUnitDrop" name="serviceUnit" class="form-control">

                                  <option value="">Service Unit of Measurement</option>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row goods-info-form-view basic-info-form-view">
                              ...
                              <div class="row othe-cost-infor modal-add-row_537">
                                ...
                                $specification = queryGet("SELECT * FROM `erp_item_specification` WHERE `item_id`= $itemId AND `specification` != '' AND `specification_detail` != '' ", true);
                                //console($select);
                                  ...
                                  <div class="row othe-cost-infor pl-0 pr-0">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                      ...
                                      <div class="form-input">
                                        ...
                                        <input type="text" name="spec[<?= $rand ?>][spec_name]" data-attr="1" class="form-control specification_1" id="" value="<?= $specification['specification'] ?>">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                      ...
                                      <div class="form-input">
                                        ...
                                        <input type="text" name="spec[<?= $rand ?>][spec_detail]" data-attr="1" class="form-control spec_dtls_vldtn specificationDetails_1" id="" value="<?= $specification['specification_detail'] ?>">
                            ...
                            <div class="row goods-info-form-view customer-info-form-view">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <input step="0.01" type="number" name="price" class="form-control price" id="exampleInputBorderWidth2" value="0" placeholder="price">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <input step="0.01" type="number" name="discount" class="form-control discount" id="exampleInputBorderWidth2" value="0" placeholder="Maximum Discount">
                            ...
                            <div class="row goods-info-form-view customer-info-form-view">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <select id="hsnDropDown" name="" class="form-control servicehsnDropDown" disabled>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  $responce = getAllChartOfAccounts_list_by_p($company_id, 3);
                          ...
                          <div class="form-input">
                            ...
                            <div class="file-upload">
                              ...
                              <div class="upload-btn-wrapper">
                                ...
                                <button class="btn waves-effect waves-light">Upload a file</button>
                                <input type="file" name="pic[]" data-attr="1" class="form-control spec_vldtn file_1" id="file-input-1">
                              </div>
                            </div>
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            if (in_array(3, $settingsCheckbox)) { ?>
                              ...
                              <td><?php
                                  if ($row['goodsType'] == 5 || $row['goodsType'] == 7) {
                            ...
                            if (in_array(8, $settingsCheckbox)) { ?>
                              ...
                              <td><?= round($summary_sql['data']['itemPrice'], 2) ?></td>
                                                      ...
                                                      <div class="accordion-body p-0">
                                                        <div class="card">
                                                          <div class="card-body p-3">
                                                            ...
                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs">HSN :</p>
                                                              <p class="font-bold text-xs"><?= $row['hsnCode'] ?></p>
                                                            </div>
                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs">GL Code :</p>
                                                              <p class="font-bold text-xs"><?= $row['parentGlId'] ?></p>
                                                            </div>
                                                            <?php
                                                            $tds_id = $row['tds'];
                                                            ...
                                                            ?>
                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs">TDS :</p>
                                                            ...
                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs">Service Unit :</p>
                                                              <p class="font-bold text-xs"><?= $service_unit_sql['data']['uomName']    ?></p>
                                                            </div>
                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs">Service Target Price :</p>
                                                      ...
                                                      <div class="accordion-body p-0">
                                                        ...
                                                        <div class="card">
                                                          ...
                                                          <div class="card-body p-3">
                                                            ...
                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs"> Moving Price :</p>
                                                              <p class="font-bold text-xs"><?= round($mwp, 2)  ?></p>
                                                            </div>

                                                            <div class="display-flex-space-between">
                                                              <p class="font-bold text-xs"> Target Price :</p>
                                                              <p class="font-bold text-xs"><?= round($summary_sql['data']['itemPrice'], 2) ?></p>
                                                            </div>
                                              ...
                                              <div class="printable-view">
                                                ...
                                                <table class="classic-view table-bordered">
                                                  ...
                                                  ?>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <th class="bg-transparent text-left" colspan="7">Service Details</th>
                                                      </tr>
                                                      <tr>
                                                        <th>Name</th>
                                                        <th>Description</th>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="text-center" colspan="3">
                                                          <p><?= $specs['specification_detail'] ?></p>
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td colspan="2" class="text-center">
                                                          <p><?= $storage_data['storageControl'] ?></p>
                                                        </td>
                                                        <td class="text-center">
                                                          <p><?= $storage_data['maxStoragePeriod'] ?></p>
                                                        </td>
                                                        <td class="text-center" colspan="2">
                                                          <p><?= $storage_data['minRemainSelfLife'] ?></p>
                                                        </td>
                                                        <td class="text-center">
                                                          <p><?= $storage_data[''] ?></p>
                                                        </td>
      ...
      <form action="" method="post" id="addNewUOMForm">
        ...
        <div class="modal-footer">
          ...
          <div class="input-group btn-col">
            ...
            <button type="button" id="addNewUOMFormSubmitBtn" class="btn btn-primary btnstyle">Submit</button>
        ...
        <div class="modal-body card-body">
          ...
          <div class="col-md-12">
            ...
            <div class="form-input mb-2">
              ...
              <input type="text" name="uomName" class="form-control uomName_service">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on("change", "#goodTypeDropDown", function() {
      ...
      load_group_new(typeId);
      function load_group_new(typeId){
...
url: `ajaxs/items/ajax-group.php`,
...
beforeSend: function() {
  $('#justAnotherInputBox').html('Loading.....');
},
...
<script type="text/javascript">
  ...
  jQuery(document).ready(function($) {
    ...
    // });
    // comboTree2 = $('#justAnotherInputBox').comboTree({
    //   source: <?= json_encode($fetchItems, true) ?>,
    //   isMultiple: false
    // });
  });
</script>

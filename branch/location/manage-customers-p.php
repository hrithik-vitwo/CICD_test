...
if (!isset($_COOKIE["cookieManageCustomer"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieManageCustomer", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookieManageCustomer');

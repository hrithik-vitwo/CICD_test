...
if (isset($_GET["create"]) && $_GET["create"] != "") {
    require_once("../../branch/location/bom/create.php");
}
...
<style>
    #dataTable_detailed_view .text-alignment {
...
<div class="content-wrapper is-sales-orders report-wrapper vitwo-alpha-global">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        foreach ($columnMapping as $column) {
                                                            $class = ($column['dataType'] === 'number') ? 'text-alignment' : 'text-left';
                                                        ?>
                                                            <th class="<?= $class ?>" data-value="<?= $column['slag'] ?>">
                                                                <?= $column['name'] ?>
                                                            </th>
                                                        <?php
                                                        }
                                                        ...
                                                        <div id="mainModalBody" class="modal-body">
                                                            <nav>
                                                                <div class="nav nav-tabs global-view-navTabs" id="nav-tab" role="tablist">
                                                                    <button class="nav-link ViewfirstTab active" id="nav-overview-tab" data-bs-toggle="tab" data-bs-target="#nav-overview" type="button" role="tab" aria-controls="nav-overview" aria-selected="true"><ion-icon name="apps-outline" role="img" class="md hydrated" aria-label="apps outline"></ion-icon>Overview</button>
                                                                </div>
                                                            </nav>
                                                            <div class="tab-content global-tab-content" id="nav-tabContent">

                                                                <div class="tab-pane fade transactional-data-tabpane active show" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                        <div class="display-flex-space-between">
                                                                                            ...
                                                                                            <p class="text-xs" id="grandMaterialCost"></p>
                                                                                        </div>
                                                                                        <div class="display-flex-space-between">
                                                                                            <p class="text-xs">Total Activivty Cost</p>
                                                                                            <p class="text-xs" id="grandActivityCost"></p>
                                                                                        </div>
                                                                                        <hr class="mt-2 mb-2">
                                                                                        <div class="display-flex-space-between">
                                                                                            <p class="text-xs font-bold">Total Cost</p>
                                                                                            <p class="text-xs font-bold" id="grandTotalCost"></p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="items-table">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="row head-state-table">
                                                                                        ...
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Item Title</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Consumption</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Extra(%)</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">UOM</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td ">Item Rate</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td ">Amount</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Remarks</div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="row orders-table">
                                                                        <div
                                                                            class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                            <div class="items-table">
                                                                                <h4>Hourly Deployment
                                                                                </h4>
                                                                                <div class="multiple-item-table">
                                                                                    <div class="row head-state-table">
                                                                                        <div class="col-lg-1 col-md-1 col-sm-1 state-col-th state-col-td">#</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Work center</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Code</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Head Name</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Consumption</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Extra(%)</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">UOM</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td ">Rate</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td ">Amount</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Remarks</div>
                                                                                    </div>

                                                                                    <div id="hourdeployTableBody">
                                                                                        <!-- Hour deploy data will be appended here -->
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="items-table">
                                                                                ...
                                                                                <div class="multiple-item-table">
                                                                                    <div class="row head-state-table">
                                                                                        ...
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Work center</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Code</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Over Head</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Consumption</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Extra(%)</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">UOM</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td ">Rate</div>
                                                                                    ...
                                                                                    <div id="overHeadstableBody">
                                                                                        <!-- Overhead data will be appended here -->
                                                                                    </div>
                                                                                </div>
...
<script>
    $(document).ready(function() {
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            if (value.bomCreateStatus == 1) {
                                actionMenu = `<div class="dropout">
                                     <button class="more">
                                          <span></span>
                                          <span></span>
                                          <span></span>
                                     ...
                                     <ul>
                                     <li>
                                         <a href="bom/bom.php?create=${btoa(value.itemId)}">
                                            <button>
                                ...
                                actionMenu = `<div class="dropout">
                                    ...
                                    <ul>
                                        <li>
                                        <a href="bom/bom.php?editBom=${btoa(value.bomId)}">
                                            <button><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                            </a>
                                        </li>  
                                        <li>
                                            <button class="soModal" data-toggle="modal" data-bomId="${value.bomId}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>  
                                    </ul>
                                </div>`
                            }
                            ...
                            dataTable.row.add([
                                `<p> ${value.sl_no}</p>`,
                                `<a href="#" class="soModal" data-bomId="${value.bomId}" data-toggle="modal" data-target="#viewGlobalModal">${value.itemCode}</a>`,
                                `<p class="pre-normal">${value.itemName}</p>`,
                                `<p>${formatDate(value.preparedDate) === "" ? "-" : formatDate(value.preparedDate)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cogm_m)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cogm_a)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cogm)}</p>`,
                                `<p class="text-right">${decimalAmount(value.cogs)}</p>`,
                                `<p class="text-right">${decimalAmount(value.msp)}</p>`,
                                `<p>${value.bomStatus}</p>`,
                                actionMenu,
                            ]).draw(false);
                        });
        ...
        $(document).on("click", ".soModal", function() {
            ...
            let bomid = $(this).attr("data-bomId");
            $.ajax({
                type: "GET",
                url: "ajaxs/modals/bom/ajax-bom-list-modal.php",
                dataType: 'json',
                data: {
                    act: "modalData",
                    bomid
                ...
                beforeSend: function() {
                    ...
                    let loader = `<div class="load-wrapp">
                                    <div class="load-1">
                                        <div class="line"></div>
                                        <div class="line"></div>
                                        <div class="line"></div>
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $("#itemCode").html(responseObj.itemCode);
                        $("#itemName").html(responseObj.itemName);
                        $("#preparedDate").html(responseObj.preparedDate);
                        $("#preparedBy").html(responseObj.preparedBy);
                        $("#grandMaterialCost").html(responseObj.companyCurrency + ' ' + responseObj.grandMaterialCost);
                        $("#grandActivityCost").html(responseObj.companyCurrency + ' ' + (responseObj.grandActivityCost));
                        $("#grandTotalCost").html(responseObj.companyCurrency + ' ' + (responseObj.grandTotalCost));

                        let itemObj = responseObj.itemObj;
                        let hourlydeployObj = responseObj.hourlydeploy;
                        let overheadObj = responseObj.overheads;
                        // Item Table
                        let itemtableBody = "";
                        if (itemObj.length === 0) {
                            itemtableBody = `<div class="row body-state-table">
                            ...
                            $.each(itemObj, function(index, value) {
                                itemtableBody += `<div class="row body-state-table">
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.itemCode}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-elipse w-30 text-dark" title="${value.itemName}">${value.itemName}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${(value.consumption)}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${(value.extra)}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.uom}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td ">${(value.rate)}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td ">${(value.amount)}</div>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.remarks}</div>
                                                </div>`;
                            });
                        }
                        $("#itemTableBody").html(itemtableBody);

                        // Hourly Deploy Table
                        let hourdeployTableBody = "";
                        if (!hourlydeployObj || hourlydeployObj.length === 0) {
                            hourdeployTableBody = `<div class="row body-state-table">
                                                        <div class="col-12 text-center py-2">
                                                            <p class="text-center">No data found</p>
                                                        </div>
                                                    </div>`;
                        } else {
                            $.each(hourlydeployObj, function(index, value) {
                                hourdeployTableBody += `<div class="row body-state-table">
                                                            <div class="col-lg-1 col-md-1 col-sm-1 state-col-td">${value.sl}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-elipse w-30 text-dark" title="${value.work_center_description}">${value.work_center_description}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.work_center_code}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.head_type}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.consumption}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.extra}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.uom}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.rate}</div>
                        ...
                        $("#hourdeployTableBody").html(hourdeployTableBody);

                        // Overheads Table
                        let overHeadstableBody = "";
                        if (!overheadObj || overheadObj.length === 0) {
                            overHeadstableBody = `<div class="row body-state-table">
                                                        <div class="col-12 text-center py-2">
                                                            <p class="text-center">No data found</p>
                                                        </div>
                                                    </div>`;
                        } else {
                            $.each(overheadObj, function(index, value) {
                                overHeadstableBody += `<div class="row body-state-table">
                                                            <div class="col-lg-1 col-md-1 col-sm-1 state-col-td">${value.sl}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-elipse w-30 text-dark" title="${value.work_center_description}">${value.work_center_description}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.work_center_code}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.head_name}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.consumption}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.extra}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.uom}</div>
                                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${value.rate}</div>
                        ...
                        $("#overHeadstableBody").html(overHeadstableBody);
        ...
        $(document).on("click", ".ion-paginationlistBOM", function(e) {
            $.ajax({
                ...
                beforeSend: function() {
                    $('#loaderModal').show();
                    $('.ion-paginationlistBOM').prop('disabled', true)
                },
                ...
                complete: function() {
                    ...
                    $('#loaderModal').hide();
                    $('.ion-paginationlistBOM').prop('disabled', false)
                }
            })
        ...
        $(document).on("click", ".ion-fulllistBOM", function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#loaderModal').show();
                    $('.ion-fulllistBOM').prop('disabled', true)
                },
                success: function(response) {
                ...
                complete: function() {
                    // Hide loader modal after request completes
                    $('#loaderModal').hide();
                    $('.ion-fulllistBOM').prop('disabled', false)
                }
            })

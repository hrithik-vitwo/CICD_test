...
if (!isset($_COOKIE["cookiefailedcollectpayment"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiefailedcollectpayment", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Failed Accounting Collection</h3>
                                            </div>
                                        </div>
                                         ...
                                         <div class="right-block">
                                            <div class="page-list-filer filter-list">
                                                ...
                                                <a class="filter-link active" id="active"><ion-icon name="list-outline" role="img" class="md hydrated" aria-label="list outline"></ion-icon>Collection
                                                </a>
                                                <style>
                                                    @keyframes pulse {
                                                        0% {
                                                ...
                                                <a class="filter-link" id="reverse"><ion-icon name="list-outline" role="img" class="md hydrated" aria-label="list outline"></ion-icon>Reverse Collection
                                                </a>
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-submenu" id="collectDropdown">
                                                            <li><a class="dropdown-item" href="collectpaymentsettelment-p.php?collect-payment">Collect Payment</a></li>
                                                            <hr>
                                                            <li><a class="dropdown-item" href="collectpaymentsettelment-p.php?adjust-payment">Settlement</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '',type = '') {
            ...
            let checkboxSettings = Cookies.get('cookiefailedcollectpayment');
            ...
            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-failed-acc-collection.php",
                dataType: 'json',
                data: {
                    act: 'tdata',
                    comid: comid,
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            if (response.type === 'active') {
                                ...
                                postBtn = `
                                    <div class="view-accoiunt" data-id='${value.paymentId}'>
                                    <a href="manage-failed-acc-collection-view.php?collect_id=${btoa(value.paymentId)}" class="wallet-accountbtn">
                                      <ion-icon name="wallet-outline"></ion-icon>
                                      <span>Post</span>
                                    </a>
                                  </div>`;
                                ...
                                postBtn = `
                                    <div class="view-accoiunt" data-id='${value.paymentId}'>
                                    <a href="manage-failed-acc-collection-reverse-view.php?collect_id=${btoa(value.paymentId)}" class="wallet-accountbtn">
                                      <ion-icon name="wallet-outline"></ion-icon>
                                      <span>Post</span>
                                    </a>
                                  </div>`;
                            ...
                            dataTable.row.add([
                                ...
                                value.paymentCollectType,
                                decimalAmount(value.collect_payment),
                                value.created_by,
                                status,
                                postBtn
                            ]).draw(false);

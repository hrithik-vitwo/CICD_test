...
<!-- Modal -->
<div class="modal fade add-customer-modal" id="addNewCustomerModal1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal  add-customer-modal" id="addNewCustomerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
  ...
  $('#customerDropDown').select2({
    ...
    if (!$results.find('a').length) {
      // $results.append(`<div class="btn-row"><a type="button" id = "addCustomerModal" class="btn btn-primary add-btn" data-toggle="modal" data-target="#addNewCustomerModal">Add New</a></div>`);
      $results.append(`<div class="btn-row"><a type="button" id = "addCustomerModal" class="btn btn-primary add-btn" data-toggle="modal">Add New</a></div>`);
    }
  });
  ...
  $(document).on("click", "#addCustomerModal", function() {
    $.ajax({
      type: 'GET',
      url: '../../api/v2/proccess/components/view/customer-view.php',
      ...
      success: function(response) {
        ...
        $('#addNewCustomerModal').html(response);
        $('#addNewCustomerModal').show();

    ...
    if (!isset($_COOKIE["cookieStorageloc"])) {
    ...
    $columnMapping = [
        ...
        [
            ...
            'slag' => 'storage.storage_location_name',
            'dataType' => 'string',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Storage Location Code',
            'slag' => 'storage.storage_location_code',
            'dataType' => 'string',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Warehouse',
            'slag' => 'erpWarehouse.warehouse_name',
            'dataType' => 'string',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Storage Control',
            'slag' => 'storage.storage_control',
            'dataType' => 'number',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Temp Control',
            'slag' => 'storage.temp_control',
            'dataType' => 'number',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
        [
            'name' => 'Created By',
            'slag' => 'storage.created_by',
            'dataType' => 'string',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
        ],
    ...
    <div class="content-wrapper report-wrapper is-stock-new is-sales-orders is-warehouse vitwo-alpha-global">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <?php
                // console($_COOKIE["cookieTableWarehouse"]);
                                        ...
                                        <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                            <div class="left-block">
                                                <div class="label-select">
                                                    <h3 class="card-title mb-0">Manage Storage Location</h3>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                                ...
                                                <a href="manage-storage-location-actions.php?create" class="btn btn-create" type="button">
                                                        ...
                                                        <div class="top-details">
                                                            <div class="left">
                                                                <p class="info-detail amount" id="amount">
                                                                    ...
                                                                    <span class="strLocname"> </span>
                                                                </p>
                                                                <span class="amount-in-words" id="amount-words"></span>
                                                                <p class="info-detail po-number"><ion-icon name="information-outline"></ion-icon><span id="strLocCode"> </span></p>
                                                            </div>
                                                            <!-- <div class="right">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        <div class="items-table">
                                                                            <h4>Storage Location Details</h4>
                                                                            <div class="customer-details">
                                                                                <div class="name-code">
                                                                                    <div class="details name">
                                                                                        <p id="storagelocName"></p>
                                                                                    </div>
                                                                                    <div class="details code">
                                                                                        <p id="strlocationCode"></p>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="details warehouse-description">
                                                                                    ...
                                                                                    <p id="storage_control"></p>
                                                                                </div>
                                                                                <div class="address-contact">
                                                                                    <div class="details">
                                                                                        <label for="">Temp control</label>
                                                                                        <p id="temp_control" class="pre-normal"></p>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="address-contact">
                                                                                    <div>
                                                                                            ...
                                                                                            <li>
                                                                                                <details open>
                                                                                                    ...
                                                                                                    <ul>
                                                                                                        <li>
                                                                                                            <details>
                                                                                                                <summary><span class="font-weight-bold">S Location :</span> <span class="strLocname"></span>
                                                                                                                </summary>
                                                                                                            </details>
                                                                                                        </li>
                                                                                                    </ul>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-mange-storage-loc.php",
                    dataType: 'json',
                    data: {
                        act: 'strageloc',
                        comid: comid,
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            $.each(responseObj, function(index, value) {
                                dataTable.row.add([
                                    value.sl_no,
                                    `<a href="#" class="soModal" data-id="${value.storage_location_id}" data-toggle="modal" data-target="#viewGlobalModal">${ value['storage.storage_location_name']}</a>`,
                                    value['storage.storage_location_code'],
                                    value['erpWarehouse.warehouse_name'],
                                    value['storage.storage_control'],
                                    value['storage.temp_control'],
                                    value['storage.created_by'],
                                    ` <div class="dropout">
                                        <button class="more">
                                            <span></span>
                                            <span></span>
                                        ...
                                        <ul>
                                        <li>
                                            <button id="editBtn" data-id="${btoa(value.storage_location_id)}" data-toggle="modal" data-target="#editModal"><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                        </li>
                            
                                        <li>
                                            <button data-toggle="modal" data-id="${value.storage_location_id}" data-target="#viewGlobalModal"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>
                                        <li>
                            ...
                            var checkboxSettings = Cookies.get('cookieStorageloc');
            ...
            $(document).on("click", ".ion-paginationlistnew", function(e) {
                $.ajax({
                    ...
                    data: {
                        ...
                        sql_data_checkbox: Cookies.get('cookieStorageloc')
                    },
                    beforeSend: function() {
    ...
    <script>
        ...
        //     $('#home-tab').tab('show');
        //     var storage_location_id = $(this).data('id');
        //     // var hhValue = so_no + 'test';
        //     $('.auditTrail').attr("data-ccode", storage_location_id);

        //     $.ajax({
        //         type: "GET",
        //         url: "ajaxs/modals/wms/ajax-storage-loc-modal.php",
        //         dataType: 'json',
        //         data: {
        ...
        //             console.log("Check storage value",value);
        //             let data = value.data;
        ...
        //             $('#storagelocName').html(data.storage_location_name)
        //             $('#strLocname').html(data.storage_location_name)
        //             $('#strlocationCode').html(data.storage_location_code)
        //             $('#strLocCode').html(data.storage_location_code)
        //             $('#warehouse').html(data.warehouse_name)
        //             $('#storage_control').html(data.storage_control)
        //             $('#temp_control').html(data.temp_control)
        ...
        $(document).on("click", ".soModal", function() {
            ...
            $.ajax({
                ...
                success: function(value) {
                    ...
                    $('#updatedBy').html(data.updated_by)
                    $('#updatedat').html(data.updated_at)
                    $('.auditTrail').attr("data-ccode", data.storage_location_code);
                    $('#storagelocName').html(data.storage_location_name)
                    $('.strLocname').html(data.storage_location_name)
                    $('#strlocationCode').html(data.storage_location_code)
                    $('#strLocCode').html(data.storage_location_code)
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            let url = "<?php echo  BRANCH_URL . 'location/manage-storage-location-actions.php?edit=' ?>" + prId;

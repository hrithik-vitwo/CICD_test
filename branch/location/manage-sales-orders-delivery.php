...
<script>
    $(document).on("click", ".soModal", function() {
        ...
        let ajaxUrl = "ajaxs/modals/so/ajax-manage-sales-orders-delivery-modal.php";
        ...
        $.ajax({
            ...
            success: function(value) {
                ...
                if (value.status) {
                    ...
                    $("#classicViewPrint").attr('href', `classic-view/invoice-preview-print.php?delv_id=${btoa(so_delivery_id)}`);

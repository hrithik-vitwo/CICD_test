...
if (!isset($_COOKIE["cookiePendingGrn"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiePendingGrn", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Pending GRN</h3>
                                            </div>
                                        </div>

                                        <div class="right-block">
                                            <?php require_once("components/mm/grnPending-tabs.php"); ?>
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                            ...
                                            <a href="manage-grn-invoice.php" class="btn btn-create" type="button">
                                                <ion-icon name="add-outline"></ion-icon>
                                                Create
                                            </a>
                                                        ...
                                                        <div class="modal-body">
                                                            <nav>
                                                                <div class="nav nav-tabs global-view-navTabs" id="nav-tab" role="tablist">
                                                                    ...
                                                                    <button class="nav-link " id="nav-print-tab" data-bs-toggle="tab" data-bs-target="#nav-print" type="button" role="tab" aria-controls="nav-print" aria-selected="true"><ion-icon name="print-outline"></ion-icon>Print Preview</button>
                                                            ...
                                                            <div class="tab-content global-tab-content" id="nav-tabContent">
                                                                ...
                                                                <div class="tab-pane fade transactional-data-tabpane show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab">
                                                                    <div class="d-flex nav-overview-tabs overrViewNavBtn">
                                                                                    ...
                                                                                    <div class="address-contact">
                                                                                        <div class="address-customer">
                                                                                            <div class="details">
                                                                                                ...
                                                                                                <p id="vendorAddress" class="pre-normal"></p>
                                                                                            </div>
                                                                                            <div class="details">
                                                                                                <label for="">Vendor Address Recipient</label>
                                                                                                <p class="pre-normal" id="vendorAddressRecpt"></p>
                                                                                            </div>
                                                                    ...
                                                                    <div class="row orders-table" id="consideredItemDiv">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                            <div class="items-table">
                                                                                <h4>Considered Item</h4>
                                                                                <div class="multiple-item-table">
                                                                                    <div class="row head-state-table">
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Amount</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Description</div>
                                                                                        <!-- <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Product Code</div> -->
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Quantity</div>
                                                                                        <!-- <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Tax</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td">Tax Rate</div> -->
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td text-right">Unit Price</div>
                                                                                        <div class="col-lg-2 col-md-2 col-sm-2 state-col-th state-col-td text-right">Net Amount</div>
                                                                    ...
                                                                    <div class="row orders-table" id="removeItemDiv">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                            <div class="items-table">
                                                                                <h4>Remove Item</h4>
                                                                                <div class="multiple-item-table">
                                                                ...
                                                                <div class="tab-pane fade transactional-data-tabpane " id="nav-print" role="tabpanel" aria-labelledby="nav-print-tab">

                                                                    <div class="d-flex nav-overview-tabs overrViewNavBtn">

                                                                    </div>

                                                                    <iframe src='' id="grnInvoicePreviewIfram" width="100%" height="500"></iframe>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookiePendingGrn');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-pending-grn.php",
                dataType: 'json',
                data: {
                    act: 'tdata',
                    comid: comid,
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                value.sl_no,
                                `<a href="#" class="soModal" data-id="${value.grnMulId}">${value.inv_no}</a>`,
                                value.po_no,
                                value.vendor_code,
                                value.vendor_name,
                                value.gst_no,
                                ...
                                ` <div class="dropout">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <button class="changeStatus"  data-id="${value.grnMulId}" data-code="${value.invNo}" ><ion-icon name="trash-outline" class="ion-delete"></ion-icon>Delete</button>
                                        </li>


                                        <li>
                                            <button class="soModal" data-toggle="modal" data-id=${value.grnMulId} data-code="${value.invNo}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>
        ...
        $(document).on("click", ".ion-paginationliststock", function(e) {
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiePendingGrn')
                },
                beforeSend: function() {
                    $('#loaderModal').show();
...
<script>
    ...
    $(document).on("click", ".soModal", function() {
        ...
        grnMulId = $(this).data('id');
        console.log(grnMulId);

        $(".overrViewNavBtn").html('');
        let grnBtn = `<a class="btn btn-primary" href="<?= BRANCH_URL ?>location/grn-actions.php?type=grn&view=${grnMulId}" aria-selected="true">GRN</a>`;
        let srnBtn = `<a class="btn btn-primary" href="<?= BRANCH_URL ?>location/grn-actions.php?type=srn&view=${grnMulId}" aria-selected="true">SRN</a>`;
        $(".overrViewNavBtn").append(grnBtn);
        $(".overrViewNavBtn").append(srnBtn);

        $.ajax({
            type: "GET",
            url: "ajaxs/modals/grn/ajax-manage-pending-grn-modal.php",
            dataType: 'json',
            data: {
                act: "modalData",
                grnMulId
            ...
            success: function(value) {
                if (value.status) {
                    ...
                    $(".left #amount").html(responseObj.companyCurrency + " " + decimalAmount(dataObj.total_amt));
                    $("#amount-words").html("(" + responseObj.currecyNameWords + ")");
                    $("#po-numbers").html(dataObj.inv_no);
                    $(".right #cus_name").html(dataObj.vendor_name);
                    $("#default_address").html(dataObj.gst_no);
                    $('#nav-trail-tab').attr('data-ccode', dataObj.inv_no);


                    // <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${val.ProductCode}</div>

                    // <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${val.Tax}</div>
                    // <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${val.TaxRate}</div>


                    // Overview information
                    let grnData = responseObj.grnData;


                    // Vendor Details
                    if (grnData.hasOwnProperty('VendorName')) {
                        $("#vendorName").html(grnData.VendorName);
                    } else {
                        $("#vendorName").html(`: - `);
                    }

                    if (grnData.hasOwnProperty('gstin_data')) {
                        $("#vendorGst").html(grnData.gstin_data[0]);
                    } else {
                        $("#vendorGst").html(`: - `);
                    }

                    if (grnData.hasOwnProperty('pan')) {
                        $("#vendorPan").html(grnData.pan[0]);
                    } else {
                        $("#vendorPan").html(`: - `);
                    }

                    if (grnData.hasOwnProperty('VendorAddress')) {
                        $("#vendorAddress").html(grnData.VendorAddress);
                    } else {
                        $("#vendorAddress").html(`: - `);
                    }

                    if (grnData.hasOwnProperty('VendorAddressRecipient')) {
                        $("#vendorAddressRecpt").html(grnData.VendorAddressRecipient);
                    } else {
                        $("#vendorAddressRecpt").html(`: - `);
                    }

                    // Considered the item
                    if (grnData.hasOwnProperty("Items")) {
                        let itemsObj = responseObj.grnData.Items;
                        if (itemsObj.length > 0) {
                            $("#consideredItemDiv").show();
                            $.each(itemsObj, function(index, val) {
                                let td = ` <div class="row body-state-table">
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${decimalAmount(val.Amount)}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-elipse w-30 text-dark" title="${val.Description}">${val.Description}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${decimalQuantity(val.Quantity)}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"> ${decimalAmount(val.UnitPrice)}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"> ${decimalAmount(val.NetAmount)}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"> ${decimalAmount(val.cgstTax)}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"> ${decimalAmount(val.sgstTax)}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-right"> ${decimalAmount(val.igstTax)}</div>
                                        </div>
                                        `;
                    ...
                    // Other Info
                    $("#documentNo").html(`: ${dataObj.inv_no}`);

                    // Invoice                    
                    if (grnData.hasOwnProperty('InvoiceDate')) {
                        $("#documentDate").html(`: ${formatDate(grnData.InvoiceDate)}`);
                    } else {
                        $("#documentDate").html(`: - `);
                    }

                    // Po Number
                    $("#poNumber").html(`: ${dataObj.po_no}`);

                    // Remove Item
                    if (grnData.hasOwnProperty("RemovedItems")) {
                        let rmItemsObj = responseObj.grnData.RemovedItems;
                        if (rmItemsObj.length > 0) {
                            $("#removeItemDiv").show();
                            $.each(rmItemsObj, function(index, val) {
                                let temp = 0;
                                ...
                                if (val.hasOwnProperty("Quantity")) {
                                    qty = decimalQuantity(val.Quantity);
                                    temp++;
                                ...
                                if (temp >= 1) {
                                    let td = ` <div class="row body-state-table">
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td text-elipse w-30 text-dark" title="${desc}">${desc}</div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td">${qty}</div>
                                        </div>
                                        `;
                                    $("#removeItemBody").append(td);
                                }
                    ...
                    // side tax card
                    let igst = 0;
                    if (grnData.hasOwnProperty("igstTotalTax")) {
                        igst = grnData.igstTotalTax;
                    }
                    let cgst = 0;
                    if (grnData.hasOwnProperty("cgstTotalTax")) {
                        cgst = grnData.cgstTotalTax;
                    }

                    let sgst = 0;
                    if (grnData.hasOwnProperty("sgstTotalTax")) {
                        sgst = grnData.sgstTotalTax;
                    }

                    let subTotal = 0;
                    if (grnData.hasOwnProperty("SubTotal")) {
                        subTotal = grnData.SubTotal;
                    }

                    let invoiceTotal = 0;
                    if (grnData.hasOwnProperty("InvoiceTotal")) {
                        invoiceTotal = grnData.InvoiceTotal;
                    }


                    $("#cardSoNo").html(dataObj.po_no);
                    $("#sub_total").html(responseObj.companyCurrency + " " + decimalAmount(subTotal));
                    $("#total_amount").html(responseObj.companyCurrency + " " + decimalAmount(invoiceTotal));
                    ...
                    // Print preview file
                    let uploadFileSize = `<?= COMP_STORAGE_URL ?>/grn-invoice/${dataObj.uploaded_file_name}#view=fitH`;
                    $("#grnInvoicePreviewIfram").attr("src", uploadFileSize);

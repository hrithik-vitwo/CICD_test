                            ...
                            <div class="tab-content p-0" id="custom-tabs-two-tabContent">
                                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                    ...
                                    if (isset($_REQUEST['keyword2']) && $_REQUEST['keyword2'] != '') {
                                        $cond .= " AND `order_code` like '%" . $_REQUEST['keyword2'] . "%' OR `order_type` like '%" . $_REQUEST['keyword2'] . "%'";
                                    } else {
                                        if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] != '') {
                                            $cond .= " AND `order_code` like '%" . $_REQUEST['keyword'] . "%'  OR `order_type` like '%" . $_REQUEST['keyword'] . "%'";
                                        }
                                    }

                                    $sql_list = "SELECT * FROM `" . ERP_PARTY_ORDER . "` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' " . $sts . "  ORDER BY id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                    $qry_list = mysqli_query($dbCon, $sql_list);
                                    $num_list = mysqli_num_rows($qry_list);

                                    $countShow = "SELECT count(*) FROM `" . ERP_PARTY_ORDER . "` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' " . $sts . " ";
                                    $countQry = mysqli_query($dbCon, $countShow);
                                    $rowCount = mysqli_fetch_array($countQry);

                                    $ins = "SELECT * FROM `" . ERP_PARTY_ORDER . "` WHERE status='active' ORDER BY so_id DESC";
                                            ...
                                            <tbody class="tableBody">
                                                ...
                                                ?>
                                                    <tr class="tableOneRow">
                                                        ...
                                                        <?php } ?>
                                                        <td>
                                                            <a style="cursor:pointer" data-toggle="modal" data-target="#fluidModalRightSuccessDemo_<?= $oneSoList['id'] ?>" class="btn btn-sm"><i class="fa fa-eye po-list-icon"></i></a>

                                                            <div class="modal fade right customer-modal classic-view-modal" id="fluidModalRightSuccessDemo_<?= $oneSoList['id'] ?>" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                                                                        ...
                                                                        <div class="modal-header">
                                                                                ...
                                                                                <div class="icon-user-text">
                                                                                    ...
                                                                                    <div class="head-section">
                                                                                        ...
                                                                                        <div class="so_number-item">
                                                                                            ...
                                                                                            <p class="heading lead text-xs"><?= $oneSoList['order_code'] ?></p>
                                                                            ...
                                                                            <div class="display-flex-space-between mt-2 mb-2">
                                                                                ...
                                                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                                                    ...
                                                                                    <li class="nav-item">
                                                                                        <?php if($oneSoList['order_type'] == "Quotation"){ ?>
                                                                                        <a class="nav-link" href="direct-create-invoice.php?party_order_to_quotation=<?= base64_encode($oneSoList['id']) ?>">Create Quotation</a>
                                                                                        <?php }else{ ?>    
                                                                                            <a class="nav-link" href="direct-create-invoice.php?party_order_to_so=<?= base64_encode($oneSoList['id']) ?>">Create SO</a>
                                                                                    <?php } ?>    
                                                                                    </li>
                                                                                </ul>
                                                                            ...
                                                                            <div class="tab-content pt-0" id="myTabContent">
                                                                                <div class="tab-pane fade show active" id="home<?= $oneSoList['so_number'] ?>" role="tabpanel" aria-labelledby="home-tab">
                                                                                    ...
                                                                                    <div class="item-detail-section">
                                                                                        <!-- <h6>Items Details</h6> -->
                                                                                        <?php
                                                                                        $itemDetails = $BranchSoObj->fetchParyOrderItems($oneSoList['id'])['data'];
                                                                                        // console('$itemDetails');
                                                                                        // console($itemDetails);
                                                                                        $flagForBtn = 0;

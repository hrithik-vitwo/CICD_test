                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $row["gl_code"] ?></td>
                                                <td><?= $row["gl_label"] ?></td>
                                                <td class="text-right"><?= decimalValue($row["opening_val"]) ?></td>
                                                <td class="text-right"><?= decimalValue($row["debit_amount"]) ?></td>
                                                <td class="text-right"><?= decimalValue($row["credit_amount"]) ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right font-weight-bold"><?= decimalValue((-1)*$grandTotalOpening) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue(0) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue(0) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue((-1)*$grandTotalClosing) ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td class="font-weight-bold">Total</td>
                                            <!-- <td class="text-right font-weight-bold"><?= decimalValue($grandTotalOpening) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue($grandTotalDebit) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue($grandTotalCredit) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue($grandTotalClosing) ?></td> -->
                                            <td class="text-right font-weight-bold"><?= decimalValue(0) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue($grandTotalDebit) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue($grandTotalCredit) ?></td>
                                            <td class="text-right font-weight-bold"><?= decimalValue(0) ?></td>

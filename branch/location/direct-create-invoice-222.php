              ...
              <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <?php if ($quotation_createion) { ?>
                    <div class="row others-info-form-view justify-content-center dotted-border-area" style="row-gap: 15px;">
                  ...
                  <?php } else { ?>
                    <div class="row others-info-form-view justify-content-center" style="row-gap: 15px;">
                      ...
                      <?php if ($sales_order_creation || $quotation_to_so) { ?>
                        ...
                        <?php } else { ?>
                          ...
                          <div class="row dotted-border-area mt-2">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                              <div class="form-input">
                            ...
                            <?php if (!isset($_GET['quotation_to_so']) && !isset($_GET['sales_order_creation']) && !isset($_GET['quotation_createion'])) { ?>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-input">
                                  <label for="">Invoice Varient <span class="text-danger">*</span></label>
                                ...
                                <div class="display-flex" style="justify-content: flex-end;">
                                  <p class="label-bold text-italic py-2" style="white-space: pre-line;"><span class="mr-1 text-xs">e.i- </span> <span class="ivnumberexample text-xs"><?= $ivselecetd; ?></span></p>
                                </div>
                              </div>
                ...
                <table class="table table-sales-order mt-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php } elseif (isset($_GET['so_to_invoice'])) {  ?>
                        <td colspan="10" class="text-right p-2" style="border: none; background: none;"> </td>
                      <?php
                      } else {
                      ?>

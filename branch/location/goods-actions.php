                          ...
                          <div class="row goods-info-form-view customer-info-form-view">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                              ...
                              <div class="boq-checkbox" id="boqCheckBoxDiv" style="display:none;">
                                ...
                                <p class="text-xs"><span class="text-danger pr-2">*</span><b>What is the significance ?</b></p>
                                <ul>
                                  <li>
                            ...
                            <div class="row goods-info-form-view customer-info-form-view">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <input step="0.01" type="number" name="min_stock" id="stock" class="form-control stock inputQuantityClass" id="exampleInputBorderWidth2">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <input step="0.01" type="number" name="max_stock" id="stock" class="form-control stock inputQuantityClass" id="exampleInputBorderWidth2">
                                ...
                                <div class="row dash-border-row">
                                  ...
                                  <div class="col-lg-12 col-md-12 col-sm-12 px-0 pt-3">
                                    ...
                                    <div class="form-input" style="display:none;" id="mwp">
                                      ...
                                      <input step="0.01" type="number" name="rate" id="rate" class="form-control rate inputAmountClass" id="exampleInputBorderWidth2" value="0">
                            ...
                            <div class="row goods-info-form-view customer-info-form-view">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <input step="0.01" type="number" name="min_stock" id="stock" class="form-control stock inputQuantityClass" id="exampleInputBorderWidth2" value="<?= inputQuantity($getPricing['data']['min_stock']) ?>">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-input">
                                  ...
                                  <input step="0.01" type="number" name="max_stock" id="stock" class="form-control stock inputQuantityClass" id="exampleInputBorderWidth2" value="<?= inputQuantity($getPricing['data']['max_stock']) ?>">
                              ...
                              ?>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="cost-center" id="cost-center">
                                    <label for="">Cost Center</label>
                                    <input type="hidden" name="costCenter" value="<?=$row['cost_center']?>">
                              ...
                              ?>
                                <div class="col-lg-12 col-md-12 col-sm-12 px-0 pt-3">
                                  ...
                                  <div class="form-input" id="mwp">
                                    ...
                                    <input step="0.01" type="number" name="rate" id="rate" class="form-control rate inputAmountClass" id="exampleInputBorderWidth2" value="<?= inputValue($getPricing['data']['movingWeightedPrice']) ?>">
...
<script>
  ...
  $(document).on('click', ".close-img", function(event) {
    ...
    $('#glCode').select2();
    $('#asset_classification_select').select2();
    $('#glCodeAsset').select2();
...
<script>
  $(document).ready(function() {
    ...
    function loadhsn(pageNo, limit, keyword = null,selected=null) {
      // alert(selected);
      $.ajax({
        method: 'POST',
        data: {
    ...
    $(document).ready(function() {
      ...
      $('#searchbar').on('keyup keydown paste', function() {
        ...
        var pageNo = 0;
        var limit = 50;
        var selected = $('input[name="hsn"]:checked').val();
        //alert(selected);
        loadhsn(pageNo, limit, keyword,selected);
      });
    });

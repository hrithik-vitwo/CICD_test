...
if (!isset($_COOKIE["cookiesTds"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiesTds", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                value.amount,
                                value.due_amount,
                                `<a href="#" class="soModal"  data-id="${value.process_id}" data-code="${value.process_id}" data-toggle="modal" data-target="#viewGlobalModal">${  decimalAmount(value.amount - value.due_amount)}</a>`,
                        ...
                        var checkboxSettings = Cookies.get('cookiesTds');
        ...
        $(document).on("click", ".ion-paginationlistnew", function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiesTds')
                },
                beforeSend: function() {

...
if (!isset($_COOKIE["cookieitemDiscountGroup"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookieitemDiscountGroup", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    } else {
        for ($i = 0; $i < 5; $i++) {
...
$columnMapping = [
    ...
    [
        'name' => 'Manage Item Discount Group',
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space"
                                        ...
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Manage Item Discount Group
                                                </h3>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="filter-action filter-mobile-search mobile-page">
                                                            ...
                                                            <div class="exportgroup mobile-page mobile-export">
                                                                ...
                                                                <ul class="export-options">
                                                                    <li>
                                                                        <button class="ion-paginationlistitemDisGroup">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-paginationlistitemDisGroup md hydrated"
                                                                                id="exportAllBtn" role="img"
                                                                                aria-label="list outline"></ion-icon>Export
                                                                        </button>
                                                                    </li>
                                                                    <li>
                                                                        <button class="ion-fulllistitemDisGroup">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-fulllistitemDisGroup md hydrated"
                                                                                role="img"
                                        ...
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active"
                                            ...
                                            <div class="filter-action">
                                                ...
                                                <div class="length-row">
                                                    <span>Show</span>
                                                    <select name="" id="cusitemGroupLimit" class="custom-select">
                                                        <option value="10">10</option>
                                                        <option value="25" selected="selected">25</option>
                                                        <option value="50">50</option>
                                                        <option value="100">100</option>
                                            ...
                                            <div class="exportgroup">
                                                ...
                                                <ul class="export-options">
                                                    ...
                                                    <li>
                                                        ...
                                                        <button class="ion-fulllistitemDisGroup">
                                                            <ion-icon name="list-outline"
                                                                class="ion-fulllistitemDisGroup md hydrated" role="img"
                                                                aria-label="list outline"></ion-icon>Download
                                                        </button>
                                                    </li>
                                                </ul>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div id="main2">
                                                                        ...
                                                                        <table class="colomnTable">
                                                                            <?php
                                                                            $cookieTableStockReport = json_decode($_COOKIE["cookieitemDiscountGroup"], true) ?? [];
...
<script>
    ...
    $(document).ready(function () {
        ...
        //     $.ajax({
        //         type: "POST",
        //         url: "ajaxs/discount/ajax-item-discount-group-all.php",
        //         dataType: 'json',
        //         data: {
        //             act: 'alldata',
        //         },
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookieitemDiscountGroup');
                        ...
                        $.each(responseObj, function (index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                ` <div class="dropout">
                                     ...
                                     <ul>
                                     <li>
                                         <button data-toggle="modal" class="edititemdiscountMrpbtn" data-itemdisgrpname="${value.item_discount_group}" data-itemdisgrpid="${value.item_discount_group_id}" 
        ...
        $(document).on('click', '.edititemdiscountMrpbtn', function (e) {
            var itemdisgrpname = $(this).data('itemdisgrpname');
            var itemdisgrpid = $(this).data('itemdisgrpid');
            $("#editFunctionality").modal('show');
            $("#edititemdisGrpname").val(itemdisgrpname);
            $("#edititemDisgrpid").val(itemdisgrpid);
        })


        $(document).on('click', "#update_itemDispgrpName", function (e) {
            e.preventDefault();
            let itemdisgrpname = $("#edititemdisGrpname").val();
            let itemdisgrpid = $("#edititemDisgrpid").val();
            // check confirmation
            // alert(cusdisgrpname + cusdisgrpid)
            Swal.fire({
                icon: 'warning',
                title: `Are you confirmed to edit the Item Discount Name (${itemdisgrpname})?`,
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {
                            act: 'updateitemDisGrp',
                            itemdisgrpname: itemdisgrpname,
                            itemdisgrpid: itemdisgrpid
                        },
                        url: 'ajaxs/discount/ajax-item-discount-group-all.php',
                        beforeSend: function () {
                        },
        ...
        $(document).on('click', '.additemdiscountMrpbtn', function (e) {
            $("#funcAddForm").modal('show');
        })


        $(document).on('click', "#add_itemDispgrpName", function (e) {
            e.preventDefault();
            let itemdisgrpname = $("#additemdisGrpname").val();
            // check confirmation
            Swal.fire({
                icon: 'warning',
                title: `Are you confirmed to add the item Discount Group Name (${itemdisgrpname})?`,
                showCancelButton: true,
                confirmButtonColor: '#198754',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Confirm',
        ...
        $(document).on("click", ".ion-paginationlistitemDisGroup", function (e) {
            $.ajax({
                type: "POST",
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookieitemDiscountGroup')
                },
                beforeSend:function(){
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-paginationlistitemDisGroup').prop('disabled', true)
                },
                ...
                complete: function() {
                    ...
                    $('#loaderModal').hide();
                    $('.ion-paginationlistitemDisGroup').prop('disabled', false);
                }
            })

        });
        $(document).on("click", ".ion-fulllistitemDisGroup", function (e) {
            $.ajax({
                type: "POST",
                url: "ajaxs/discount/ajax-item-discount-group-all.php",
                dataType: "json",
                ...
                beforeSend:function(){
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-fulllistitemDisGroup').prop('disabled', true)
                },
                success: function(response) {
                ...
                complete: function() {
                    // Hide loader modal after request completes
                    $('#loaderModal').hide();
                    $('.ion-fulllistitemDisGroup').prop('disabled', false);
                }
            })
        ...
        $(document).on("click", "#pagination a", function (e) {
            ...
            var limitDisplay = $("#cusitemGroupLimit").val();

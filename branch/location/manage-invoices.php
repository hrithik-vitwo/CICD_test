                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-submenu" id="invoiceDropdown">
                                                            ...
                                                            <hr>
                                                            <li><a class="dropdown-item" href="direct-create-invoice.php?proforma_invoice">Proforma Invoice</a></li>
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($columnMapping as $columnIndex  => $column) {
                                                                            if ($columnIndex === 0 || $columnIndex === 4 || $columnIndex === 8) {
                                                                                continue;
                                                                            } ?>
                                                                            <tr>
                                                                                <td>
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            if (value.status === 'active') {
                                ...
                                reverseInvBtn = `<li>
                                         <button class="repostInvoice" data-id="${value.soInvoiceId}" data-code="${value.invNo}" ><i class="far fa-retweet po-list-icon"></i></ion-icon>Repost</button>
                                    </li>
                                `;
                            }
                            ...
                            if (value.status === 'reverse') {
                                invStatus = `<p class="status-bg status-closed">Reverse</p>`;
                            ...
                            if (value.status === "active") {
                                editBtn = `                               
                                        <li>
                                            <button class="editInvBtn" data-id=${value.soInvoiceId} data-code="${value.invNo}"><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                        </li>`;
                            }
...
<script>
    ...
    $(document).on("click", ".soModal", function() {
        ...
        //t$c 
        var templateId = $('#templateSelectorCompany').val();
        // alert(templateSelectorCompany);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('.auditTrailBodyContentLine').attr("data-id", soInvId);
...
<script>
    ...
    $(document).on('click', '.editInvBtn', function() {
        ...
        let url = `direct-create-invoice.php?edit_invoice=${btoa(id)}`;
        Swal.fire({
            icon: 'warning',
            title: 'Are you sure?',
    ...
    $(document).on('click', '.repostInvoice', function() {
        let id = $(this).data('id');
        let code = $(this).data('code');
        let url = `direct-create-invoice.php?repost_invoice=${btoa(id)}`;
        Swal.fire({
            icon: 'warning',
            title: 'Are you sure?',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            try {
                                ...
                                console.error(e);
                                console.log("Error in Reverse Invoice: " + response);
                            }

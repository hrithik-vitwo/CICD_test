                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Quality Analysis</h3>
                                            </div>
                                        </div>

                                        <div class="right-block">
                                            <?php require_once("components/qltanalysis/quality-analysis-tabs.php"); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fill_datatable(formDatas = '', pageNo = '', limit = '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-recieved-items-rejected.php",
                    dataType: 'json',
                    data: {
                        act: 'poRecievedItemsRejected',
                        comid: comid,
                        locId: locId,
                        bId: bId,
                        formDatas: formDatas,
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            var checkboxSettings = Cookies.get('cookiesPoItemsRejected');

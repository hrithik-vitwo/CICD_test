...
$columnMapping = [
    ...
    [
        'name' => 'Unit Price',
        'slag' => 'po_items.unitPrice',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Value(total)',
        'slag' => 'po_items.total_price',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'number'
    ],
    [
        'name' => 'Value(remaining)',
        'slag' => 'remaining_price',
        'icon' => '<ion-icon name="location-outline"></ion-icon>',
        'dataType' => 'number'
    ]
];
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">PO Items</h3>
                                            </div>
                                        </div>
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($columnMapping as $columnIndex  => $column) {
                                                                            if ($columnIndex === 0 || $column['name'] == 'Value(remaining)') {
                                                                                continue;
                                                                            } ?>
                                                                            <tr>
                                                                                <td>
                        ...
                        if (response.status) {
                            ...
                            $.each(responseObj, function(index, value) {
                                ...
                                dataTable.row.add([
                                    ...
                                    value["po_items.qty"],
                                    value["po_items.remainingQty"],
                                    value.uom,
                                    value["po_items.unitPrice"],
                                    value["po_items.total_price"],
                            ...
                            var checkboxSettings = Cookies.get('cookiesPoItems');
            ...
            $(document).on("click", ".ion-paginationliststock", function(e) {
                $.ajax({
                    ...
                    data: {
                        ...
                        sql_data_checkbox: Cookies.get('cookiesPoItems')
                    },
                    beforeSend: function() {
                        $('#loaderModal').show();
            ...
            $(document).ready(function() {
                $(document).on("click", "#serach_submit", function(event) {
                    ...
                    $(".selectOperator").each(function() {
                        ...
                        if ((columnSlag === 'delivery_date' || columnSlag === 'po_date') && operatorName == "BETWEEN") {
    ...
    <script>
        $(document).ready(function() {
            $(document).on("change", ".selectOperator", function() {
                ...
                let inputId;
                if (columnName === 'Schedule Date') {
                    inputId = "value3_" + columnIndex;
                } else if (columnName === 'PO Date') {
                    inputId = "value2_" + columnIndex;
                }

                if ((columnName === 'Schedule Date' || columnName === 'PO Date') && operatorName === 'BETWEEN') {

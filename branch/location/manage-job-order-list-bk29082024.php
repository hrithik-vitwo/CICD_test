...
// $subs = $BranchSoObj->subscriptionInvoice();
// console("*************////++++***********");
// console('$subs');
// console($subs);
global $company_id;
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="form-input">
                                                    ...
                                                    <select name="kamId" class="form-control" id="kamDropDown" required>
                                                        ...
                                                        ?>
                                                            <option value="<?= $func['kamId'] ?>"><?= $func['kamName'] ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card items-select-table">
                            ...
                            <table class="table table-sales-order mt-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="9" class="text-right p-2" style="border: none; background: none;">
                                        </td>
                                        ...
                                        <td id="grandSubTotalAmt" class="p-2" style="border: none; background: none;">0.00
                                            </th>
                                    </tr>
                                    <tr>
                                        <td colspan="9" class="text-right p-2" style="border: none; background: none;">
                                        ...
                                        <td id="grandTotalDiscount" class="p-2" style="border: none; background: none;">0.00
                                        </td>
                                    </tr>
                                    <tr class="p-2">
                                        <td colspan="9" class="text-right p-2" style="border: none; background: none;">
                                        </td>
                                        <td colspan="0" class="text-left p-2 font-weight-bold totalCal" style="border: none; background: none;">TOTAL <sup class="text-info">[TAX]</sup>
                                        </td>
                          ...
                          <a href="<?php echo basename($_SERVER['PHP_SELF']) ?>?customer-so-creation" class="btn btn-primary relative-add-btn"><i class="fa fa-plus"></i></a>
                                        ...
                                        <div class="modal fade list-filter-search-modal" id="btnSearchCollpase_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Filter Pending
                                                            Sales Order</h5>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                        ...
                                        $sql_list = "SELECT * FROM `" . ERP_BRANCH_SALES_ORDER . "` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' AND goodsType='project' AND approvalStatus='9' AND jobOrderApprovalStatus=14 " . $sts . "  ORDER BY so_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                                        $qry_list = mysqli_query($dbCon, $sql_list);
                                        $num_list = mysqli_num_rows($qry_list);

                                        $countShow = "SELECT count(*) FROM `" . ERP_BRANCH_SALES_ORDER . "` WHERE 1 " . $cond . "  AND company_id='" . $company_id . "'  AND branch_id='" . $branch_id . "'  AND location_id='" . $location_id . "' AND goodsType='project' AND approvalStatus=9 AND jobOrderApprovalStatus=14 " . $sts . " ";
                                                                    ...
                                                                    <div class="modal-dialog modal-full-height modal-right modal-notify modal-success" role="document">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-header">
                                                                                ...
                                                                                <div class="so-header">
                                                                                    ...
                                                                                    <div class="icon-user-text">
                                                                                        ...
                                                                                        <p class="text-sm text-white mt-3">
                                                                                            <?= $customerDetails['trade_name'] ?>
                                                                                        </p>

                                                                                        <div class="d-flex so_number-item mt-1 mb-2">

                                                                                            <p class="heading lead text-xs">
                                                                                                <?= $oneSoList['so_number'] ?></p>

                                                                                            <div class="item-count text-xs">
                                                                                                <p class="round-item-count text-xs">
                                                                                ...
                                                                                $itemDetails = queryGet("SELECT * FROM `" . ERP_BRANCH_SALES_ORDER_ITEMS . "` WHERE `so_id`='" . $oneSoList['so_id'] . "' AND invStatus='pending' AND status='active'", true)['data'];
                                                                                ...
                                                                                foreach ($itemDetails as $oneItem) {
                                                                                    ...
                                                                                    $grandTotalAmt += $itemTotalAmt;
                                                                                }
                                                                                ?>
                                                                                <div class="customer-head-info mb-0 mt-2">
                                                                                    <div class="customer-name-code">
                                                                                        <h2 class="text-lg mb-0">
                                                                                            <small><?= $oneSoList['currency_name'] ?></small><?= $grandTotalAmt ?>
                                                                                        </h2>
                                                                                        <p class="text-xs">
                                                                                            (<?= number_to_words_indian_rupees($grandTotalAmt) ?>)
                                                                                        </p>
                                      ...
                                      <i class="fa fa-user"></i>
                                        ...
                                        <a class="nav-link" target="_blank" href="branch-so-invoice-view.php?so_id=<?= base64_encode($oneSoList['so_id']) ?>">Classic View</a>
                                                                                        ...
                                                                                        <li class="nav-item">
                                                                                            <a class="nav-link" id="classic-view-tab" data-toggle="tab" href="#classic-view<?= $oneSoList['so_number'] ?>" role="tab" aria-controls="classic-view" aria-selected="false">Classic
                                                                                                View</a>
                                                                                        </li>
                                                                                        ...
                                                                                        <div class="action-btns display-flex-gap create-delivery-btn-sales" id="action-navbar">
                                                                                            ...
                                                                                            ?>
                                                                                                    <div class="d-flex btnHideShow<?= $oneSoList['so_id']; ?>">
                                                                                                        <a href="manage-sales-orders-delivery.php?create-sales-order-delivery=<?= base64_encode($oneSoList['so_number']) ?>" class="btn-primary text-xs text-light deliveryCreationBtn pl-2 pr-2"><i class="fa fa-plus mr-2"></i>Create
                                                                                                            Delivery</a>
                                                                                                        <a title="Create Invoice" href="direct-create-invoice.php?so_to_invoice=<?= base64_encode($oneSoList['so_id']) ?>" class="btn-primary text-xs text-light deliveryCreationBtn pl-2 pr-2 ml-2"><i class="fa fa-plus mr-2"></i>Create
                                                                                                            Invoice</a>
                                                                                                    </div>
                                                                                                <?php
                                                                                                } else if ($oneSoList['goodsType'] == 'project') { ?>
                                                                                                    <a title="Create Invoice" href="direct-create-invoice.php?joborder_to_invoice=<?= base64_encode($oneSoList['so_id']) ?>" class="btn-primary text-xs text-light deliveryCreationBtn pl-2 pr-2 ml-2"><i class="fa fa-plus mr-2"></i>Create
                                                                                                        Invoice</a>
                                                                                                <?php } else {
                                                                                                ?>
                                                                                                    <a title="Create Invoice" href="direct-create-invoice.php?so_to_invoice=<?= base64_encode($oneSoList['so_id']) ?>" class="btn-primary text-xs text-light deliveryCreationBtn pl-2 pr-2 ml-2"><i class="fa fa-plus mr-2"></i>Create
                                                                                                ...
                                                                                                <a title="Delivery Creation" href="#" class="btn-warning text-xs text-dark deliveryCreationBtn pl-2 pr-2"><i class="fa fa-clock mr-2"></i>
                                                                                                    Pending For Approval</a>
                                                                                            <?php } else if ($oneSoList['approvalStatus'] == 10) { ?>
                                                                                                <a title="Delivery Creation" href="#" class="btn-secondary text-xs text-light deliveryCreationBtn pl-2 pr-2"><i class="fa fa-check-circle mr-2"></i>
                                                                                                    Delivery Closed</a>
                                                                                            <?php } ?>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                                                <div class="dFlex">
                                                                                                                    ...
                                                                                                                    <div class="text-xs">
                                                                                                                        <p class="text-right">
                                                                                                                            <?php if ($oneItem['invStatus'] == "done") { ?>
                                                                                                                                <span class="font-weight-bold my-1 shadow-sm text-uppercase border border-success text-success px-2"><i class="fas fa-check-circle"></i>
                                                                                                                                    <?= $oneItem['invStatus'] ?></span>
                                                                                                                            <?php } elseif ($oneItem['invStatus'] == "pending") { ?>
                                                                                                                                <span class="font-weight-bold my-1 shadow-sm text-uppercase border border-warning text-muted px-2"><i class="far fa-clock"></i>
                                                                                                                                    <?= $oneItem['invStatus'] ?></span>
                                                                                                                            <?php } ?>
                                                                                                                        </p>
                                                                                                                        <p class="text-right">Qty : <?= $oneItem['completion_value'] ?> <?= $uomName ?></p>
                                                                                                                        <!-- <p class="text-right"> Remaining <?= $oneItem['remainingQty'] ?> of <?= $oneItem['qty'] ?> <?= $uomName ?></p> -->
                                                                                                                        <p class="text-right"><span class="rupee-symbol"><small><?= $oneSoList['currency_name'] ?></small></span><?= number_format($oneItem['unitPrice'], 2) ?>
                                                                                                                        </p>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                                                <div class="right-section">
                                                                                                                    <div class="dFlex p-0">
                                                                                                                        <span class="mr-3 text-xs font-bold mb-2">Sub
                                                                                                                            Total</span>
                                                                                                                    ...
                                                                                                                    <?php if ($oneItem['totalDiscount'] > 0) { ?>
                                                                                                                        <div class="discount dFlex p-0">
                                                                                                                            <span class="mr-3 text-xs font-bold mb-2">Total
                                                                                                                                Discount
                                                                                                                            </span>
                                                                                                                            <div>
                                                                                                                                <span class="rupee-symbol text-xs font-bold mb-2"><small><?= $oneSoList['currency_name'] ?></small><?= $itemTotalDiscount ?></span>
                                                                                                                    ...
                                                                                                                    <div class="dFlex p-0">
                                                                                                                        <span class="mr-3 text-xs font-bold mb-2">Total
                                                                                                                            Tax </span>
                                                                                                                        <div>
                                                                                                                            <span class="rupee-symbol text-xs font-bold mb-2"><small><?= $oneSoList['currency_name'] ?></small><?= $itemTotalTax ?></span>
                                                                                                                            <span class="text-xs">(<?= $oneItem['tax'] ?>%)</span>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div style="border-top: 1px solid;" class="font-weight-bold dFlex">
                                                                                                                        <span class="text-xs font-bold">Total
                                                                                                                            Amount</span>
                                                                                                                        <span class="rupee-symbol text-xs font-bold mb-2"><small><?= $oneSoList['currency_name'] ?></small><?= number_format($itemTotalAmt, 2) ?>
                                                                                                                    </div>
                                                                                                                    <!-- <div class="discount">
                                                    ...
                                                    (-<?= $oneItem['totalDiscount'] ?>%)
                                                                                                            ...
                                                                                                            <div class="p-0 pt-1 my-2">
                                                                                                                <ul class="nav nav-tabs" style="border: none;" id="custom-tabs-two-tab" role="tablist">
                                                                                                                    <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                                                                                                                        ...
                                                                                                                        <span><?= $boqDetailObj["data"]["boq_data"]["itemCode"] ?? "" ?>
                                                                                                                            -
                                                                                                                            <?= $boqDetailObj["data"]["boq_data"]["itemName"] ?? "" ?></span>
                                                            ...
                                                            <a href="?editboq=<?= $_GET["view"] ?? '' ?>" class="btn btn-sm btn-primary ml-2">Change Items</a>
                                                                                                            ...
                                                                                                            <div class="">
                                                                                                                <div class="card">
                                                                                                                    <div class="card-body">
                                                                                                                        <p class="text-left m-0 pl-3 pb-2 font-bold">
                                                                                                                            Service
                                                                                                                            Items</p>
                                                                                                                        <table class="table">
                                                                                                                            <thead>
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                ...
                                                                                                                                ?>
                                                                                                                                    <tr>
                                                                                                                                        <td><?= $boqOneItem["itemCode"] ?? "" ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["itemName"] ?? "" ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["consumption"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["extra"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["uom"] ?>
                                                                                                                                        ...
                                                                                                                                        <td><?= $boqOneItem["amount"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["remarks"] ?>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                <?php
                                                                                                                                }
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                ...
                                                                                                                                ?>
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td><?= $boqOneItem["cost_center_id"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["cost_center_id"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= strtoupper($boqOneItem["head_type"]) ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["consumption"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["extra"] ?>
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                ...
                                                                                                                                ?>
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td><?= ucfirst($boqOneItem["head_name"] ?? "") ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["consumption"] ?>
                                                                                                                                        </td>
                                                                                                                                        <td><?= $boqOneItem["extra"] ?>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                    <div class="card">
                                                                                                                        <div class="card-body">
                                                                                                                            ...
                                                                                                                            <form action="" method="post">
                                                                                                                                ...
                                                                                                                                <button type="submit" name="addCOGSFormSubmitBtn" class="btn btn-sm btn-primary text-xs mb-4 mr-3 float-right" value="Create COGS">Create
                                                                                                                                    COGS</button>
                                                                                                                            </form>
                                                                                                                    ...
                                                                                                                    <script>
                                                                                                                        $(document).ready(
                                                                                                                            function() {
                                                                                                                                function addOtherAddonsFormItem(
                                                                                                                                    rowNo =
                                                                                                                                    0) {
                                                                                                                                    $("#otherAddonsForm")
                                                                                                                                        .append(`
                                            <tr id="otherAddonItemTr_${rowNo}">
                                                ...
                                                <td>
                                                    ${rowNo==0?`<i class="fa fa-plus bg-success rounded p-1 mt-2 addOtherAddonItemBtn" style="cursor: pointer;"></i>`:`<i class="fa fa-minus bg-danger rounded p-1 mt-2 removeOtherAddonItemBtn" style="cursor: pointer;"></i>`}
                                                                                                                                    ...
                                                                                                                                    $(`#boqOtherAddonItemGl_${rowNo}`)
                                                                                                                                        .select2();
                                                                                                                                }

                                                                                                                                addOtherAddonsFormItem
                                                                                                                                    (rowNo =
                                                                                                                                        0);
                                                                                                                                // adding other addon items to boq list
                                                                                                                                var otherAddonItemsRowNo =
                                                                                                                                    0;
                                                                                                                                $(document)
                                                                                                                                    .on("click",
                                                                                                                                        ".addOtherAddonItemBtn",
                                                                                                                                        function() {
                                                                                                                                            addOtherAddonsFormItem
                                                                                                                                                (otherAddonItemsRowNo +=
                                                                                                                                                    1
                                                                                                                                                );
                                                                                                                                        });
                                                                                                                ...
                                                                                                                ?>
                                                                                                                        ...
                                                                                                                        <div class="card-body">
                                                                                                                            ...
                                                                                                                            <table class="table mb-3">
                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    ...
                                                                                                                                    ?>
                                                                                                                                            <tr>
                                                                                                                                                <td><?= $boqOneItem["othersItem"] ?>
                                                                                                                                                </td>
                                                                                                                                                <td><?= $boqOneItem["itemGl"] ?>
                                                                                                                                                </td>
                                                                                                                                                <td><?= $boqOneItem["amount"] ?>
                                                                                                                                                </td>
                                                                                                                                                <td><?= $boqOneItem["remarks"] ?>
                                                                                                                    ...
                                                                                                                    <div class="card">
                                                                                                                        <div class="card-body">
                                                                                                                            <p class="text-left pl-3 pb-2 font-bold">
                                                                                                                                Discount &
                                                                                                                                Margins</p>
                                                                                                                            <table class="table">
                                                                                                                                <thead>
                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td><input type="text" class="form-control mt-2 mb-2" name="boqDiscount" placeholder="boq Discount" />
                                                                                                                                        </td>
                                                                                                                                        <td><input step="0.01" type="number" class="form-control mt-2 mb-2" name="boqMargin" placeholder="boq margings" />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
                                                                                            ...
                                                                                            <script>
                                                                                                ...
                                                                                                ?>
                                                                                                    $(".btnHideShow<?= $oneSoList['so_id'] ?>")
                                                                                                        .html(
                                                                                                            '<a href="#" class="bg-success text-xs text-light deliveryCreationBtn"><i class="fa fa-check-circle"></i> Delivery Created</a>'
                                                                                                        );
                                                                                                <?php
                                                                                                        ...
                                                                                                        <div class="card h-100">
                                                                                                            <div class="card-body p-3" style="height: 245px !important;">
                                                                                                                <div class="display-flex-space-between">
                                                                                                                    <p class="font-bold text-xs text-left">
                                                                                                                        Code :</p>
                                                                                                                    <p class="font-bold text-xs text-left">
                                                                                                                ...
                                                                                                                <div class="display-flex-space-between">
                                                                                                                    ...
                                                                                                                    <p class="font-bold text-xs text-left w-75">
                                                                                    ...
                                                                                    <div class="tab-pane fade" id="history<?= $oneSoList['so_id'] ?>" role="tabpanel" aria-labelledby="history-tab">
                                                                                        <div class="audit-head-section mb-3 mt-3 ">
                                                                                            <p class="text-xs font-italic"><span class="font-bold text-normal">Created
                                                                                                    by </span>
                                                                                                <?= getCreatedByUser($oneSoList['created_by']) ?>
                                                                                                <span class="font-bold text-normal">
                                                                                                    on </span>
                                                                                                <?= formatDateORDateTime($oneSoList['created_at']) ?>
                                                                                            </p>
                                                                                            <p class="text-xs font-italic"> <span class="font-bold text-normal">Last
                                                                                                    Updated by</span>
                                                                                                <?= getCreatedByUser($oneSoList['updated_by']) ?>
                                                                                                <span class="font-bold text-normal">
                                                                                                    on </span>
                                                                                                <?= formatDateORDateTime($oneSoList['updated_at']) ?>
                                                                                            </p>
                                                                                        </div>
                                                                                        <hr>
                                                                                        <div class="audit-body-section mt-2 mb-3 auditTrailBodyContent<?= $oneSoList['so_number'] ?>">
                                                                                            ...
                                                                                            <ol class="timeline">
                                                                                                ...
                                                                                                <p class="mt-0 mb-5 ml-5">Loading...
                                                                                                </p>
...
<script>
    $(document).ready(function() {
        ...
        function so_check_date() {
            ...
            if (date < min) {
                $(".soDateMsg").html(
                    `<p class="text-danger text-xs" id="podatelabel">Invalid SO creation Date</p>`);
        ...
        function delivery_check_date() {
            ...
            if (deliveryDate < soDate) {
                $(".deliveryDateMsg").html(
                    `<p class="text-danger text-xs" id="podatelabel">Invalid Delivery creation Date</p>`);
                document.getElementById("soCreationBtn").disabled = true;
            } else {
                $(".deliveryDateMsg").html("");
                document.getElementById("soCreationBtn").disabled = false;
        ...
        $(document).on('click', '#save', function() {
            ...
            if (billingNo != '' && flatNo != '' && streetName != '' && location != '' && city != '' &&
        ...
        function calculateOneItemAmounts(rowNo) {
            let itemQty = (parseFloat($(`#itemQty_${rowNo}`).val()) > 0) ? parseFloat($(`#itemQty_${rowNo}`)
                .val()) : 0;
            let itemUnitPrice = (parseFloat($(`#itemUnitPrice_${rowNo}`).val()) > 0) ? parseFloat($(
                `#itemUnitPrice_${rowNo}`).val()) : 0;
            let itemDiscount = (parseFloat($(`#itemDiscount_${rowNo}`).val())) ? parseFloat($(
        ...
        function calculateQuantity(rowNo, itemId, thisVal) {
            ...
            let itemQty = (parseFloat($(`#itemQty_${itemId}`).val()) > 0) ? parseFloat($(`#itemQty_${itemId}`)
                .val()) : 0;
            let totalQty = 0;

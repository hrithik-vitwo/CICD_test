...
if (!isset($_COOKIE["cookiesPartyorder"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiesPartyorder", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    }
}
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space"
                                        ...
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Request From Customer</h3>
                                            </div>
                                        </div>
                                            ...
                                            <div id="modal-container">
                                                <div class="modal-background">
                                                    <div class="modal">
                                                        ...
                                                        <h5>Filter Pages</h5>
                                                        <div
                                                            class="page-list-filer filter-list mobile-page mobile-filter-list">
                                                        ...
                                                        <div class="filter-action filter-mobile-search mobile-page">
                                                            ...
                                                            <div class="exportgroup mobile-page mobile-export">
                                                                ...
                                                                <ul class="export-options">
                                                                    <li>
                                                                        <button class="ion-fulllistpartyOrderlist">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-fulllistpartyOrderlist md hydrated"
                                                                    ...
                                                                    <li>
                                                                        <button
                                                                            class="ion-paginationlistpartyOrderlist">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-paginationlistpartyOrderlist md hydrated"
                                                                                role="img"
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active"
                                            ...
                                            <div class="exportgroup">
                                                ...
                                                <ul class="export-options">
                                                    <li>
                                                        <button class="ion-paginationlistpartyOrderlist">
                                                            <ion-icon name="list-outline"
                                                                class="ion-paginationlistpartyOrderlist md hydrated"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div id="main2">
                                                                        ...
                                                                        <table class="colomnTable">
                                                                            <?php
                                                                            $cookieTableStockReport = json_decode($_COOKIE["cookiesPartyorder"], true) ?? [];
                                                            ...
                                                            <div class="top-details">
                                                                <div class="left">
                                                                    ...
                                                                    <p class="info-detail po-number"><ion-icon
                                                                            name="information-outline"></ion-icon>Order
                                                                        Date:- <span id="po-numbers"> </span></p>
                                                                </div>
                                                                <div class="right">
                                                            ...
                                                            <div class="tab-content global-tab-content"
                                                                ...
                                                                <div class="tab-pane fade transactional-data-tabpane show active"
                                                                    ...
                                                                    <div class="d-flex nav-overview-tabs">
                                                                        <div
                                                                            class="action-btns display-flex-gap create-delivery-btn-sales">
                                                                            <a href="" type="button"
                                                                                class="btn btn-primary"
                                                                                id="navBtn"><span
                                                                                    id="navBtnName">demo</span></a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '', columnMapping = '') {
            ...
            var checkboxSettings = Cookies.get('cookiesPartyorder');
            var notVisibleColArr = [];

            $.ajax({
                type: "POST",
                url: "ajaxs/ajax-manage-party-order.php",
                dataType: 'json',
                data: {
                    act: 'tdata',
                    comid: comid,
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        $.each(responseObj, function(index, value) {
                            ...
                            // let status = '';
                            // if (value['so.status'] == "active") {
                            //     status = '<p class="status-bg status-open">Active</p>';
                            // } else if (value['so.status'] == "inactive") {
                            //     status = '<p class="status-bg status-pending">Inactive</p>';
                            // } else {
                            //     status = `<p class="status-bg status-pending">${value['so.status']}</p>`;
                            // }

                            let status = '';
                            let orderStatus = value['so.status'] ? value['so.status'].toLowerCase() : '';
                            ...
                            dataTable.row.add([
                                value['sl_no'],
                                `<a class="soModal" data-id="${btoa(value['party_order_id'])}" data-code="${value['so.order_code']}">${value['so.order_code']}</a>`,
                                `<p class="pre-normal">${value['cust.customer_code']}</p>`,
                                ...
                                ` <div class="dropout">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <button class="deleteBtn"   data-id="${btoa(value.party_order_id)}" data-code="${value['so.order_code']}"><ion-icon name="trash-outline" class="ion-delete"></ion-icon>Delete</button>                                    </li>

                                        </li>
                                        <li>
                                            <button class="soModal" data-toggle="modal"  data-id="${btoa(value.party_order_id)}" data-code="${value['so.order_code']}"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
        ...
        $(document).on("click", ".ion-paginationlistpartyOrderlist", function(e) {
            // console.log("called")
            $.ajax({
                type: "POST",
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiesPartyorder')
                },
                beforeSend: function() {
                    $('#loaderModal').show();
        ...
        // $(document).on("click", ".ion-fulllistpartyOrderlist", function (e) {
        ...
        $(document).on('click', ".deleteBtn", function() {
            let bashId = $(this).data('code');
            // var soNum = $(this).data('id');
            if (!confirm(`Are you sure to delete Order ${bashId}?`)) {
                return false;
            }
            $.ajax({
                type: "GET",
                url: `ajaxs/ajax-party-order-delete.php`,
                data: {
                    act: "deletePartyOrder",
                    partyOrderVal: bashId
                },
                success: function(response) {
                    ...
                    Swal.fire({
                        icon: data.status,
                        title: `Order #${bashId} deleted successfully!`,
        ...
        $(document).ready(function() {
            $(document).on("click", "#serach_submit", function(event) {
                ...
                $(".selectOperator").each(function() {
                    ...
                    if (columnSlag === 'so.created_at') {
                        values = value4;
                    }

                    if ((columnSlag === 'delivery_date' || columnSlag === 'so_date' || columnSlag === 'so.created_at') && operatorName == "BETWEEN") {
...
<script>
    $(document).ready(function() {
        $(document).on("change", ".selectOperator", function() {
            ...
            let inputId;
            if (columnName.trim() == 'Created At') {
                inputId = "value4_" + columnIndex;
            }

            if ((columnName.trim() === 'Created At') && operatorName === 'BETWEEN') {
...
<script>
    $(document).on("click", ".soModal", function() {
        ...
        let bashId = $(this).data('id');
        let id = atob(bashId);
        let code = $(this).data('code');
        $('.auditTrail').attr("data-ccode", code);
        $.ajax({
            type: "GET",
            url: "ajaxs/modals/so/ajax-manage-party-orders-modal.php",
            dataType: 'json',
            data: {
                act: "modalData",
                id: id
            ...
            success: function(value) {
                if (value.status) {
                    ...
                    // nav bar 
                    $("#amount").html(responseObj.dataObj.order_code);
                    $("#po-numbers").html(formatDate(responseObj.dataObj.created_at));
                    $(".right #cus_name").html(responseObj.dataObj.trade_name);
                    $("#default_address").html(responseObj.customerAddress);
                    $(".nav-overview-tabs").html(responseObj.navbar);

                    // trail 
                    $(".created_by_trail").html(responseObj.dataObj.created_by + "<span class='font-bold text-normal'> on </span>" + formatDateTime(responseObj.dataObj.created_at));
                    $(".updated_by").html(responseObj.dataObj.updated_by + "<span class='font-bold text-normal'> on </span>" + formatDateTime(responseObj.dataObj.updated_at));
                    ...
                    $.each(itemsObj, function(index, val) {
                        let td = ` <div class="row body-state-table">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 state-col-td w-30 text-dark">${val.itemName}</div>
                    ...
                    if (responseObj.dataObj.order_type == "Quotation") {
                        let url = `direct-create-invoice.php?party_order_to_quotation=${bashId}`;
                        $('#navBtn').attr("href", url);
                        $('#navBtnName').html("Create Quotation");
                    } else {
                        let url = `sales_order_creation.php?party_order_to_so=${bashId}`;
                        $('#navBtn').attr("href", url);
                        $('#navBtnName').html("Create SO");
                    }
            ...
            error: function(xhr, status, error) {
                ...
                console.log(xhr.responseText); // Check the server's response here
            }
        });
    });
</script>
...
if (isset($_POST['accpost'])) {  
    $payrollPostingObj = payrollAccounting($_POST);
    // console($payrollPostingObj);
    // exit();
    swalAlert($payrollPostingObj["status"], ucfirst($payrollPostingObj["status"]), $payrollPostingObj["message"]);
                                ...
                                <div class="row filter-serach-row">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                            ...
                                            $sal = queryGet("SELECT * FROM erp_payroll_processing WHERE pay_type='salary' AND status !='deleted'", true);
                                                        ...
                                                        <tr style="cursor:pointer">
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    }else if($data['status'] == 'reverse') {
                                                                        echo '<a title="Reversed" class="btn btn-sm"><i class="fa fa-check po-list-icon" aria-hidden="true"></i></a>';
                                                                    } ?>
                                ...
                                <div class="row filter-serach-row">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                            <?php
                                            $cond = '';
                                            $sal = queryGet("SELECT * FROM erp_payroll_processing WHERE pay_type='tds' AND status !='deleted'", true);
                                ...
                                <div class="row filter-serach-row">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                            <?php
                                            $cond = '';
                                            $sal = queryGet("SELECT * FROM erp_payroll_processing WHERE pay_type='esi' AND status !='deleted'", true);
                                ...
                                <div class="row filter-serach-row">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                            <?php
                                            $cond = '';
                                            $sal = queryGet("SELECT * FROM erp_payroll_processing WHERE pay_type='pf' AND status !='deleted'", true);
                                ...
                                <div class="row filter-serach-row">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                            <?php
                                            $cond = '';
                                            $sal = queryGet("SELECT * FROM erp_payroll_processing WHERE pay_type='ptax' AND status !='deleted'", true);
            ...
            <div class="container-fluid">
                ...
                <div class="row p-0 m-0">
                    <div class="col-12 mt-2 p-0">'
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <h3 class="text-lg mb-0">Manage Payroll</h3>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="btn-group mr-2 float-right">
                                    <button type="button" class="btn dropdown-toggle btn-primary waves-effect waves-light" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fa fa-plus"></i> Create Payroll
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item text-sm" href="payroll.php?payroll">Claimz Report</a></li>
                                        <li><a class="dropdown-item text-sm" href="payroll.php?manual">Manual Payroll Form</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row filter-serach-row">
                                    ...
                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                        <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                                            ...
                                            // $sal = queryGet("SELECT SUM(`gross`) as gross, SUM(`esi`) as esi, SUM(`pf_employee`) as pf_employee,SUM(`pf_employeer`) as pf_employeer,SUM(`pf_admin`) as pf_admin, SUM(`ptax`) as ptax,`payroll_month` as month,`payroll_year` as year FROM `erp_payroll` WHERE `company_id`=$company_id AND `location_id`=$location_id AND `branch_id`=$branch_id GROUP BY `payroll_year`, `payroll_month`", true);  

                                            $sal = queryGet("SELECT * FROM `erp_payroll_main` WHERE `company_id`=$company_id AND `location_id`=$location_id AND `branch_id`=$branch_id ORDER BY `payroll_year`, `payroll_month`", true);
                                            // console($sal);
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr style="cursor:pointer">
                                                            ...
                                                            if (in_array(4, $settingsCheckbox)) { ?>
                                                                <td><?= $data['sum_pf_employeer'] ?>
                                                                </td>

                                                            <?php }
                                                            if (in_array(5, $settingsCheckbox)) { ?>
                                                                <td><?= $data['sum_pf_admin'] ?>
                                                                </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <form action="" method="POST" class="btn btn-sm">
                                                                        ...
                                                                        <input type="hidden" name="sum_pf_employeer" value='<?= $data['sum_pf_employeer'] ?>'>
                                                                        <input type="hidden" name="sum_pf_admin" value='<?= $data['sum_pf_admin'] ?>'>
                                                                        <input type="hidden" name="sum_esi_employee" value='<?= $data['sum_esi_employee'] ?>'>
                                                                        <input type="hidden" name="sum_esi_employeer" value='<?= $data['sum_esi_employeer'] ?>'>

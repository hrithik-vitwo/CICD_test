      ...
      <div class="container-fluid">
        <div class="row pt-2 pb-2">
          ...
          <script>
            ...
            //   $("#goodsSubmitFormSaveBtn").click(function(){
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <div id="accordion">
                  ...
                  <div id="collapseOne" class="collapse show" data-parent="#accordion">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12" style="display: flex; align-items: center; gap: 3px;" id="bomCheckBoxDiv">
                  ...
                  <div id="collapseTwo" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="input-group">
                            <input type="text" name="itemName" class="m-input item_name" id="exampleInputBorderWidth2">
                            <label>Item Name</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <select id="buomDrop" name="baseUnitMeasure" class="select2 form-control form-control-border borderColor">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <select id="iuomDrop" name="issueUnit" class="select2 form-control form-control-border borderColor">
                        ...
                        <div class="col-md-2">
                          <div class="input-group">
                            <input type="text" name="netWeight" class="m-input" id="buom" placeholder="Base Unit of Measure" readonly>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2">
                          <div class="input-group">
                            <input type="text" name="rel" class="m-input item_rel" id="rel">
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="input-group">
                            <input type="text" name="netWeight" class="m-input" placeholder="Issue Unit of Measure" id="ioum" readonly>
                          </div>
                        </div>

                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="netWeight" class="m-input net_weight" id="exampleInputBorderWidth2">
                            <label>Net Weight</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="grossWeight" class="m-input gross_weight" id="exampleInputBorderWidth2">
                        ...
                        <div class="col-md-4">
                          <div class="input-group">
                            <input type="text" name="height" class="m-input calculate_volume" id="height">
                            <label>Height</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="input-group">
                            <input type="text" name="width" class="m-input calculate_volume" id="width">
                            <label>Width</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="input-group">
                            <input type="text" name="length" class="m-input calculate_volume" id="length">
                            <label>Length</label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="volume" class="m-input" id="volcm" readonly>
                            <label>Volume In CM<sup>3</sup></label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="volume" class="m-input" id="volm" readonly>
                            <label>Volume In M<sup>3</sup></label>
                          </div>
                        </div>

                        <div class="col-md-12">
                          <textarea type="text" name="itemDesc" class="form-control form-control-border borderColor item_desc" id="exampleInputBorderWidth2" placeholder="Item Description"></textarea>
                        </div>


                        <div class="col-md-12 mb-12">
                          <div class="input-group">
                            <select id="hsnDropDown" name="hsn" class="form-control form-control-border borderColor">
                  ...
                  <div id="collapseThree" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="storageBin" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="pickingArea" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="tempControl" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="storageControl" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="maxStoragePeriod" class="m-input">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="maxtimeUnit" class="m-input">
                            <label>Time Unit</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="minRemainSelfLife" class="m-input">
                            <label>Min Remain Self Life</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="mintimeUnit" class="m-input">
                            <label>Time Unit</label>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <input type="text" name="purchasingValueKey" class="form-control form-control-border borderColor purchasing_value" id="exampleInputBorderWidth2" placeholder="Purchasing Value Key">
                            </div>
                          </div>
                        </div>
                ...
                <div class="card card-success">
                  <div class="card-header cardHeader">
                    <h4 class="card-title w-100"> <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseFive">Pricing and Discount</a> </h4>
                  </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="row">
                            <div class="col-md-6">
                              <label for="" class="form-control borderNone">Target Price :</label>
                            </div>
                            <div class="col-md-6">
                              <input type="number" name="price" class="form-control form-control-border borderColor price" id="exampleInputBorderWidth2" placeholder="price">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="row">
                            <div class="col-md-6">
                              <label for="" class="form-control borderNone">Max Discount :</label>
                            </div>
                            <div class="col-md-6">
                              <input type="number" name="discount" class="form-control form-control-border borderColor discount" id="exampleInputBorderWidth2" placeholder="Maximum Discount">
                            </div>
                          </div>
                        </div>
                      </div>
...
?>
  ...
  <div class="content-wrapper">
    ...
    $sql = "SELECT * FROM `erp_inventory_items` as item , `erp_inventory_mstr_purchase_groups` as purchase_group, `erp_inventory_mstr_good_types` as good_type , `erp_inventory_mstr_good_groups` as good_group WHERE `item`.`goodsType` = `good_type`.`goodTypeId` AND `item`.`goodsGroup` = `good_group`.`goodGroupId` AND item.purchaseGroup = `purchase_group`.`purchaseGroupId` AND `item`.`itemId` = $itemId";
                  ...
                  <div id="collapseTwo" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="itemName" class="m-input item_name" id="exampleInputBorderWidth2" value=<?= $row['itemName'] ?>>
                            <label>Item Name</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="netWeight" class="m-input net_weight" id="exampleInputBorderWidth2" value=<?= $row['netWeight'] ?>>
                            <label>Net Weight</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" name="grossWeight" class="m-input gross_weight" id="exampleInputBorderWidth2" value=<?= $row['grossWeight'] ?>>
                            <label>Gross Weight</label>
                          </div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="row p-0 m-0">
          <div class="col-12 mt-2 p-0">
            ...
            <div class="card card-tabs" style="border-radius: 20px;">
              ...
              $sql_list = "SELECT * FROM " . ERP_INVENTORY_ITEMS . " WHERE  `branch`=$branch_id ORDER BY itemId desc  ";
                  $qry_list = mysqli_query($dbCon, $sql_list);
                  $num_list = mysqli_num_rows($qry_list);


               $countShow = "SELECT count(*) FROM " . ERP_INVENTORY_ITEMS . " WHERE `branch`=$branch_id  ";
                  ...
                  if ($num_list > 0) { ?>
                    <table class="table table-hover text-nowrap p-0 m-0">
                      <thead>
                        <tr class="alert-light">
                          ...
                          if (in_array(3, $settingsCheckbox)) { ?>
                            <th class="borderNone">Net Weight</th>
                          <?php  }
                          if (in_array(4, $settingsCheckbox)) { ?>
                            <th class="borderNone">Volume</th>
                          <?php }
                          if (in_array(5, $settingsCheckbox)) { ?>
                            <th class="borderNone">Goods Type</th>
                          <?php  }
                          if (in_array(6, $settingsCheckbox)) { ?>
                            <th class="borderNone">Gross Weight</th>
                          <?php
                          }
                          ?>
                          <th class="borderNone">BOM Status</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr style="cursor:pointer" data-toggle="modal" data-target="#fluidModalRightSuccessDemo_<?= $row['itemId'] ?>">
                            <td><?= $cnt++ ?></td>
                            <?php if (in_array(1, $settingsCheckbox)) { ?>
                              <td><?= $row['itemCode'] ?></td>
                            <?php }
                            ...
                            <td>
                              <?php
                                if($row['bomStatus'] == 1){
                                  ...
                                  echo '<span class="badge badge-secondary">Not Required</span>';
                                } 
                              ?>
                            </td>
                          ...
                          <div class="modal fade right" id="fluidModalRightSuccessDemo_<?= $row['itemId'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="true" style="display: none;" aria-hidden="true">
                            <div style="max-width: 50%; min-width:50%" class="modal-dialog modal-full-height modal-right modal-notify modal-success" role="document">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-header " style="background: none; border:none; color:#424242">
                                  <p class="heading lead"><?= $itemName ?></p>
                                        ...
                                        <div class="shadow-sm bg-light py-2 mx-2 my-2" id="action-navbar" style="text-align:right">
                                          ...
                                          <form action="" method="POST">
                                            <?php if ($row['bomStatus'] != 0) { ?>
                                              <a href="goods.php?bom=<?= $itemId; ?>" name="customerEditBtn">
                                                <i title="BOM" style="font-size: 1em" class="shadow-sm p-1 fa fa-cogs  text-info mx-3"> BOM</i>
                                              </a>
                                            <?php } ?>
                                      ...
                                      <div class="row px-3 p-0 m-0" style="place-items: self-start;">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Item Name: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $itemName ?></span>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Item Code: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $itemCode ?></span>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary"> Net Weight: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Gross Weight: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Volume: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Height: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Width: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['width'] ?></span>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Length: </span>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Goods Type: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['goodsGroup'] ?> </span>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Purchase Group: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['purchaseGroup'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Availability Check: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['availabilityCheck'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Base Unit Measure: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['baseUnitMeasure'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Issue Unit Measure: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['issueUnitMeasure'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Storage Bin: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['storageBin'] ?> </span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Picking Area: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['pickingArea'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Temp Control: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['tempControl'] ?> </span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Storage Control: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['storageControl'] ?> </span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Max Storage Period: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['maxStoragePeriod'] ?> </span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Max Storage Period Time: </span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['maxStoragePeriodTimeUnit'] ?> </span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Min Remain Self Life Time Unit</span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['minRemainSelfLife'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary">Min Remain Self Life :</span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['minRemainSelfLifeTimeUnit'] ?></span>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="row m-2 py-2 shadow-sm bg-light">
                                            <div class="col-md-6">
                                              <span class="font-weight-bold text-secondary"> Purchasing Value Key :</span>
                                            </div>
                                            <div class="col-md-6">
                                              <span><?= $row['purchasingValueKey'] ?></span>
                                            </div>
                                          </div>
                                        </div>

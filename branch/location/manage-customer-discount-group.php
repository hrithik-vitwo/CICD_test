        ...
        $(document).on("click", ".ion-paginationlistCusDisGroup", function (e) {
            $.ajax({
                ...
                beforeSend:function(){
                    ...
                    $('#loaderModal').show();
                    $('.ion-paginationlistCusDisGroup').prop('disabled', true)
                },
                ...
                complete: function() {
                    ...
                    $('#loaderModal').hide();
                    $('.ion-paginationlistCusDisGroup').prop('disabled', false);
                }
            })
        ...
        $(document).on("click", ".ion-fulllistCusDisGroup", function (e) {
            $.ajax({
                ...
                beforeSend:function(){
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-fulllistCusDisGroup').prop('disabled', true)
                },
                success: function(response) {
                ...
                complete: function() {
                    // Hide loader modal after request completes
                    $('#loaderModal').hide();
                    $('.ion-fulllistCusDisGroup').prop('disabled', false);
                }
            })

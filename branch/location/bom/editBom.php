...
<div class="row m-0 p-0 messages justify-content-end">
    ...
    // echo base64_decode($_GET["editBom"]);
   ...
   //   console($bomDetailObj);
    //   exit();
    $itemId = $bomDetailObj['data']['bom_data']['itemId'];
    ...
    if (isset($_POST["createBomSubmitBtn"])) {
        ...
        if ($createObj["status"] == "success") {
            swalAlert($createObj["status"], ucfirst($createObj["status"]), 'BOM Updated Successfully', LOCATION_URL . "bom.php");
        } else {
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="preparedBy" value="<?= $bomDetailObj["data"]["bom_data"]["preparedBy"] ?>" placeholder="Created by" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label>Prepared Date</label>
                                <input type="date" value="<?= $bomDetailObj["data"]["bom_data"]["preparedDate"] ?>" name="preparedDate" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label>Product Title</label>
                                <input type="text" name="itemTitle" value="<?= $bomDetailObj["data"]["bom_data"]["itemName"] ?>" placeholder="Product title" class="form-control" readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="itemCode" value="<?= $bomDetailObj["data"]["bom_data"]["itemCode"] ?>" placeholder="Product Code" class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="workCenter" id="workCenterDropDown" class="form-control" required>
                                    ...
                                    ?>
                                        <option value="<?= $wc['work_center_id'] ?>" <?php if($wc['work_center_id'] == $bomDetailObj["data"]["bom_data"]['wc_id']) { echo "selected"; } ?>><?= $wc['work_center_name'] . '(' . $wc['work_center_code'] . ')' ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <tbody id="bomMaterialDiv">
                                ...
                                ?>
                                    <tr id="bomMaterialsDivRow_<?= $rowNo ?>">
                                        ...
                                        <td>
                                            <input type="number" step="any" name="bomMaterial[<?= $rowNo ?>][Consumption]" id="bomMaterialConsumption_<?= $rowNo ?>" class="form-control m-0 bomMaterialConsumtion bomMaterialRowInput text-right" value="<?= $rowData["consumption"] ?>">
                                        </td>
                                        <td class="d-flex">
                                            <input type="number" step="any" name="bomMaterial[<?= $rowNo ?>][ExtraPurchage]" id="bomMaterialExtraPurchage_<?= $rowNo ?>" class="form-control m-0 bomMaterialExtraPurchage bomMaterialRowInput text-right" value="<?= $rowData["extra"] ?>"><span class="text-muted mt-1 ml-1">%</span>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomMaterial[<?= $rowNo ?>][Rate]" id="bomMaterialRate_<?= $rowNo ?>" class="form-control m-0 bomMaterialRate text-right" value="<?= $rowData["rate"] ?>" readonly>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomMaterial[<?= $rowNo ?>][Amount]" id="bomMaterialAmount_<?= $rowNo ?>" class="form-control m-0 bomMaterialAmount text-right" value="<?= $rowData["amount"] ?>" readonly>
                                        </td>
                                        <td>
                            ...
                            <tbody id="bomHourlyDeploymentDiv">
                                ...
                                ?>
                                    <tr id="bomHdDivRow_<?= $rowNo ?>">
                                        ...
                                        <td>
                                            <input type="number" step="any" name="bomHd[<?= $rowNo ?>][Consumption]" id="bomHdConsumption_<?= $rowNo ?>" class="form-control m-0 bomHdConsumption bomHdRowInput text-right" value="<?= $hdrowData['consumption'] ?>">
                                        </td>
                                        <td class="d-flex">
                                            <input type="number" step="any" name="bomHd[<?= $rowNo ?>][ExtraPurchage]" id="bomHdExtraPurchage_<?= $rowNo ?>" class="form-control m-0 bomHdExtraPurchage bomHdRowInput text-right" value="<?= $hdrowData['extra'] ?>"><span class="text-muted mt-1 ml-1">%</span>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomHd[<?= $rowNo ?>][Rate]" id="bomHdRate_<?= $rowNo ?>" class="form-control m-0 bomHdRate text-right" value="<?= $hdrowData['rate'] ?>" readonly>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomHd[<?= $rowNo ?>][Amount]" id="bomHdAmount_<?= $rowNo ?>" placeholder="0.00" class="form-control m-0 bomHdAmount text-right" value="<?= $hdrowData['amount'] ?>" readonly>
                                        </td>
                                        <td>
                            ...
                            <tbody id="bomOtherHeadDiv">
                                ...
                                ?>
                                    <tr id="bomOtherHeadDivRow_<?= $rowNo ?>">
                                        ...
                                        <td>
                                            <input type="number" step="any" name="bomOtherHead[<?= $rowNo ?>][Consumption]" id="bomOtherHeadConsumption_<?= $rowNo ?>" value="<?= $hdOtherRowData['consumption'] ?>" class="form-control m-0 bomOtherHeadConsumption bomOtherHeadRowInput text-right">
                                        </td>
                                        <td class="d-flex">
                                            <input type="number" step="any" name="bomOtherHead[<?= $rowNo ?>][ExtraPurchage]" id="bomOtherHeadExtraPurchage_<?= $rowNo ?>" value="<?= $hdOtherRowData['extra'] ?>" class="form-control m-0 bomOtherHeadExtraPurchage bomOtherHeadRowInput text-right"><span class="text-muted mt-1 ml-1">%</span>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomOtherHead[<?= $rowNo ?>][Rate]" value="<?= $hdOtherRowData['rate'] ?>" id="bomOtherHeadRate_<?= $rowNo ?>" placeholder="0.00" class="form-control m-0 bomOtherHeadRate text-right" readonly>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomOtherHead[<?= $rowNo ?>][Amount]" value="<?= $hdOtherRowData['amount'] ?>" id="bomOtherHeadAmount_<?= $rowNo ?>" placeholder="0.00" class="form-control m-0 bomOtherHeadAmount text-right" readonly>
                                        </td>
                                        <td>
    ...
    $(document).ready(function() {
        ...
        function addBoqItemMaterialNewRow(rowNo = 0) {
            $("#bomMaterialDiv").append(`<tr id="bomMaterialsDivRow_${rowNo}">
                                    ...
                                    <td>
                                        <input type = "number" step = "any" name = "bomMaterial[${rowNo}][Consumption]" id = "bomMaterialConsumption_${rowNo}" placeholder = "0.00" class = "form-control m-0 bomMaterialConsumtion bomMaterialRowInput text-right" >
                                    </td>
                                    <td class="d-flex">
                                        <input type = "number" step = "any" name = "bomMaterial[${rowNo}][ExtraPurchage]" id = "bomMaterialExtraPurchage_${rowNo}" placeholder = "0.00" class = "form-control m-0 bomMaterialExtraPurchage bomMaterialRowInput text-right" ><span class = "text-muted mt-1 ml-1">%</span>
                                    </td>
                                    <td>
                                        <input type = "number" step = "any" name = "bomMaterial[${rowNo}][Rate]" value="0.00" id = "bomMaterialRate_${rowNo}" placeholder = "0.00" class = "form-control m-0 bomMaterialRate text-right" readonly >
                                    </td>
                                    <td>
                                        <input type = "number" step = "any" name = "bomMaterial[${rowNo}][Amount]" value="0.00" id = "bomMaterialAmount_${rowNo}" placeholder = "0.00" class = "form-control m-0 bomMaterialAmount text-right" readonly >
                                    </td>
                                    <td>
        ...
        function addBoqItemHourlyDeploymentNewRow(rowNo = 0) {
            $("#bomHourlyDeploymentDiv").append(`
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <input type="number" step="any" name="bomHd[${rowNo}][Consumption]" id="bomHdConsumption_${rowNo}" placeholder="0.00" class="form-control m-0 bomHdConsumption bomHdRowInput text-right">
                                        </td>
                                        <td class="d-flex">
                                            <input type="number" step="any" name="bomHd[${rowNo}][ExtraPurchage]" id="bomHdExtraPurchage_${rowNo}" placeholder="0.00" class="form-control m-0 bomHdExtraPurchage bomHdRowInput text-right"><span class="text-muted mt-1 ml-1">%</span>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomHd[${rowNo}][Rate]" value="0.00" id="bomHdRate_${rowNo}" placeholder="0.00" class="form-control m-0 bomHdRate text-right" readonly>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomHd[${rowNo}][Amount]" value="0.00" id="bomHdAmount_${rowNo}" placeholder="0.00" class="form-control m-0 bomHdAmount text-right" readonly>
                                        </td>
                                        <td>
        ...
        function addBoqItemOtherHeadNewRow(rowNo = 0) {
            $("#bomOtherHeadDiv").append(`
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <input type="number" step="any" name="bomOtherHead[${rowNo}][Consumption]" id="bomOtherHeadConsumption_${rowNo}" placeholder="0.00" class="form-control m-0 bomOtherHeadConsumption bomOtherHeadRowInput text-right">
                                        </td>
                                        <td class="d-flex">
                                            <input type="number" step="any" name="bomOtherHead[${rowNo}][ExtraPurchage]" id="bomOtherHeadExtraPurchage_${rowNo}" placeholder="0.00" class="form-control m-0 bomOtherHeadExtraPurchage bomOtherHeadRowInput text-right"><span class="text-muted mt-1 ml-1">%</span>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomOtherHead[${rowNo}][Rate]" value="0.00" id="bomOtherHeadRate_${rowNo}" placeholder="0.00" class="form-control m-0 bomOtherHeadRate text-right" readonly>
                                        </td>
                                        <td>
                                            <input type="number" step="any" name="bomOtherHead[${rowNo}][Amount]" value="0.00" id="bomOtherHeadAmount_${rowNo}" placeholder="0.00" class="form-control m-0 bomOtherHeadAmount text-right" readonly>
                                        </td>
                                        <td>

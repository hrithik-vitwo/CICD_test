...
if (!isset($_COOKIE["cookiemrpGroup"])) {
    ...
    if ($settingsCheckbox_concised_view) {
        setcookie("cookiemrpGroup", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
    } else {
        for ($i = 0; $i < 5; $i++) {
                                    ...
                                    <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space"
                                        ...
                                        <div class="left-block">
                                            <div class="label-select">
                                                <h3 class="card-title mb-0">Manage Customer MRP Group</h3>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="filter-action filter-mobile-search mobile-page">
                                                            ...
                                                            <div class="exportgroup mobile-page mobile-export">
                                                                ...
                                                                <ul class="export-options">
                                                                    <li>
                                                                        <button class="ion-paginationlistMrpGroup">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-paginationlistMrpGroup md hydrated"
                                                                                id="exportAllBtn" role="img"
                                                                                aria-label="list outline"></ion-icon>Export
                                                                        </button>
                                                                    </li>
                                                                    <li>
                                                                        <button class="ion-fulllistMrpGroup">
                                                                            <ion-icon name="list-outline"
                                                                                class="ion-fulllistMrpGroup md hydrated"
                                                                                role="img"
                                        ...
                                        <div class="tab-pane dataTableTemplate dataTable_stock fade show active"
                                            ...
                                            <div class="filter-action">
                                                ...
                                                <div class="length-row">
                                                    <span>Show</span>
                                                    <select name="" id="mrpGroupLimit" class="custom-select">
                                                        <option value="10">10</option>
                                                        <option value="25" selected="selected">25</option>
                                                        <option value="50">50</option>
                                                        <option value="100">100</option>
                                            ...
                                            <div class="exportgroup">
                                                ...
                                                <ul class="export-options">
                                                    ...
                                                    <li>
                                                        ...
                                                        <button class="ion-fulllistMrpGroup">
                                                            <ion-icon name="list-outline"
                                                                class="ion-fulllistMrpGroup md hydrated" role="img"
                                                                aria-label="list outline"></ion-icon>Download
                                                        </button>
                                                    </li>
                                                </ul>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div id="main2">
                                                                        ...
                                                                        <table class="colomnTable">
                                                                            <?php
                                                                            $cookieTableStockReport = json_decode($_COOKIE["cookiemrpGroup"], true) ?? [];
...
<script>
    ...
    // });
        ...
        //     $.ajax({
        //         type: "POST",
        //         url: "ajaxs/mrp/ajax-customer-mrp-group-all.php",
        //         dataType: 'json',
        //         data: {
        //             act: 'alldata',
        //         },
        ...
        function fill_datatable(formDatas = '', pageNo = '', limit = '') {
            ...
            var checkboxSettings = Cookies.get('cookiemrpGroup');
                        ...
                        $.each(responseObj, function (index, value) {
                            ...
                            dataTable.row.add([
                                ...
                                ` <div class="dropout">
                                     ...
                                     <ul>
                                     <li>
                                         <button data-toggle="modal" class="editMrpbtn" data-mrpGrpname="${value.customer_mrp_group}" data-mrpgrpid="${value.customer_mrp_group_id}" 
        ...
        $(document).on('click', "#update_mrpgrpName", function (e) {
            e.preventDefault();
            let mrpGroupName = $("#editmrpGroupName").val();
            let mrpid = $("#editGroupId").val();
            // check confirmation
            Swal.fire({
                icon: 'warning',
                title: `Are you confirmed to edit the MRP Group Name (${mrpGroupName})?`,
        ...
        $(document).on('click', "#add_mrpgrpName", function (e) {
            e.preventDefault();
            let mrpGroupName = $("#addmrpGroupName").val();
            // check confirmation
            Swal.fire({
                icon: 'warning',
                title: `Are you confirmed to add the MRP Group Name (${mrpGroupName})?`,
                showCancelButton: true,
                confirmButtonColor: '#198754',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Confirm',
        ...
        $(document).on("click", ".ion-paginationlistMrpGroup", function (e) {
            $.ajax({
                type: "POST",
                ...
                data: {
                    ...
                    sql_data_checkbox: Cookies.get('cookiemrpGroup')
                },
                beforeSend:function(){
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-paginationlistMrpGroup').prop('disabled', true)
                },
                ...
                complete: function() {
                    ...
                    $('#loaderModal').hide();
                    $('.ion-paginationlistMrpGroup').prop('disabled', false);
                }
            })

        });
        $(document).on("click", ".ion-fulllistMrpGroup", function (e) {
            ...
            $.ajax({
                ...
                beforeSend:function(){
                    // console.log(sql_data_checkbox);
                    $('#loaderModal').show();
                    $('.ion-fulllistMrpGroup').prop('disabled', true)
                },
                success: function(response) {
                ...
                complete: function() {
                    // Hide loader modal after request completes
                    $('#loaderModal').hide();
                    $('.ion-fulllistMrpGroup').prop('disabled', false);
                }
            })
        ...
        $(document).on("click", "#pagination a", function (e) {
            ...
            var limitDisplay = $("#mrpGroupLimit").val();

    ...
    if (!isset($_COOKIE["cookieBinLOg"])) {
        ...
        if ($settingsCheckbox_concised_view) {
            setcookie("cookieBinLOg", json_encode($settingsCheckbox_concised_view), time() + 86400 * 30, '/');
        }
    }
    ...
    $columnMapping = [
        ...
        [
            'name' => 'Layer Name',
            'slag' => 'erpBin.layer_name',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
            'dataType' => 'string'
        ],
        [
            'name' => 'Max Temperature',
            'slag' => 'bin.max_temperature',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
            'dataType' => 'number'
        ],
        [
            'name' => 'Min Temperature',
            'slag' => 'bin.min_temperature',
            'icon' => '<ion-icon name="location-outline"></ion-icon>',
            'dataType' => 'number'
        ],
        [
                                        ...
                                        <li class="pt-2 pt-md-0 px-3 d-flex justify-content-between align-items-center header-space" style="width:100%">
                                            <div class="left-block">
                                                <div class="label-select">
                                                    <h3 class="card-title mb-0">Manage Bin</h3>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane dataTableTemplate dataTable_stock fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                                ...
                                                <div class="exportgroup">
                                                    ...
                                                    <ul class="export-options">
                                                        <li>
                                                            <button class="ion-paginationlistBin">
                                                                <ion-icon name="list-outline" class="ion-paginationlistBin md hydrated" role="img" aria-label="list outline"></ion-icon>Exports
                                                            </button>
                                                        </li>
                                                        <li>

                                                            <button class="ion-fulllistBin">
                                                                <ion-icon name="list-outline" class="ion-fulllistBin md hydrated" role="img" aria-label="list outline"></ion-icon>Download
                                                            </button>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <a href="manage-bin-actions.php?create" class="btn btn-create" type="button">
                                                        ...
                                                        <div class="top-details">
                                                            <div class="left">
                                                                <p class="info-detail amount" id="amount">
                                                                    ...
                                                                    <span class="binName"> </span>
                                                                </p>
                                                                <!-- <span class="amount-in-words" id="binCode"></span> -->
                                                                <p class="info-detail po-number"><ion-icon name="information-outline"></ion-icon><span id="binCode"> </span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--Body-->
                                                                                ...
                                                                                <div class="card-body">
                                                                                    ...
                                                                                    <div class="group-tree">
                                                                                        <ul class="pl-0 ml-0">
                                                                                            <li>
                                                                                                <details open>
                                                                                                    <summary><span class="font-weight-bold">Warehouse : </span> <span class="warehouse"></span>
                                                                                                    </summary>
                                                                                                    <ul>
                                                                                                        <li>
                                                                                                            <details>
                                                                                                                ...
                                                                                                                <ul>
                                                                                                                    ...
                                                                                                                    <li>
                                                                                                                        <details>
                                                                                                                            <summary><span class="font-weight-bold">Layer :</span> <span class="layerName"></span>
                                                                                                                            </summary>
                                                                                                                        </details>
                                                                                                                    </li>
                                                                                                                    <li>
                                                                                                                        <details>
                                                                                                                            <summary><span class="font-weight-bold">Bin :</span> <span class="binName"></span>
                                                                                                                            </summary>
                                                                                                                        </details>
                                                                                                                    </li>
                                                                                                                </ul>
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            $.each(responseObj, function(index, value) {
                                dataTable.row.add([
                                    value.sl_no,
                                    `<a href="#" class="soModal" data-id="${value['bin.bin_id']}">${value['bin.bin_name']}</a>`,
                                    value['bin.bin_code'],
                                    value['erpBin.layer_name'],
                                    value['bin.max_temperature'],
                                    value['bin.min_temperature'],
                                    value['bin.created_by'],
                                    // value.storage_location_name,
                                    // value.rack_description,
                                    // value.created_by,
                                    ` <div class="dropout">
                                        <button class="more">
                                            <span></span>
                                        ...
                                        <ul>
                                        <li>
                                            <button id="editBtn" data-id="${btoa(value['bin.bin_id'])}" data-toggle="modal" data-target="#editModal"><ion-icon name="create-outline" class="ion-edit"></ion-icon>Edit</button>
                                        </li>
                            
                                        <li>
                                            <button class="soModal" data-toggle="modal" data-id="${value['bin.bin_id']}" data-target="#viewGlobalModal"><ion-icon name="create-outline" class="ion-view"></ion-icon>View</button>
                                        </li>
                                        <li>
                            ...
                            var checkboxSettings = Cookies.get('cookieBinLOg');
            ...
            $(document).on("click", ".ion-paginationlistBin", function(e) {
                $.ajax({
                    type: "POST",
                    ...
                    data: {
                        ...
                        sql_data_checkbox: Cookies.get('cookieBinLOg')
                    },
                    beforeSend: function() {
                        // console.log(sql_data_checkbox);
                        $('#loaderModal').show();
                        $('.ion-paginationlistBin').prop('disabled', true)
                    },
                    ...
                    complete: function() {
                        ...
                        $('#loaderModal').hide();
                        $('.ion-paginationlistBin').prop('disabled', false)
                    }
                })

            });
            $(document).on("click", ".ion-fulllistBin", function(e) {
                $.ajax({
                    type: "POST",
                    url: "ajaxs/ajax-mange-bin.php",
                    dataType: "json",
                    ...
                    beforeSend: function() {
                        // console.log(sql_data_checkbox);
                        $('#loaderModal').show();
                        $('.ion-fulllistBin').prop('disabled', true)
                    },
                    success: function(response) {
                    ...
                    complete: function() {
                        // Hide loader modal after request completes
                        $('#loaderModal').hide();
                        $('.ion-fulllistBin').prop('disabled', false);
                    }
                })
    ...
    <script>
        $(document).on("click", ".soModal", function() {
            ...
            // $('.auditTrail').attr("data-ccode", bin_id);

            $.ajax({
                type: "GET",
                url: "ajaxs/modals/wms/ajax-manage-bin-modal.php",
                dataType: 'json',
                data: {
                    bin_id: bin_id
                },
                ...
                success: function(value) {
                    console.log("view modal data", value);
                    let data = value.data;
                    $('.auditTrail').attr("data-ccode", data.bin_code);
                    // $('#createdBy').html(data.createdBy)
                    $('.binName').html(data.bin_name)
                    $('#binCode').html(data.bin_code)
                    $('storagelocationName').html(data.storage_location_name)
                    $('.layerName').html(data.layer_name)
                    $('.rackName').html(data.rack_name)
                    $('.warehouse').html(data.warehouse_name)
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            let url = "<?php echo  BRANCH_URL . 'location/manage-bin-actions.php?edit=' ?>" + prId;

$(document).ready(function () {
	$('#addNewCreditNoteFormSubmitBtn').click(function (e) {
		...
		function validateForm() {
			...
			let partyCreditDate = $('#partyCreditDate').val();
		...
		function disableButton() {
		   ...
		   // script for checking parent 'tr' exist on form submit

		if(!($('.add-btn-minus-bill').parent().parent().parent().length)){
			    addToErrorMessages('At least one item is required.');
				displayValidationMessage('At least one item is required.', $(this));
				displayModalValidationMessage('At least one item is required.');

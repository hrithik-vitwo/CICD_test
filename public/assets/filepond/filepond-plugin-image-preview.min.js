...
!(function (e, t) {
  ...
  var n = function (e, t) {
    ...
    p = { left: "start", center: "middle", right: "end" },
    g = function (e) {
      return function (t) {
        return d(e, { id: t.id });
      };
    ...
    P = function (e, t) {
      ...
      return (
        ...
        { x: 0.5 * (e.width - i), y: 0.5 * (e.height - r), width: i, height: r }
      );
    },
    C = function (e) {
      var t =
      ...
      return e.utils.createView({
        ...
        create: function (t) {
          ...
          (i.ref.image = i.appendChildView(
            ...
            (i.ref.destroyMarkup = function () {
              i.ref.markup &&
                (i.removeChildView(i.ref.markup), (i.ref.markup = null));
            });
        ...
        write: function (e) {
          ...
          var u = {
            ...
            y = R(l, P(u, g), p, m ? a.center : { x: 0.5, y: 0.5 }),
            E = a.zoom * y;
          n && n.length
            ? (t.ref.createMarkup(),
      ...
      self.onmessage = function (e) {
        for (
          ...
          (A = r[T] / 255),
            ...
            (r[T + 1] = Math.max(
              0,
              Math.min(255 * (A * u + R * l + P * d + C * f + p), 255)
            )),
            (r[T + 2] = Math.max(
              0,
              Math.min(255 * (A * g + R * m + P * y + C * E + v), 255)
            )),
            (r[T + 3] = Math.max(
              0,
      ...
      var t = e.utils.createView({
          ...
          create: function (e) {
            ...
            G++,
              ...
              (t.element.innerHTML = r.replace(/__UID__/g, G));
          },
          mixins: {
            styles: ["opacity"],
        ...
        write: e.utils.createRoute(
          {
            ...
            DID_FINISH_CALCULATE_PREVIEWSIZE: function (e) {
              ...
              if (c) {
                var s,
                  ...
                  f = function (e) {
                    ...
                    if (o && s) {
                      ...
                      var u = Math.max(1, 0.75 * window.devicePixelRatio),
                        d = t.query("GET_IMAGE_PREVIEW_ZOOM_FACTOR") * u,
                        f = s / o,
                        ...
                        y = m * f;
                      f > 1
                        ? (y = (m = Math.min(o, p * d)) * f)
                        : (m = (y = Math.min(s, g * d)) / f);
                      var E = S(e, m, y, r),
                        v = function () {
                          var r = t.query(
                ...
                if (
                  ((s = c.file),
                  (h = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./)),
                  !(null !== (u = h ? parseInt(h[1]) : null) && u <= 58) &&
                    "createImageBitmap" in window &&
                    L(s))
                ) {
                  var p = r(V);
                  p.post({ file: c.file }, function (e) {
                    p.terminate(), e ? f(e) : d();
                  });
                } else d();
              }
                  ...
                  if (/filter/.test(r.change.key)) {
                    ...
                    if (/crop|markup|resize/.test(r.change.key)) {
                      ...
                      if (
                        ...
                        h.crop &&
                        h.crop.aspectRatio &&
                        Math.abs(s.aspectRatio - h.crop.aspectRatio) > 1e-5
                      ) {
                        var u = (function (e) {
                          var t = e.root,
                        ...
                        n({
                          ...
                          image:
                            ((l = u.image),
                            ((d = d || document.createElement("canvas")).width =
                              l.width),
                            (d.height = l.height),
  ...
  return (
    "undefined" != typeof window &&
      ...
      document.dispatchEvent(
        new CustomEvent("FilePond:pluginloaded", { detail: H })
      ),
    H
  );
});
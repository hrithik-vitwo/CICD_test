                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-inline gst-check-section mb-2">
                                                        <div class="gst-check">
                                                            <input type="radio" name="chose_gst" class="gstAlert" id="gst" value="check_true" checked /><label class="mb-0 font-bold" for=""> Have GST Number</label>
                                                        </div>
                                                        <div class="gst-check">
                                                            <input type="radio" name="chose_gst" class="gstAlert" id="no_gst" value="check_false" /><label class="mb-0 font-bold" for="">Have No GST Number</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="show_details" style="display: none;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                                        <div class="form-input">
                                                            <label for="">PIN</label>
                                                            <input type="text" name="deliveryDate1" id="v_pin" class="form-control" placeholder="PIN" />
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                                        <div class="form-input">
                                                            ...
                                                            <input type="text" name="deliveryDate1" id="v_state" class="form-control" placeholder="State" />
                                    ...
                                    <div id="show_details">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <div class="form-input">
                                                    <label for="">PAN</label>
                                                    <input type="text" name="deliveryDate1" id="v_pan" class="form-control" placeholder="PAN" value="<?= $detail['vendor_pan'] ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <div class="form-input">
                                                    <label for="">PIN</label>
                                                    <input type="text" name="deliveryDate1" id="v_pin" class="form-control" placeholder="PIN" value="<?= $detail['vendor_business_pin_code'] ?>" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-input rfq-vendor-item">
                                                        ...
                                                        <input type="number" name="deliveryDate1" class="form-control each_quantity w-75" id="itemQty_<?= $item['itemId'] ?>" placeholder="Quantity" value="<?= $item['itemQuantity'] ?>" />
                                                ...
                                                <td>
                                                    <div class="form-input rfq-vendor-item">
                                                        ...
                                                        <input type="number" name="deliveryDate1" class="form-control each_price w-75" placeholder="Price" id="itemUnitPrice_<?= $item['itemId'] ?>" value="0" />
                                                ...
                                                <td>
                                                    <div class="form-input rfq-vendor-item">
                                                        ...
                                                        <input type="number" name="deliveryDate1" class="form-control each_discount w-75" placeholder="Discount" id="itemDiscount_<?= $item['itemId'] ?>" value="0" />
                                                ...
                                                <td>
                                                    <div class="form-input rfq-vendor-item">
                                                        <label for="">GST</label>
                                                        <input type="number" name="deliveryDate1" class="form-control each_gst w-75" placeholder="GST" id="itemGST_<?= $item['itemId'] ?>" value="0" />
                                                ...
                                                <td>
                                                    <div class="form-input rfq-vendor-item">
                                                        ...
                                                        <input type="number" name="deliveryDate1" id="itemTotalPrice_<?= $item['itemId'] ?>" class="form-control each_total w-75" placeholder="Total" readonly value="0" />
                                                ...
                                                <input type="hidden" id="" class="form-control each_detail" value="<?= $item['itemId'] . "|" . $item['itemCode'] . "|" . $item['itemName'] . "|" . $item['itemDesc'] . "|" . $item['itemQuantity'] . "|" . $item['netWeight'] . "|" . $item['grossWeight'] . "|" . $item['baseUnitMeasure'] . "|" . $item['volume'] . "|" . $item['volumeCubeCm'] . "|" . $item['height'] . "|" . $item['width'] . "|" . $item['length'] . "|" . $item['goodsType'] . "|" . $item['goodsGroup'] . "|" . $item['purchaseGroup'] . "|" . $item['branch'] . "|" . $item['availabilityCheck'] . "|" . $item['issueUnitMeasure'] . "|" . $item['uomRel'] . "|" . $item['storageBin'] . "|" . $item['pickingArea'] . "|" . $item['tempControl'] . "|" . $item['storageControl'] . "|" . $item['maxStoragePeriod'] . "|" . $item['maxStoragePeriodTimeUnit'] . "|" . $item['minRemainSelfLife'] . "|" . $item['minRemainSelfLifeTimeUnit'] . "|" . $item['purchasingValueKey'] ?>">

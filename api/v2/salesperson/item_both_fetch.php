...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    WHERE summary.company_id='$company_id' AND summary.branch_id = '$branch_id' AND summary.location_id = '$location_id' AND items.goodsType IN(3,4,5) AND summary.status = 'active' AND items.status = 'active'";

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_list = "SELECT * FROM `" . ERP_CUSTOMER . "` WHERE company_id='" . $company_id . "' AND (customer_visible_to_all='Yes' OR location_id=$location_id) AND `customer_status`='active' ORDER BY `customer_code` DESC";
//  exit();

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    WHERE company_id=" . $company_id . " AND branch_id = " . $branch_id . " AND location_id = " . $location_id . " AND type='customer' AND reconciliationType='invoice' " . $cond . " ORDER BY id desc limit " . $start . "," . $end . "";

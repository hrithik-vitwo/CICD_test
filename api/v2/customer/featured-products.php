...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($iv_sql["data"] as &$product) {
        ...
        $product['stock'] = $branchObj->itemQtyStockCheck($dynamic_item_id, "'rmWhOpen', 'fgWhOpen'")['sumOfBatches'];
        ...
        if ($territory == 0 && $mrp_group == 0) {
            $product['mrp_value'] = $product['itemPrice'];
        } else {

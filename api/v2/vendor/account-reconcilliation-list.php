...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    WHERE company_id=" . $company_id . " AND branch_id = " . $branch_id . " AND location_id = " . $location_id . " AND type='vendor' AND reconciliationType='account' " . $cond . " ORDER BY id desc limit " . $start . "," . $end . "";
    ...
    if ($iv_sql['status'] == "success") {
        ...
        // $data_array[] = array("cr-dr-reconcilliation" => $iv_data);
        sendApiResponse([
            "status" => "success",
            "message" => "Data found",
            "data" => $iv_sql["data"]

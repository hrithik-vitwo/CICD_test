<?php
    ...
    class StockLogUpload  extends OpeningClosingBalance
    {
        ...
        foreach($POST_DATA as $POST)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    $parentGlId = $item_query["data"]["parentGlId"];
                    $itemCode = $item_query["data"]["itemCode"];
                    ...
                    $totalamount=$oneItemStocksQty*$oneItemUnitPrice;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ($stockLogInsertSqlInsert['status'] == 'success') {
                                ...
                                $resultObj = $this->saveOpeningBalance($array);

                                $returnData['status'] = "success";
                                $returnData['message'] = "Stock Log added successfully";
                                $flag[] = array("status"=>"success","Item Code" => $itemCode,"Stock Message"=>"Stock Log added successfully at line ".$i,"Opening Message" => $resultObj["message"]);
                            } else {
                                $returnData['status'] = "warning";

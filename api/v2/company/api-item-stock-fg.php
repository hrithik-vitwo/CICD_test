...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    //find customer gl 
    $gl= queryGet("SELECT `itemsFG_gl` FROM `erp_acc_gl_mapping` WHERE `company_id` = $company_id");
    // console($gl['data']['customer_gl']);
    $gl_id = $gl['data']['itemsFG_gl'];

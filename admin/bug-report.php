...
if (isset($_POST['assign_task'])) {
    ...
    swalToast($comment["status"], $comment["message"]);
} else if (isset($_POST['transfer_task'])) {
                            ...
                            <div class="card card-tabs mb-0" style="border-radius: 20px;">
                                ...
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab" style="background: #fff; border-radius: 20px;">
                                        ...
                                        $sql_list = "SELECT * FROM `erp_bug_list`  WHERE `created_at` BETWEEN '" . $f_date . "' AND '" . $to_date . "'";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                <td> <?php echo $data['bug_description']; ?></td>
                                                            <?php }
                                                            $i++;
                                                            if (in_array($i, $settingsCheckbox)) { ?>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body" style="height: 334px;">
                                                                                <?php if ($data['assign_to'] != NULL) { ?>
                                                                                    <form action="" method="POST">
                                                                                        <input type="hidden" name="transfer_task">
                                                                                        <input type="hidden" name="bug_id" value="<?= $data['id'] ?>">
                                                                                        <input type="hidden" name="user_id" value="<?= $data['assign_to'] ?>">
                                                                                                                ...
                                                                                                                <div class="conversation">
                                                                                                                    ...
                                                                                                                    <!-- <form class="conversation-compose" method="POST" id="convFormId<?= $data["id"] ?>" enctype="multipart/form-data">
                                                                                                                        <div class="attachment">
                                                                                                                            ...
                                                                                                                            <input type="file" name="" id="attachFile<?= $data['id'] ?>" onchange="displayFileName(<?= $data['id'] ?>)">
                                                                                                                        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.data.forEach(function(messageData) {
                    ...
                    if (created_by.endsWith("admin") && !attatch) {
                        chatHtml += `
                    ...
                    } else if (created_by.endsWith("admin") && attatch) {
                    ...
                    <div class="message received"><div class="recever-name">${user_name??''}</div> ${conversation}
                        <span class="metadata"><span class="time">${time}</span></span>
                    </div>
                    `;
                    } else {

<?php
class TemplateQuotationTaxController
{
    ...
    public function printQuotationTax($quotationId = 0, $company_id = 0, $branch_id = 0, $location_id = 0, $printFlag = false, $templateId = 0, $redirectUrl = "")
    {
...
?>
                ...
                <div class="card classic-view bg-transparent">
                    <div class="card-body classic-view-so-table" style="overflow: auto;">
                        ...
                        <div class="printable-view">
                            <h3 class="h3-title text-center font-bold text-sm mb-4">Quotations</h3>
                            <?php console($country_fields); ?>
                            ...
                            <table class="classic-view table-bordered tableBorder">
                                <tbody>
                                    <tr>
                                        <td rowspan="3" colspan="5" class="px-2">
                                            ...
                                            <p>Flat No.<?= $companyData['location_flat_no'] ?>,
                                                <?= $companyData['location_street_name'] ?>,
                                            </p>
                                            <p><?= $companyData['location'] ?>, <?= $companyData['location_city'] ?>,
                                                <?= $companyData['location_district'] ?> <?= $companyData['location_pin_code'] ?>
                                            </p>
                                            <?php if ($countryCode == "103") { ?>
                                                <p>GSTIN/UIN: <?= $companyData['branch_gstin'] ?></p>
                                            <?php } ?>
                                            <p>Company's PAN: <?= $companyData['company_pan'] ?></p>
                                            <p>State Name : <?= fetchStateNameByGstin($companyData['branch_gstin']) ?>, Code :
                                                <?= substr($companyData['branch_gstin'], 0, 2); ?>
                                            </p>
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-2">
                                            ...
                                            <p>State Name : <?= fetchStateNameByGstin($customerData['customer_gstin']) ?>, Code :
                                                <?= substr($customerData['customer_gstin'], 0, 2); ?>
                                            </p>
                                        </td>
                                        <td colspan="5" class="px-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center text-bold invoiceTableHeadStyle" colspan="3">GST</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right px-2">
                                                ...
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($item['unitPrice'] * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            </td>
                                            <td class="text-right px-2">
                                                ...
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview(($item['unitPrice'] * $item['qty']) * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            </td>
                                            <!-- <td class="border-bottom-0"><?= $subTotalAmt ?></td> -->
                                            <td class="text-right px-2">
                                                <p><span class="text-small">(<?= decimalQuantityPreview($item['totalDiscount']) ?>%)</span>
                                                    <?= decimalValuePreview($item['itemTotalDiscount']) ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($item['itemTotalDiscount'] * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            </td>
                                            <td class="px-2">
                                            ...
                                            <td class="px-2" colspan="2">
                                                <p class=" font-bold"><span
                                                        class="rupee-symbol"></span><?= decimalValuePreview($item['totalTax']) ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($item['totalTax'] * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td class="text-right px-2">
                                                ...
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($item['totalPrice'] * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        <td colspan="11" class="font-bold text-right px-2">
                                            ...
                                            <?php if ($totalDiscountAmt > 0) { ?>
                                                ...
                                                <?php } ?>
                                            <?php } ?>
                                            <p>Total GST (<?= $companyCurrencyName ?>)</p>
                                            <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                <small class="text-small text-muted">Total GST (<?= $customerCurrencyName ?>)</small>
                                            <?php } ?>
                                        ...
                                        <td colspan="2" class="text-right font-bold px-2">
                                            ...
                                            <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                <small
                                                    class="text-small text-muted"><?= decimalValuePreview($subTotalAmt * $currencyConversionRate) ?></small>
                                            <?php } ?>
                                            <?php if ($totalDiscountAmt > 0) { ?>
                                                <p><span class="rupee-symbol pr-1"></span>(-)<?= decimalValuePreview($totalDiscountAmt) ?>
                                                </p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted">(-)<?= decimalValuePreview($totalDiscountAmt * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            <?php } ?>
                                            <?php if ($conditionGST || $gstCode == "") { ?>
                                                ...
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= decimalValuePreview(($totalTaxAmt / 2) * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                                <p><span class="pr-1"></span><?= decimalValuePreview($totalTaxAmt / 2) ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= decimalValuePreview($totalTaxAmt * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            <?php } ?>
                                            <p><?= decimalValuePreview($quotationDetails['totalAmount']) ?></p>
                                            <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                <small
                                                    class="text-small text-muted"><?= decimalValuePreview($quotationDetails['totalAmount'] * $currencyConversionRate) ?></small>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td colspan="7" class="px-2">
                                            ...
                                            <p class="font-bold">
                                                <?= $companyCurrencyName . " " . number_to_words_indian_rupees($quotationDetails['totalAmount']); ?>
                                                ONLY
                                            </p>
                                            <!-- <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="7" class="px-2">
                                            ...
                                            <p>Created By: <strong><?= getCreatedByUser($quotationDetails['created_by']); ?></strong>
                                            </p>
                                            <?php if ($attachmentObj['status'] == 'success' && $printFlag == TRUE) { ?>
                                                <a href="<?= COMP_STORAGE_URL . '/others/' ?><?= $attachmentObj['data']['file_name'] ?>"
                                                    target="_blank"
                                                    class="text-primary font-bold text-decoration-none text-decoration-underline" download>
                                                    View Attachment
                                                </a>
                                            <?php } ?>
                                        </td>
                                        <td colspan="6" class="text-right px-2">
                                            ...
                                            <p class="text-center sign-img">
                                                <img width="160" src="<?= COMP_STORAGE_URL ?>/profile/<?= $companyData['signature'] ?>"
                                                    alt="">
                                            </p>
                                        </td>
                                    </tr>
    ...
    public function printQuotation($quotationId = 0, $company_id = 0, $branch_id = 0, $location_id = 0, $printFlag = false, $templateId = 0, $redirectUrl = "")
    {
        ...
        if (count($quotationDetailsObj['data']) <= 0) {
            ...
            $quotationDetails = $quotationDetailsObj['data'];
            $taxComponents = json_decode($quotationDetails['taxComponents'], true);
            $company_id = $quotationDetails['company_id'];
            $branch_id = $quotationDetails['branch_id'];
            $location_id = $quotationDetails['location_id'];
                            ...
                            <table class="classic-view table-bordered tableBorder">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="8" class="px-2">
                                            <p>Mode/Terms of Payment</p>
                                            <p>Inco Term : <?= $quotationDetails['inco_term'] ?></p>
                                            <p>Lead Time : <?= $quotationDetails['leadtime'] ?></p>
                                            <p>Validity Period : <?= formatDateWeb($quotationDetails['validityperiod']) ?></p>
                                            <?php if ($quotationDetails['credit_period'] != "") { ?>
                                                <p><?= $quotationDetails['credit_period'] ?></p>
                                            <?php } ?>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2" class="invoiceTableHeadStyle">Taxable Amount</th>
                                        <!-- <th rowspan="2">Sub Total</th> -->
                                        <th class="text-center text-bold invoiceTableHeadStyle" colspan="2">Discount</th>
                                    ...
                                    foreach ($quotationItemDetails as $key => $item) {
                                        ...
                                        $totalTaxAmt += $item['totalTax'];
                                        $allSubTotalAmt += $item['unitPrice'] * $item['qty'];
                                        $totalDiscountAmt += $item['itemTotalDiscount'] + $item['cashDiscountAmount'];
                                        $subTotalAmt += $item['unitPrice'] * $item['qty'];
                                        $totalAmt += $item['totalPrice'];
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-right px-2">
                                                <p><span class="text-small">(<?= decimalQuantityPreview($item['cashDiscount']) ?>%)</span>
                                                    <?= decimalValuePreview($item['cashDiscountAmount']) ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($item['cashDiscountAmount'] * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            </td>
                                            ...
                                            ?>
                                                    ...
                                                    <td class="text-right px-2">
                                                        <p class=" font-bold"><span
                                                                class="rupee-symbol"></span><?= decimalValuePreview($itemGstAmt) ?></p>
                                                        <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                            <small
                                                                class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($itemGstAmt * $currencyConversionRate) ?></small>
                                                        <?php } ?>
                                                    </td>
                                                    <td class="text-right px-2">
                                                        <p class=" font-bold"><?= decimalQuantityPreview($itemGstPer) ?>%</p>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <td class="px-2" colspan="2">
                                                        <p class="text-right font-bold"><span
                                                                class="rupee-symbol"></span><?= decimalValuePreview($item['totalTax']) ?></p>
                                                        <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                            <small
                                                                class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($item['totalTax'] * $currencyConversionRate) ?></small>
                                    ...
                                    <tr>
                                        <td colspan="11" class="font-bold text-right px-2">
                                            ...
                                            <?php if ($countrycode == 103) {
                                                ...
                                                foreach ($taxComponents as $tax) { ?>
                                                    ...
                                                    <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                        <small class="text-small text-muted">Total <?= $tax['gstType'] ?>
                                                            (<?= $customerCurrencyName ?>)</small>
                                                    <?php } ?>
                                            <?php }
                                            } ?>
                                            <p>Grand Total (<?= $companyCurrencyName ?>)</p>
                                        ...
                                        <td colspan="2" class="text-right font-bold px-2">
                                            ...
                                            <?php if ($totalDiscountAmt > 0) { ?>
                                                ...
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small
                                                        class="text-small text-right text-muted">(-)<?= decimalValuePreview($totalDiscountAmt * $currencyConversionRate) ?></small>
                                                <?php } ?>
                                            <?php } ?>
                                            <?php if ($countrycode == 103) {
                                                if ($conditionGST || $gstCode == "") { ?>
                                                ...
                                                foreach ($taxComponents as $tax) { ?>
                                                    <p><span
                                                            class="pr-1"></span><?= decimalValuePreview($totalTaxAmt / (100 / $tax['taxPercentage']), 2) ?>
                                                    </p>
                                                    <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                        <small
                                                            class="text-small text-muted"><?= decimalValuePreview($totalTaxAmt / (100 / $tax['taxPercentage']) * $currencyConversionRate) ?></small>
                                            <?php }
                                                }
                                            } ?>
                                            <p><?= decimalValuePreview($quotationDetails['totalAmount']) ?></p>

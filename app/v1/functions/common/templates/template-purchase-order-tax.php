            ...
            <div class="card classic-view bg-transparent">
                <div class="card-body classic-view-so-table" style="overflow: auto;">
                    <div class="printable-view">
                        <h3 class="h3-title text-center font-bold text-sm mb-4">Purchase Orders</h3>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="6" class="border-right">
                                        ...
                                        <?php if ($v_address != null) { ?>
                                            ...
                                            <p>State Name :<?= $v_address['vendor_business_state'] ?></p>
                                        <?php
                                        }
                                        ?>
                                        <?php if ($businessTaxID!=null) { ?>
                                                <p><?= $businessTaxID?>: <?= $vendorDetails['vendor_gstin'] ?></p>
                                            <?php } ?>
                                                <?php if($taxNumber!=null) {?>
                                            <p>Company's <?=$taxNumber?>: <?= $vendorDetails['vendor_pan'] ?></p>
                                             <?php }?>
                                ...
                                <tr>
                                    <td colspan="6" class="border-right">
                                        ...
                                        <p>State Name : <?= $branchDetailsObj['location_state']; ?></p>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><p><?=decimalQuantityPreview( $oneItems['gst']) ?></p></td>

...
class TemplateInvoiceController
{
    ...
    // print invoice
    public function printInvoicetax($invoiceId = 0, $templateId = 0, $redirectUrl = "")
    {
        //  echo '0000000000000';
        // echo 1;
        // exit();
        ...
        $company_id = $invoiceDetailsObj['data'][0]['company_id'];
        $branch_id = $invoiceDetailsObj['data'][0]['branch_id'];
        $location_id = $invoiceDetailsObj['data'][0]['location_id'];
        $created_by = $invoiceDetailsObj['data'][0]['created_by'];
        $updated_by = $invoiceDetailsObj['data'][0]['updated_by'];
        ...
        $cust_id=$invoiceDetailsObj['data'][0]['customer_id'];

        $source_address_sql = queryGet("SELECT * FROM `erp_customer_address` WHERE `customer_id`= '" . $cust_id . "' ")['data'];
        // console($source_address_sql);

        $state_name = $source_address_sql['customer_address_state'];
        $branchDetailsObj = queryGet("SELECT state as location_state FROM `" . ERP_BRANCHES . "` WHERE `branch_id`='$branch_id' AND `company_id`='$company_id'")['data'];
        ...
        if (count($invoiceDetailsObj['data']) <= 0) {
            ...
            $taxComponents = json_decode($invoiceDetails['taxComponents'], true);
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            ...
                                            foreach ($taxComponents as $tax) { ?>
                                                <th class="text-center text-bold invoiceTableHeadStyle" colspan="2"><?= $tax['gstType'] ?></th>
                                        <?php }
                                        } ?>
                                        ...
                                        <td colspan="2" class="text-right font-bold px-2">
                                            ...
                                            <?php if ($invoiceDetails['total_tax_amt'] > 0) { ?>
                                                <?php if ($countrycode == 103) {
                                                    ...
                                                    foreach ($taxComponents as $tax) { ?>
                                                        <p><span class="pr-1"></span><?= decimalValuePreview($tax['taxAmount']) ?></p>
                                                        <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                            <small class="text-small text-muted"><?= decimalValuePreview($tax['taxAmount'] * $currencyConversionRate) ?></small>
                                                        <?php } ?>
                                                <?php    }
                                                } ?>
                                            <?php } ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <?php if ($countrycode == 103) {
                                            ...
                                            foreach ($taxComponents as $tax) { ?>
                                                <th colspan="3" class="text-bold text-center invoiceHSNTableHeadStyle"><?= $tax['gstType'] ?></th>
                                        <?php }
                                        } ?>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($countrycode == 103) {
                                                ...
                                                foreach ($taxComponents as $key => $tax) {
                                                    $itemGstAmt = $item['totalTax'] / (100 / $tax['taxPercentage']);
                                                    $itemGstPer = $item['tax'] / (100 / $tax['taxPercentage']);
                                                    $totaltax[$key] += $itemGstAmt; ?>
                                                    <td class="text-right px-2">
                                                        <p class="invoiceSmallFont"><?= decimalQuantityPreview($itemGstPer) ?>%</p>
                                                    </td>
                                                    <td class="text-right px-2" colspan="2">
                                                        <p class="invoiceSmallFont"><?= decimalValuePreview($itemGstAmt, 2) ?></p>
                                                        <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                            <small class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($itemGstAmt * $currencyConversionRate) ?></small>
                                                        <?php } ?>
                                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($countrycode == 103) {
                                            ...
                                            foreach ($taxComponents as $key => $tax) { ?>
                                                <td class="text-right font-bold px-2" colspan="3">
                                                    <p class="invoiceSmallFont"><?= decimalValuePreview($totaltax[$key]) ?></p>
                                                    <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                        <small class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($totaltax[$key] * $currencyConversionRate) ?></small>
                                                    <?php } ?>
                                                </td>
                                        <?php }
                                        } ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <!-- taxable amount -->
                                            <td class="text-right px-2">
                                                <p><?= decimalValuePreview($taxableAmount) ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($countrycode == 103) {
                                                ...
                                                foreach ($taxComponents as $key => $tax) {
                                                    ...
                                                    <td class="text-right px-2" colspan="2">
                                                        <p class="invoiceSmallFont"><?= decimalValuePreview($itemGstAmt) ?></p>
                                                        <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                            <small class="text-small text-muted"><?= $customerCurrencyName . ' ' . decimalValuePreview($itemGstAmt * $currencyConversionRate) ?></small>
                                                        <?php } ?>
                                                    </td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                    ...
                                                    <td class="text-right px-2">
                                                        <p class="">(<?= decimalValuePreview($itemGstPer) ?>%)</p>
                                        ...
                                        <td colspan="11" class="font-bold text-right px-2">
                                            ...
                                            <?php if ($invoiceDetails['total_tax_amt'] > 0) { ?>
                                                <?php if ($countrycode == 103) {
                                                    ...
                                                    foreach ($taxComponents as $tax) { ?>
                                                        <p>Total <?= $tax['gstType'] ?> (<?= $customerCurrencyName ?>)</p>
                                                <?php  }
                                                } ?>
                                            <?php } ?>
                                            <?php
                                        ...
                                        <td colspan="2" class="text-right font-bold px-2">
                                            ...
                                            <?php if ($invoiceDetails['total_tax_amt'] > 0) { ?>
                                                <?php if ($countrycode == 103) {
                                                    ...
                                                    foreach ($taxComponents as $tax) { ?>
                                                        <p><span class="pr-1"></span><?= decimalValuePreview($tax['taxAmount'] * $currencyConversionRate) ?></p>
                                                <?php  }
                                                } ?>
                                            <?php } ?>
                                            <?php
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($countrycode == 103) {
                                                ...
                                                foreach ($taxComponents as $key => $tax) {
                                                    ...
                                                    <td class="text-right px-2" colspan="2">
                                                        <p class="invoiceSmallFont"><?= decimalValuePreview($itemGstAmt * $currencyConversionRate) ?></p>
                                                    </td>
                                            <?php }
                                            } ?>
                                            <td colspan="3" class="text-right px-2">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($countrycode == 103) {
                                            ...
                                            foreach ($taxComponents as $key => $tax) { ?>
                                                <td class="text-right font-bold px-2" colspan="3">
                                                    <p class="invoiceSmallFont"><?= decimalValuePreview($totaltax[$key] * $currencyConversionRate) ?></p>
                                                </td>
                                        <?php  }
                                        } ?>
                                        <td colspan="3" class="text-right font-bold px-2">

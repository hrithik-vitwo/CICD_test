...
class TemplateCreditNoteController
{
    ...
    public function printCreditNotes($cr_note_id = 0)
    {
                                ...
                                <td rowspan="2" colspan="9">
                                    <div class="d-flex">
                                        ...
                                        <div class="add-details text-left">
                                            ...
                                            <p>PAN No : <?= $customerData['customer_pan'] ?></p>
                                            <p>State Name : <?= fetchStateNameByGstin($customerData['customer_gstin']) ?></p>
                            ...
                            ?>
                                <tr>
                                    ...
                                    if ($conditionGST || $customerGstin == "") {
                                        ...
                                        $cgstAmt= isset($item['cgst']) && $item['cgst'] !== null && $item['cgst'] !== 0 ? decimalValuePreview($item['cgst']) : decimalValuePreview($taxbleAmount * $cgstigstpersentage / 100);
                                        $sgstAmt= isset($item['sgst']) && $item['sgst'] !== null && $item['sgst'] !== 0 ?  decimalValuePreview($item['sgst']) : decimalValuePreview($taxbleAmount * $cgstigstpersentage / 100);
                                    ...
                                    <?php } else {   
                                        $igstAmt = isset($item['igst']) && $item['igst'] !== null && $item['igst'] !== 0 ? decimalValuePreview($item['igst']) : decimalValuePreview($taxbleAmount * $item['item_tax'] / 100);                                      
                                        $totaligst += $igstAmt;
                                        ?>
                                        <td>

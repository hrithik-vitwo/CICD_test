                                            ...
                                            <td colspan="13" class="px-2">
                                                <div class="qr-section d-flex justify-content-between">
                                                    ...
                                                    <div class="invoice-qr">
                                                        ...
                                                        <div id="eInvoiceQrCode0<?= $invoiceDetails['invoice_no'] ?>"></div>
                                                    </div>
                                                </div>
                                                <script>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                <td class="text-right px-2">
                                                    <p class="">(<?= number_format($itemGstPer, 2) ?>%)</p>
                                                
                                                    <p class=""><span class="rupee-symbol"></span><?= number_format($itemGstAmt, 2) ?></p>
                                                    <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                            ...
                                            <?php } else { ?>
                                                <td class="px-2" colspan="2">
                                                    <p class="">(<?= $item['tax'] ?>%)</p>
                                                    <p class=""><span class="rupee-symbol"></span><?= number_format($item['totalTax'], 2) ?></p>
                                                    <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td colspan="3" class="text-right px-2">
                                                <p class="invoiceSmallFont"><?= number_format($item['hsnTaxableAmount'], 2) ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small class="text-small text-muted"><?= $customerCurrencyName . ' ' . number_format($item['hsnTaxableAmount'] * $currencyConversionRate, 2) ?></small>
                                                <?php } ?>
                                            </td>
                                            <?php if ($conditionGST || $gstCode == "") { ?>
                                                <td class="text-right px-2">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6" class="text-right px-2">
                                            ...
                                            <p class="text-center sign-img">
                                                <img width="160" src="<?= BUCKET_URL . "uploads/" . $company_id . "/profile/" . $companyData['signature'] ?>" alt="signature">
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                                        ...
                                        <tr>
                                            <td colspan="15" class="px-2">
                                                <div class="qr-section d-flex justify-content-between">
                                                    ...
                                                    <div class="invoice-qr">
                                                        <!-- <img width="200" src="" alt="QRCode"> -->
                                                        <div id="eInvoiceQrCode1<?= $invoiceDetails['invoice_no'] ?>"></div>
                                                    </div>
                                                </div>
                                                <script>
                                                    $(document).ready(function() {
                                    ...
                                    foreach ($invoiceItemDetails as $key => $item) {
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td class="text-right px-2">
                                                <p><?php echo number_format(((($item['unitPrice'] * $item['qty']) - $item['totalDiscountAmt']) / $item['qty']), 2); ?> </p>
                                            </td>
                                            <td class="text-right px-2">
                                                <p><?= $taxableAmount ?></p>
                                                <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                <td class="text-right px-2">
                                                    <p class="">(<?= number_format($itemGstPer, 2) ?>%)</p>
                                                    <p class=" "><span class="rupee-symbol"></span><?= number_format($itemGstAmt * $currencyConversionRate, 2) ?></p>
                                            ...
                                            <?php } else { ?>
                                                <td class="px-2 text-right" colspan="2">
                                                    <p class=" ">(<?= $item['tax'] ?>%)</p>
                                                    <p class=" "><span class="rupee-symbol"></span><?= number_format($item['totalTax'] * $currencyConversionRate, 2) ?></p>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td colspan="3" class="text-right px-2">
                                                <p class="invoiceSmallFont"><?= number_format($item['hsnTaxableAmount'] * $currencyConversionRate, 2) ?></p>
                                                <!-- <?php if ($companyCurrencyName != $customerCurrencyName) { ?>
                                                    <small class="text-small text-muted"><?= $customerCurrencyName . ' ' . number_format($item['hsnTaxableAmount'] * $currencyConversionRate, 2) ?></small>
                                                <?php } ?> -->
                                            </td>

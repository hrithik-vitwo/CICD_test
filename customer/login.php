...
if(isset($_GET["logout"])){
    unset($_SESSION["logedCustomerAdminInfo"]);
    session_destroy();
            ...
            <div class="card-body">
                ...
                <form action="" method="post" onsubmit="return validate();">
                    <div class="input-group mb-3">
                        <input type="text" name="customer_code" id="customer_code" class="form-control" placeholder="Customer Code">
                    ...
                    <span class="my-0" style="position: absolute; top: 175px; color: red; font-size: 12px; " id="error_customer_code"></span>
                    <div class="input-group mb-3">

...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="<?= SERVICE_URL ?>" class="brand-link" style="">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= SERVICE_URL ?>" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?= SERVICE_URL ?>login.php?logout" onclick="return confirm('Are you sure to logout?')" class="nav-link">
